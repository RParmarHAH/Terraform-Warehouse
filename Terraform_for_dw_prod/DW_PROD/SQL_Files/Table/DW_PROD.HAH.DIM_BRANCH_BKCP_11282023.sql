CREATE OR REPLACE TABLE DW_PROD.HAH.DIM_BRANCH_BKCP_11282023 (
	...
	constraint FK_DIM_BRANCH_PARENT_BRANCH foreign key (PARENT_BRANCH_KEY) references DW_PROD.HAH.DIM_BRANCH(BRANCH_KEY),
