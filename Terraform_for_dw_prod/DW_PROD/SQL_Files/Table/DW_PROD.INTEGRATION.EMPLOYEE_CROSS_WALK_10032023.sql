CREATE OR REPLACE TABLE DW_PROD.INTEGRATION.EMPLOYEE_CROSS_WALK_10032023 cluster by (EMPLOYEE_ENTERPRISE_ID,AMS_EMPLOYEE_KEY,PAYROLL_EMPLOYEE_KEY,AMS_EMPLOYEE_ID, AMS_SOURCE_SYSTEM_ID, AMS_SYSTEM_CODE)(
