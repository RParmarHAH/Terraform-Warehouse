CREATE OR REPLACE TABLE DW_PROD.PUBLIC.EMPLOYEE_CROSS_WALK_TEMP_FOR_DUPS_TEST cluster by (EMPLOYEE_ENTERPRISE_ID,AMS_EMPLOYEE_KEY,PAYROLL_EMPLOYEE_KEY,AMS_EMPLOYEE_ID, AMS_SOURCE_SYSTEM_ID, AMS_SYSTEM_CODE)(
