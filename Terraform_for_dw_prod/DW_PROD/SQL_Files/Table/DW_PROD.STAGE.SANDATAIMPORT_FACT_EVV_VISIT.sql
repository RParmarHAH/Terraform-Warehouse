CREATE OR REPLACE TABLE DW_PROD.STAGE.SANDATAIMPORT_FACT_EVV_VISIT (
	VISIT_KEY VARCHAR(32) NOT NULL,
	SCHEDULE_VISIT_INDICATOR VARCHAR(15),
	...
	SCHEDULE_TIMEIN TIMESTAMP_NTZ(9),
	SCHEDULE_TIMEOUT TIMESTAMP_NTZ(9),
	SCHEDULE_DURATION NUMBER(4,2),
	ACTUAL_TIMEIN TIMESTAMP_NTZ(9),
	ACTUAL_TIMEOUT TIMESTAMP_NTZ(9),
	ACTUAL_DURATION NUMBER(4,2),
	ADJUSTED_TIMEIN TIMESTAMP_NTZ(9),
	ADJUSTED_TIMEOUT TIMESTAMP_NTZ(9),
	ADJUSTED_DURATION NUMBER(4,2),
	COMMENTS VARCHAR(5000),
	IS_EVV_FLAG BOOLEAN COMMENT 'Record came from EVV feed',
	...
	constraint PK_FACT_VISIT primary key (VISIT_KEY)
);