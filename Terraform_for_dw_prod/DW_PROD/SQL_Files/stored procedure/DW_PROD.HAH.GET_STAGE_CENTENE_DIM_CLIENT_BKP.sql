CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_CENTENE_DIM_CLIENT_BKP("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
