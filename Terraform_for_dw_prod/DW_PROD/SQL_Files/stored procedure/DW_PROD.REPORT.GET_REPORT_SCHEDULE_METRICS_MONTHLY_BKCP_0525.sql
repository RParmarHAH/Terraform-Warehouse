CREATE OR REPLACE PROCEDURE DW_PROD.REPORT.GET_REPORT_SCHEDULE_METRICS_MONTHLY_BKCP_0525("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
--*****************************************************************************************************************************
INSERT OVERWRITE INTO REPORT.SCHEDULE_METRICS_MONTHLY_BKCP_0525
	(REPORT_DATE, SOURCE_SYSTEM_ID, ORIGINAL_CLIENT_KEY, CLIENT_KEY, CONTRACT_KEY, ORIGINAL_EMPLOYEE_KEY, EMPLOYEE_KEY, BRANCH_KEY, VISITS_SCHEDULED, 
	VISITS_COMPLETED, VISITS_CANCELLED, VISITS_IN_REVIEW, FUTURE_VISITS, FUTURE_CANCELLED_VISITS, FUTURE_HOLD_VISITS, VISITS_MISSED, VISITS_RESCHEDULED, 
	HOURS_SCHEDULED, HOURS_SERVED, HOURS_CANCELLED, HOURS_IN_REVIEW, FUTURE_HOURS, FUTURE_CANCELLED_HOURS, FUTURE_HOLD_HOURS, HOURS_MISSED, HOURS_RESCHEDULED, 
	...
	SELECT REPORT_DATE, SOURCE_SYSTEM_ID, ORIGINAL_CLIENT_KEY, CLIENT_KEY, CONTRACT_KEY, ORIGINAL_EMPLOYEE_KEY, EMPLOYEE_KEY, BRANCH_KEY, 
	VISITS_SCHEDULED, VISITS_COMPLETED, VISITS_CANCELLED, VISITS_IN_REVIEW, FUTURE_VISITS, FUTURE_CANCELLED_VISITS, FUTURE_HOLD_VISITS, VISITS_MISSED, VISITS_RESCHEDULED, 
	HOURS_SCHEDULED, HOURS_SERVED, HOURS_CANCELLED, HOURS_IN_REVIEW, FUTURE_HOURS, FUTURE_CANCELLED_HOURS, FUTURE_HOLD_HOURS, HOURS_MISSED, HOURS_RESCHEDULED, 
