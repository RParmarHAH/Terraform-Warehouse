CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_MATRIXCARE_FACT_VISIT_BKCP_0525("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
-- 05/08/23     Jashvant Patel          Updated date logic to convert time from UTC to American
--*****************************************************************************************************************************
INSERT OVERWRITE INTO STAGE.MATRIXCARE_FACT_VISIT_BKCP_0525
