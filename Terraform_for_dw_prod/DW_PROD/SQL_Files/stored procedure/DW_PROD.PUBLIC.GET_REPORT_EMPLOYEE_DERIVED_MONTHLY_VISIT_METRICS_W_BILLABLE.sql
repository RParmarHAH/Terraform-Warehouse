CREATE OR REPLACE PROCEDURE DW_PROD.PUBLIC.GET_REPORT_EMPLOYEE_DERIVED_MONTHLY_VISIT_METRICS_W_BILLABLE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
SELECT ellm.SERVICE_MONTH, 
       ...
       WHEN ALTAMAHA_EMPLOYEE.EMPLOYEE_KEY IS NOT NULL THEN ''ALTAMAHA'' 
		WHEN PRAETORIAN_ACQUIRED_EMPLOYEE.EMPLOYEE_KEY IS NOT NULL THEN ''PRAETORIAN_ACQUIRED_EMPLOYEE''		
