CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_COSTALSYNCDATA_DIM_INVOICE_STATUS_MAPPING()
...
USING DW_PROD.STAGE.COSTALSYNCDATA_DIM_INVOICE_STATUS_MAPPING STAGE 
