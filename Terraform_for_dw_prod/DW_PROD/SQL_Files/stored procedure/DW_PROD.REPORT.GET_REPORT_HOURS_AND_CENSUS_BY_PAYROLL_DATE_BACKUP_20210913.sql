CREATE OR REPLACE PROCEDURE DW_PROD.REPORT.GET_REPORT_HOURS_AND_CENSUS_BY_PAYROLL_DATE_BACKUP_20210913("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
