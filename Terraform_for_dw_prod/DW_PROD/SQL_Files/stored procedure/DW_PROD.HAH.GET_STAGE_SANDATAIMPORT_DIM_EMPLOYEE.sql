CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_SANDATAIMPORT_DIM_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
--*****************************************************************************************************************************
--
INSERT OVERWRITE INTO DW_PROD.STAGE.SANDATAIMPORT_DIM_EMPLOYEE
WITH 
-- offbrnch AS
-- (
...
-- FROM DISC_DEV.SandataImport.Sandata_Staffs AS stf
-- LEFT OUTER JOIN DISC_DEV.BI_Repository.EXTERNALIDS AS eid ON stf.HomeLocation = eid.ExtID AND eid.Typ = ''L''
...
FROM DISC_DEDUPE_PROD.SANDATAIMPORT.EMPLOYEE_MASTER_LIST AS stf
