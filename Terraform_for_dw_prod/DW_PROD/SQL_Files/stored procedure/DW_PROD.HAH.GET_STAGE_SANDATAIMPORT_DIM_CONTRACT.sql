CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_SANDATAIMPORT_DIM_CONTRACT("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
--*****************************************************************************************************************************
--
INSERT OVERWRITE INTO DW_PROD.STAGE.SANDATAIMPORT_DIM_CONTRACT
WITH MAPPING AS (
    SELECT DISTINCT
