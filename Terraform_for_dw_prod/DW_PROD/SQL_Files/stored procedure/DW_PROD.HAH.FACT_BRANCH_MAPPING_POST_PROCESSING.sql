CREATE OR REPLACE PROCEDURE DW_PROD.HAH.FACT_BRANCH_MAPPING_POST_PROCESSING()
...
INSERT OVERWRITE INTO DW_PROD.HAH.FACT_BRANCH_MAPPING 
WITH MERGE_1 AS (
	...
	(
		...
		LEFT JOIN LOAD_ALAYACARE_PROD.CONFIGURATION.REALIGNED_BRANCHES AS ALAYACARE_MERGED_BRANCH_MAPPING
