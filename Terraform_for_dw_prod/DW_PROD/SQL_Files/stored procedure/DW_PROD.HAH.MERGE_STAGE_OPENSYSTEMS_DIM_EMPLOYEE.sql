CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_OPENSYSTEMS_DIM_EMPLOYEE()
...
BEGIN
MERGE INTO DW_PROD.HAH.DIM_EMPLOYEE TGT 
USING DW_PROD.STAGE.OPENSYSTEMS_DIM_EMPLOYEE STAGE 
