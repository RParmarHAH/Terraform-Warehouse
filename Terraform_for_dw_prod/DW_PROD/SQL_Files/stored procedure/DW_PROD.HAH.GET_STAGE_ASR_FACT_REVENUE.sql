CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_ASR_FACT_REVENUE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
INSERT OVERWRITE INTO DW_PROD.STAGE.ASR_FACT_REVENUE 
WITH CLIENT AS
(
    SELECT * FROM
    (
...
,ALL_CONTRACTS AS (
    SELECT SERVICE_TYPE_ID, SERVICE_TYPE_NAME FROM DISC_PROD.ASR.ASR_SERVICETYPES S 
    UNION
...
LEFT JOIN 
DISC_PROD.ASR.ASR_SERVICE_TYPE_MAPPING SM ON SM.SERVICE_TYPE_NAME = RSB.SERVICETYPE 
LEFT JOIN 
DISC_PROD.ASR.ASR_VISITS V ON V.SERVICEVISITACTUALID = RSB.SERVICEVISITACTUALID
