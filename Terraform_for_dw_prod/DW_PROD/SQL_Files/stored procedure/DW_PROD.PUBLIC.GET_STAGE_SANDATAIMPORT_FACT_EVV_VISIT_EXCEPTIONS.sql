CREATE OR REPLACE PROCEDURE DW_PROD.PUBLIC.GET_STAGE_SANDATAIMPORT_FACT_EVV_VISIT_EXCEPTIONS("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
LATERAL FLATTEN(INPUT=>SPLIT(exceptioncode, ''|'')) cs
...
LEFT JOIN DISC_PROD.SANDATAIMPORT.SANDATA_EXCEPTIONCODES excep 
