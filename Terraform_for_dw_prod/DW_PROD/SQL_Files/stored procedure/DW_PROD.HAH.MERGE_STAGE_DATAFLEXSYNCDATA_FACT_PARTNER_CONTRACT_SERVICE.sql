CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_DATAFLEXSYNCDATA_FACT_PARTNER_CONTRACT_SERVICE()
...
USING DW_PROD.STAGE.DATAFLEXSYNCDATA_FACT_PARTNER_CONTRACT_SERVICE AS src
