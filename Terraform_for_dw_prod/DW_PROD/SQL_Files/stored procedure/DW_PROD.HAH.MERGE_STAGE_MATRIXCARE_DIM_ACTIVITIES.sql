CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_MATRIXCARE_DIM_ACTIVITIES()
...
BEGIN
    MERGE INTO DW_PROD.HAH.DIM_ACTIVITIES TGT 
USING DW_PROD.STAGE.MATRIXCARE_DIM_ACTIVITIES STAGE 
