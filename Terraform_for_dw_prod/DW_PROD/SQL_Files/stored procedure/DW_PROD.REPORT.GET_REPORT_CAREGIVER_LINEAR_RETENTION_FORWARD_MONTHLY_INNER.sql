CREATE OR REPLACE PROCEDURE DW_PROD.REPORT.GET_REPORT_CAREGIVER_LINEAR_RETENTION_FORWARD_MONTHLY_INNER("MONTH_DATE" DATE, "STR_ETL_TASK_KEY" VARCHAR(16777216))
