CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_ASR_FACT_CLIENT_SERVICE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
INSERT OVERWRITE INTO DW_PROD.STAGE.ASR_FACT_CLIENT_SERVICE
WITH DEDUPE AS (SELECT * FROM DISC_PROD.ASR.ASR_PLANOFSERVICE  S
...
WHEN S.RECURRENCETYPE = 7 THEN ''By Request (Weekly)''
	...
	LEFT JOIN DISC_PROD.ASR.ASR_SERVICETYPES SER ON SER.SERVICE_TYPE_ID = S.SERVICETYPE 
	LEFT JOIN DISC_PROD.ASR.ASR_BILLINGCODES B ON B.BILLINGCODEID = S.BILLINGCODEID;
