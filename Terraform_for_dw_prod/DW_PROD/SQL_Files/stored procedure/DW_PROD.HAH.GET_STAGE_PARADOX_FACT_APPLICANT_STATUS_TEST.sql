CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_PARADOX_FACT_APPLICANT_STATUS_TEST("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
--*****************************************************************************************************************************
--
INSERT OVERWRITE INTO DW_PROD.STAGE.PARADOX_FACT_APPLICANT_STATUS_TEST
...
FROM DISC_PROD.PARADOX.CANDIDATE_JOURNEY CJ
   ...
   -- LEFT JOIN DW_PROD.HAH.AMS_PARADOX_BRANCH_MAPPING CS 
    LEFT JOIN DW_PROD.HAH.AMS_PARADOX_BRANCH_MAPPING_test_1 CS
