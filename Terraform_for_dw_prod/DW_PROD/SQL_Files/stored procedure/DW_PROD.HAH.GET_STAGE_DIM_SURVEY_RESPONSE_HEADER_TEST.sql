CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_DIM_SURVEY_RESPONSE_HEADER_TEST("SURVEY_ID" VARCHAR(16777216))
...
||IFF("''PARTNER_KEY''" IS NOT NULL,''LEFT JOIN DW_PROD.HAH.DIM_PARTNER DP ON f.value:values.''||"''PARTNER_KEY''"||''::STRING = DP.PARTNER_CODE\\n'','''')
