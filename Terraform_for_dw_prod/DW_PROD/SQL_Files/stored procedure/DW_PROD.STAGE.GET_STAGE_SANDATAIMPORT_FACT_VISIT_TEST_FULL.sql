CREATE OR REPLACE PROCEDURE DW_PROD.STAGE.GET_STAGE_SANDATAIMPORT_FACT_VISIT_TEST_FULL("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
