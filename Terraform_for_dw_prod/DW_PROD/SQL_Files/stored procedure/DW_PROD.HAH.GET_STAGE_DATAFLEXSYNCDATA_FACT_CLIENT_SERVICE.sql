CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_DATAFLEXSYNCDATA_FACT_CLIENT_SERVICE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
--This prc is taking auth type from DISC_DEV.DATAFLEXSYNCDATA.DFCONTRACTSAUTH which was created
--after receiving multiple weekly auth type contract in jira ticket  ---IDDOX-554
--*********************************************************************************************************************
CALL DW_PROD.HAH.GET_STAGE_DATAFLEXSYNCDATA_DIM_DERIVED_AUTH_FROM_HISTORY_WITH_MASTER_DEDUP(-1,-1,-1);	
...
FROM DW_PROD.STAGE.DATAFLEXSYNCDATA_DIM_DERIVED_AUTH_FROM_HISTORY_WITH_MASTER_DEDUP CC
...
LEFT JOIN DW_PROD.HAH.FACT_SYSTEM_CUTOVER_DATE_2_0 CUT
