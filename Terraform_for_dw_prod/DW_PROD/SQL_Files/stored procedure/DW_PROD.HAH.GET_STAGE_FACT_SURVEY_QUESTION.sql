CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_FACT_SURVEY_QUESTION("SURVEY_ID" VARCHAR(16777216))
...
DECLARE
    SQL VARCHAR;
BEGIN
	DELETE FROM DW_PROD.STAGE.FACT_SURVEY_QUESTION WHERE SURVEY_ID=:SURVEY_ID;
																	 

	INSERT INTO DW_PROD.STAGE.FACT_SURVEY_QUESTION
WITH MAIN AS 
...
FROM FINAL_CLEANED
LEFT JOIN DW_PROD.HAH.GATOR_SURVEY_QUESTION_KEY_MAPPING GSQM ON FINAL_CLEANED.SURVEY_ID=GSQM.SURVEY_ID 
