CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_OPENSYSTEMS_FACT_VISIT_EXCEPTION()
...
BEGIN
	MERGE INTO DW_PROD.HAH.FACT_VISIT_EXCEPTION TGT USING DW_PROD.STAGE.OPENSYSTEMS_FACT_VISIT_EXCEPTION STAGE 
