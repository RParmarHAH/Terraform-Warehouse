CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_PAYLOCITY_DIM_BRANCH("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
INSERT OVERWRITE INTO DW_PROD.STAGE.PAYLOCITY_DIM_BRANCH
...
FROM BRANCH_MAPPING
LEFT JOIN DW_PROD.HAH.DIM_BRANCH AS BRANCH ON BRANCH_MAPPING.BRANCH_KEY=BRANCH.BRANCH_KEY
LEFT JOIN DW_PROD.HAH.DIM_SOURCE_SYSTEM AS SOURCE_SYSTEM WHERE SOURCE_SYSTEM.SOURCE_SYSTEM_ID = 10
