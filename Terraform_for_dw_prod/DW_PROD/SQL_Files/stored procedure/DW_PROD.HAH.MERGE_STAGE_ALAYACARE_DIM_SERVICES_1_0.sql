CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_ALAYACARE_DIM_SERVICES_1_0()
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS 'DECLARE result_string STRING;
BEGIN
	MERGE INTO DW_PROD.HAH.DIM_SERVICES_1_0 TGT
	USING DW_PROD.STAGE.ALAYACARE_DIM_SERVICES_1_0 STAGE
