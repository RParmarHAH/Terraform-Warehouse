CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_PAYOR_CONTRACT_UI_DIM_PARENT_PARTNER()
...
BEGIN
MERGE INTO DW_PROD.HAH.DIM_PARENT_PARTNER AS tgt
USING DW_PROD.STAGE.PAYOR_CONTRACT_UI_DIM_PARENT_PARTNER AS src
