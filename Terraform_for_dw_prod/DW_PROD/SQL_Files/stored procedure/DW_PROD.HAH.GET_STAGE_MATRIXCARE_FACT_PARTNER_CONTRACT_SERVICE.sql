CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_MATRIXCARE_FACT_PARTNER_CONTRACT_SERVICE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
--LEFT JOIN DISC_PROD.MATRIXCARE.STVHC_T_PAYERSERVICES PS ON P.PAY_ID =PS.PAYSVC_PAYERID 
LEFT JOIN DISC_PROD.MATRIXCARE.STVHC_T_SERVICECODE sc ON PAYER_SERVICES.SERVICECODEID=SC.SVCC_ID 
