CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_ASR_FACT_CLIENT_SERVICE()
...
DECLARE
  ...
  BEGIN
	MERGE INTO DW_PROD.HAH.FACT_CLIENT_SERVICE TGT
	USING DW_PROD.STAGE.ASR_FACT_CLIENT_SERVICE STAGE
