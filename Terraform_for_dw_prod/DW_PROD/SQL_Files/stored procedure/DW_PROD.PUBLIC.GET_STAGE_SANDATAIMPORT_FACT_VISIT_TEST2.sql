CREATE OR REPLACE PROCEDURE DW_PROD.PUBLIC.GET_STAGE_SANDATAIMPORT_FACT_VISIT_TEST2("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
--*****************************************************************************************************************************
INSERT OVERWRITE INTO dw_prod."PUBLIC".san_test 
...
`;
	...
	sql = `
MERGE INTO dw_prod."PUBLIC".san_test AS TARGET USING ( 
WITH clu as (
	    select
