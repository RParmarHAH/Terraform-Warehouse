CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_ALAYACARE_FACT_ADMISSION()
...
DECLARE
  ...
  BEGIN
    MERGE INTO DW_PROD.HAH.FACT_ADMISSION TGT
USING DW_PROD.STAGE.ALAYACARE_FACT_ADMISSION STAGE
