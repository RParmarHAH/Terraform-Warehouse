CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_DATAFLEXSYNCDATA_FACT_INTAKE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
FROM DISC_PROD.DATAFLEXSYNCDATA.DFCLIENTCONTRACTS f
JOIN DISC_PROD.DATAFLEXSYNCDATA.DFCLIENTS c ON f.CLIENTNUMBER = c."NUMBER" AND f.DBNAME =c.DBNAME 
