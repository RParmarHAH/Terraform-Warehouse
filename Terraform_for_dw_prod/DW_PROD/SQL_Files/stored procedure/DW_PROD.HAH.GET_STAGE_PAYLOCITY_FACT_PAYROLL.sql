CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_PAYLOCITY_FACT_PAYROLL("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
LEFT JOIN DISC_PROD.PAYLOCITY.EMPLOYEE_DETAILS DETAILS
...
LEFT JOIN DW_PROD.HAH.DIM_BRANCH BRANCH ON COALESCE(EMP.COMPANYID, DETAILS.COMPANYID) = BRANCH.SYSTEM_CODE AND TRIM(COALESCE(EMP.DEPARTMENTPOSITION_COSTCENTER1, DETAILS.DEPARTMENTPOSITION_COSTCENTER1)) = BRANCH.OFFICE_CODE
