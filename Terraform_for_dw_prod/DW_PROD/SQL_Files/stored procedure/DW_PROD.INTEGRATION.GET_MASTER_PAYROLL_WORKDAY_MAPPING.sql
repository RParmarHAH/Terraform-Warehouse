CREATE OR REPLACE PROCEDURE DW_PROD.INTEGRATION.GET_MASTER_PAYROLL_WORKDAY_MAPPING("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
BEGIN 
   INSERT OVERWRITE INTO DW_PROD.INTEGRATION.PAYROLL_WORKDAY_MAPPING
