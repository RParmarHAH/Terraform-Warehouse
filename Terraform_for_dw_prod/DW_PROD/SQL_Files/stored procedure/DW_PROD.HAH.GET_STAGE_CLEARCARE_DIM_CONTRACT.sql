CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_CLEARCARE_DIM_CONTRACT("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
left join DISC_PROD.CLEARCARE.PROFILE_PARENTPAYERSERVICE PP on pp.id = au.service_id
...
left join DISC_PROD.CLEARCARE.BILLING_CLIENTAUTHORIZATION AU on au.BILL_RATE_ID = BR.id
left join DISC_PROD.CLEARCARE.PROFILE_PARENTPAYERSERVICE PP on pp.id = au.service_id
