CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_SANDATAIMPORT_FACT_EVV_VISIT_BCP("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
        var sql = `
    INSERT OVERWRITE INTO STAGE.SANDATAIMPORT_FACT_EVV_VISIT_BCP
...
var sql=`MERGE INTO DW_PROD.STAGE.SANDATAIMPORT_FACT_EVV_VISIT_BCP AS TARGET USING (
WITH clu as (
    select
