CREATE OR REPLACE PROCEDURE DW_PROD.PUBLIC.GET_STAGE_SANDATAIMPORT_FACT_VISIT_MV("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
--*****************************************************************************************************************************
INSERT OVERWRITE INTO PUBLIC.SANDATAIMPORT_FACT_VISIT_MV 
...
`;
	...
	sql = `
MERGE INTO PUBLIC.SANDATAIMPORT_FACT_VISIT_MV AS TARGET USING ( 
WITH clu as (
	    select
