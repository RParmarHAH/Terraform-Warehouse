CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_MATRIXCARE_DIM_INVOICE_VISIT_LINKAGE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
FROM DISC_PROD.MATRIXCARE.STVHC_T_INVOICEDETAILS INV
LEFT JOIN DISC_PROD.MATRIXCARE.STVHC_T_SCHEDULES VIS ON INV.INVD_SCHEDULEID = VIS.SCH_ID
; 
