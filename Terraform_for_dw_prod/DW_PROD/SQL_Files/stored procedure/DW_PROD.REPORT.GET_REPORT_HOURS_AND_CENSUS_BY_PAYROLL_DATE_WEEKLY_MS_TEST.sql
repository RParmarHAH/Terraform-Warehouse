CREATE OR REPLACE PROCEDURE DW_PROD.REPORT.GET_REPORT_HOURS_AND_CENSUS_BY_PAYROLL_DATE_WEEKLY_MS_TEST("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
INSERT OVERWRITE INTO DW_PROD.REPORT.HOURS_AND_CENSUS_BY_PAYROLL_DATE_WEEKLY_MS_TEST
...
NEW_METRICS AS
	(	
		...
		FROM DW_PROD.PUBLIC.SCHEDULE_METRICS_WEEKLY_TEST_101123
		GROUP BY 
			/*PAYROLL_DATE,
			PAY_PERIOD_START_DATE, 
			PAY_PERIOD_END_DATE,*/
