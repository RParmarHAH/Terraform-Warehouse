CREATE OR REPLACE PROCEDURE DW_PROD.PUBLIC.GET_STAGE_SANDATAIMPORT_FACT_INTAKE_MV_COMP("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
--*****************************************************************************************************************************
INSERT OVERWRITE INTO DW_PROD.PUBLIC.SANDATAIMPORT_FACT_INTAKE_MV_COMP
WITH AD AS
    ( SELECT DISTINCT
       F.CLIENTID
      ,F.ADMISSIONID
