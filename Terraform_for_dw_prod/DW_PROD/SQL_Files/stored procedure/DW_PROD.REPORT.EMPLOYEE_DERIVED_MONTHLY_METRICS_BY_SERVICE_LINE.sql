CREATE OR REPLACE PROCEDURE DW_PROD.REPORT.EMPLOYEE_DERIVED_MONTHLY_METRICS_BY_SERVICE_LINE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
