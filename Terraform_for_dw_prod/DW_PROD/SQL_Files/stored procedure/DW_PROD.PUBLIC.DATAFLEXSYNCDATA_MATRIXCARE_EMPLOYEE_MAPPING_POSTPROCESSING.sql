CREATE OR REPLACE PROCEDURE DW_PROD.PUBLIC.DATAFLEXSYNCDATA_MATRIXCARE_EMPLOYEE_MAPPING_POSTPROCESSING("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
