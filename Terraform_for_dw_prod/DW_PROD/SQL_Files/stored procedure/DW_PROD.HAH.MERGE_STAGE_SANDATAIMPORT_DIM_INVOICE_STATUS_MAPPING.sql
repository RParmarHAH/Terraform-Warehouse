CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_SANDATAIMPORT_DIM_INVOICE_STATUS_MAPPING()
...
USING DW_PROD.STAGE.SANDATAIMPORT_DIM_INVOICE_STATUS_MAPPING STAGE 
