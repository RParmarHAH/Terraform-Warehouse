CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_COSTALSYNCDATA_FACT_CLIENT_SERVICE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
--LEFT JOIN DISC_PROD.PAYOR_CONTRACT_UI.PAYOR_CONTRACT_MAPPING PCM ON AUTH.SYSTEM_CODE=PCM.ORIGINAL_SYSTEM_CODE 
--AND TRIM(AUTH.CONTRACT_CODE)=TRIM(PCM.CONTRACT_CODE))
--LEFT JOIN (SELECT DISTINCT DB,PLAN_CODE,PROCCODE FROM DISC_PROD.COSTALSYNCDATA.CV_PLANRATEDETAILS) B 
