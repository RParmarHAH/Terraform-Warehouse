CREATE OR REPLACE PROCEDURE DW_PROD.REPORT.GET_REPORT_UTILIZATION_WEEKLY_2_0_WIP_TEST("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
left join DW_PROD.REPORT.MS_OSHAH_CONTRACT_MAP mc on mc.client_key =data.client_key and data.partner_contract_service_key = mc.hha_con and data.SERVICE_WEEK=''2023-08-01''
