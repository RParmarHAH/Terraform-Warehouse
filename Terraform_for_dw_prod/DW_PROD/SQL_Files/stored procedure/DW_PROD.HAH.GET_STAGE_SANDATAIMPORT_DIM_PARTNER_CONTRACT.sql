CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_SANDATAIMPORT_DIM_PARTNER_CONTRACT("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
LEFT JOIN DISC_PROD.SANDATAIMPORT.SANDATA_PAYORS P ON P.PAYORID = AUTH.PAYORID AND P.AGENCYID =8485
...
LEFT JOIN DISC_PROD.SANDATAIMPORT.SANDATA_AUTHORIZATIONS AUTH
	    	ON AUTH.ADMISSIONID =CA.ADMISSIONID AND AUTH.AGENCYID=CA.AGENCYID 
LEFT JOIN DISC_PROD.SANDATAIMPORT.SANDATA_PAYORS P ON P.PAYORID = INV_H.PAYORID AND P.AGENCYID =8485
LEFT JOIN HAH.FACT_REVENUE_SUBCATEGORY_CONTRACT_MAPPING M
    	ON M.SOURCE_SYSTEM_ID = 4 AND M.SYSTEM_CODE = CA.AGENCYID AND M.CONTRACT_CODE = CA.ADMISSIONTYPE
