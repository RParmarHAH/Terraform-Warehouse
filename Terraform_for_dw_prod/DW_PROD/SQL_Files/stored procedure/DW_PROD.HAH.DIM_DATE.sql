CREATE OR REPLACE PROCEDURE DW_PROD.HAH.DIM_DATE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
              ...
              sql = `UPDATE HAH.DIM_DATE SET ALL_STATE_PAID = TRUE
                     WHERE CALENDAR_DATE <= (SELECT MIN(CHECK_DATE) PAYROLL_END_DATE FROM
                      (
                         ...
                         from DW_PROD.HAH.FACT_BRANCH_PAYROLL_PERIODS
