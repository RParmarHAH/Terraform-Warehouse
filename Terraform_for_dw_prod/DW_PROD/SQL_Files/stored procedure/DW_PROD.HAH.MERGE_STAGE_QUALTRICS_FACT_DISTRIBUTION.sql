CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_QUALTRICS_FACT_DISTRIBUTION()
...
MERGE INTO DW_PROD.HAH.FACT_DISTRIBUTION TGT 
USING DW_PROD.STAGE.QUALTRICS_FACT_DISTRIBUTION STAGE 
