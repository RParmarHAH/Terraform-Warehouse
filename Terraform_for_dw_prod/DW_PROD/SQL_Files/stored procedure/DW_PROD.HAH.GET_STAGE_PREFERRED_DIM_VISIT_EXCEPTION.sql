CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_PREFERRED_DIM_VISIT_EXCEPTION("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
INSERT OVERWRITE INTO DW_PROD.STAGE.PREFERRED_DIM_VISIT_EXCEPTION
WITH EXCEPTIONS AS (
	SELECT 
		DISTINCT
		...
		ED."STATUS"
	FROM 
		DISC_PROD.HHAEXCHANGEPREFERRED.EXCEPTIONDETAILS ED
		)
SELECT
