CREATE OR REPLACE PROCEDURE DW_PROD.PUBLIC.GET_REPORT_UTILIZATION_PROD_MV("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
--*****************************************************************************************************************************
	INSERT OVERWRITE INTO PUBLIC.UTILIZATION_PROD_MV
	(PERIOD_BEGIN_DATE, STATE, BRANCH_KEY, ORIGINAL_BRANCH_KEY, OFFICE_NUMBER, OFFICE_NAME, SUPERVISOR_KEY, SUPERVISOR_CODE,
		...
		HOURS_SCHEDULED, HOURS_SERVED, HOURS_CANCELLED, HOURS_IN_REVIEW, HOURS_MISSED, FUTURE_HOURS, FUTURE_CANCELLED_HOURS, FUTURE_HOLD_HOURS,
	...
	VISITS_ALL, VISITS_CLEAN_SHIFTS, VISITS_NEED_MAINTENANCE, CLIENT_SERVED_FLAG,
		...
		--
		WITH VISITS AS (		
		SELECT DATE_TRUNC(MONTH, VISIT.REPORT_DATE) REPORT_DATE, 
		VISIT.CLIENT_KEY, 
...
,UTILIZATION_DETAIL AS (
	SELECT VISIT.REPORT_DATE PERIOD_BEGIN_DATE,
		BRANCH.BRANCH_KEY,
		VISIT.ORIGINAL_BRANCH_KEY,
