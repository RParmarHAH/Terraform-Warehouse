CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_OLYMPUS_DIM_CLIENT("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
FROM DISC_PROD.OLYMPUS.OLYMPUS_SOURCE_DATA C WHERE C.LOADDATE =(SELECT MAX(LOADDATE) FROM  DISC_PROD.OLYMPUS.OLYMPUS_SOURCE_DATA)
;
RETURN ''SUCCESS'';
END;
';