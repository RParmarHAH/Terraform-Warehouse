CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_PREFERRED_DIM_INVOICE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
INNER JOIN DISC_PROD.HHAEXCHANGEPREFERRED.AGENCY_MAPPING AGENCY_CONFIG
	ON AGENCY_CONFIG.AGENCYID = INV_HEAD.AGENCYID
		AND AGENCY_CONFIG.ISACTIVE = TRUE
LEFT JOIN DISC_PROD.HHAEXCHANGEPREFERRED.VISITS V
...
LEFT JOIN DISC_PROD.HHAEXCHANGEPREFERRED.STAGE_PAYER_REPL PYR
