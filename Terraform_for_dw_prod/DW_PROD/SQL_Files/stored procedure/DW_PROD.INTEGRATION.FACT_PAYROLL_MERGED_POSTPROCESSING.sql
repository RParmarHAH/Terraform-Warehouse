CREATE OR REPLACE PROCEDURE DW_PROD.INTEGRATION.FACT_PAYROLL_MERGED_POSTPROCESSING("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
INSERT OVERWRITE INTO DW_PROD.INTEGRATION.FACT_PAYROLL_MERGED 
	...
	FROM DW_PROD.HAH.FACT_PAYROLL AS PAYROLL
