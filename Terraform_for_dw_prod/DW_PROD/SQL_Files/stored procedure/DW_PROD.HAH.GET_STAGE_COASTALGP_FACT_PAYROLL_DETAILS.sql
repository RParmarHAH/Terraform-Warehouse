CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_COASTALGP_FACT_PAYROLL_DETAILS("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
