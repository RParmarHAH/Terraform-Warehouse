CREATE OR REPLACE PROCEDURE DW_PROD.REPORT.GET_REPORT_UTILIZATION_BACKUP("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
WITH CLEAN AS
     ...
     INTAKE AS (
         ...
         FROM DW_PROD.HAH.FACT_INTAKE I
