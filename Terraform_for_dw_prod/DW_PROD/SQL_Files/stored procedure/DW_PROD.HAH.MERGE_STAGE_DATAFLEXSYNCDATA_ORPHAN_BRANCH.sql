CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_DATAFLEXSYNCDATA_ORPHAN_BRANCH()
...
DECLARE
  ...
  BEGIN
    MERGE INTO DW_PROD.HAH.DIM_ORPHAN_BRANCH TGT 
USING DW_PROD.STAGE.DATAFLEXSYNCDATA_ORPHAN_BRANCH STAGE 
