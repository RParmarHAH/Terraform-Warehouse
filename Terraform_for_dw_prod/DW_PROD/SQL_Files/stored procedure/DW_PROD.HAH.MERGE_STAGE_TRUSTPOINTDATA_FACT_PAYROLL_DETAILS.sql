CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_TRUSTPOINTDATA_FACT_PAYROLL_DETAILS()
...
BEGIN
    MERGE INTO DW_PROD.HAH.FACT_PAYROLL_DETAILS TGT USING DW_PROD.STAGE.TRUSTPOINTDATA_FACT_PAYROLL_DETAILS STAGE 
