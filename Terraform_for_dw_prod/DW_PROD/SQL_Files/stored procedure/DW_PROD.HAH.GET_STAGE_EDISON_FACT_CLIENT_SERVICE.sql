CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_EDISON_FACT_CLIENT_SERVICE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
INSERT OVERWRITE INTO DW_PROD.STAGE.EDISON_FACT_CLIENT_SERVICE
...
LEFT JOIN DISC_PROD.HHAEXCHANGEEDISON.PATIENTS P 
...
JOIN DISC_PROD.HHAEXCHANGEEDISON.SERVICECODES SC 
...
FULL JOIN DISC_PROD.HHAEXCHANGEEDISON.VW_EDISON_REVENUE_SEG RS 
