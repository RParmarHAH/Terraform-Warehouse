CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_OSHAH_DIM_SERVICES()
...
BEGIN
MERGE INTO DW_PROD.HAH.DIM_SERVICES TGT 
USING DW_PROD.STAGE.OSHAH_DIM_SERVICES STAGE 
