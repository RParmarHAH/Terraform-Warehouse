CREATE OR REPLACE PROCEDURE DW_PROD.REPORT.GET_REPORT_CLIENT_SERVICE_MONTHLY_AUTHORIZATION_BKCP1310("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
--*****************************************************************************************************************************
INSERT OVERWRITE INTO DW_PROD.REPORT.CLIENT_SERVICE_MONTHLY_AUTHORIZATION_bkcp1310 
...
FROM 
DW_PROD.integration.FACT_CLIENT_SERVICE_MERGED PL
