CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_OPENSYSTEMS_DIM_BRANCH()
...
BEGIN 
MERGE INTO DW_PROD.HAH.DIM_BRANCH AS tgt 
USING DW_PROD.STAGE.OPENSYSTEMS_DIM_BRANCH  AS src
