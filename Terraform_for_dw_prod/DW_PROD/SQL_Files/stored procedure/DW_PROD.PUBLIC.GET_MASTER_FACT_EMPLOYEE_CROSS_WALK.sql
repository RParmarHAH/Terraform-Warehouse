CREATE OR REPLACE PROCEDURE DW_PROD.PUBLIC.GET_MASTER_FACT_EMPLOYEE_CROSS_WALK("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
FROM DW_PROD.INTEGRATION.DIM_EMPLOYEE_MERGED DM
...
WITH KEYS_CHANGED AS 
	...
	LEFT JOIN DW_PROD.INTEGRATION.DIM_EMPLOYEE_MERGED EM 
...
MERGE INTO DW_PROD.INTEGRATION.EMPLOYEE_CROSS_WALK  AS cw
USING 
	...
	SELECT * FROM DW_PROD.INTEGRATION.VW_EMPLOYEE_CROSS_WALK
...
FROM (
	...
	JOIN DW_PROD.INTEGRATION.DIM_EMPLOYEE_MERGED DM 
