CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_ASR_DIM_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
--	FROM DISC_PROD.ASR.ASR_EMPLOYEETRAININGLICENSESCERTS ECERT
...
--    IFF(ECERT.COVIDBOOSTERDOSE IS NOT NULL, ECERT.COVIDBOOSTERDOSE, TO_DATE(''1900-01-01'', ''YYYY-MM-DD'')),
    ...
    ,NULL AS LINKED_ID
FROM DISC_DEDUPE_PROD.ASR.EMPLOYEE_MASTER_LIST E
LEFT JOIN DISC_PROD.ASR.ASR_TERMINATIONREASONS TR ON TR.TERMINATION_REASON_ID = CAST(E.TERMINATIONREASON AS INT)
LEFT JOIN DISC_PROD.ASR.ASR_LOCATIONS L ON L.LOCATIONID = E.LOCATIONID
