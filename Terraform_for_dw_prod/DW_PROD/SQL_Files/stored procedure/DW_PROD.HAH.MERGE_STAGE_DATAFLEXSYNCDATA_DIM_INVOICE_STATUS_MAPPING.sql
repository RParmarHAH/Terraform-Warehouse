CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_DATAFLEXSYNCDATA_DIM_INVOICE_STATUS_MAPPING()
...
USING DW_PROD.STAGE.DATAFLEXSYNCDATA_DIM_INVOICE_STATUS_MAPPING STAGE 
