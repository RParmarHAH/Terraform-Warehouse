CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_ADPALLIANCE_FACT_PAYROLL_DETAILS("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
--		COALESCE(HE.DESCRIPTION, PS.DESCRIPTION) AS PAY_CODE_DESCRIPTION,
		...
		SUM(RATE) AS RATE
	FROM DISC_PROD.ADP.ALLIANCE_PAYROLL_DETAILS P
...
LEFT JOIN DW_PROD.STAGE.ADPALLIANCE_DIM_PAYCODE_MAPPING PCM
