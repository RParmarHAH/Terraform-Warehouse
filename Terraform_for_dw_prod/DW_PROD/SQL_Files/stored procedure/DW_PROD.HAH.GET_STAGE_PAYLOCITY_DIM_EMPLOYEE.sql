CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_PAYLOCITY_DIM_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
LEFT JOIN DISC_PROD.PAYLOCITY.EMPLOYEE_DETAILS EMP_D
