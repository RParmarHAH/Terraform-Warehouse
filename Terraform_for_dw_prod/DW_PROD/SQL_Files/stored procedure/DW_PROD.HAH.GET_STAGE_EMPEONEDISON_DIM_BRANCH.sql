CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_EMPEONEDISON_DIM_BRANCH("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
INSERT OVERWRITE INTO DW_PROD.STAGE.EMPEONEDISON_DIM_BRANCH
WITH BRANCH AS(
SELECT DISTINCT
...
FROM DISC_PROD.EMPEONEDISON.EINFO_TABLE
)
