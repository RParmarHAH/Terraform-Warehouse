CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_PREFERRED_FACT_CLIENT_SERVICE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
INSERT OVERWRITE INTO DW_PROD.STAGE.PREFERRED_FACT_CLIENT_SERVICE
...
LEFT JOIN DISC_PROD.HHAEXCHANGEPREFERRED.STAGE_PATIENTS P ON P.PATIENTID = CLIENT.PATIENTID
LEFT JOIN DISC_PROD.HHAEXCHANGEPREFERRED.OFFICE_OFFICES_REPL O ON CLIENT.OFFICEID = O.OFFICEID
...
FULL JOIN DISC_PROD.HHAEXCHANGEPREFERRED.REVENUE_MAPPING RS ON
