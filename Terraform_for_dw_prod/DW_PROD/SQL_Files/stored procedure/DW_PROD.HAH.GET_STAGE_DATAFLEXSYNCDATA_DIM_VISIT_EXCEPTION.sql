CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_DATAFLEXSYNCDATA_DIM_VISIT_EXCEPTION("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
, EXC_CODES AS (
	...
	FROM 
		DISC_PROD.SANDATAIMPORT.SANDATA_MANUAL_EXCEPTIONCODES SEC
	WHERE
