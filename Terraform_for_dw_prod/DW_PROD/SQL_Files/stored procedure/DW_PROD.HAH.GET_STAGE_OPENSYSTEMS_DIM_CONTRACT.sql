CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_OPENSYSTEMS_DIM_CONTRACT("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
--***************************************************************************************************************************
INSERT OVERWRITE INTO DW_PROD.STAGE.OPENSYSTEMS_DIM_CONTRACT
...
FROM DISC_PROD.HHAEXCHANGEOPENSYSTEMS.SERVICECODES SC
	...
	LEFT JOIN DISC_PROD.HHAEXCHANGEOPENSYSTEMS.VW_OPENSYSTEMS_REVENUE vor
