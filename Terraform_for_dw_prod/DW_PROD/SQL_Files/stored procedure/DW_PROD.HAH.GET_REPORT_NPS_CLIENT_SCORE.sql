CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_REPORT_NPS_CLIENT_SCORE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
SURVEY_MAPPING AS (
    ...
    FROM DW_PROD.INTEGRATION.FACT_SURVEY_QUESTION_RESPONSE_MAPPING SQR
