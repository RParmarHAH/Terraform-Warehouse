CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_ADPANSWERCARE_DIM_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
DUP AS (
	SELECT DISTINCT 
		...
		FROM DISC_PROD.ADP.ANSWERCARE_PAYROLL AP
	LEFT JOIN DW_PROD."STAGE".CLEARCARE_DIM_EMPLOYEE CDE
...
SALARY_RATE AS (
	...
	FROM DISC_PROD.ADP.ANSWERCARE_PAYROLL QUALIFY RANK = 1
)
SELECT DISTINCT 
...
FROM DISC_DEDUPE_PROD.ADP.ANSWERCARE_EMPLOYEE_MASTER_LIST EML
