CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_CCSI_FACT_CLIENT_SERVICE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
INSERT OVERWRITE INTO DW_PROD.STAGE.CCSI_FACT_CLIENT_SERVICE
...
MD5(NVL(R.CLIENT_ID,''E'')::STRING || ''-'' || NVL(COALESCE(O.AREA,O1.AREA),''E'')::STRING 
	...
	LEFT JOIN DW_PROD.HAH.DIM_SERVICES S ON S.SERVICE_CODE = R.SERVICE_TYPE
	LEFT JOIN DW_PROD.HAH.FACT_PARTNER_CONTRACT_SERVICE PCS ON R.CONTRACT_NO = PCS.CONTRACT_CODE 
