CREATE OR REPLACE PROCEDURE DW_PROD.HAH.FACT_CLIENT_ACQUIRED_POSTPROCESSING_2_0()
...
var sql = `
INSERT OVERWRITE INTO DW_PROD.HAH.FACT_CLIENT_ACQUIRED_2_0
...
INNER JOIN DW_PROD.HAH.DIM_BRANCH BRANCH
	ON VISIT.BRANCH_KEY = BRANCH.BRANCH_KEY
INNER JOIN DW_PROD.INTEGRATION.DIM_BRANCH_MERGED BRANCH_MERGED ON BRANCH_MERGED.ORIGINAL_BRANCH_KEY = BRANCH.BRANCH_KEY 
