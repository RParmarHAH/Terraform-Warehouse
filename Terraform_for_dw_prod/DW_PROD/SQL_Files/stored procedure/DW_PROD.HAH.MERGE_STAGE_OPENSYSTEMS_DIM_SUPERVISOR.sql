CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_OPENSYSTEMS_DIM_SUPERVISOR()
...
BEGIN 
MERGE INTO DW_PROD.HAH.DIM_SUPERVISOR AS tgt
USING DW_PROD."STAGE".OPENSYSTEMS_DIM_SUPERVISOR AS STAGE
