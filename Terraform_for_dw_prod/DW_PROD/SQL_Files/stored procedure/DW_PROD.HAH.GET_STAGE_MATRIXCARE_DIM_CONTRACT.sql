CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_MATRIXCARE_DIM_CONTRACT("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
WITH PAYER_SERVICES AS (
	...
	LEFT JOIN DISC_PROD."STAGE".ADAPTIVE_CONTRACTCODE_MAPPING_MI MI_CODE 
