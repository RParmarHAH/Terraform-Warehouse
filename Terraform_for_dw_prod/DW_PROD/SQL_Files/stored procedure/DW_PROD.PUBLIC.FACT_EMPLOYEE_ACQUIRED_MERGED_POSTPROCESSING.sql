CREATE OR REPLACE PROCEDURE DW_PROD.PUBLIC.FACT_EMPLOYEE_ACQUIRED_MERGED_POSTPROCESSING("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS '
        var sql = `
    INSERT OVERWRITE INTO DW_PROD.HAH.FACT_EMPLOYEE_ACQUIRED_MERGED
...
EMPLOYEE_key in (
  ...
  (select EMPLOYEEID from DISC_DEV.EMPLOYEESETUP.ES_ENTRIESDATA where referral in (''Praetorian'',''Praetorian Employee'')))
