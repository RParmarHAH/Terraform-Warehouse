CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_ZENDESK_FACT_CALLS("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
FROM DISC_PROD.ZENDESK.CALLS C
...
LEFT JOIN DISC_PROD.ZENDESK.USER AGENT
