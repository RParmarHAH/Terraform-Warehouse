CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_COSTALSYNCDATA_ORPHAN_BRANCH("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
INSERT OVERWRITE INTO DW_PROD.STAGE.COSTALSYNCDATA_ORPHAN_BRANCH

--NO RESPECTIVE VALUE FOR COLUMN  - LOCATION_CODE(EMPTY STRING) FOR TABLE DISC_PROD.CostalSyncData.CV_Locations 
