CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_OPENSYSTEMS_DIM_CONTRACT()
...
BEGIN
MERGE INTO DW_PROD.HAH.DIM_CONTRACT AS tgt
USING DW_PROD."STAGE".OPENSYSTEMS_DIM_CONTRACT AS src
