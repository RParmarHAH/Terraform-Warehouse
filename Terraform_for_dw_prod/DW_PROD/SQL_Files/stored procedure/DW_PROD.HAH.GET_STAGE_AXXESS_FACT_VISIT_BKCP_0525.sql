CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_AXXESS_FACT_VISIT_BKCP_0525("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
