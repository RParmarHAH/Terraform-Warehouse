CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_DATAFLEXSYNCDATA_DIM_CLIENT("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
FROM DISC_DEDUPE_PROD.DATAFLEXSYNCDATA.CLIENT_MASTER_LIST AS C
) AS SPV_LIST
...
LEFT JOIN DISC_DEDUPE_PROD.DATAFLEXSYNCDATA.CLIENT_MATCH_LIST ML
