CREATE OR REPLACE PROCEDURE DW_PROD.REPORT.GET_REPORT_NPS_CAREGIVER_SCORE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
LEFT JOIN DW_PROD.INTEGRATION.DIM_EMPLOYEE_MERGED DE ON DE.ORIGINAL_EMPLOYEE_KEY = coalesce(SRH.WH_EMPLOYEE_KEY,SRH.EMPLOYEE_KEY)
