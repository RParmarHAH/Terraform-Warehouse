CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_OPENSYSTEMS_DIM_VISIT_STATUS_MAPPING()
...
USING DW_PROD."STAGE".OPENSYSTEMS_DIM_VISIT_STATUS_MAPPING  AS src
