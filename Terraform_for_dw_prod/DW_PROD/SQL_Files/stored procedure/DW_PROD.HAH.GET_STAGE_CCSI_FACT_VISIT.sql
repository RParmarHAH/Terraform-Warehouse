CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_CCSI_FACT_VISIT("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
CALLSFIELD_DATA AS (
	...
	FROM DISC_PROD.CCSI.CALLSFIELD CF	
)
,LOG_IN_DATA AS (
