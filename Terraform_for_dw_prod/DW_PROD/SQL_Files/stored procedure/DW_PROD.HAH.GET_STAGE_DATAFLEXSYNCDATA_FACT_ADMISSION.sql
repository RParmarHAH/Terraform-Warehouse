CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_DATAFLEXSYNCDATA_FACT_ADMISSION("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
INSERT OVERWRITE INTO DW_PROD.STAGE.DATAFLEXSYNCDATA_FACT_ADMISSION
WITH ADMISSION AS (
	SELECT 
		CC.DBNAME,
		CC.CLIENTNUMBER,
	...
	FROM 
		DISC_PROD.DATAFLEXSYNCDATA.DFCLIENTCONTRACTS CC
