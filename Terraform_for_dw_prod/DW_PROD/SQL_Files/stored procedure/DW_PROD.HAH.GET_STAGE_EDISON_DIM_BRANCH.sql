CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_EDISON_DIM_BRANCH("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
SELECT HHAEXCHANGEEDISON_OFFICES.BRANCH_KEY, HHAEXCHANGEEDISON_OFFICES.BRANCH_NAME, HHAEXCHANGEEDISON_OFFICES.SYSTEM_CODE, HHAEXCHANGEEDISON_OFFICES.SOURCE_SYSTEM_ID, SOURCE_SYSTEM.SOURCE_SYSTEM_TYPE,
    ...
    LEFT JOIN "DW_PROD"."HAH"."DIM_STATE" AS STATES 
    ...
    LEFT JOIN DW_PROD.STAGE.EDISON_OFFICE_DESCRIPTIONS DESC ON DESC.OFFICEID = HHAEXCHANGEEDISON_OFFICES.OFFICE_CODE
	LEFT JOIN DW_PROD.HAH.DIM_SOURCE_SYSTEM AS SOURCE_SYSTEM ON SOURCE_SYSTEM.SOURCE_SYSTEM_ID = HHAEXCHANGEEDISON_OFFICES.SOURCE_SYSTEM_ID
