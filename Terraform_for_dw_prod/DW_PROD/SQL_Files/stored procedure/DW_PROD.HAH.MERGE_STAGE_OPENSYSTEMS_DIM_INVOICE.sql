CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_OPENSYSTEMS_DIM_INVOICE()
...
BEGIN
MERGE INTO DW_PROD.HAH.DIM_INVOICE TGT 
USING DW_PROD.STAGE.OPENSYSTEMS_DIM_INVOICE STAGE 
