CREATE OR REPLACE PROCEDURE DW_PROD.REPORT.GET_REPORT_HOURS_AND_CENSUS_BY_PAYROLL_DATE_WEEKLY_1_0("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
INSERT OVERWRITE INTO REPORT.HOURS_AND_CENSUS_BY_PAYROLL_DATE_WEEKLY_1_0
...
--        VISIT.SERVICE_DATE,
   ...
   WHERE NVL(VISIT.BILL_UNIT_TYPE, ''Hourly'') = ''Hourly'' AND-- VISIT.CONFIRMED_FLAG = ''YES'' 	-- Only confirmed visits	-- Need all visits now									  
	VISIT.ORIGINAL_SOURCE_SYSTEM_ID NOT IN (4,7,17,13,9,3,8,1,2,16,19)													  
   GROUP BY
