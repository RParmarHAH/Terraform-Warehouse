CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_SANDATAIMPORT_FACT_EVV_VISIT("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
MERGE INTO DW_PROD.STAGE.SANDATAIMPORT_FACT_EVV_VISIT AS TARGET USING (
WITH clu as (
    select
