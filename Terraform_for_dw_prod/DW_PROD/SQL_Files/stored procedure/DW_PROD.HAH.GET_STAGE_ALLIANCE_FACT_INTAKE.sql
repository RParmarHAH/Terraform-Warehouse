CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_ALLIANCE_FACT_INTAKE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
(
	...
	INNER JOIN DISC_PROD.GENERATIONSALLIANCE.SERVICEREQUEST SR
...
(
	...
	INNER JOIN DISC_PROD.GENERATIONSALLIANCE.VW_BRANCH_MAPPING BM
