CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_PARADOX_DIM_APPLICANT("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
WITH CANDIDATE_FORM AS (
    ...
    FROM DISC_PROD.PARADOX.CANDIDATE_FORM_PA A
  UNION
    SELECT
        A.CANDIDATE_ID, 
        A.PROFILE_ID, 
    ...
    FROM DISC_PROD.PARADOX.CANDIDATE_FORM_GA A
  UNION
    SELECT
      A.CANDIDATE_ID, 
      A.PROFILE_ID, 
    ...
    FROM DISC_PROD.PARADOX.CANDIDATE_FORM_MO A
  UNION
    SELECT
      A.CANDIDATE_ID, 
      A.PROFILE_ID, 
      ...
      A.PERSONAL_INFORMATION_PHONE_NUMBER MOBILE_PHONE,
      COALESCE(A.PERSONAL_INFORMATION_EMERGENCY_CONTACT_CELL_PHONE_NUMBER, A.PERSONAL_INFORMATION_EMERGENCY_CONTACT_HOME_PHONE_NUMBER) HOME_PHONE
    FROM DISC_PROD.PARADOX.CANDIDATE_FORM_OH A
  UNION
    SELECT
      A.CANDIDATE_ID, 
      A.PROFILE_ID, 
    ...
    FROM DISC_PROD.PARADOX.CANDIDATE_FORM_IN_ADAPTIVE A
  UNION
    SELECT
      A.CANDIDATE_ID, 
      A.PROFILE_ID, 
      ...
      A.PERSONAL_INFORMATION_PHONE_NUMBER MOBILE_PHONE,
      A.PERSONAL_INFORMATION_EMERGENCY_CONTACT_PHONE_NUMBER HOME_PHONE
    FROM DISC_PROD.PARADOX.CANDIDATE_FORM_IN A
  UNION
    SELECT
      A.CANDIDATE_ID, 
      A.PROFILE_ID, 
      ...
      A.PERSONAL_INFORMATION_PHONE_NUMBER MOBILE_PHONE,
      A.PERSONAL_INFORMATION_EMERGENCY_CONTACT_PHONE_NUMBER HOME_PHONE
    FROM DISC_PROD.PARADOX.CANDIDATE_FORM_AL A
...
,UNIQUE_APPLICANTS AS (
    ...
    FROM DISC_PROD.PARADOX.CANDIDATE_SPECIFIC
    QUALIFY RANK = 1
)
,FINAL AS (SELECT
    DISTINCT
...
from DISC_PROD.PARADOX.CANDIDATE_SPECIFIC A
    ...
    LEFT JOIN DISC_PROD.PARADOX.GA_ONBOARDING_ADMIN GA_ADMIN ON A.CANDIDATE_ID = GA_ADMIN.CANDIDATE_ID
    LEFT JOIN DISC_PROD.PARADOX.GA_ONBOARDING_DIRECT_CARE GA_DIRECT_CARE ON A.CANDIDATE_ID = GA_DIRECT_CARE.CANDIDATE_ID
    LEFT JOIN DW_PROD.HAH.DIM_GEOGRAPHY G ON COALESCE(GA_ADMIN.EMERGENCY_CONTACT_ZIP_CODE, GA_DIRECT_CARE.EMERGENCY_CONTACT_ZIP_CODE, F.PERSONAL_INFORMATION__ZIP_CODE, A.ZIP_CODE) = G.ZIP_CODE
