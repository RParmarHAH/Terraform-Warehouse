CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_ALAYACARE_FACT_INVOICE_TRANSACTIONS("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
FROM DISC_PROD.ALAYACARE.ACCOUNTING_TRANSACTION AT
LEFT JOIN DISC_PROD.ALAYACARE.INVOICE_ITEM INVOICE_ITEM ON NVL(AT.ALLOC_TRANS_INVOICE_ID,AT.MAIN_TRANSACTION_INVOICE_ID)=INVOICE_ITEM.INVOICE_ID
