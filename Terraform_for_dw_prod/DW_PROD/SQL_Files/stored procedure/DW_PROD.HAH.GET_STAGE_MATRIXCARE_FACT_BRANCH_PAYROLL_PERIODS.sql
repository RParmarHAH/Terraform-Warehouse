CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_MATRIXCARE_FACT_BRANCH_PAYROLL_PERIODS("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
WITH BRANCHES AS (
	...
	LEFT JOIN DISC_PROD.MATRIXCARE.MATRIXCARE_MASTER_BRANCH_MAPPING AS MAPPING
	...
	FROM DISC_PROD.MATRIXCARE.STVHC_T_PAYROLLBATCH PB
	LEFT JOIN DISC_PROD.MATRIXCARE.STVHC_T_PAYROLLDETAILS PD 
	...
	JOIN DISC_PROD.APPBASEDATA.PAYROLLPERIODGROUPS AS PAYROLL_GROUP
		ON PAYROLL_GROUP.STATECODE = L.OFFICE_STATE_CODE
	JOIN DISC_PROD.APPBASEDATA.PAYROLLPERIODS AS PAYROLL_PERIOD 
	...
	FROM DISC_PROD.MATRIXCARE.STVHC_T_PAYROLLBATCH ))
), RESULTS AS (
