CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_MATRIXCARE_FACT_INVOICE_TRANSACTIONS("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
LEFT JOIN DISC_PROD.MATRIXCARE.STVHC_T_INVOICEDETAILS INVD ON INVD.INVD_ID = P.POST_INVOICEDETAILID
LEFT JOIN DISC_PROD.MATRIXCARE.STVHC_T_SCHEDULES SCH ON INVD.INVD_SCHEDULEID = SCH.SCH_ID
LEFT JOIN DISC_PROD.MATRIXCARE.STVHC_T_PAYMENTREGISTER PAYREG ON PAYREG.PMTREG_ID = P.POST_PAYMENTREGISTERID 
