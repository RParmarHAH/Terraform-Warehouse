CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_CLEARCARE_DIM_INVOICE_STATUS_MAPPING()
...
USING DW_PROD.STAGE.CLEARCARE_DIM_INVOICE_STATUS_MAPPING STAGE 
