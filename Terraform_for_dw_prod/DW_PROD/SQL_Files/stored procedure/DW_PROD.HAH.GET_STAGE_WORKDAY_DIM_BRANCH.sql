CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_WORKDAY_DIM_BRANCH("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
WITH BRANCHES AS (
    ...
    FROM 
	DISC_PROD.WORKDAY.WORKER_POSITION_DATA Br
...
FROM 
	BRANCHES Br
LEFT JOIN 
	DW_PROD.HAH.DIM_STATE st 
	ON UPPER(Br.BUSINESS_SITE_REGION) = UPPER(ST.STATE_NAME)
JOIN 
	DW_PROD.HAH.DIM_SOURCE_SYSTEM src 
