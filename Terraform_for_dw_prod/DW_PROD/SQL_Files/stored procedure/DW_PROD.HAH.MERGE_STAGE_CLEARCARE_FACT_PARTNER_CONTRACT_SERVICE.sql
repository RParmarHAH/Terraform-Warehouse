CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_CLEARCARE_FACT_PARTNER_CONTRACT_SERVICE()
...
USING DW_PROD.STAGE.CLEARCARE_FACT_PARTNER_CONTRACT_SERVICE AS src
