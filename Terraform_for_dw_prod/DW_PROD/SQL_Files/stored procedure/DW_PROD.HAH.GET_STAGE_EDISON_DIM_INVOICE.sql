CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_EDISON_DIM_INVOICE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
LEFT JOIN DISC_PROD.HHAEXCHANGEEDISON.PAYER_REPL PYR
	ON PYR.PAYERID = INV_DET.PAYERID 
		AND INV_HEAD.AGENCYID = INV_DET.AGENCYID
LEFT JOIN SUPERVISOR SUP
	ON SUP.PATIENTID = INV_DET.PATIENTID 
		AND SUP.RN  = 1
LEFT JOIN DISC_PROD.HHAEXCHANGEEDISON.OFFICE_OFFICES_REPL O ON O.OFFICEID = INV_HEAD.OFFICEID
