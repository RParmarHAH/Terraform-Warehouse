CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_DATAFLEXSYNCDATA_DIM_DERIVED_AUTH_FROM_HISTORY_WITH_MASTER_DEDUP("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
INSERT OVERWRITE INTO DW_PROD.STAGE.DATAFLEXSYNCDATA_DIM_DERIVED_AUTH_FROM_HISTORY_WITH_MASTER_DEDUP
...
WITH auth_all_records AS (
	...
	FROM DISC_PROD.DATAFLEXSYNCDATA.HIST_DFCLIENTCONTRACTS )D
	INNER JOIN DISC_PROD.DATAFLEXSYNCDATA.DFCLIENTCONTRACTS DC
...
LEFT JOIN DISC_PROD.DATAFLEXSYNCDATA.DFCONTRACTSAUTH EC
...
,CURRENT_AUTH AS (
	...
	LEFT JOIN DISC_PROD.DATAFLEXSYNCDATA.DFCLIENTS C 
...
FROM MNOP CA
LEFT JOIN DISC_PROD.DATAFLEXSYNCDATA.DFCLIENTS DC
