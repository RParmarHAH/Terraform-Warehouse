CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_AMERIHEALTH_DIM_CLIENT("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
from DISC_PROD.AmeriHealth.AmeriHealth_SOURCE_DATA ;
