CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_ALAYACARE_DIM_SUPERVISOR("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
--*****************************************************************************************************************************
INSERT OVERWRITE INTO DW_PROD.STAGE.ALAYACARE_DIM_SUPERVISOR
WITH EMP AS 
(
...
FROM EMP E
LEFT JOIN DISC_PROD.ALAYACARE.BRANCH B ON E.BRANCH_ID = B.BRANCH_ID
