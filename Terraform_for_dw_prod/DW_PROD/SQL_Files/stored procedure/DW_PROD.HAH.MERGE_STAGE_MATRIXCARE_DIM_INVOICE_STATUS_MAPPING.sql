CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_MATRIXCARE_DIM_INVOICE_STATUS_MAPPING()
...
USING DW_PROD.STAGE.MATRIXCARE_DIM_INVOICE_STATUS_MAPPING STAGE 
