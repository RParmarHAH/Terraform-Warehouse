CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_PREFERRED_DIM_INVOICE_STATUS_MAPPING("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
-- DATE        AUTHOR                NOTES:
-- --------    -------------------   -----------------------------------------------------------------------------------------------
--  21/04/23    Pinkal Panchal        Initial PRODelopment
--  12/09/23    Preeti Sharma         INVOICE_STATUS_MAPPING LOGIC CHANGES AND ADDED CTE FOR RCM
--*****************************************************************************************************************************

INSERT OVERWRITE INTO DW_PROD.STAGE.PREFERRED_DIM_INVOICE_STATUS_MAPPING
...
(
	...
	FROM DISC_PROD.HHAEXCHANGEPREFERRED.BILLING_PAIDVISITS_REPL BPV
	INNER JOIN DISC_PROD.HHAEXCHANGEPREFERRED.TBLINVOICEDETAILS_REPL INV_DET
	...
	WHERE INV_HEAD .AGENCYID  IN (''371'',''243'')
...
(
	...
	FROM DISC_PROD.HHAEXCHANGEPREFERRED.PAYMENTS PYM
	INNER JOIN DISC_PROD.HHAEXCHANGEPREFERRED.TBLINVOICEDETAILS_REPL INV_DET
...
(
	...
	FROM DISC_PROD.HHAEXCHANGEPREFERRED.TBLINVOICEHEADER_REPL INV_HEAD
	INNER JOIN DISC_PROD.HHAEXCHANGEPREFERRED.TBLINVOICEDETAILS_REPL INV_DET
...
FROM DISC_PROD.HHAEXCHANGEPREFERRED.TBLINVOICEHEADER_REPL INV
