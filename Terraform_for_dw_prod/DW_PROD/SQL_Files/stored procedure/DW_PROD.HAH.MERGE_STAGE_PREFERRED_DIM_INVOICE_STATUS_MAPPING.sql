CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_PREFERRED_DIM_INVOICE_STATUS_MAPPING()
...
USING DW_PROD.STAGE.PREFERRED_DIM_INVOICE_STATUS_MAPPING STAGE 
