CREATE OR REPLACE PROCEDURE DW_PROD.REPORT.GET_REPORT_SCHEDULE_METRICS_WEEKLY("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
INSERT OVERWRITE INTO REPORT.SCHEDULE_METRICS_WEEKLY
	( --PAYROLL_DATE, PAY_PERIOD_START_DATE, PAY_PERIOD_END_DATE, 
	SERVICE_WEEK, CLIENT_KEY, CONTRACT_KEY, PARTNER_CONTRACT_SERVICE_KEY, ORIGINAL_SOURCE_SYSTEM_ID, SOURCE_SYSTEM_ID, BRANCH_KEY, SUPERVISOR_KEY, EMPLOYEE_KEY, HOURS_SERVED, 
	 HOURS_IN_REVIEW, FUTURE_HOURS, FUTURE_HOURS_NO_CAREGIVER,
FUTURE_CANCELLED_HOURS, FUTURE_HOLD_HOURS, HOURS_MISSED, HOURS_CANCELLED, HOURS_RESCHEDULED, HOURS_SCHEDULED, VISITS_IN_REVIEW, 
	 FUTURE_VISITS, FUTURE_VISITS_NO_CAREGIVER, FUTURE_CANCELLED_VISITS, FUTURE_HOLD_VISITS, VISITS_MISSED, VISITS_COMPLETED, VISITS_CANCELLED, VISITS_RESCHEDULED, VISITS_SCHEDULED, 
...
GROUP BY
	...
	SELECT /*PAYROLL_DATE, PAY_PERIOD_START_DATE, PAY_PERIOD_END_DATE,*/ SERVICE_WEEK, CLIENT_KEY, CONTRACT_KEY,PARTNER_CONTRACT_SERVICE_KEY, ORIGINAL_SOURCE_SYSTEM_ID,
	SOURCE_SYSTEM_ID, BRANCH_KEY, SUPERVISOR_KEY, EMPLOYEE_KEY, HOURS_SERVED, 
	HOURS_IN_REVIEW, FUTURE_HOURS, FUTURE_HOURS_NO_CAREGIVER,
FUTURE_CANCELLED_HOURS, FUTURE_HOLD_HOURS, HOURS_MISSED, HOURS_CANCELLED, HOURS_RESCHEDULED, HOURS_SCHEDULED, VISITS_IN_REVIEW, 
	FUTURE_VISITS,FUTURE_VISITS_NO_CAREGIVER, FUTURE_CANCELLED_VISITS, FUTURE_HOLD_VISITS, VISITS_MISSED, VISITS_COMPLETED, VISITS_CANCELLED, VISITS_RESCHEDULED, VISITS_SCHEDULED, 
