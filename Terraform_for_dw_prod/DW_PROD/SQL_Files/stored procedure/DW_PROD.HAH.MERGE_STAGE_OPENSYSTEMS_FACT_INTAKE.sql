CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_OPENSYSTEMS_FACT_INTAKE()
...
MERGE INTO DW_PROD.HAH.FACT_INTAKE AS tgt
USING DW_PROD.STAGE.OPENSYSTEMS_FACT_INTAKE AS src
