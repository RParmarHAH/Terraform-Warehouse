CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_DATAFLEXSYNCDATA_DIM_PARTNER_CONTRACT()
...
USING DW_PROD.STAGE.DATAFLEXSYNCDATA_DIM_PARTNER_CONTRACT AS SRC
