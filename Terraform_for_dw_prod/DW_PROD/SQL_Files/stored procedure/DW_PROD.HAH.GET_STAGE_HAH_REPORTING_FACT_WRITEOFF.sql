CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_HAH_REPORTING_FACT_WRITEOFF("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
FROM DISC_PROD.HAH_REPORTING.AGING_SUMMARY_AMOUNTDATA f
