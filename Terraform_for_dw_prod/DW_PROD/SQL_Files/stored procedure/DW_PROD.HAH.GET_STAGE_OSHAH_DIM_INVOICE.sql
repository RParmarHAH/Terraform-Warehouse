CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_OSHAH_DIM_INVOICE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
--*****************************************************************************************************************************
INSERT OVERWRITE INTO DW_PROD."STAGE".OSHAH_DIM_INVOICE 
WITH CLIENT AS 
(
	SELECT * FROM
	(
...
FROM DISC_PROD.HHAEXCHANGEOSHAH.TBLINVOICEHEADER_REPL HEAD
INNER JOIN INVOICE_DETAILS INVOICE 
	  ON HEAD.INVOICEHEADERID = INVOICE.INVOICEHEADERID
INNER  JOIN CLIENT CLI 
	  ON HEAD.PATIENTID = CLI.PATIENTID
INNER JOIN DISC_PROD.HHAEXCHANGEOSHAH.INVOICEDETAILS DETAILS 
...
LEFT JOIN DISC_PROD.HHAEXCHANGEOSHAH.STAGE_PAYER_REPL P 
