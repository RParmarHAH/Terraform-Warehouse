CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_PREFERRED_DIM_REFERRER("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
INSERT OVERWRITE INTO STAGE.PREFERRED_DIM_REFERRER 
SELECT 
md5(r.AGENCYID||''-''||r."REFERRALSOURCEID"||''-''||''PREFERRED'') REFERRER_KEY,
...
FROM DISC_PROD.HHAEXCHANGEPREFERRED.REFERRALSOURCE r;
;
