CREATE OR REPLACE PROCEDURE DW_PROD.INTEGRATION.GET_MASTER_DIM_CLIENT_AL_MERGED_DEDUPE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
CLUSTER_ID FROM DW_PROD.INTEGRATION.DIM_CLIENT_AL_RL_OUTPUT WHERE CLUSTER_ID IS NOT NULL
)
...
ID,SYSTEM_CODE,SOURCE_SYSTEM_ID,CLIENT_NUMBER,CLIENT_PID,CLUSTER_ID,AGENCY FROM DW_PROD.INTEGRATION.DIM_CLIENT_AL_RL_OUTPUT WHERE CLUSTER_ID IS NOT NULL
)-- WHERE min_record_id = 1
...
FROM  DW_PROD.INTEGRATION.DIM_CLIENT_AL_RL_OUTPUT R
...
FROM  DW_PROD.INTEGRATION.DIM_CLIENT_AL_RL_OUTPUT U
