CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_PAYOR_CONTRACT_UI_FACT_PARTNER_CONTRACT_SERVICE("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
LEFT JOIN  DISC_PROD.PAYOR_CONTRACT_UI.PAYOR P ON P.PAYOR_ID = PCM.PAYOR_ID;
return ''SUCCESS'';
END;
';