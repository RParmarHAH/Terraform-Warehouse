CREATE OR REPLACE PROCEDURE DW_PROD.REPORT.GET_REPORT_COVID_19_DAILYVISITHOURSCOUNTRECENT4WEEKS("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
BEGIN
    INSERT OVERWRITE INTO REPORT.COVID_19_DAILYVISITHOURSCOUNTRECENT4WEEKS
with SD_Visits as 
(
    SELECT 
...
INSERT INTO REPORT.COVID_19_DAILYVISITHOURSCOUNTRECENT4WEEKS
with SD_Visits as 
(
    SELECT 
    "DATE" as Service_Date,
