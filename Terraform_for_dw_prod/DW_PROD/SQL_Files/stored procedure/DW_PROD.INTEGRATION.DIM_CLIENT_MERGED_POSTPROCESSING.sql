CREATE OR REPLACE PROCEDURE DW_PROD.INTEGRATION.DIM_CLIENT_MERGED_POSTPROCESSING("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
--*****************************************************************************************************************************
INSERT OVERWRITE INTO DW_PROD.INTEGRATION.DIM_CLIENT_MERGED
WITH CLIENT_DEDUPE AS
(SELECT * FROM DW_PROD.INTEGRATION.DIM_CLIENT_MERGED_DEDUPE
), CLIENTS AS (
SELECT * FROM DW_PROD.INTEGRATION.VW_DIM_CLIENT_MERGED WHERE SOURCE_SYSTEM_ID NOT IN (''13'',''14'',''16'')
