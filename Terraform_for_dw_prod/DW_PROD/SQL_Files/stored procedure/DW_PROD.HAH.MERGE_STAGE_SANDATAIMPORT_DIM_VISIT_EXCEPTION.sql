CREATE OR REPLACE PROCEDURE DW_PROD.HAH.MERGE_STAGE_SANDATAIMPORT_DIM_VISIT_EXCEPTION()
...
BEGIN
	MERGE INTO DW_PROD.HAH.DIM_VISIT_EXCEPTION TGT USING DW_PROD.STAGE.SANDATAIMPORT_DIM_VISIT_EXCEPTION STAGE 
