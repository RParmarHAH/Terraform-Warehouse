CREATE OR REPLACE PROCEDURE DW_PROD.HAH.GET_STAGE_EMPEONEDISON_DIM_PAYCODE_MAPPING("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
WITH PAYCODES AS (
	...
	FROM DISC_PROD.EMPEONEDISON.ETAX
),
USAGE_DATES AS (
	SELECT DISTINCT
	...
	FROM DISC_PROD.EMPEONEDISON.EPAYHISTDETAIL ED
	LEFT JOIN DISC_PROD.EMPEONEDISON.EPAYHIST EH 
