create or replace view DW_PROD.REPORT.VW_GATOR_CAREGIVER_CARE_PROGRAM(
	ACCOUNT_ID,
	EMPLOYEE_KEY,
...
(
	...
	FROM DW_PROD.REPORT.VW_GATOR_CLIENT_CARE_PROGRAM CLIENT_CARE_PROGRAM
...
(
	...
	FROM APP_DB_PROD.CARE_COORDINATION.CLIENT_PROGRAM_MEMBERSHIP_STATUS_HISTORY ENROLLMENT,
	LATERAL 
	(
		SELECT MIN(ETL_INSERTED_DATE) AS DISENROLLMENT_DATE 
		FROM APP_DB_PROD.CARE_COORDINATION.CLIENT_PROGRAM_MEMBERSHIP_STATUS_HISTORY DISENROLLMENT
...
(
	...
	FROM DW_PROD.INTEGRATION.DIM_CLIENT_MERGED CLIENT
	INNER JOIN CLIENT_CARE_PROGRAM_INFO CLIENT_PROGRAM
		ON CLIENT_PROGRAM.ORIGINAL_CLIENT_KEY = CLIENT.ORIGINAL_CLIENT_KEY
	INNER JOIN DW_PROD.INTEGRATION.FACT_VISIT_MERGED VISIT
		ON VISIT.CLIENT_KEY = CLIENT.CLIENT_KEY 
	INNER JOIN DW_PROD.HAH.DIM_CONTRACT CONTRACT
		ON CONTRACT.CONTRACT_KEY = VISIT.CONTRACT_KEY 
	INNER JOIN DW_PROD.INTEGRATION.DIM_BRANCH_MERGED BRANCH
...
(
	...
	FROM DW_PROD.REPORT.VW_GATOR_CAREGIVER_MAPPING GATOR_CAREGIVER
