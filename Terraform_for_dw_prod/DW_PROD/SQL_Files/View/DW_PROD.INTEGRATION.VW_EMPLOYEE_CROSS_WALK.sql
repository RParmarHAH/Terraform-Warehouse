create or replace view DW_PROD.INTEGRATION.VW_EMPLOYEE_CROSS_WALK(
...
, UNMAPPED_APPLIANTS AS
	...
	WHERE NOT APPLICANT_KEY IN 
		(SELECT DISTINCT APPLICANT_KEY FROM DW_PROD.INTEGRATION.APPLICANT_WORKDAY_EMPLOYEE_MAPPING)
	)
, FINAL AS (
