create or replace view DW_PROD.STAGE.VW_CURRENT_DELETED_GPSYNCDATA_FACT_PAYROLL(
	PAYROLL_KEY
) as
...
FROM DISC_PROD.GPSYNCDATA.HIST_Paystub_Master AS m1
...
FROM DISC_PROD.GPSYNCDATA.HIST_PAYSTUB_MASTER)
