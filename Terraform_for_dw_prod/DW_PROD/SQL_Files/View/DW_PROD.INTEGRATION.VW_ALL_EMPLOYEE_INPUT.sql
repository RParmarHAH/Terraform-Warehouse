create or replace view DW_PROD.INTEGRATION.VW_ALL_EMPLOYEE_INPUT(
	ID,
	SOURCE_SYSTEM_TYPE,
	SYSTEM_CODE,
	SSN,
  ...
  INNER JOIN DW_PROD.HAH.DIM_SOURCE_SYSTEM S ON E.SOURCE_SYSTEM_ID = S.SOURCE_SYSTEM_ID  WHERE SOURCE_SYSTEM_TYPE IN ('AMS','Payroll','HCM');