create or replace view DW_PROD.REPORT.VW_PARADOX_APPLICATION_DETAILS_BACKUP_20221110(
	CANDIDATE_ID,
	"First Name",
	"Middle Name",
	"Last Name",
...
FROM DW_PROD.HAH.FACT_APPLICANT_STATUS S
    ...
    --LEFT JOIN DISC_PROD.ALAYACARE.TBL_COST_CENTRES_TIER_4 CCL ON TRIM(UPPER(J.CITY)) = TRIM(UPPER(CCL.PROPERTIES_DESCRIPTION)) 
    --LEFT JOIN DISC_PROD.ALAYACARE.GROUPS GL ON TRIM(UPPER(J.CITY)) = TRIM(UPPER(GL.PROPERTIES_DESCRIPTION))
