create or replace view DW_PROD.REPORT.VW_HOURS_AND_CLIENT_CENSUS_MONTHLY(
	PERIOD_BEGIN_DATE,
	PERIOD_NAME,
	STATE,
	BRANCH_KEY,
...
NON_STANDARD_UNITS,HOURS_SERVED_ALL, HOURS_BILLED_ALL,	HOURS_AUTHORIZED_ALL,	HOURS_AUTHORIZED_NON_ADJUSTED_ALL,
...
HOURS_SERVED_WHERE_AUTH_EXISTS,	HOURS_BILLED_WHERE_AUTH_EXISTS,	HOURS_AUTHORIZED_WHERE_AUTH_EXISTS,	HOURS_AUTHORIZED_NON_ADJUSTED_WHERE_AUTH_EXISTS,NON_STANDARD_UNITS,
...
SELECT FINAL_UTILIZATION.PERIOD_BEGIN_DATE,
FINAL_UTILIZATION.PERIOD_NAME,
FINAL_UTILIZATION.STATE,
FINAL_UTILIZATION.BRANCH_KEY,
FINAL_UTILIZATION.OFFICE_NUMBER,
FINAL_UTILIZATION.OFFICE_NAME,
FINAL_UTILIZATION.SUPERVISOR_KEY,
FINAL_UTILIZATION.SUPERVISOR_CODE,
SERVICEDATES.ABSOLUTE_FIRST_SERVICE_DATE,
SERVICEDATES.ABSOLUTE_LAST_SERVICE_DATE,
FINAL_UTILIZATION.CLIENT_KEY_DATA,
FINAL_UTILIZATION.CLIENT_NUMBER,
FINAL_UTILIZATION.ORIGINAL_SOURCE_SYSTEM_ID,
FINAL_UTILIZATION.SOURCE_SYSTEM_ID,
FINAL_UTILIZATION.CONTRACT_KEY,
NVL(SE.HHAX_PARTNER_CONTRACT_SERVICE_KEY, FINAL_UTILIZATION.PARTNER_CONTRACT_SERVICE_KEY) PARTNER_CONTRACT_SERVICE_KEY,
NVL(SE.HHAX_CONTRACT_CODE,FINAL_UTILIZATION.CONTRACT_CODE) AS CONTRACT_CODE,
FINAL_UTILIZATION.CLIENT_KEY,
FINAL_UTILIZATION.HOURS_SCHEDULED,
FINAL_UTILIZATION.HOURS_CANCELLED,
FINAL_UTILIZATION.HOURS_IN_REVIEW,
FINAL_UTILIZATION.HOURS_MISSED,
FINAL_UTILIZATION.HOURS_RESCHEDULED,
FINAL_UTILIZATION.FUTURE_HOURS,
FINAL_UTILIZATION.FUTURE_HOURS_NO_CAREGIVER,
FINAL_UTILIZATION.FUTURE_CANCELLED_HOURS,
FINAL_UTILIZATION.FUTURE_HOLD_HOURS,
FINAL_UTILIZATION.HOURS_SERVED_WHERE_AUTH_EXISTS,
FINAL_UTILIZATION.HOURS_BILLED_WHERE_AUTH_EXISTS,
IFF(SE.CLIENT_KEY IS NOT NULL,0, FINAL_UTILIZATION.HOURS_AUTHORIZED_WHERE_AUTH_EXISTS) AS HOURS_AUTHORIZED_WHERE_AUTH_EXISTS,
FINAL_UTILIZATION.NON_STANDARD_UNITS,
IFF(SE.CLIENT_KEY IS NOT NULL, 0, FINAL_UTILIZATION.HOURS_AUTHORIZED_NON_ADJUSTED_ALL) AS HOURS_AUTHORIZED_NON_ADJUSTED_WHERE_AUTH_EXISTS,
FINAL_UTILIZATION.HOURS_SERVED_ALL,
FINAL_UTILIZATION.HOURS_BILLED_ALL,
IFF(SE.CLIENT_KEY IS NOT NULL,0,FINAL_UTILIZATION.HOURS_AUTHORIZED_ALL) AS HOURS_AUTHORIZED_ALL,
IFF(SE.CLIENT_KEY IS NOT NULL,0,FINAL_UTILIZATION.HOURS_AUTHORIZED_NON_ADJUSTED_ALL) AS HOURS_AUTHORIZED_NON_ADJUSTED_ALL,
FINAL_UTILIZATION.INCLUDE_FOR_CLIENTS,
FINAL_UTILIZATION.INCLUDE_FOR_HOURS,
FINAL_UTILIZATION.REVENUE_CATEGORY,
FINAL_UTILIZATION.VISITS_ALL,
FINAL_UTILIZATION.VISITS_CLEAN_SHIFTS,
FINAL_UTILIZATION.VISITS_NEED_MAINTENANCE,
FINAL_UTILIZATION.VISITS_SCHEDULED,
FINAL_UTILIZATION.VISITS_COMPLETED,
FINAL_UTILIZATION.VISITS_CANCELLED,
FINAL_UTILIZATION.VISITS_IN_REVIEW,
FINAL_UTILIZATION.VISITS_MISSED,
FINAL_UTILIZATION.VISITS_RESCHEDULED,
FINAL_UTILIZATION.FUTURE_VISITS,
FINAL_UTILIZATION.FUTURE_CANCELLED_VISITS,
FINAL_UTILIZATION.FUTURE_HOLD_VISITS,
FINAL_UTILIZATION.CLIENT_ACQUIRED_FLAG,
FINAL_UTILIZATION.CLIENT_ACQUISITION_NAME,
FINAL_UTILIZATION.CLIENT_SERVED_FLAG,
FINAL_UTILIZATION.NPS,
FINAL_UTILIZATION.ETL_LAST_UPDATED_DATE
FROM
FINAL_UTILIZATION
JOIN ABSOLUTE_SERVICE_DATES SERVICEDATES ON FINAL_UTILIZATION.CLIENT_KEY = SERVICEDATES.CLIENTKEY
LEFT JOIN DW_PROD.REPORT.SANDATA_AUTH_EXCLUDE SE ON FINAL_UTILIZATION.CLIENT_KEY = SE.CLIENT_KEY  AND FINAL_UTILIZATION.PARTNER_CONTRACT_SERVICE_KEY = SE.PARTNER_CONTRACT_SERVICE_KEY AND FINAL_UTILIZATION.PERIOD_BEGIN_DATE ='2023-06-01';