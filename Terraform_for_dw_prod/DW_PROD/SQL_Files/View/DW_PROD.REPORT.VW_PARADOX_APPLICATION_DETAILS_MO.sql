create or replace view DW_PROD.REPORT.VW_PARADOX_APPLICATION_DETAILS_MO(
	CANDIDATE_ID,
	"First Name",
	"Middle Name",
	"Last Name",
...
FROM DW_PROD.HAH.FACT_APPLICANT_STATUS S
    ...
    LEFT JOIN DW_DEV.HAH.DIM_BRANCH BR ON LOWER(TRIM(J.STATE)) = 'missouri' and S.BRANCH_KEY = BR.BRANCH_KEY
WHERE 
