create or replace view DW_PROD.REPORT.CLIENT_METRICS_FOR_SLT_FJN_W_BILLABLE(
	SERVICE_YEAR,
	STATE_CODE,
	CLIENT_KEY,
	CLIENT_ETHNICITY,
...
FROM DW_PROD.Report.Client_Derived_Monthly_Visit_Metrics_CLS_w_Billable AS cdmv
