create or replace view DW_PROD.REPORT.ALVAREZMARSALDATA_WORKEDHOURS(
	EMPLOYEE_KEY,
	EMPLOYEENAME,
	EMPLOYEENUMBER,
	CLIENTKEY,
...
JOIN DW_PROD.INTEGRATION.DIM_EMPLOYEE_MERGED e 
...
LEFT JOIN DW_PROD.INTEGRATION.DIM_BRANCH_MERGED b 
