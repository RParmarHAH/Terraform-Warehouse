create or replace view DW_PROD.REPORT.VW_SANDATA_REJECT_CODES(
	REJECT_CODE,
	DESCRIPTION,
	SANDATA_VISIT_ID,
	SCHEDULE_ID,
...
JOIN DISC_PROD.SANDATAIMPORT.SANDATA_CLIENTS C
...
JOIN DISC_PROD.SANDATAIMPORT.SANDATA_REJECTIONCODES RC on S.AGENCYID = RC.AGENCYID and S.REJECTIONCODE = RC.CODE
