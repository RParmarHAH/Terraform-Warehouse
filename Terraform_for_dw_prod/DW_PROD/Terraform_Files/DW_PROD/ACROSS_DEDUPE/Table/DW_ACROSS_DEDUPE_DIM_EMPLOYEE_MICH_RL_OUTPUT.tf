resource "snowflake_table" "DW_ACROSS_DEDUPE_DIM_EMPLOYEE_MICH_RL_OUTPUT" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "ACROSS_DEDUPE"
	name = "DIM_EMPLOYEE_MICH_RL_OUTPUT"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.ACROSS_DEDUPE.DIM_EMPLOYEE_MICH_RL_OUTPUT
