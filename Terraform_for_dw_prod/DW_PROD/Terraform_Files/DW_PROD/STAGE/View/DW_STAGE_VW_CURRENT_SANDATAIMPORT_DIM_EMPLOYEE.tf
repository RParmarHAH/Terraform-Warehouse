resource "snowflake_view" "DW_STAGE_VW_CURRENT_SANDATAIMPORT_DIM_EMPLOYEE" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "VW_CURRENT_SANDATAIMPORT_DIM_EMPLOYEE"
	statement = <<-SQL
	 WITH 
-- offbrnch AS
-- (
...
FROM DISC_${var.SF_ENVIRONMENT}.TrustPointData.Employees AS tp
