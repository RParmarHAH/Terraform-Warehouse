resource "snowflake_view" "DW_STAGE_VW_CURRENT_COSTALSYNCDATA_FACT_REVENUE" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "VW_CURRENT_COSTALSYNCDATA_FACT_REVENUE"
	statement = <<-SQL
...
--			AND TRIM(UPPER(SCHEDULES.SCHEDULE_STATUS_CODE)) IN ('B', 'BP', 'P') 
	...
	FROM DISC_${var.SF_ENVIRONMENT}.COSTALSYNCDATA.CV_BILLINGDATA DATA
