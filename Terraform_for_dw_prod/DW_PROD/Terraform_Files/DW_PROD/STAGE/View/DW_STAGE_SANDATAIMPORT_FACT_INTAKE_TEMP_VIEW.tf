resource "snowflake_view" "DW_STAGE_SANDATAIMPORT_FACT_INTAKE_TEMP_VIEW" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "SANDATAIMPORT_FACT_INTAKE_TEMP_VIEW"
	statement = <<-SQL
...
FROM (
	...
	LEFT JOIN DW_${var.SF_ENVIRONMENT}.HAH.DIM_DATE CAL
