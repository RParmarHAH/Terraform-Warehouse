resource "snowflake_view" "DW_STAGE_VW_CURRENT_DELETED_HAH_REPORTING_FACT_WRITEOFF" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "VW_CURRENT_DELETED_HAH_REPORTING_FACT_WRITEOFF"
	statement = <<-SQL
	 SELECT
...
FROM DISC_${var.SF_ENVIRONMENT}.HAH_REPORTING.HIST_AGING_SUMMARY_AMOUNTDATA f
...
FROM DISC_${var.SF_ENVIRONMENT}.HAH_REPORTING.HIST_AGING_SUMMARY_AMOUNTDATA)
