resource "snowflake_table" "DW_STAGE_DATAFLEXSYNCDATA_FACT_VISIT_HISTORY" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "DATAFLEXSYNCDATA_FACT_VISIT_HISTORY"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.STAGE.DATAFLEXSYNCDATA_FACT_VISIT_HISTORY
