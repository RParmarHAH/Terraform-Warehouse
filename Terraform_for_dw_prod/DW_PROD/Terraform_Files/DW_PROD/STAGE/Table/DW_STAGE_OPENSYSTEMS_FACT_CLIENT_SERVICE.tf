resource "snowflake_table" "DW_STAGE_OPENSYSTEMS_FACT_CLIENT_SERVICE" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "OPENSYSTEMS_FACT_CLIENT_SERVICE"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.STAGE.OPENSYSTEMS_FACT_CLIENT_SERVICE
