resource "snowflake_table" "DW_STAGE_PREFERRED_DIM_VISIT_STATUS_MAPPING" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "PREFERRED_DIM_VISIT_STATUS_MAPPING"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.STAGE.PREFERRED_DIM_VISIT_STATUS_MAPPING
