resource "snowflake_table" "DW_STAGE_ADPANSWERCARE_DIM_EMPLOYEE_BCKP_11102023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "ADPANSWERCARE_DIM_EMPLOYEE_BCKP_11102023"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.STAGE.ADPANSWERCARE_DIM_EMPLOYEE_BCKP_11102023
