resource "snowflake_table" "DW_STAGE_OSHAH_FACT_CLIENT_SERVICE_BKCP2610" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "OSHAH_FACT_CLIENT_SERVICE_BKCP2610"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.STAGE.OSHAH_FACT_CLIENT_SERVICE_BKCP2610
