resource "snowflake_table" "DW_STAGE_SANDATAIMPORT_DIM_CLIENT_BKCP_07_27_2023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "SANDATAIMPORT_DIM_CLIENT_BKCP_07_27_2023"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.STAGE.SANDATAIMPORT_DIM_CLIENT_BKCP_07_27_2023
