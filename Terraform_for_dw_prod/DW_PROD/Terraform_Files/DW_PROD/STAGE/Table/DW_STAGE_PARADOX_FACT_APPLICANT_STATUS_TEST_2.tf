resource "snowflake_table" "DW_STAGE_PARADOX_FACT_APPLICANT_STATUS_TEST_2" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "PARADOX_FACT_APPLICANT_STATUS_TEST_2"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.STAGE.PARADOX_FACT_APPLICANT_STATUS_TEST_2
