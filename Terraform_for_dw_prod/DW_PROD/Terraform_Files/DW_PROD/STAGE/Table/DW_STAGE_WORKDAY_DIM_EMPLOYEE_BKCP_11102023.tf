resource "snowflake_table" "DW_STAGE_WORKDAY_DIM_EMPLOYEE_BKCP_11102023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "WORKDAY_DIM_EMPLOYEE_BKCP_11102023"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.STAGE.WORKDAY_DIM_EMPLOYEE_BKCP_11102023
