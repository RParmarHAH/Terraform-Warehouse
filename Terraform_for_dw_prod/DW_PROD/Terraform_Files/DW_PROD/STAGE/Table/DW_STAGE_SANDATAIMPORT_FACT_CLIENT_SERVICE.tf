resource "snowflake_table" "DW_STAGE_SANDATAIMPORT_FACT_CLIENT_SERVICE" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "SANDATAIMPORT_FACT_CLIENT_SERVICE"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.STAGE.SANDATAIMPORT_FACT_CLIENT_SERVICE
