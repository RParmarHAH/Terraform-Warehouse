resource "snowflake_table" "DW_STAGE_EDISON_DIM_VISIT_STATUS_MAPPING" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "EDISON_DIM_VISIT_STATUS_MAPPING"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.STAGE.EDISON_DIM_VISIT_STATUS_MAPPING
