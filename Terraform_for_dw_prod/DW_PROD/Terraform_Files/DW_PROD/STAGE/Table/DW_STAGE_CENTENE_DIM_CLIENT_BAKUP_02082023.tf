resource "snowflake_table" "DW_STAGE_CENTENE_DIM_CLIENT_BAKUP_02082023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "CENTENE_DIM_CLIENT_BAKUP_02082023"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.STAGE.CENTENE_DIM_CLIENT_BAKUP_02082023
