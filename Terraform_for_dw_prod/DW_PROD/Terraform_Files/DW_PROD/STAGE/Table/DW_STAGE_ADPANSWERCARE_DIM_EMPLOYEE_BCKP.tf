resource "snowflake_table" "DW_STAGE_ADPANSWERCARE_DIM_EMPLOYEE_BCKP" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "ADPANSWERCARE_DIM_EMPLOYEE_BCKP"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.STAGE.ADPANSWERCARE_DIM_EMPLOYEE_BCKP
