resource "snowflake_table" "DW_STAGE_CLEARCARE_FACT_INTAKE_BKCP_06_10_23" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "CLEARCARE_FACT_INTAKE_BKCP_06_10_23"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.STAGE.CLEARCARE_FACT_INTAKE_BKCP_06_10_23
