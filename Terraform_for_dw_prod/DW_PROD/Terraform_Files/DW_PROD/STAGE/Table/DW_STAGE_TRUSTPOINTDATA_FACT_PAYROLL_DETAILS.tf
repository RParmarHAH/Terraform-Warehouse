resource "snowflake_table" "DW_STAGE_TRUSTPOINTDATA_FACT_PAYROLL_DETAILS" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "TRUSTPOINTDATA_FACT_PAYROLL_DETAILS"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.STAGE.TRUSTPOINTDATA_FACT_PAYROLL_DETAILS
