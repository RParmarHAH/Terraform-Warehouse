resource "snowflake_table" "DW_STAGE_QUALTRICS_FACT_DISTRIBUTION" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "QUALTRICS_FACT_DISTRIBUTION"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.STAGE.QUALTRICS_FACT_DISTRIBUTION
...
column {
	name = "QUALTRICS_FACT_DISTRIBUTION_KEY"
	type = "VARCHAR(32)"
	nullable = true
}
