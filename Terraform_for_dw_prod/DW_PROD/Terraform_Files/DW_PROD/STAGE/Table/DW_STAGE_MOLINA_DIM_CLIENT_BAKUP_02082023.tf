resource "snowflake_table" "DW_STAGE_MOLINA_DIM_CLIENT_BAKUP_02082023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "MOLINA_DIM_CLIENT_BAKUP_02082023"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.STAGE.MOLINA_DIM_CLIENT_BAKUP_02082023
