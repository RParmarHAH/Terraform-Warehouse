resource "snowflake_procedure" "DW_REPORT_GET_REPORT_HOURS_AND_CENSUS_BY_PAYROLL_DATE_WEEKLY_1_0" {
	name ="GET_REPORT_HOURS_AND_CENSUS_BY_PAYROLL_DATE_WEEKLY_1_0"
