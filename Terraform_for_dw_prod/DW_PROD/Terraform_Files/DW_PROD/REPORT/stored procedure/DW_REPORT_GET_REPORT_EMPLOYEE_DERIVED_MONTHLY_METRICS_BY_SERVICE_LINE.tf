resource "snowflake_procedure" "DW_REPORT_GET_REPORT_EMPLOYEE_DERIVED_MONTHLY_METRICS_BY_SERVICE_LINE" {
	name ="GET_REPORT_EMPLOYEE_DERIVED_MONTHLY_METRICS_BY_SERVICE_LINE"
