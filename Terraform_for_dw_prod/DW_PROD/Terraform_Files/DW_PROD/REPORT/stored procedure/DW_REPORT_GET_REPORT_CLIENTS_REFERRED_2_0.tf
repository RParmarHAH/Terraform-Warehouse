resource "snowflake_procedure" "DW_REPORT_GET_REPORT_CLIENTS_REFERRED_2_0" {
	name ="GET_REPORT_CLIENTS_REFERRED_2_0"
...
BEGIN
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.REPORT.CLIENTS_REFERRED_2_0
WITH AUTHORIZATION AS (
	...
	FROM DW_${var.SF_ENVIRONMENT}.REPORT.CLIENT_SERVICE_MONTHLY_AUTHORIZATION GROUP BY 1,2,3,4,5--,6
), FUTURE_VISITS AS 
(
SELECT
	CLIENT_KEY,
...
, CLIENTS_SERVICE_DATES AS (
	...
	FROM DW_${var.SF_ENVIRONMENT}.INTEGRATION.FACT_VISIT_MERGED V
--	LEFT JOIN DW_${var.SF_ENVIRONMENT}.HAH.FACT_PARTNER_CONTRACT_SERVICE FPS
...
LEFT JOIN DW_${var.SF_ENVIRONMENT}.HAH.FACT_PARTNER_CONTRACT_SERVICE PCS ON PCS.PARTNER_CONTRACT_SERVICE_KEY = AUTH.PARTNER_CONTRACT_SERVICE_KEY
