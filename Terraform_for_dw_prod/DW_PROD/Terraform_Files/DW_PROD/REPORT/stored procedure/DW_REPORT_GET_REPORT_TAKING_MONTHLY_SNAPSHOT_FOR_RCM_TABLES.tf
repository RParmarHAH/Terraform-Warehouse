resource "snowflake_procedure" "DW_REPORT_GET_REPORT_TAKING_MONTHLY_SNAPSHOT_FOR_RCM_TABLES" {
	name ="GET_REPORT_TAKING_MONTHLY_SNAPSHOT_FOR_RCM_TABLES"
...
DECLARE 
	return_result DATE;
	LAST_INSERTED_DATE DATE DEFAULT (SELECT MAX(MONTH_DATE) FROM DW_${var.SF_ENVIRONMENT}.REPORT.RPT_INVOICE_METRICS_MONTHLY);	--Added on 12/02/24
BEGIN
...
INSERT INTO DW_${var.SF_ENVIRONMENT}.REPORT.TAKING_MONTHLY_SNAPSHOT_FOR_RCM_TABLES
SELECT * FROM (
...
FROM DW_${var.SF_ENVIRONMENT}.HAH.DIM_INVOICE_MONTHLY
UNION
...
FROM DW_${var.SF_ENVIRONMENT}.HAH.FACT_REVENUE_MONTHLY
UNION 
...
FROM DW_${var.SF_ENVIRONMENT}.REPORT.RPT_INVOICE_METRICS_MONTHLY
UNION 
...
FROM DW_${var.SF_ENVIRONMENT}.REPORT.RPT_UNBILLED_METRICS_MONTHLY
UNION 
...
FROM DW_${var.SF_ENVIRONMENT}.HAH.DIM_INVOICE_VISIT_LINKAGE_MONTHLY
);
...
FROM DW_${var.SF_ENVIRONMENT}.HAH.dim_date d1
...
INSERT INTO DW_${var.SF_ENVIRONMENT}.HAH.DIM_INVOICE_MONTHLY
SELECT *, current_timestamp::date AS MONTH_DATE
FROM DW_${var.SF_ENVIRONMENT}.HAH.DIM_INVOICE
WHERE current_timestamp::date = :return_result;

INSERT INTO DW_${var.SF_ENVIRONMENT}.HAH.FACT_REVENUE_MONTHLY
SELECT *, current_timestamp::date AS MONTH_DATE
FROM DW_${var.SF_ENVIRONMENT}.HAH.FACT_REVENUE
WHERE current_timestamp::date = :return_result;

INSERT INTO DW_${var.SF_ENVIRONMENT}.REPORT.RPT_INVOICE_METRICS_MONTHLY
...
FROM DW_${var.SF_ENVIRONMENT}.REPORT.RPT_INVOICE_METRICS
WHERE current_timestamp::date = :return_result and MONTH_DATE::date != :LAST_INSERTED_DATE;

INSERT INTO DW_${var.SF_ENVIRONMENT}.REPORT.RPT_UNBILLED_METRICS_MONTHLY
SELECT *, current_timestamp::date AS MONTH_DATE
FROM DW_${var.SF_ENVIRONMENT}.REPORT.RPT_UNBILLED_METRICS
WHERE current_timestamp::date = :return_result;

INSERT INTO DW_${var.SF_ENVIRONMENT}.HAH.DIM_INVOICE_VISIT_LINKAGE_MONTHLY
SELECT *, current_timestamp::date AS MONTH_DATE
FROM DW_${var.SF_ENVIRONMENT}.HAH.DIM_INVOICE_VISIT_LINKAGE
WHERE current_timestamp::date = :return_result;

UPDATE DW_${var.SF_ENVIRONMENT}.REPORT.TAKING_MONTHLY_SNAPSHOT_FOR_RCM_TABLES A
