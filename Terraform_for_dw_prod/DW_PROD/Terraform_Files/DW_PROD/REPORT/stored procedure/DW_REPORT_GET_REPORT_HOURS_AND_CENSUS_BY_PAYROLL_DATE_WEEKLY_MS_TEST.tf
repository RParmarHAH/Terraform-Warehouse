resource "snowflake_procedure" "DW_REPORT_GET_REPORT_HOURS_AND_CENSUS_BY_PAYROLL_DATE_WEEKLY_MS_TEST" {
	name ="GET_REPORT_HOURS_AND_CENSUS_BY_PAYROLL_DATE_WEEKLY_MS_TEST"
...
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.REPORT.HOURS_AND_CENSUS_BY_PAYROLL_DATE_WEEKLY_MS_TEST
...
NEW_METRICS AS
	(	
		...
		FROM DW_${var.SF_ENVIRONMENT}.PUBLIC.SCHEDULE_METRICS_WEEKLY_TEST_101123
		GROUP BY 
			/*PAYROLL_DATE,
			PAY_PERIOD_START_DATE, 
			PAY_PERIOD_END_DATE,*/
