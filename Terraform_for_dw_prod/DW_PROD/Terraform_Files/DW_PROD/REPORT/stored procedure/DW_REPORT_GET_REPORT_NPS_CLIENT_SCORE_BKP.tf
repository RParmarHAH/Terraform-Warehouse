resource "snowflake_procedure" "DW_REPORT_GET_REPORT_NPS_CLIENT_SCORE_BKP" {
	name ="GET_REPORT_NPS_CLIENT_SCORE_BKP"
...
WITH SURVEY_MAPPING AS (
  ...
  , CLIENT_CONTRACTS AS (
      ...
      INNER JOIN DW_${var.SF_ENVIRONMENT}.HAH.FACT_VISIT FV
