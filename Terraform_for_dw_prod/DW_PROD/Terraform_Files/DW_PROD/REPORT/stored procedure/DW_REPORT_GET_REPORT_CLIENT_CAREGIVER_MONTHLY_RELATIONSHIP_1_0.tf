resource "snowflake_procedure" "DW_REPORT_GET_REPORT_CLIENT_CAREGIVER_MONTHLY_RELATIONSHIP_1_0" {
	name ="GET_REPORT_CLIENT_CAREGIVER_MONTHLY_RELATIONSHIP_1_0"
...
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.REPORT.CLIENT_CAREGIVER_MONTHLY_RELATIONSHIP_1_0
SELECT
