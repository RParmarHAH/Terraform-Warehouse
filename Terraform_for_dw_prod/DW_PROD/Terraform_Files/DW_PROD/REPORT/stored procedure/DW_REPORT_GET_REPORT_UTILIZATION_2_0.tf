resource "snowflake_procedure" "DW_REPORT_GET_REPORT_UTILIZATION_2_0" {
	name ="GET_REPORT_UTILIZATION_2_0"
...
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.REPORT.UTILIZATION_2_0
