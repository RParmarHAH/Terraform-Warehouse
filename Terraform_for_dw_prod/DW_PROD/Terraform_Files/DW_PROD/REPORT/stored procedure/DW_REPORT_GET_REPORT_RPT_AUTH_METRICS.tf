resource "snowflake_procedure" "DW_REPORT_GET_REPORT_RPT_AUTH_METRICS" {
	name ="GET_REPORT_RPT_AUTH_METRICS"
...
--*****************************************************************************************************************************
	INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.REPORT.RPT_AUTH_METRICS
	...
	FROM DW_${var.SF_ENVIRONMENT}.INTEGRATION.FACT_INTAKE_MERGED INTAKE
