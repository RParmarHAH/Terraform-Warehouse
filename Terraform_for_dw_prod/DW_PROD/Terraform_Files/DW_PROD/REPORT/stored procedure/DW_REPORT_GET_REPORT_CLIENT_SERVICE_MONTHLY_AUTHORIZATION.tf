resource "snowflake_procedure" "DW_REPORT_GET_REPORT_CLIENT_SERVICE_MONTHLY_AUTHORIZATION" {
	name ="GET_REPORT_CLIENT_SERVICE_MONTHLY_AUTHORIZATION"
...
CASE WHEN AUTHORIZATION_TYPE =''Visit Authorization'' THEN ''Visit''
	...
	FROM DW_${var.SF_ENVIRONMENT}.INTEGRATION.FACT_CLIENT_SERVICE_MERGED 
