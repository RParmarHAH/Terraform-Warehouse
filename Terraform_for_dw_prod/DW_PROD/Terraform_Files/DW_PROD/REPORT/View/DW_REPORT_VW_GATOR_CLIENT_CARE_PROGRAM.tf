resource "snowflake_view" "DW_REPORT_VW_GATOR_CLIENT_CARE_PROGRAM" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "VW_GATOR_CLIENT_CARE_PROGRAM"
	statement = <<-SQL
	 ------------------------------------------------------------------------------------------------------------------------------
/*
Object Type : 	View
...
(
	...
	LEFT JOIN DW_${var.SF_ENVIRONMENT}.REPORT.VW_GATOR_CLIENT_MAPPING GATOR_CLIENT_MAP -- Using this view to get Client and Original Client Keys
	...
	LEFT JOIN DISC_${var.SF_ENVIRONMENT}.HEALTH_NAVIGATOR.CAREPROGRAMENROLLEE CLIENT_CARE_PROGRAM
		INNER JOIN DISC_${var.SF_ENVIRONMENT}.HEALTH_NAVIGATOR.CAREPROGRAM CARE_PROGRAM
...
(
	...
	FROM DW_${var.SF_ENVIRONMENT}.REPORT.ARCHIVED_CC_CLIENT_CARE_PROGRAM ARCHIVED_CLIENTS
	INNER JOIN DISC_${var.SF_ENVIRONMENT}.HEALTH_NAVIGATOR.ACCOUNT GATOR_CLIENT
...
--				AND CLIENT_CARE_PROGRAM.STATUS = 'Legacy'
	LEFT JOIN DW_${var.SF_ENVIRONMENT}.REPORT.VW_GATOR_CLIENT_MAPPING GATOR_CLIENT_MAP
			ON GATOR_CLIENT_MAP.ACCOUNT_ID = GATOR_CLIENT.ID
