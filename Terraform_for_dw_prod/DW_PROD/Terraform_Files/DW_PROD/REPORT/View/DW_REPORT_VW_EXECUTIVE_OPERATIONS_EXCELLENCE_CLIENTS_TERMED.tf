resource "snowflake_view" "DW_REPORT_VW_EXECUTIVE_OPERATIONS_EXCELLENCE_CLIENTS_TERMED" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "VW_EXECUTIVE_OPERATIONS_EXCELLENCE_CLIENTS_TERMED"
	statement = <<-SQL
	...
	JOIN REPORT.VW_EXECUTIVE_OPERATIONS_EXCELLENCE_CLIENTS_TERMED_DIM_DATE DATES
	...
	WHERE VISITS.PERIOD_BEGIN_DATE IS NULL
)
