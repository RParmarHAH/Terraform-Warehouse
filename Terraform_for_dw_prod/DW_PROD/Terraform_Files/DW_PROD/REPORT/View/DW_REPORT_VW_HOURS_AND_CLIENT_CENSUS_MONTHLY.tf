resource "snowflake_view" "DW_REPORT_VW_HOURS_AND_CLIENT_CENSUS_MONTHLY" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "VW_HOURS_AND_CLIENT_CENSUS_MONTHLY"
	statement = <<-SQL
	 WITH DATES AS 
(
...
LEFT JOIN DW_${var.SF_ENVIRONMENT}.REPORT.SANDATA_AUTH_EXCLUDE SE ON FINAL_UTILIZATION.CLIENT_KEY = SE.CLIENT_KEY  AND FINAL_UTILIZATION.PARTNER_CONTRACT_SERVICE_KEY = SE.PARTNER_CONTRACT_SERVICE_KEY AND FINAL_UTILIZATION.PERIOD_BEGIN_DATE ='2023-06-01';
SQL
	or_replace = true 
	is_secure = false 
}
