resource "snowflake_view" "DW_REPORT_VW_HOURS_AND_CENSUS_OVERTIME_EXCLUDED_CONTRACTS" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "VW_HOURS_AND_CENSUS_OVERTIME_EXCLUDED_CONTRACTS"
	statement = <<-SQL
...
WITH INCLUDED_CONTRACTS AS (
	...
	FROM DISC_${var.SF_ENVIRONMENT}.DATAFLEXSYNCDATA.DFCONTRACTS DFCONTRACTS
