resource "snowflake_view" "DW_REPORT_CLIENT_DERIVED_MONTHLY_VISIT_METRICS_SEC_WITH_MASTER_CLIENT_KEY_BKCP_08_01_2022" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "CLIENT_DERIVED_MONTHLY_VISIT_METRICS_SEC_WITH_MASTER_CLIENT_KEY_BKCP_08_01_2022"
	statement = <<-SQL
	 SELECT
    SERVICE_MONTH
	  ,ORIGINAL_CLIENT_KEY
