resource "snowflake_view" "DW_REPORT_EMPLOYEE_DERIVED_MONTHLY_VISIT_METRICS_W_BILLABLE_MASTER_EMP_KEY" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "EMPLOYEE_DERIVED_MONTHLY_VISIT_METRICS_W_BILLABLE_MASTER_EMP_KEY"
	statement = <<-SQL
