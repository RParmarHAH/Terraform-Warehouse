resource "snowflake_view" "DW_REPORT_VW_EXECUTIVE_OPERATIONS_EXCELLENCE_UTILIZATION_W_DEMOGRAPHICS" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "VW_EXECUTIVE_OPERATIONS_EXCELLENCE_UTILIZATION_W_DEMOGRAPHICS"
	statement = <<-SQL
	 	WITH DATES AS (
		...
		FROM DW_${var.SF_ENVIRONMENT}.REPORT.VW_DASHBOARD_CONTRACTS c
