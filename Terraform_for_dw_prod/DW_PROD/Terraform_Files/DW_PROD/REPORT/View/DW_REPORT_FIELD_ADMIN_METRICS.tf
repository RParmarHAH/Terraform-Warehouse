resource "snowflake_view" "DW_REPORT_FIELD_ADMIN_METRICS" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "FIELD_ADMIN_METRICS"
	statement = <<-SQL
	 ---------------------development log---------------------
...
------ merged tables and DW_${var.SF_ENVIRONMENT}.INTEGRATION.DIM_EMPLOYEE_PAYROLL_MERGE_DEDUPE 

FROM DW_${var.SF_ENVIRONMENT}.INTEGRATION.DIM_EMPLOYEE_MERGED  EMP
