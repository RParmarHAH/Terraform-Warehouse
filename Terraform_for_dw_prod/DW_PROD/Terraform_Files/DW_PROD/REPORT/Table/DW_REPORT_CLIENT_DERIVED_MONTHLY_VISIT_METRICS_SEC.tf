resource "snowflake_table" "DW_REPORT_CLIENT_DERIVED_MONTHLY_VISIT_METRICS_SEC" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "CLIENT_DERIVED_MONTHLY_VISIT_METRICS_SEC"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.REPORT.CLIENT_DERIVED_MONTHLY_VISIT_METRICS_SEC
...
column {
	name = "NUMBER_OF_OTHER_VISIT_DAYS"
	type = "NUMBER(38,0)"
	nullable = true
}
