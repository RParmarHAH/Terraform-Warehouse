resource "snowflake_table" "DW_REPORT_RPT_INVOICE_METRICS_MONTHLY_UNIQUE_REOCRD_010923" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "RPT_INVOICE_METRICS_MONTHLY_UNIQUE_REOCRD_010923"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.REPORT.RPT_INVOICE_METRICS_MONTHLY_UNIQUE_REOCRD_010923
