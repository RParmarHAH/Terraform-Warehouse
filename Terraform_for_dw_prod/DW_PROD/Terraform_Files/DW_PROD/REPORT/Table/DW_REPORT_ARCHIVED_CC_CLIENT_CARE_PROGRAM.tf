resource "snowflake_table" "DW_REPORT_ARCHIVED_CC_CLIENT_CARE_PROGRAM" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "ARCHIVED_CC_CLIENT_CARE_PROGRAM"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.REPORT.ARCHIVED_CC_CLIENT_CARE_PROGRAM
