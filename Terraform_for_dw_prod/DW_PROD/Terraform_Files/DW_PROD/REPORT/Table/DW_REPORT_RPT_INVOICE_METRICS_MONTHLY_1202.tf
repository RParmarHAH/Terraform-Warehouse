resource "snowflake_table" "DW_REPORT_RPT_INVOICE_METRICS_MONTHLY_1202" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "RPT_INVOICE_METRICS_MONTHLY_1202"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.REPORT.RPT_INVOICE_METRICS_MONTHLY_1202
