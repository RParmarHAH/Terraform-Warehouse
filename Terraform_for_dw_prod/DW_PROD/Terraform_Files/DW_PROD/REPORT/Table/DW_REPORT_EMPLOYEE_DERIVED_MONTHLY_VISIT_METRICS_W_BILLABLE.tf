resource "snowflake_table" "DW_REPORT_EMPLOYEE_DERIVED_MONTHLY_VISIT_METRICS_W_BILLABLE" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "EMPLOYEE_DERIVED_MONTHLY_VISIT_METRICS_W_BILLABLE"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.REPORT.EMPLOYEE_DERIVED_MONTHLY_VISIT_METRICS_W_BILLABLE
