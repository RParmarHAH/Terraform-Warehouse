resource "snowflake_table" "DW_REPORT_CLIENT_SERVICE_MONTHLY_AUTHORIZATION_BKCP1310" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "CLIENT_SERVICE_MONTHLY_AUTHORIZATION_BKCP1310"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.REPORT.CLIENT_SERVICE_MONTHLY_AUTHORIZATION_BKCP1310
