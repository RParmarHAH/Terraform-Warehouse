resource "snowflake_table" "DW_REPORT_WORKDAY_X_ATTRIBUTE_COMPARISION_MZ" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "WORKDAY_X_ATTRIBUTE_COMPARISION_MZ"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.REPORT.WORKDAY_X_ATTRIBUTE_COMPARISION_MZ
