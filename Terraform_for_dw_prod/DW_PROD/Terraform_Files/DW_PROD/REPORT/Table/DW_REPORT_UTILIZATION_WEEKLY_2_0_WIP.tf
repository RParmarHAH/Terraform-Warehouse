resource "snowflake_table" "DW_REPORT_UTILIZATION_WEEKLY_2_0_WIP" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "UTILIZATION_WEEKLY_2_0_WIP"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.REPORT.UTILIZATION_WEEKLY_2_0_WIP
