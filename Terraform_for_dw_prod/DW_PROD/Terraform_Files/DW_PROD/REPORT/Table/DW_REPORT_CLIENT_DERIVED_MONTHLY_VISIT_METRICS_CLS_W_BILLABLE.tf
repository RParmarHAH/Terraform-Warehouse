resource "snowflake_table" "DW_REPORT_CLIENT_DERIVED_MONTHLY_VISIT_METRICS_CLS_W_BILLABLE" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "CLIENT_DERIVED_MONTHLY_VISIT_METRICS_CLS_W_BILLABLE"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.REPORT.CLIENT_DERIVED_MONTHLY_VISIT_METRICS_CLS_W_BILLABLE
