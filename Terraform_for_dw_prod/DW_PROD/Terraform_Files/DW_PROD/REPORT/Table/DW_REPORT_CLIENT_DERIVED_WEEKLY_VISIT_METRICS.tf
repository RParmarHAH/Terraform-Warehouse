resource "snowflake_table" "DW_REPORT_CLIENT_DERIVED_WEEKLY_VISIT_METRICS" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "CLIENT_DERIVED_WEEKLY_VISIT_METRICS"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.REPORT.CLIENT_DERIVED_WEEKLY_VISIT_METRICS
...
column {
	name = "LIFETIME_FIRST_SERVICE_WEEK"
	type = "DATE"
	nullable = true
}
...
column {
	name = "LIFETIME_LAST_SERVICE_WEEK"
	type = "DATE"
	nullable = true
}
...
column {
	name = "LIFETIME_NUMBER_WEEKS_WITH_SERVICE"
	type = "NUMBER(38,0)"
	nullable = true
}
...
column {
	name = "LIFETIME_NUMBER_WEEKS_WO_SERVICE"
	type = "NUMBER(38,0)"
	nullable = true
}
...
column {
	name = "PREVIOUS_2_WEEKS_NUMBER_OF_VISITS"
	type = "NUMBER(38,0)"
	nullable = true
}
...
column {
	name = "NEXT_2_WEEKS_NUMBER_OF_VISITS"
	type = "NUMBER(38,0)"
	nullable = true
}
...
column {
	name = "PREVIOUS_WEEK_SUM_OF_HOURS_RECEIVED"
	type = "NUMBER(9,3)"
	nullable = true
}
...
column {
	name = "PREVIOUS_2_WEEKS_SUM_OF_HOURS_RECEIVED"
	type = "NUMBER(9,3)"
	nullable = true
}
...
column {
	name = "NEXT_WEEKS_SUM_OF_HOURS_RECEIVED"
	type = "NUMBER(9,3)"
	nullable = true
}
...
column {
	name = "NEXT_2_WEEKS_SUM_OF_HOURS_RECEIVED"
	type = "NUMBER(9,3)"
	nullable = true
}
