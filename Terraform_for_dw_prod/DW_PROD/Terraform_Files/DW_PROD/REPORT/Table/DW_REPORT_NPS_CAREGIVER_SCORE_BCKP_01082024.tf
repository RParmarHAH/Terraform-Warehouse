resource "snowflake_table" "DW_REPORT_NPS_CAREGIVER_SCORE_BCKP_01082024" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "NPS_CAREGIVER_SCORE_BCKP_01082024"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.REPORT.NPS_CAREGIVER_SCORE_BCKP_01082024
