resource "snowflake_table" "DW_REPORT_EMPLOYEE_DERIVED_WEEKLY_VISIT_METRICS_27_SEP_2023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "EMPLOYEE_DERIVED_WEEKLY_VISIT_METRICS_27_SEP_2023"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.REPORT.EMPLOYEE_DERIVED_WEEKLY_VISIT_METRICS_27_SEP_2023
...
column {
	name = "FIRST_SERVICE_WEEK_END_DATE"
	type = "DATE"
	nullable = true
}
...
column {
	name = "LAST_SERVICE_WEEK_END_DATE"
	type = "DATE"
	nullable = true
}
...
column {
	name = "NUMBER_WEEKS_WITH_SERVICE"
	type = "NUMBER(38,0)"
	nullable = true
}
...
column {
	name = "OTHER_CONTRACT_SERVICES_PROVIDED"
	type = "BOOLEAN"
	nullable = true
}
...
column {
	name = "PREVIOUS_WEEK_NUMBER_OF_VISITS"
	type = "NUMBER(38,0)"
	nullable = true
}
...
column {
	name = "PREVIOUS_2_WEEK_NUMBER_OF_VISITS"
	type = "NUMBER(38,0)"
	nullable = true
}
...
column {
	name = "NEXT_WEEK_NUMBER_OF_VISITS"
	type = "NUMBER(38,0)"
	nullable = true
}
...
column {
	name = "NEXT_2_WEEK_NUMBER_OF_VISITS"
	type = "NUMBER(38,0)"
	nullable = true
}
...
column {
	name = "PREVIOUS_WEEK_NUMBER_OF_DISTINCT_CLIENTS"
	type = "NUMBER(38,0)"
	nullable = true
}
...
column {
	name = "PREVIOUS_2_WEEK_NUMBER_OF_DISTINCT_CLIENTS"
	type = "NUMBER(38,0)"
	nullable = true
}
...
column {
	name = "NEXT_WEEK_NUMBER_OF_DISTINCT_CLIENTS"
	type = "NUMBER(38,0)"
	nullable = true
}
...
column {
	name = "NEXT_2_WEEK_NUMBER_OF_DISTINCT_CLIENTS"
	type = "NUMBER(38,0)"
	nullable = true
}
...
column {
	name = "PREVIOUS_WEEK_SUM_OF_HOURS_SERVED"
	type = "NUMBER(9,3)"
	nullable = true
}
...
column {
	name = "PREVIOUS_2_WEEK_SUM_OF_HOURS_SERVED"
	type = "NUMBER(9,3)"
	nullable = true
}
...
column {
	name = "NEXT_WEEK_SUM_OF_HOURS_SERVED"
	type = "NUMBER(9,3)"
	nullable = true
}
...
column {
	name = "NEXT_2_WEEK_SUM_OF_HOURS_SERVED"
	type = "NUMBER(9,3)"
	nullable = true
}
