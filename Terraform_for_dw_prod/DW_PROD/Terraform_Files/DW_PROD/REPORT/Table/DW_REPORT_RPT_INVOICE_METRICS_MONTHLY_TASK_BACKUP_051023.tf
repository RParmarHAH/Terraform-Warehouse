resource "snowflake_table" "DW_REPORT_RPT_INVOICE_METRICS_MONTHLY_TASK_BACKUP_051023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "RPT_INVOICE_METRICS_MONTHLY_TASK_BACKUP_051023"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.REPORT.RPT_INVOICE_METRICS_MONTHLY_TASK_BACKUP_051023
