resource "snowflake_table" "DW_REPORT_HOURS_AND_CENSUS_BY_PAYROLL_DATE_WEEKLY_2_0" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "HOURS_AND_CENSUS_BY_PAYROLL_DATE_WEEKLY_2_0"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.REPORT.HOURS_AND_CENSUS_BY_PAYROLL_DATE_WEEKLY_2_0
