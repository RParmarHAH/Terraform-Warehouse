resource "snowflake_table" "DW_REPORT_EMPLOYEE_DERIVED_MONTHLY_VISIT_METRICS_27_SEP_2023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "REPORT"
	name = "EMPLOYEE_DERIVED_MONTHLY_VISIT_METRICS_27_SEP_2023"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.REPORT.EMPLOYEE_DERIVED_MONTHLY_VISIT_METRICS_27_SEP_2023
