resource "snowflake_table" "DW_HAH_DIM_CLIENT_BKCP_11212023_PRODREFRESH" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "HAH"
	name = "DIM_CLIENT_BKCP_11212023_PRODREFRESH"
	change_tracking = false
	comment = "TAKING THIS BACKUP AS A PART OF CLIENT DISCHARGE REASON RELEASE IDDOX - 466"
