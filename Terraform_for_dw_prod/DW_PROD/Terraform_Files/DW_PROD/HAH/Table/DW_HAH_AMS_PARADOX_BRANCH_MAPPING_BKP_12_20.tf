resource "snowflake_table" "DW_HAH_AMS_PARADOX_BRANCH_MAPPING_BKP_12_20" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "HAH"
	name = "AMS_PARADOX_BRANCH_MAPPING_BKP_12_20"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.HAH.AMS_PARADOX_BRANCH_MAPPING_BKP_12_20
