resource "snowflake_table" "DW_HAH_DIM_CLIENT_BKCP_20112023_AFTERPIPELINE" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "HAH"
	name = "DIM_CLIENT_BKCP_20112023_AFTERPIPELINE"
	change_tracking = false
	comment = "This is a cloned table from original_table beacuse we add new CLIENT_STATUS filed in that"
