resource "snowflake_table" "DW_HAH_DIM_EMPLOYEE_27102023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "HAH"
	name = "DIM_EMPLOYEE_27102023"
	change_tracking = false
	comment = "Before mapping changes in survival logic for payroll system in discovey -- jigar prajapati"
