resource "snowflake_table" "DW_HAH_FACT_VISIT_DARSHAN_18_JULY_23_277132" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "HAH"
	name = "FACT_VISIT_DARSHAN_18_JULY_23_277132"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.HAH.FACT_VISIT_DARSHAN_18_JULY_23_277132
