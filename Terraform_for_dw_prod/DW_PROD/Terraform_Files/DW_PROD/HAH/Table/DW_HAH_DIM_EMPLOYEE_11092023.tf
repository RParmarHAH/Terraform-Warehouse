resource "snowflake_table" "DW_HAH_DIM_EMPLOYEE_11092023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "HAH"
	name = "DIM_EMPLOYEE_11092023"
	change_tracking = false
	comment = "BACKUP BEFORE ADDING DERIVED DATES -- JIGAR PRAJAPATI"
...
column {
	name = "BACKUP BEFORE ADDING DERIVED"
	type = "DATE"
	nullable = true
}
