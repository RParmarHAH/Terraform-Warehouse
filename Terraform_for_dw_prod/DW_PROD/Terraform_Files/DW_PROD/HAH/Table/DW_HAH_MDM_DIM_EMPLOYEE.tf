resource "snowflake_table" "DW_HAH_MDM_DIM_EMPLOYEE" {
    ...
    -- NAME :  DW_PROD.HAH.MDM_DIM_EMPLOYEE
...
column {
	name = "PREVIOUS_WORKER_EMPLOYEE_KEY"
	type = "VARCHAR(32)"
	nullable = true
}
...
column {
	name = "PREVIOUS_WORKER_EMPLOYEE_ID"
	type = "VARCHAR(32)"
	nullable = true
}
...
column {
	name = "PREVIOUS_WORKER_EFFECTIVE_FROM"
	type = "DATE"
	nullable = true
}
...
column {
	name = "PREVIOUS_WORKER_EFFECTIVE_TO"
	type = "DATE"
	nullable = true
}
