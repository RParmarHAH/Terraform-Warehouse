resource "snowflake_view" "DW_HAH_VW_DIM_SOURCE_SYSTEM_TO_MARKET" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "HAH"
	name = "VW_DIM_SOURCE_SYSTEM_TO_MARKET"
	statement = <<-SQL
...
INNER JOIN DW_${var.SF_ENVIRONMENT}.HAH.DIM_Source_System AS ss ON emp.Source_System_ID = ss.Source_System_ID
UNION
