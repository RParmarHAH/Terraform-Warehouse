resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_MATRIXCARE_FACT_INVOICE_TRANSACTIONS" {
	name ="MERGE_STAGE_MATRIXCARE_FACT_INVOICE_TRANSACTIONS"
...
USING STAGE.MATRIXCARE_FACT_INVOICE_TRANSACTIONS STAGE
ON 
