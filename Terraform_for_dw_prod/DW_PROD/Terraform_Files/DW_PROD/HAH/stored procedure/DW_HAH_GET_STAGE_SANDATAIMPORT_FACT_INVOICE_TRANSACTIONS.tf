resource "snowflake_procedure" "DW_HAH_GET_STAGE_SANDATAIMPORT_FACT_INVOICE_TRANSACTIONS" {
	name ="GET_STAGE_SANDATAIMPORT_FACT_INVOICE_TRANSACTIONS"
    ...
    BEGIN
        ...
        WITH all_visits AS (select agencyid,
                            ...
                            from disc_${var.SF_ENVIRONMENT}.sandataimport.sandata_visits v
             ...
             INVOICES AS (SELECT CASE
                          ...
                          FROM DISC_${var.SF_ENVIRONMENT}.SANDATAIMPORT.SANDATA_INVOICEHEADER H
                                   ...
                                   LEFT JOIN DISC_${var.SF_ENVIRONMENT}.SANDATAIMPORT.SANDATA_INVOICEDETAILS D
                                   ...
                                   LEFT JOIN (SELECT INVOICEDETAILID,
                                              ...
                                              FROM DISC_${var.SF_ENVIRONMENT}.SANDATAIMPORT.SANDATA_PAYMENTDETAILS --Added on 31/07/23
        ...
        FROM DISC_${var.SF_ENVIRONMENT}.SANDATAIMPORT.SANDATA_PAYMENTDETAILS PAY_DET
                 LEFT JOIN DISC_${var.SF_ENVIRONMENT}.SANDATAIMPORT.SANDATA_PAYMENTHEADER PAY_HED
                           ON PAY_DET.AGENCYID =
