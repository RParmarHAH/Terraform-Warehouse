resource "snowflake_procedure" "DW_HAH_GET_STAGE_ALLIANCE_FACT_CLIENT_SERVICE" {
	name ="GET_STAGE_ALLIANCE_FACT_CLIENT_SERVICE"
...
--LEFT JOIN DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.AUTHORIZATIONS A 
