resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_DATAFLEXSYNCDATA_DIM_INVOICE" {
	name ="MERGE_STAGE_DATAFLEXSYNCDATA_DIM_INVOICE"
...
USING STAGE.DATAFLEXSYNCDATA_DIM_INVOICE STAGE 
