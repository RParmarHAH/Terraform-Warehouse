resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_MATRIXCARE_FACT_ADMISSION" {
	name ="MERGE_STAGE_MATRIXCARE_FACT_ADMISSION"
...
USING STAGE.MATRIXCARE_FACT_ADMISSION STAGE
