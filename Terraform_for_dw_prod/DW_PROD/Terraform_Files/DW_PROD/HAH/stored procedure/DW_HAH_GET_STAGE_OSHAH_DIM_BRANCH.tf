resource "snowflake_procedure" "DW_HAH_GET_STAGE_OSHAH_DIM_BRANCH" {
	name ="GET_STAGE_OSHAH_DIM_BRANCH"
...
WITH OSHAH_DATA AS (
        ...
        FROM "DISC_${var.SF_ENVIRONMENT}"."HHAEXCHANGEOSHAH"."OFFICE_OFFICES_REPL" AS OFFICES
        LEFT JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.OFFICE_OFFICELEVELS_REPL OL ON OL.OFFICELEVELID = OFFICES.OFFICELEVELID --ADDED
     ...
     FOR_Branch_Service_Line AS (
   	 ...
   	 FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.vISITS v
      JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.VW_OSHAH_REVENUE VOR ON vor.SERVICECODE = v.PRIMARYSERVICECODE
