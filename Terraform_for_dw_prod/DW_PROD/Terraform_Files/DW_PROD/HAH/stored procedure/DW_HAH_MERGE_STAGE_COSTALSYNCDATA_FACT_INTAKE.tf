resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_COSTALSYNCDATA_FACT_INTAKE" {
	name ="MERGE_STAGE_COSTALSYNCDATA_FACT_INTAKE"
...
USING STAGE.COSTALSYNCDATA_FACT_INTAKE STAGE 
