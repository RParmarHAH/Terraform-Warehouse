resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_GPSYNCDATA_FACT_PAYROLL" {
	name ="MERGE_STAGE_GPSYNCDATA_FACT_PAYROLL"
...
USING STAGE.GPSYNCDATA_FACT_PAYROLL STAGE 
