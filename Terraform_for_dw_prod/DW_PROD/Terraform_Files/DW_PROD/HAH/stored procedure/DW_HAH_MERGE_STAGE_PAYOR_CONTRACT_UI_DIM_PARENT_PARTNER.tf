resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_PAYOR_CONTRACT_UI_DIM_PARENT_PARTNER" {
	name ="MERGE_STAGE_PAYOR_CONTRACT_UI_DIM_PARENT_PARTNER"
...
BEGIN
MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.DIM_PARENT_PARTNER AS tgt
USING DW_${var.SF_ENVIRONMENT}.STAGE.PAYOR_CONTRACT_UI_DIM_PARENT_PARTNER AS src
ON tgt.PARENT_PARTNER_KEY=src.PARENT_PARTNER_KEY
WHEN MATCHED THEN UPDATE SET
 	  ...
 	  tgt.PARENT_PARTNER_CODE=src.PARENT_PARTNER_CODE,
...
VALUES ( src.PARENT_PARTNER_KEY
	,src.SOURCE_SYSTEM_ID
	,src.SYSTEM_CODE
	,src.PARENT_PARTNER_NAME
	,src.PARENT_PARTNER_CODE
	,src.ACTIVE_FLAG
	,src.START_DATE
	,src.END_DATE
	,src."LEVEL"
