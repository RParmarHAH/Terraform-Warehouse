resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_SANDATAIMPORT_FACT_CLIENT_SERVICE" {
	name ="MERGE_STAGE_SANDATAIMPORT_FACT_CLIENT_SERVICE"
...
BEGIN
	MERGE INTO HAH.FACT_CLIENT_SERVICE TGT
	USING STAGE.SANDATAIMPORT_FACT_CLIENT_SERVICE STAGE
