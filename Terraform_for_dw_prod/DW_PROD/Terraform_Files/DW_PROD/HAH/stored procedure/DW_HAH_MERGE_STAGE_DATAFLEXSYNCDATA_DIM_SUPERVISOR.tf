resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_DATAFLEXSYNCDATA_DIM_SUPERVISOR" {
	name ="MERGE_STAGE_DATAFLEXSYNCDATA_DIM_SUPERVISOR"
...
USING STAGE.DATAFLEXSYNCDATA_DIM_SUPERVISOR STAGE 
