resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OPENSYSTEMS_FACT_VISIT_EXCEPTION" {
	name ="MERGE_STAGE_OPENSYSTEMS_FACT_VISIT_EXCEPTION"
...
BEGIN
	MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.FACT_VISIT_EXCEPTION TGT USING DW_${var.SF_ENVIRONMENT}.STAGE.OPENSYSTEMS_FACT_VISIT_EXCEPTION STAGE 
