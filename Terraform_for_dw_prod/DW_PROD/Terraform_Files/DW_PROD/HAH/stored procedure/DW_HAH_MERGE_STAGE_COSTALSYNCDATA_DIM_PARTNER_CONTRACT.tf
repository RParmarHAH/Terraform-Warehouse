resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_COSTALSYNCDATA_DIM_PARTNER_CONTRACT" {
	name ="MERGE_STAGE_COSTALSYNCDATA_DIM_PARTNER_CONTRACT"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.COSTALSYNCDATA_DIM_PARTNER_CONTRACT AS src
