resource "snowflake_procedure" "DW_HAH_GET_STAGE_PREFERRED_DIM_CLIENT" {
	name ="GET_STAGE_PREFERRED_DIM_CLIENT"
...
(
	...
	FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.PATIENTSTATUSCHANGEACTIVITY 
	)
,				
...
(
	...
	FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.PATIENTSTATUSCHANGEACTIVITY S 
), SERVICE_DATE AS 
(
...
FROM DISC_DEDUPE_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.CLIENT_MASTER_LIST M
...
--LEFT JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.OFFICE_OFFICES_REPL  O ON M.OFFICEID = O.OFFICEID
...
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.REFERRALSOURCE RS ON RS.REFERRALSOURCEID = M.REFERRALSOURCEID
