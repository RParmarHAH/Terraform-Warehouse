resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OSHAH_FACT_ADMISSION" {
	name ="MERGE_STAGE_OSHAH_FACT_ADMISSION"
...
USING DW_${var.SF_ENVIRONMENT}."STAGE".OSHAH_FACT_ADMISSION AS src
