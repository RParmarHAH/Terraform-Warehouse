resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_VIVENTIUM_FACT_PAYROLL_DETAILS" {
	name ="MERGE_STAGE_VIVENTIUM_FACT_PAYROLL_DETAILS"
...
USING STAGE.VIVENTIUM_FACT_PAYROLL_DETAILS STAGE 
