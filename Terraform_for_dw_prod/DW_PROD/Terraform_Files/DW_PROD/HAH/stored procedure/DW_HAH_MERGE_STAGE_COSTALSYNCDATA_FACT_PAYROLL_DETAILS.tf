resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_COSTALSYNCDATA_FACT_PAYROLL_DETAILS" {
	name ="MERGE_STAGE_COSTALSYNCDATA_FACT_PAYROLL_DETAILS"
...
USING STAGE.COSTALSYNCDATA_FACT_PAYROLL_DETAILS STAGE 
