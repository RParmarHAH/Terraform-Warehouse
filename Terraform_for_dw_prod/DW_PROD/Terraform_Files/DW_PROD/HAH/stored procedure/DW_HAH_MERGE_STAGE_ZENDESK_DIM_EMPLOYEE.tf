resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ZENDESK_DIM_EMPLOYEE" {
	name ="MERGE_STAGE_ZENDESK_DIM_EMPLOYEE"
...
BEGIN
	...
	USING STAGE.ZENDESK_DIM_EMPLOYEE STG 
	...
	UPDATE SET 
		...
		,TGT.SALARY = STG.SALARY
		,TGT.PAY_RATE = STG.PAY_RATE
