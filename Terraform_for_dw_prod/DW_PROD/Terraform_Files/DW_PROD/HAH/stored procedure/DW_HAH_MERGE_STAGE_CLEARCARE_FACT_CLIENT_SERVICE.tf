resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_CLEARCARE_FACT_CLIENT_SERVICE" {
	name ="MERGE_STAGE_CLEARCARE_FACT_CLIENT_SERVICE"
...
MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.FACT_CLIENT_SERVICE AS tgt
	USING STAGE.CLEARCARE_FACT_CLIENT_SERVICE STAGE
