resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_COSTALSYNCDATA_FACT_REVENUE" {
	name ="MERGE_STAGE_COSTALSYNCDATA_FACT_REVENUE"
...
USING STAGE.COSTALSYNCDATA_FACT_REVENUE STAGE 
