resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ALLIANCE_DIM_PARTNER" {
	name ="MERGE_STAGE_ALLIANCE_DIM_PARTNER"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.ALLIANCE_DIM_PARTNER AS SRC
