resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ASR_FACT_VISIT" {
	name ="MERGE_STAGE_ASR_FACT_VISIT"
...
BEGIN
    MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.FACT_VISIT TGT 
USING STAGE.ASR_FACT_VISIT STAGE 
