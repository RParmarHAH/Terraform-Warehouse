resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_CLEARCARE_DIM_VISIT_STATUS_MAPPING" {
	name ="MERGE_STAGE_CLEARCARE_DIM_VISIT_STATUS_MAPPING"
...
USING STAGE.CLEARCARE_DIM_VISIT_STATUS_MAPPING STAGE 
