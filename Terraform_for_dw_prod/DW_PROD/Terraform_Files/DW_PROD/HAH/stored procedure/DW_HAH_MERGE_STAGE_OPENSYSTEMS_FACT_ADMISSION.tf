resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OPENSYSTEMS_FACT_ADMISSION" {
	name ="MERGE_STAGE_OPENSYSTEMS_FACT_ADMISSION"
...
USING DW_${var.SF_ENVIRONMENT}."STAGE".OPENSYSTEMS_FACT_ADMISSION AS src
