resource "snowflake_procedure" "DW_HAH_GET_STAGE_QUALTRICS_FACT_DISTRIBUTION" {
	name ="GET_STAGE_QUALTRICS_FACT_DISTRIBUTION"
...
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.STAGE.QUALTRICS_FACT_DISTRIBUTION
...
FROM DISC_${var.SF_ENVIRONMENT}.QUALTRICS_SURVEYS.QUALTRICS_SURVEY_DISTRIBUTION_HISTORY H
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.QUALTRICS_SURVEYS.QUALTRICS_DIRECTORY_CONTACTS C ON C.CONTACTID = H.CONTACT_ID
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.QUALTRICS_SURVEYS.QUALTRICS_SURVEY_DISTRIBUTION_LIST L ON L.ID = H.DISTRIBUTION_ID
