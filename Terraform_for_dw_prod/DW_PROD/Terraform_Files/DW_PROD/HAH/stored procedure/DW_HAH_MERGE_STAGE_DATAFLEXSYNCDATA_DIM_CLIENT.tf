resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_DATAFLEXSYNCDATA_DIM_CLIENT" {
	name ="MERGE_STAGE_DATAFLEXSYNCDATA_DIM_CLIENT"
...
USING STAGE.DATAFLEXSYNCDATA_DIM_CLIENT STAGE 
