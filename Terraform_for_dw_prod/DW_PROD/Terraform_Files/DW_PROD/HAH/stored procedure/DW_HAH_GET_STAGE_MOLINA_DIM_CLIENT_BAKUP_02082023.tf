resource "snowflake_procedure" "DW_HAH_GET_STAGE_MOLINA_DIM_CLIENT_BAKUP_02082023" {
	name ="GET_STAGE_MOLINA_DIM_CLIENT_BAKUP_02082023"
...
from DISC_${var.SF_ENVIRONMENT}.MOLINA.MOLINA_SOURCE_DATA) DATA;
