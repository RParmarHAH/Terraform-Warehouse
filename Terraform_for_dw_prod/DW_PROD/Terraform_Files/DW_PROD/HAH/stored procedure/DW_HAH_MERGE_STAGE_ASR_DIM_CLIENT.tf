resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ASR_DIM_CLIENT" {
	name ="MERGE_STAGE_ASR_DIM_CLIENT"
...
BEGIN
    MERGE INTO HAH.DIM_CLIENT TGT USING STAGE.ASR_DIM_CLIENT STAGE 
