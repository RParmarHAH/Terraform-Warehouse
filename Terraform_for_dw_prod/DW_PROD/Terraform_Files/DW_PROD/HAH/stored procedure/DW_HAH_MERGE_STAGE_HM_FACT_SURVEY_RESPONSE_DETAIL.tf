resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_HM_FACT_SURVEY_RESPONSE_DETAIL" {
	name ="MERGE_STAGE_HM_FACT_SURVEY_RESPONSE_DETAIL"
...
USING STAGE.HM_FACT_SURVEY_RESPONSE_DETAIL STAGE 
