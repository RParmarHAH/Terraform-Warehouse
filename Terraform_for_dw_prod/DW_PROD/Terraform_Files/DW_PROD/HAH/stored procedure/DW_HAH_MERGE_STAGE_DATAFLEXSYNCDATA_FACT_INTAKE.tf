resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_DATAFLEXSYNCDATA_FACT_INTAKE" {
	name ="MERGE_STAGE_DATAFLEXSYNCDATA_FACT_INTAKE"
...
USING STAGE.DATAFLEXSYNCDATA_FACT_INTAKE STAGE 
