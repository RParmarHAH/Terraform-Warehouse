resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_DATAFLEXSYNCDATA_ORPHAN_BRANCH" {
	name ="MERGE_STAGE_DATAFLEXSYNCDATA_ORPHAN_BRANCH"
...
DECLARE
  ...
  BEGIN
    MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.DIM_ORPHAN_BRANCH TGT 
USING DW_${var.SF_ENVIRONMENT}.STAGE.DATAFLEXSYNCDATA_ORPHAN_BRANCH STAGE 
