resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_MATRIXCARE_FACT_REVENUE" {
	name ="MERGE_STAGE_MATRIXCARE_FACT_REVENUE"
...
USING STAGE.MATRIXCARE_FACT_REVENUE STAGE 
