resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ADPOPAL_FACT_PAYROLL_DETAILS" {
	name ="MERGE_STAGE_ADPOPAL_FACT_PAYROLL_DETAILS"
...
USING STAGE.ADPOPAL_FACT_PAYROLL_DETAILS STAGE 
