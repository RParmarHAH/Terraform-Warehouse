resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_EMPEONEDISON_FACT_PAYROLL_DETAILS" {
	name ="MERGE_STAGE_EMPEONEDISON_FACT_PAYROLL_DETAILS"
...
USING STAGE.EMPEONEDISON_FACT_PAYROLL_DETAILS STAGE 
