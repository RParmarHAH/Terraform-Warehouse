resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_QUICKBOOKS_FACT_PAYROLL_DETAILS" {
	name ="MERGE_STAGE_QUICKBOOKS_FACT_PAYROLL_DETAILS"
...
USING STAGE.QUICKBOOKS_FACT_PAYROLL_DETAILS STAGE 
