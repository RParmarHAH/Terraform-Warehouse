resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_EMPEONEDISON_DIM_EMPLOYEE" {
	name ="MERGE_STAGE_EMPEONEDISON_DIM_EMPLOYEE"
...
USING STAGE.EMPEONEDISON_DIM_EMPLOYEE STAGE 
