resource "snowflake_procedure" "DW_HAH_GET_STAGE_DATAFLEXSYNCDATA_FACT_VISIT" {
	name ="GET_STAGE_DATAFLEXSYNCDATA_FACT_VISIT"
...
LEFT JOIN DW_${var.SF_ENVIRONMENT}.STAGE.DATAFLEXSYNCDATA_DIM_DERIVED_AUTH_FROM_HISTORY_WITH_MASTER_DEDUP auth
