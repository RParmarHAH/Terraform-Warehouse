resource "snowflake_procedure" "DW_HAH_GET_STAGE_OPENSYSTEMS_FACT_CLIENT_SERVICE_BKCP2610" {
	name ="GET_STAGE_OPENSYSTEMS_FACT_CLIENT_SERVICE_BKCP2610"
...
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}."STAGE".OPENSYSTEMS_FACT_CLIENT_SERVICE_bkcp2610
WITH CLIENT AS
(SELECT * FROM
