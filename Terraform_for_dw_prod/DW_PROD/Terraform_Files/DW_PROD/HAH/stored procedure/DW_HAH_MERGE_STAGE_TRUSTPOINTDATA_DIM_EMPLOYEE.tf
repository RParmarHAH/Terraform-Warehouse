resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_TRUSTPOINTDATA_DIM_EMPLOYEE" {
	name ="MERGE_STAGE_TRUSTPOINTDATA_DIM_EMPLOYEE"
...
USING STAGE.TRUSTPOINTDATA_DIM_EMPLOYEE STAGE 
