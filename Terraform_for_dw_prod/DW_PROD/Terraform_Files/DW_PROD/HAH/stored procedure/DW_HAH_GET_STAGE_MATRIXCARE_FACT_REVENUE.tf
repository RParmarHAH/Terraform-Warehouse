resource "snowflake_procedure" "DW_HAH_GET_STAGE_MATRIXCARE_FACT_REVENUE" {
	name ="GET_STAGE_MATRIXCARE_FACT_REVENUE"
...
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.MATRIXCARE.STVHC_T_SERVICECODE AS SERCO
...
LEFT JOIN (
    ...
    FROM DISC_${var.SF_ENVIRONMENT}.MATRIXCARE.STVHC_T_PAYMENTPOSTING WHERE "POST_PAYMENTPOSTINGTYPEID"  IN (1,5,6,10,10001,10006,10007)
...
--LEFT JOIN DISC_${var.SF_ENVIRONMENT}.MATRIXCARE.STVHC_T_CAREGIVER AS CAREGIVER
