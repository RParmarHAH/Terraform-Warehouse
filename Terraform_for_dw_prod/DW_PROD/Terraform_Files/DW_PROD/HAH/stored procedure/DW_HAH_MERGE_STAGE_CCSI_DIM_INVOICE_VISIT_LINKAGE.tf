resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_CCSI_DIM_INVOICE_VISIT_LINKAGE" {
	name ="MERGE_STAGE_CCSI_DIM_INVOICE_VISIT_LINKAGE"
...
USING STAGE.CCSI_DIM_INVOICE_VISIT_LINKAGE STAGE
ON 
