resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_SANDATAIMPORT_FACT_INTAKE" {
	name ="MERGE_STAGE_SANDATAIMPORT_FACT_INTAKE"
...
USING STAGE.SANDATAIMPORT_FACT_INTAKE STAGE 
