resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OSHAH_DIM_PARTNER" {
	name ="MERGE_STAGE_OSHAH_DIM_PARTNER"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.OSHAH_DIM_PARTNER AS src
