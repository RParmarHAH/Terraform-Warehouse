resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_PAYLOCITY_DIM_PAYCODE_MAPPING" {
	name ="MERGE_STAGE_PAYLOCITY_DIM_PAYCODE_MAPPING"
...
USING STAGE.PAYLOCITY_DIM_PAYCODE_MAPPING STAGE 
