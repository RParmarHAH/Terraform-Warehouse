resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_PREFERRED_FACT_VISIT_EXCEPTION" {
	name ="MERGE_STAGE_PREFERRED_FACT_VISIT_EXCEPTION"
...
BEGIN
	MERGE INTO HAH.FACT_VISIT_EXCEPTION TGT USING STAGE.PREFERRED_FACT_VISIT_EXCEPTION STAGE 
