resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_AXXESS_DIM_INVOICE_TRANSACTION_TYPE" {
	name ="MERGE_STAGE_AXXESS_DIM_INVOICE_TRANSACTION_TYPE"
...
USING STAGE.AXXESS_DIM_INVOICE_TRANSACTION_TYPE STAGE
ON 
