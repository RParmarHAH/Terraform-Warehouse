resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_AXXESS_FACT_INTAKE" {
	name ="MERGE_STAGE_AXXESS_FACT_INTAKE"
...
USING STAGE.AXXESS_FACT_INTAKE STAGE 
...
UPDATE SET 
   ...
   ,TGT.PRE_AUTH_NUMBER= STAGE.PRE_AUTH_NUMBER 			 -- Added by PJShah on 02052022
   ,TGT.BEGIN_SERVICE_DATE= STAGE.BEGIN_SERVICE_DATE	 -- Added by PJShah on 02052022
   ,TGT.END_SERVICE_DATE= STAGE.END_SERVICE_DATE		 -- Added by PJShah on 02052022
   ,TGT.LATEST_AUTH_BEGIN_DATE= STAGE.LATEST_AUTH_BEGIN_DATE  -- Added by PJShah on 02052022
   ,TGT.LATEST_AUTH_END_DATE= STAGE.LATEST_AUTH_END_DATE	 -- Added by PJShah on 02052022
...
INSERT ( 
   ...
   ,SOURCE_SYSTEM_ID
   ,REAUTHORIZED_DATE
   ,PRE_AUTH_NUMBER				-- Added by PJShah on 02052022
   ,BEGIN_SERVICE_DATE      	-- Added by PJShah on 02052022                 
   ,END_SERVICE_DATE			-- Added by PJShah on 02052022
   ,LATEST_AUTH_BEGIN_DATE		-- Added by PJShah on 02052022            
   ,LATEST_AUTH_END_DATE		-- Added by PJShah on 02052022
   ,BRANCH_NAME
   ,CLIENT_NUMBER
   ,CONTRACT_CODE
   ,BILL_RATE
