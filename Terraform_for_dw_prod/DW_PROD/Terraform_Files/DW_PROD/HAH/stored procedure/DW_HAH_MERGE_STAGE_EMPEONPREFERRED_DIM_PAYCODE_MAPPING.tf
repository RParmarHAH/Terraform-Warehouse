resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_EMPEONPREFERRED_DIM_PAYCODE_MAPPING" {
	name ="MERGE_STAGE_EMPEONPREFERRED_DIM_PAYCODE_MAPPING"
...
USING STAGE.EMPEONPREFERRED_DIM_PAYCODE_MAPPING STAGE 
