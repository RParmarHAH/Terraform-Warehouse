resource "snowflake_procedure" "DW_HAH_GET_STAGE_CLEARCARE_DIM_SERVICES_1_0" {
	name ="GET_STAGE_CLEARCARE_DIM_SERVICES_1_0"
...
FROM DISC_${var.SF_ENVIRONMENT}.CLEARCARE.PROFILE_PARENTPAYERSERVICE PP
