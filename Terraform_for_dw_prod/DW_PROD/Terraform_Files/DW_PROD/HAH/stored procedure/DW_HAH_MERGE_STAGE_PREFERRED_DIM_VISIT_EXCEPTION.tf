resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_PREFERRED_DIM_VISIT_EXCEPTION" {
	name ="MERGE_STAGE_PREFERRED_DIM_VISIT_EXCEPTION"
...
BEGIN
	MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.DIM_VISIT_EXCEPTION TGT USING DW_${var.SF_ENVIRONMENT}.STAGE.PREFERRED_DIM_VISIT_EXCEPTION STAGE 
