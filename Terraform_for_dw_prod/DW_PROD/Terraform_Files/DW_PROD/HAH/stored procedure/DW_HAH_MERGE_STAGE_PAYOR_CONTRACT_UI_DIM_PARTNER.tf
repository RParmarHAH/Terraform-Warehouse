resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_PAYOR_CONTRACT_UI_DIM_PARTNER" {
	name ="MERGE_STAGE_PAYOR_CONTRACT_UI_DIM_PARTNER"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.PAYOR_CONTRACT_UI_DIM_PARTNER AS src
