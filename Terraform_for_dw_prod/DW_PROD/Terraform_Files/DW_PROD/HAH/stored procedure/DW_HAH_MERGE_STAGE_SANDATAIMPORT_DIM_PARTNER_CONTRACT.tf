resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_SANDATAIMPORT_DIM_PARTNER_CONTRACT" {
	name ="MERGE_STAGE_SANDATAIMPORT_DIM_PARTNER_CONTRACT"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.SANDATAIMPORT_DIM_PARTNER_CONTRACT AS SRC
