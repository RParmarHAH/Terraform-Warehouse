resource "snowflake_procedure" "DW_HAH_GET_STAGE_SANDATAIMPORT_FACT_CLIENT_SERVICE" {
	name ="GET_STAGE_SANDATAIMPORT_FACT_CLIENT_SERVICE"
...
FROM DISC_${var.SF_ENVIRONMENT}.SANDATAIMPORT.SANDATA_AUTHORIZATIONS AUTH
