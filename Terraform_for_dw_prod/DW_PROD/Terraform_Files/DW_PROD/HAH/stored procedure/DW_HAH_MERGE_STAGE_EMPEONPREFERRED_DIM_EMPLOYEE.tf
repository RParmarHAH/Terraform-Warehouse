resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_EMPEONPREFERRED_DIM_EMPLOYEE" {
	name ="MERGE_STAGE_EMPEONPREFERRED_DIM_EMPLOYEE"
...
USING STAGE.EMPEONPREFERRED_DIM_EMPLOYEE STAGE 
...
UPDATE SET 
   ...
   ,TGT.ACQUIRED_SYSTEM = STAGE.ACQUIRED_SYSTEM
