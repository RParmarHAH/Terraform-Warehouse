resource "snowflake_procedure" "DW_HAH_GET_STAGE_ASR_DIM_BRANCH" {
	name ="GET_STAGE_ASR_DIM_BRANCH"
...
FROM DISC_${var.SF_ENVIRONMENT}.ASR.ASR_LOCATIONS L
...
--UNION 
--SELECT * FROM DW_${var.SF_ENVIRONMENT}.HAH.DIM_ORPHAN_BRANCH  ---- ADDED ORPHAN BRANCHES FOR IDDOX - 506
