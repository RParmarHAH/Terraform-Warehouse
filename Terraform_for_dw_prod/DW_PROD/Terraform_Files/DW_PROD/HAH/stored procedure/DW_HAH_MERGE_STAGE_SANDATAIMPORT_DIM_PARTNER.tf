resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_SANDATAIMPORT_DIM_PARTNER" {
	name ="MERGE_STAGE_SANDATAIMPORT_DIM_PARTNER"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.SANDATAIMPORT_DIM_PARTNER AS src
