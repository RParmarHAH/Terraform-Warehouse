resource "snowflake_procedure" "DW_HAH_GET_STAGE_NAVISION_FACT_PAYROLL" {
	name ="GET_STAGE_NAVISION_FACT_PAYROLL"
...
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.NAVISION.EMPLOYEE_RATES AS ERATES 
