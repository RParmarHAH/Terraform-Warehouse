resource "snowflake_procedure" "DW_HAH_GET_STAGE_OPENSYSTEMS_DIM_VISIT_STATUS_MAPPING" {
	name ="GET_STAGE_OPENSYSTEMS_DIM_VISIT_STATUS_MAPPING"
...
--***************************************************************************************************************************
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.STAGE.OPENSYSTEMS_DIM_VISIT_STATUS_MAPPING
WITH RESCHEDULE AS 
(
	WITH CTE AS
	(
