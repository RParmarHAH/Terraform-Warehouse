resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OSHAH_DIM_INVOICE" {
	name ="MERGE_STAGE_OSHAH_DIM_INVOICE"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.OSHAH_DIM_INVOICE STAGE 
