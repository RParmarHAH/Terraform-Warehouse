resource "snowflake_procedure" "DW_HAH_GET_STAGE_CLEARCARE_FACT_PARTNER_CONTRACT_SERVICE" {
	name ="GET_STAGE_CLEARCARE_FACT_PARTNER_CONTRACT_SERVICE"
...
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.STAGE.CLEARCARE_FACT_PARTNER_CONTRACT_SERVICE
