resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_GPSYNCDATA_FACT_BRANCH_PAYROLL_PERIODS" {
	name ="MERGE_STAGE_GPSYNCDATA_FACT_BRANCH_PAYROLL_PERIODS"
...
USING STAGE.GPSYNCDATA_FACT_BRANCH_PAYROLL_PERIODS STAGE 
