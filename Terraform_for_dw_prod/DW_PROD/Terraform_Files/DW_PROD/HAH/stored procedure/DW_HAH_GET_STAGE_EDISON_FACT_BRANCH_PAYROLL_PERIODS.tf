resource "snowflake_procedure" "DW_HAH_GET_STAGE_EDISON_FACT_BRANCH_PAYROLL_PERIODS" {
	name ="GET_STAGE_EDISON_FACT_BRANCH_PAYROLL_PERIODS"
	...
	statement = <<-EOT
                ...
                BEGIN
    --*****************************************************************************************************************************
-- NAME:  EDISON_FACT BRANCH PAYROLL PERIOD
--
...
--*****************************************************************************************************************************
INSERT OVERWRITE INTO STAGE.EDISON_FACT_BRANCH_PAYROLL_PERIODS
...
JOIN DW_${var.SF_ENVIRONMENT}."STAGE".EDISON_DIM_BRANCH BR ON 1=1
;
    RETURN ''SUCCESS'';
    END;
