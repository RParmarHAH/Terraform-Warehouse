resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_EDISON_DIM_BILLING" {
	name ="MERGE_STAGE_EDISON_DIM_BILLING"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.EDISON_DIM_BILLING AS src
