resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_COASTALGP_FACT_PAYROLL_DETAILS" {
	name ="MERGE_STAGE_COASTALGP_FACT_PAYROLL_DETAILS"
...
USING STAGE.COASTALGP_FACT_PAYROLL_DETAILS STAGE 
