resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OSHAH_FACT_BRANCH_PAYROLL_PERIODS" {
	name ="MERGE_STAGE_OSHAH_FACT_BRANCH_PAYROLL_PERIODS"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.OSHAH_FACT_BRANCH_PAYROLL_PERIODS AS src
