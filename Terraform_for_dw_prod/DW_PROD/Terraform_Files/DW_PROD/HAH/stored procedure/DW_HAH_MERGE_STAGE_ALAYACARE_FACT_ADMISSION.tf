resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ALAYACARE_FACT_ADMISSION" {
	name ="MERGE_STAGE_ALAYACARE_FACT_ADMISSION"
...
DECLARE
  ...
  BEGIN
    MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.FACT_ADMISSION TGT
USING DW_${var.SF_ENVIRONMENT}.STAGE.ALAYACARE_FACT_ADMISSION STAGE
