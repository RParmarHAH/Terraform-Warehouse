resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_SANDATAIMPORT_DIM_CLIENT" {
	name ="MERGE_STAGE_SANDATAIMPORT_DIM_CLIENT"
...
USING STAGE.SANDATAIMPORT_DIM_CLIENT STAGE 
