resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_GPSYNCDATA_DIM_EMPLOYEE" {
	name ="MERGE_STAGE_GPSYNCDATA_DIM_EMPLOYEE"
...
USING STAGE.GPSYNCDATA_DIM_EMPLOYEE STAGE 
