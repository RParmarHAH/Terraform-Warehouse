resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_DATAFLEXSYNCDATA_DIM_CONTRACT" {
	name ="MERGE_STAGE_DATAFLEXSYNCDATA_DIM_CONTRACT"
...
USING STAGE.DATAFLEXSYNCDATA_DIM_CONTRACT STAGE 
