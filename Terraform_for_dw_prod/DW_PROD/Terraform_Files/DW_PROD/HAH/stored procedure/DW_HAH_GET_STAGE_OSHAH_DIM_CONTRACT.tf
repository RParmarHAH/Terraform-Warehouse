resource "snowflake_procedure" "DW_HAH_GET_STAGE_OSHAH_DIM_CONTRACT" {
	name ="GET_STAGE_OSHAH_DIM_CONTRACT"
...
FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.SERVICECODES SC
	...
	LEFT JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.CONTRACTS C  
 	...
 	LEFT JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.VW_OSHAH_REVENUE RP
