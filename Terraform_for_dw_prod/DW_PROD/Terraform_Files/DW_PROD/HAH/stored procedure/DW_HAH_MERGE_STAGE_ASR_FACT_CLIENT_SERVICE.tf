resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ASR_FACT_CLIENT_SERVICE" {
	name ="MERGE_STAGE_ASR_FACT_CLIENT_SERVICE"
...
DECLARE
  ...
  BEGIN
	MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.FACT_CLIENT_SERVICE TGT
	USING DW_${var.SF_ENVIRONMENT}.STAGE.ASR_FACT_CLIENT_SERVICE STAGE
