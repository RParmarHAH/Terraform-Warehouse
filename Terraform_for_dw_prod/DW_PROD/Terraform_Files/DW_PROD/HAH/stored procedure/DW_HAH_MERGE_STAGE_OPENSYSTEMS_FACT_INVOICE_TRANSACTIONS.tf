resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OPENSYSTEMS_FACT_INVOICE_TRANSACTIONS" {
	name ="MERGE_STAGE_OPENSYSTEMS_FACT_INVOICE_TRANSACTIONS"
...
USING STAGE.OPENSYSTEMS_FACT_INVOICE_TRANSACTIONS STAGE
ON 
