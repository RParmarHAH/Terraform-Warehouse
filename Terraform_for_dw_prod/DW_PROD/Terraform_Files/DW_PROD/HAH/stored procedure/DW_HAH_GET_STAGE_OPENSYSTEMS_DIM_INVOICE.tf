resource "snowflake_procedure" "DW_HAH_GET_STAGE_OPENSYSTEMS_DIM_INVOICE" {
	name ="GET_STAGE_OPENSYSTEMS_DIM_INVOICE"
...
--***************************************************************************************************************************
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.STAGE.OPENSYSTEMS_DIM_INVOICE
WITH CLIENT AS
(
	SELECT * FROM
	(
...
FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.TBLINVOICEHEADER_REPL INV_HED
...
INNER JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.INVOICEDETAILS INV_DET ON INV_DET.INVOICEHEADERID = INV_HED.INVOICEHEADERID
...
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.STAGE_PAYER_REPL P ON INV_DET.PAYERID = P.PAYERID
