resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_EDISON_DIM_PARTNER" {
	name ="MERGE_STAGE_EDISON_DIM_PARTNER"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.EDISON_DIM_PARTNER AS src
