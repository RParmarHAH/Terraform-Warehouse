resource "snowflake_procedure" "DW_HAH_GET_STAGE_PARADOX_FACT_APPLICANT_WITH_PDR_STATUS" {
	name ="GET_STAGE_PARADOX_FACT_APPLICANT_WITH_PDR_STATUS"
...
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.STAGE.PARADOX_FACT_APPLICANT_WITH_PDR_STATUS
WITH CANDIDATES_WITH_PDR_STATUS AS (
    ...
    FROM DISC_${var.SF_ENVIRONMENT}.PARADOX.CANDIDATE_JOURNEY_STATUS_HISTORY
    WHERE 
...
, F AS (
    ...
    FROM DW_${var.SF_ENVIRONMENT}.HAH.FACT_APPLICANT_STATUS S
        ...
        LEFT JOIN DW_${var.SF_ENVIRONMENT}.HAH.DIM_STATE DSJ
            ON UPPER(J.STATE) = UPPER(DSJ.STATE_NAME)
        LEFT JOIN DW_${var.SF_ENVIRONMENT}.HAH.DIM_STATE DSA
