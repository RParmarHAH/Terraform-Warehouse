resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_PAYOR_CONTRACT_UI_DIM_PARTNER_CONTRACT" {
	name ="MERGE_STAGE_PAYOR_CONTRACT_UI_DIM_PARTNER_CONTRACT"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.PAYOR_CONTRACT_UI_DIM_PARTNER_CONTRACT AS src
