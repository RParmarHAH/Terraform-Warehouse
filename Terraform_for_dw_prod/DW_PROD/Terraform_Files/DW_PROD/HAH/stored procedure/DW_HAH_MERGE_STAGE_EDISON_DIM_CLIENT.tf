resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_EDISON_DIM_CLIENT" {
	name ="MERGE_STAGE_EDISON_DIM_CLIENT"
...
USING STAGE.EDISON_DIM_CLIENT STG 
...
,TGT.CLIENT_STATUS= STG.CLIENT_STATUS
...
,TGT.REFERRER_KEY=STG.REFERRER_KEY
