resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_DATAFLEXSYNCDATA_DIM_EMPLOYEE" {
	name ="MERGE_STAGE_DATAFLEXSYNCDATA_DIM_EMPLOYEE"
...
USING STAGE.DATAFLEXSYNCDATA_DIM_EMPLOYEE STAGE 
