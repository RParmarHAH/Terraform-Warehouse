resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_PREFERRED_DIM_INVOICE_STATUS_MAPPING" {
	name ="MERGE_STAGE_PREFERRED_DIM_INVOICE_STATUS_MAPPING"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.PREFERRED_DIM_INVOICE_STATUS_MAPPING STAGE 
