resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ADPANSWERCARE_FACT_PAYROLL" {
	name ="MERGE_STAGE_ADPANSWERCARE_FACT_PAYROLL"
...
USING STAGE.ADPANSWERCARE_FACT_PAYROLL STAGE 
