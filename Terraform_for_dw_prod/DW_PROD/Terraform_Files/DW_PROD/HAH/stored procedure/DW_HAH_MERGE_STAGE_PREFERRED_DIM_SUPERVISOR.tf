resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_PREFERRED_DIM_SUPERVISOR" {
	name ="MERGE_STAGE_PREFERRED_DIM_SUPERVISOR"
...
BEGIN
	...
	USING STAGE.PREFERRED_DIM_SUPERVISOR STAGE 
