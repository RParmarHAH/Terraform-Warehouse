resource "snowflake_procedure" "DW_HAH_GET_STAGE_ADPANSWERCARE_DIM_PAYCODE_MAPPING" {
	name ="GET_STAGE_ADPANSWERCARE_DIM_PAYCODE_MAPPING"
...
(
	...
	FROM DISC_${var.SF_ENVIRONMENT}.ADP.ANSWERCARE_PAYROLL_DETAIL
...
FROM DISC_${var.SF_ENVIRONMENT}.ADP.ANSWERCARE_PAYROLL_DETAIL APD
