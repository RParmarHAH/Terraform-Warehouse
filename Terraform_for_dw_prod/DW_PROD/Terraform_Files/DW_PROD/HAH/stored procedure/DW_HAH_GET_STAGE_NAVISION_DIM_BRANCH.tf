resource "snowflake_procedure" "DW_HAH_GET_STAGE_NAVISION_DIM_BRANCH" {
	name ="GET_STAGE_NAVISION_DIM_BRANCH"
...
--*****************************************************************************************************************************
	...
	(
		...
		ELSE NULL
		END AS MANAGER
		FROM DISC_${var.SF_ENVIRONMENT}.NAVISION.BRANCH_MAPPING B
	)
	SELECT DISTINCT 
