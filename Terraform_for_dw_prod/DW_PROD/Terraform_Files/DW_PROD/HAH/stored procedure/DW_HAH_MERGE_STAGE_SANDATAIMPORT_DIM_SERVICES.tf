resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_SANDATAIMPORT_DIM_SERVICES" {
	name ="MERGE_STAGE_SANDATAIMPORT_DIM_SERVICES"
...
USING STAGE.SANDATAIMPORT_DIM_SERVICES STAGE 
