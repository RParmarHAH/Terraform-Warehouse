resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_PAYOR_CONTRACT_UI_FACT_PARTNER_CONTRACT_SERVICE" {
	name ="MERGE_STAGE_PAYOR_CONTRACT_UI_FACT_PARTNER_CONTRACT_SERVICE"
...
BEGIN
MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.FACT_PARTNER_CONTRACT_SERVICE AS tgt
USING DW_${var.SF_ENVIRONMENT}.STAGE.PAYOR_CONTRACT_UI_FACT_PARTNER_CONTRACT_SERVICE AS src
