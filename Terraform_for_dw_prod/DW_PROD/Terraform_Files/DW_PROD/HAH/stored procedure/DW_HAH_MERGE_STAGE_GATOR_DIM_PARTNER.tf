resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_GATOR_DIM_PARTNER" {
	name ="MERGE_STAGE_GATOR_DIM_PARTNER"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.GATOR_DIM_PARTNER AS src
