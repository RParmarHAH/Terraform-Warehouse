resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_DATAFLEXSYNCDATA_DIM_BRANCH" {
	name ="MERGE_STAGE_DATAFLEXSYNCDATA_DIM_BRANCH"
...
USING STAGE.DATAFLEXSYNCDATA_DIM_BRANCH STAGE 
