resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ADPALLIANCE_DIM_PAYCODE_MAPPING" {
	name ="MERGE_STAGE_ADPALLIANCE_DIM_PAYCODE_MAPPING"
...
USING STAGE.ADPALLIANCE_DIM_PAYCODE_MAPPING STAGE 
