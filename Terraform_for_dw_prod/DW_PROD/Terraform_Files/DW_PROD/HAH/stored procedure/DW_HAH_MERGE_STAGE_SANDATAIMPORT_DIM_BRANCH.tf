resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_SANDATAIMPORT_DIM_BRANCH" {
	name ="MERGE_STAGE_SANDATAIMPORT_DIM_BRANCH"
...
USING STAGE.SANDATAIMPORT_DIM_BRANCH STAGE 
