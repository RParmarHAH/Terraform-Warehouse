resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_PREFERRED_DIM_EMPLOYEE" {
	name ="MERGE_STAGE_PREFERRED_DIM_EMPLOYEE"
...
BEGIN
    MERGE INTO HAH.DIM_EMPLOYEE TGT USING STAGE.PREFERRED_DIM_EMPLOYEE STAGE 
