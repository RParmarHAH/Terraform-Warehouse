resource "snowflake_procedure" "DW_HAH_GET_STAGE_OSHAH_DIM_REFERRER" {
	name ="GET_STAGE_OSHAH_DIM_REFERRER"
...
FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.REFERRALSOURCE r;
;
