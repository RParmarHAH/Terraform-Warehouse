resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_EMPEONPREFERRED_FACT_PAYROLL" {
	name ="MERGE_STAGE_EMPEONPREFERRED_FACT_PAYROLL"
...
USING STAGE.EMPEONPREFERRED_FACT_PAYROLL STAGE 
