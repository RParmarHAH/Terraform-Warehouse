resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ASR_DIM_EMPLOYEE" {
	name ="MERGE_STAGE_ASR_DIM_EMPLOYEE"
...
BEGIN
    MERGE INTO HAH.DIM_EMPLOYEE TGT USING STAGE.ASR_DIM_EMPLOYEE STAGE 
...
UPDATE SET 
 ...
 --  ,TGT.COVIDVACCINESTEP1= STAGE.COVIDVACCINESTEP1
--   ,TGT.COVIDVACCINESTEP2= STAGE.COVIDVACCINESTEP2
--   ,TGT.COVIDBOOSTERDOSE= STAGE.COVIDBOOSTERDOSE
...
--   ,STAGE.COVIDVACCINESTEP1
--   ,STAGE.COVIDVACCINESTEP2
--   ,STAGE.COVIDBOOSTERDOSE
   ,STAGE.LINKED_ID
