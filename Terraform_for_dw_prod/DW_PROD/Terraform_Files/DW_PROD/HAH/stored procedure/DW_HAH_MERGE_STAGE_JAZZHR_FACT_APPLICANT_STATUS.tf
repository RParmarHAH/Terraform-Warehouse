resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_JAZZHR_FACT_APPLICANT_STATUS" {
	name ="MERGE_STAGE_JAZZHR_FACT_APPLICANT_STATUS"
...
USING STAGE.JAZZHR_FACT_APPLICANT_STATUS STAGE 
