resource "snowflake_procedure" "DW_HAH_GET_STAGE_ALAYACARE_FACT_VISIT_CSF" {
	name ="GET_STAGE_ALAYACARE_FACT_VISIT_CSF"
...
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.ALAYACARE.WORK_SESSION_TIER_4 WORK_SESSION ON 
