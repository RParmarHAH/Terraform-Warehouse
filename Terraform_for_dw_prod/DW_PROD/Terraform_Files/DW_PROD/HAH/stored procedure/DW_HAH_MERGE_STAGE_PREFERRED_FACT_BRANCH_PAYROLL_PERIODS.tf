resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_PREFERRED_FACT_BRANCH_PAYROLL_PERIODS" {
	name ="MERGE_STAGE_PREFERRED_FACT_BRANCH_PAYROLL_PERIODS"
...
BEGIN
    MERGE INTO HAH.FACT_BRANCH_PAYROLL_PERIODS TGT USING STAGE.PREFERRED_FACT_BRANCH_PAYROLL_PERIODS STAGE 
