resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_DATAFLEXSYNCDATA_FACT_INVOICE_TRANSACTIONS" {
	name ="MERGE_STAGE_DATAFLEXSYNCDATA_FACT_INVOICE_TRANSACTIONS"
...
USING STAGE.DATAFLEXSYNCDATA_FACT_INVOICE_TRANSACTIONS STAGE
ON 
