resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_EMPEONEDISON_FACT_PAYROLL" {
	name ="MERGE_STAGE_EMPEONEDISON_FACT_PAYROLL"
...
USING STAGE.EMPEONEDISON_FACT_PAYROLL STAGE 
