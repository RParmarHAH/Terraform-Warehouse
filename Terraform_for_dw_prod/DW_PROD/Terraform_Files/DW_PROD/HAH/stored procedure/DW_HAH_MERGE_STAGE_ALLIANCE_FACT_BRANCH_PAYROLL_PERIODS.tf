resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ALLIANCE_FACT_BRANCH_PAYROLL_PERIODS" {
	name ="MERGE_STAGE_ALLIANCE_FACT_BRANCH_PAYROLL_PERIODS"
...
BEGIN
	...
	USING STAGE.ALLIANCE_FACT_BRANCH_PAYROLL_PERIODS STAGE 
