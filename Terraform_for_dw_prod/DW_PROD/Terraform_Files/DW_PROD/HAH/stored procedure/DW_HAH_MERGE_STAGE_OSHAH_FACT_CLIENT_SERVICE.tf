resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OSHAH_FACT_CLIENT_SERVICE" {
	name ="MERGE_STAGE_OSHAH_FACT_CLIENT_SERVICE"
...
USING STAGE.OSHAH_FACT_CLIENT_SERVICE AS src
