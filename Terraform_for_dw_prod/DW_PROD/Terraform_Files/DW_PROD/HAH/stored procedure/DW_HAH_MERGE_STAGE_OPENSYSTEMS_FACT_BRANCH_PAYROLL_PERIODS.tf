resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OPENSYSTEMS_FACT_BRANCH_PAYROLL_PERIODS" {
	name ="MERGE_STAGE_OPENSYSTEMS_FACT_BRANCH_PAYROLL_PERIODS"
...
BEGIN
MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.FACT_BRANCH_PAYROLL_PERIODS AS tgt
USING DW_${var.SF_ENVIRONMENT}.STAGE.OPENSYSTEMS_FACT_BRANCH_PAYROLL_PERIODS AS src
