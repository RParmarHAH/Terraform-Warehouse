resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_MATRIXCARE_DIM_SERVICES_1_0" {
	name ="MERGE_STAGE_MATRIXCARE_DIM_SERVICES_1_0"
...
BEGIN
MERGE INTO HAH.DIM_SERVICES_1_0 TGT USING STAGE.MATRIXCARE_DIM_SERVICES_1_0 STAGE
