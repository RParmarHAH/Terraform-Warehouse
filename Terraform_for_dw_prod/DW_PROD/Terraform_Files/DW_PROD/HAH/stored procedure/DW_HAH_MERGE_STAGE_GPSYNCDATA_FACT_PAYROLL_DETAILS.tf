resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_GPSYNCDATA_FACT_PAYROLL_DETAILS" {
	name ="MERGE_STAGE_GPSYNCDATA_FACT_PAYROLL_DETAILS"
...
USING STAGE.GPSYNCDATA_FACT_PAYROLL_DETAILS STAGE 
