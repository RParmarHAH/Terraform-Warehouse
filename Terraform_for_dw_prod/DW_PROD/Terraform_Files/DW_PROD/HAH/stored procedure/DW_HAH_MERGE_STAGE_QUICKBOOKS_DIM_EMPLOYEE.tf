resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_QUICKBOOKS_DIM_EMPLOYEE" {
	name ="MERGE_STAGE_QUICKBOOKS_DIM_EMPLOYEE"
...
USING STAGE.QUICKBOOKS_DIM_EMPLOYEE STAGE 
