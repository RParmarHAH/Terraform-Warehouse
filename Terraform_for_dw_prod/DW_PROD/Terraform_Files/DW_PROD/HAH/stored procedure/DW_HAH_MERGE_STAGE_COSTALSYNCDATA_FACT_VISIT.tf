resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_COSTALSYNCDATA_FACT_VISIT" {
	name ="MERGE_STAGE_COSTALSYNCDATA_FACT_VISIT"
...
USING STAGE.COSTALSYNCDATA_FACT_VISIT STAGE 
