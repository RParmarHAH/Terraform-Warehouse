resource "snowflake_procedure" "DW_HAH_GET_STAGE_COSTALSYNCDATA_DIM_INVOICE_VISIT_LINKAGE" {
	name ="GET_STAGE_COSTALSYNCDATA_DIM_INVOICE_VISIT_LINKAGE"
...
SELECT  
	...
	LEFT JOIN DISC_${var.SF_ENVIRONMENT}.COSTALSYNCDATA.CV_CHARGES AS CHARGES
