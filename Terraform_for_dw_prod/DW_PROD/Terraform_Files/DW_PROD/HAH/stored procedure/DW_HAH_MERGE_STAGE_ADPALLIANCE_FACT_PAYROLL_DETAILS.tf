resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ADPALLIANCE_FACT_PAYROLL_DETAILS" {
	name ="MERGE_STAGE_ADPALLIANCE_FACT_PAYROLL_DETAILS"
...
USING STAGE.ADPALLIANCE_FACT_PAYROLL_DETAILS STAGE 
