resource "snowflake_procedure" "DW_HAH_GET_STAGE_SANDATAIMPORT_FACT_INTAKE" {
	name ="GET_STAGE_SANDATAIMPORT_FACT_INTAKE"
...
--*****************************************************************************************************************************
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.STAGE.SANDATAIMPORT_FACT_INTAKE
WITH 
CLIENT AS
(
	SELECT * FROM
