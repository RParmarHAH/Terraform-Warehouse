resource "snowflake_procedure" "DW_HAH_GET_STAGE_SANDATAIMPORT_FACT_EVV_VISIT_BCP" {
	name ="GET_STAGE_SANDATAIMPORT_FACT_EVV_VISIT_BCP"
...
var sql=`MERGE INTO DW_${var.SF_ENVIRONMENT}.STAGE.SANDATAIMPORT_FACT_EVV_VISIT_BCP AS TARGET USING (
WITH clu as (
    select
