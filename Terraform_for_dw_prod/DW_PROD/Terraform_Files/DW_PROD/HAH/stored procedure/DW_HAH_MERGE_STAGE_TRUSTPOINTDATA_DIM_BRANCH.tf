resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_TRUSTPOINTDATA_DIM_BRANCH" {
	name ="MERGE_STAGE_TRUSTPOINTDATA_DIM_BRANCH"
...
BEGIN
    MERGE INTO HAH.DIM_BRANCH TGT USING STAGE.TRUSTPOINTDATA_DIM_BRANCH STAGE 
