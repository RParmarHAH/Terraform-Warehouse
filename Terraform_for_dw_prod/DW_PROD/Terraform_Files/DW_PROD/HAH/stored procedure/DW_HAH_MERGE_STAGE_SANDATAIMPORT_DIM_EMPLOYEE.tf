resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_SANDATAIMPORT_DIM_EMPLOYEE" {
	name ="MERGE_STAGE_SANDATAIMPORT_DIM_EMPLOYEE"
...
USING STAGE.SANDATAIMPORT_DIM_EMPLOYEE STAGE 
