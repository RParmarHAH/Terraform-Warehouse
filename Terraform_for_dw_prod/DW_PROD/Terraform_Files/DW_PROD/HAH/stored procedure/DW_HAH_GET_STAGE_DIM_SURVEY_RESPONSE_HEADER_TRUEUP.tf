resource "snowflake_procedure" "DW_HAH_GET_STAGE_DIM_SURVEY_RESPONSE_HEADER_TRUEUP" {
	name ="GET_STAGE_DIM_SURVEY_RESPONSE_HEADER_TRUEUP"
...
||''FROM (SELECT * FROM DISC_${var.SF_ENVIRONMENT}.QUALTRICS_SURVEYS.QUALTRICS_SURVEY_RESPONSE_TRUEUP, table(flatten(SURVEY_JSON))) f\\n''
