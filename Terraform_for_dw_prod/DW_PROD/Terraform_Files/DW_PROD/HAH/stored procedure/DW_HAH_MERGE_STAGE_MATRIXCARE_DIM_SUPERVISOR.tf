resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_MATRIXCARE_DIM_SUPERVISOR" {
	name ="MERGE_STAGE_MATRIXCARE_DIM_SUPERVISOR"
...
BEGIN
    MERGE INTO HAH.DIM_SUPERVISOR TGT USING STAGE.MATRIXCARE_DIM_SUPERVISOR STAGE 
