resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OSHAH_DIM_EMPLOYEE" {
	name ="MERGE_STAGE_OSHAH_DIM_EMPLOYEE"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.OSHAH_DIM_EMPLOYEE STAGE 
