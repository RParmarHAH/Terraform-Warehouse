resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_COSTALSYNCDATA_FACT_CLIENT_SERVICE" {
	name ="MERGE_STAGE_COSTALSYNCDATA_FACT_CLIENT_SERVICE"
...
MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.FACT_CLIENT_SERVICE AS tgt
	USING STAGE.COSTALSYNCDATA_FACT_CLIENT_SERVICE STAGE
