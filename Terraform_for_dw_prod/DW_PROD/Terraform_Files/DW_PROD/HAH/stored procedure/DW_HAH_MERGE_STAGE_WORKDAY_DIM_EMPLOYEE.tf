resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_WORKDAY_DIM_EMPLOYEE" {
	name ="MERGE_STAGE_WORKDAY_DIM_EMPLOYEE"
...
USING STAGE.WORKDAY_DIM_EMPLOYEE STAGE 
...
UPDATE SET 
   ...
   ,TGT.ETL_INFERRED_MEMBER_FLAG= STAGE.ETL_INFERRED_MEMBER_FLAG
	,TGT.DERIVED_FIRST_SERVICE_DATE = STAGE.DERIVED_FIRST_SERVICE_DATE
	,TGT.DERIVED_LAST_SERVICE_DATE = STAGE.DERIVED_LAST_SERVICE_DATE
	,TGT.DERIVED_PAYROLL_FIRST_CHECK_DATE = STAGE.DERIVED_PAYROLL_FIRST_CHECK_DATE
	,TGT.DERIVED_PAYROLL_LAST_CHECK_DATE = STAGE.DERIVED_PAYROLL_LAST_CHECK_DATE
	,TGT.AMS_SOURCE_SYSTEM = STAGE.AMS_SOURCE_SYSTEM
	,TGT.PAYROLL_SOURCE_SYSTEM = STAGE.PAYROLL_SOURCE_SYSTEM
	,TGT.LOCATION_HIERARCHY = STAGE.LOCATION_HIERARCHY
...
VALUES (
   ...
   ,STAGE.DERIVED_FIRST_SERVICE_DATE
   ,STAGE.DERIVED_LAST_SERVICE_DATE
   ,STAGE.DERIVED_PAYROLL_FIRST_CHECK_DATE
   ,STAGE.DERIVED_PAYROLL_LAST_CHECK_DATE
   ,STAGE.AMS_SOURCE_SYSTEM
   ,STAGE.PAYROLL_SOURCE_SYSTEM
   ,STAGE.LOCATION_HIERARCHY
   ,STAGE.APPLICANT_ID
   ,STAGE.STATUS
);
