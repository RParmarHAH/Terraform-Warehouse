resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_EDISON_FACT_PARTNER_CONTRACT_SERVICE" {
	name ="MERGE_STAGE_EDISON_FACT_PARTNER_CONTRACT_SERVICE"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.EDISON_FACT_PARTNER_CONTRACT_SERVICE AS src
