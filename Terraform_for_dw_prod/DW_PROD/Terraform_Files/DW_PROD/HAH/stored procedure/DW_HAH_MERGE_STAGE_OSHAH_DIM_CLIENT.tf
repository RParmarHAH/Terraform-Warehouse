resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OSHAH_DIM_CLIENT" {
	name ="MERGE_STAGE_OSHAH_DIM_CLIENT"
...
BEGIN
    MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.DIM_CLIENT TGT 
USING DW_${var.SF_ENVIRONMENT}.STAGE.OSHAH_DIM_CLIENT STAGE 
