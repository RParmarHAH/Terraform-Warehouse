resource "snowflake_procedure" "DW_HAH_GET_STAGE_MOLINA_GAPS_IN_CARE" {
	name ="GET_STAGE_MOLINA_GAPS_IN_CARE"
...
--*****************************************************************************************************************************
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.STAGE.MOLINA_FACT_GAPS_IN_CARE
...
FROM DISC_${var.SF_ENVIRONMENT}.MOLINA.MOLINA_GAPS_IN_CARE GP
INNER JOIN DW_${var.SF_ENVIRONMENT}.HAH.DIM_PARTNER_CONTRACT CT ON GP.PARTNER = CT.PARTNER_CODE;
RETURN ''SUCCESS'';
END
 EOT
}
