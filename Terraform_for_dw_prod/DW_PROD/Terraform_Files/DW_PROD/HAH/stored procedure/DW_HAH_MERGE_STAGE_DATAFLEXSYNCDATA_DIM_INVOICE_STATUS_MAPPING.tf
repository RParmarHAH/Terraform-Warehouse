resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_DATAFLEXSYNCDATA_DIM_INVOICE_STATUS_MAPPING" {
	name ="MERGE_STAGE_DATAFLEXSYNCDATA_DIM_INVOICE_STATUS_MAPPING"
...
BEGIN 
    MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.DIM_INVOICE_STATUS_MAPPING TGT 
USING DW_${var.SF_ENVIRONMENT}.STAGE.DATAFLEXSYNCDATA_DIM_INVOICE_STATUS_MAPPING STAGE 
