resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_MATRIXCARE_DIM_BILLING" {
	name ="MERGE_STAGE_MATRIXCARE_DIM_BILLING"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.MATRIXCARE_DIM_BILLING AS src
