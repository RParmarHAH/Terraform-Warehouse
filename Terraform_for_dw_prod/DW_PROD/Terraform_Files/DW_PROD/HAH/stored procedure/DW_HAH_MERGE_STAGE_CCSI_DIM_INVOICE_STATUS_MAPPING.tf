resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_CCSI_DIM_INVOICE_STATUS_MAPPING" {
	name ="MERGE_STAGE_CCSI_DIM_INVOICE_STATUS_MAPPING"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.CCSI_DIM_INVOICE_STATUS_MAPPING STAGE 
