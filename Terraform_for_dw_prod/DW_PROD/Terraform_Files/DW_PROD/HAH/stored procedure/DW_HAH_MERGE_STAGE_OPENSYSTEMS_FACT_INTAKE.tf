resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OPENSYSTEMS_FACT_INTAKE" {
	name ="MERGE_STAGE_OPENSYSTEMS_FACT_INTAKE"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.OPENSYSTEMS_FACT_INTAKE AS src
