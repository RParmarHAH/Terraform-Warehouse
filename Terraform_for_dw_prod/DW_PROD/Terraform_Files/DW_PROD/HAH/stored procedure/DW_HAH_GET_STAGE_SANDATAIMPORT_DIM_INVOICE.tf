resource "snowflake_procedure" "DW_HAH_GET_STAGE_SANDATAIMPORT_DIM_INVOICE" {
	name ="GET_STAGE_SANDATAIMPORT_DIM_INVOICE"
...
--*****************************************************************************************************************************
--
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.STAGE.SandataImport_DIM_INVOICE
--SELECT 
--		 INVOICE_KEY
--		,CLIENT_KEY
--		,INVOICE_NUMBER
...
FROM DISC_${var.SF_ENVIRONMENT}.SANDATAIMPORT.SANDATA_INVOICEHEADER inv
--LEFT JOIN DISC_${var.SF_ENVIRONMENT}.SANDATAIMPORT.SANDATA_INVOICEDETAILS D ON D.AGENCYID = inv.AGENCYID AND D.INVOICENUMBER = inv.INVOICENUMBER 
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.SANDATAIMPORT.SANDATA_INVOICEDETAILS_20231102_FULL D ON D.AGENCYID = inv.AGENCYID AND D.INVOICENUMBER = inv.INVOICENUMBER 
