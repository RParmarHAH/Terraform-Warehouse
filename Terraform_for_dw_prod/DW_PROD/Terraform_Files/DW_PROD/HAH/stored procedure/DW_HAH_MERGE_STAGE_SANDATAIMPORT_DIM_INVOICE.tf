resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_SANDATAIMPORT_DIM_INVOICE" {
	name ="MERGE_STAGE_SANDATAIMPORT_DIM_INVOICE"
...
USING STAGE.SANDATAIMPORT_DIM_INVOICE STAGE 
