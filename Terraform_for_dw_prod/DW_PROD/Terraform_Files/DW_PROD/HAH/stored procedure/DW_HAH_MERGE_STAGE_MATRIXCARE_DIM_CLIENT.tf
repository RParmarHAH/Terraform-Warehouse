resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_MATRIXCARE_DIM_CLIENT" {
	name ="MERGE_STAGE_MATRIXCARE_DIM_CLIENT"
...
BEGIN 
    MERGE INTO HAH.DIM_CLIENT TGT USING STAGE.MATRIXCARE_DIM_CLIENT STAGE 
