resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OPENSYSTEMS_DIM_BILLING" {
	name ="MERGE_STAGE_OPENSYSTEMS_DIM_BILLING"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.OPENSYSTEMS_DIM_BILLING AS src
