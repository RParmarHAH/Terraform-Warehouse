resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_COSTALSYNCDATA_FACT_PAYROLL" {
	name ="MERGE_STAGE_COSTALSYNCDATA_FACT_PAYROLL"
...
USING STAGE.COSTALSYNCDATA_FACT_PAYROLL STAGE 
