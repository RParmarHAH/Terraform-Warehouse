resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OPENSYSTEMS_DIM_SUPERVISOR" {
	name ="MERGE_STAGE_OPENSYSTEMS_DIM_SUPERVISOR"
...
BEGIN 
MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.DIM_SUPERVISOR AS tgt
USING DW_${var.SF_ENVIRONMENT}."STAGE".OPENSYSTEMS_DIM_SUPERVISOR AS STAGE
