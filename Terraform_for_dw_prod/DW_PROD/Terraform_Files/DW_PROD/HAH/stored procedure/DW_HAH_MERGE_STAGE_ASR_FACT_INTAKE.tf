resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ASR_FACT_INTAKE" {
	name ="MERGE_STAGE_ASR_FACT_INTAKE"
...
BEGIN
    MERGE INTO HAH.FACT_INTAKE TGT USING STAGE.ASR_FACT_INTAKE STAGE 
