resource "snowflake_procedure" "DW_HAH_GET_STAGE_OSHAH_FACT_CLIENT_SERVICE_BKCP2610" {
	name ="GET_STAGE_OSHAH_FACT_CLIENT_SERVICE_BKCP2610"
...
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}."STAGE".OSHAH_FACT_CLIENT_SERVICE_BKCP2610
