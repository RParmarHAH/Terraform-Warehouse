resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_PREFERRED_DIM_CLIENT" {
	name ="MERGE_STAGE_PREFERRED_DIM_CLIENT"
...
BEGIN
    MERGE INTO HAH.DIM_CLIENT TGT USING STAGE.PREFERRED_DIM_CLIENT STAGE 
