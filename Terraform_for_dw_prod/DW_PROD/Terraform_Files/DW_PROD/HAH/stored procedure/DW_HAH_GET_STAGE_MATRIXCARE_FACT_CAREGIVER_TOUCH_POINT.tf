resource "snowflake_procedure" "DW_HAH_GET_STAGE_MATRIXCARE_FACT_CAREGIVER_TOUCH_POINT" {
	name ="GET_STAGE_MATRIXCARE_FACT_CAREGIVER_TOUCH_POINT"
...
--*****************************************************************************************************************************
--
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.STAGE.MATRIXCARE_FACT_CAREGIVER_TOUCH_POINT
...
7 AS SOURCE_SYSTEM_ID,
 ...
 :STR_ETL_TASK_KEY  AS ETL_TASK_KEY,
	...
	FROM DISC_${var.SF_ENVIRONMENT}.MATRIXCARE.STVHC_T_ACTIVITIES a
JOIN DISC_${var.SF_ENVIRONMENT}.MATRIXCARE.STVHC_T_ACTIVITYCATEGORIES b ON a.ACT_ACTIVITYCATEGORYID = b.ACTCAT_ID 
JOIN DISC_${var.SF_ENVIRONMENT}.MATRIXCARE.STVHC_T_ACTIVITYTYPES tt ON a.ACT_ACTIVITYTYPEID =tt.ACTTYPE_ID 
JOIN disc_${var.SF_ENVIRONMENT}.MATRIXCARE.STVHC_T_ACTIVITYENTITIES ae ON ae.ACTENT_ACTIVITIESID =a.ACT_ID 
JOIN EMPLOYEE car ON car.CAR_ID =ae.ACTENT_RECORDID 
JOIN DISC_${var.SF_ENVIRONMENT}.MATRIXCARE.STVHC_T_BRANCHES br ON br.BR_ID =a.ACT_BRANCHID 
JOIN DISC_${var.SF_ENVIRONMENT}.MATRIXCARE.STVHC_T_ENTITIES e ON e.ENT_ID =ae.ACTENT_RECORDTYPE 
JOIN DISC_DEDUPE_${var.SF_ENVIRONMENT}.MATRIXCARE.EMPLOYEE_MASTER_LIST CG ON CG.MASTER_ID = CAR.MASTER_ID
WHERE 
