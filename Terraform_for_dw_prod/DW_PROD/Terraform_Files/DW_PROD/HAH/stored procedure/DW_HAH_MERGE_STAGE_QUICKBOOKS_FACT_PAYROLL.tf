resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_QUICKBOOKS_FACT_PAYROLL" {
	name ="MERGE_STAGE_QUICKBOOKS_FACT_PAYROLL"
...
USING STAGE.QUICKBOOKS_FACT_PAYROLL STAGE 
