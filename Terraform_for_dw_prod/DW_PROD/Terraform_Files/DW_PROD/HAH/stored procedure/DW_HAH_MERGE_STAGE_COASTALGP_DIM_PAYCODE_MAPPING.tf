resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_COASTALGP_DIM_PAYCODE_MAPPING" {
	name ="MERGE_STAGE_COASTALGP_DIM_PAYCODE_MAPPING"
...
USING STAGE.COASTALGP_DIM_PAYCODE_MAPPING STAGE 
