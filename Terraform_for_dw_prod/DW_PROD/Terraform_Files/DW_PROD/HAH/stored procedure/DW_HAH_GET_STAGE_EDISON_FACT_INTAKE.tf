resource "snowflake_procedure" "DW_HAH_GET_STAGE_EDISON_FACT_INTAKE" {
	name ="GET_STAGE_EDISON_FACT_INTAKE"
...
INNER JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.PATIENTS P
	ON P.PATIENTID = CLIENT.CLIENT_NUMBER
INNER JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.OFFICE_OFFICES_REPL O 
