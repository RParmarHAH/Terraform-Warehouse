resource "snowflake_procedure" "DW_HAH_GET_STAGE_PREFERRED_FACT_INTAKE" {
	name ="GET_STAGE_PREFERRED_FACT_INTAKE"
...
INNER JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.STAGE_PATIENTS P
