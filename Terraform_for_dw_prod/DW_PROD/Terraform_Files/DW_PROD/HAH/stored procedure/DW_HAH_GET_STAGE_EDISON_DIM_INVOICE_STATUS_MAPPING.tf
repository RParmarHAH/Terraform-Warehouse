resource "snowflake_procedure" "DW_HAH_GET_STAGE_EDISON_DIM_INVOICE_STATUS_MAPPING" {
	name ="GET_STAGE_EDISON_DIM_INVOICE_STATUS_MAPPING"
...
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.STAGE.EDISON_DIM_INVOICE_STATUS_MAPPING
