resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_EDISON_DIM_INVOICE" {
	name ="MERGE_STAGE_EDISON_DIM_INVOICE"
...
BEGIN
    MERGE INTO HAH.DIM_INVOICE TGT 	USING STAGE.EDISON_DIM_INVOICE STG 
