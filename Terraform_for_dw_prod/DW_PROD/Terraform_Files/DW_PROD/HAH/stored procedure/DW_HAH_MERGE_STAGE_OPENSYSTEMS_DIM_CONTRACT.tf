resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OPENSYSTEMS_DIM_CONTRACT" {
	name ="MERGE_STAGE_OPENSYSTEMS_DIM_CONTRACT"
...
USING DW_${var.SF_ENVIRONMENT}."STAGE".OPENSYSTEMS_DIM_CONTRACT AS src
