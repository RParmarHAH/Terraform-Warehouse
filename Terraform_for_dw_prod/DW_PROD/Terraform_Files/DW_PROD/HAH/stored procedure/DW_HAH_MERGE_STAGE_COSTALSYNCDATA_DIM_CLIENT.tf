resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_COSTALSYNCDATA_DIM_CLIENT" {
	name ="MERGE_STAGE_COSTALSYNCDATA_DIM_CLIENT"
...
MERGE INTO HAH.DIM_CLIENT TGT USING STAGE.COSTALSYNCDATA_DIM_CLIENT STAGE 
