resource "snowflake_procedure" "DW_HAH_GET_STAGE_OPENSYSTEMS_DIM_BRANCH" {
	name ="GET_STAGE_OPENSYSTEMS_DIM_BRANCH"
...
--***************************************************************************************************************************
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.STAGE.OPENSYSTEMS_DIM_BRANCH
WITH OPENSYSTEMS_DATA AS (
	 ...
	 END  AS REGION_NAME
     FROM "DISC_${var.SF_ENVIRONMENT}"."HHAEXCHANGEOPENSYSTEMS"."OFFICE_OFFICES_REPL" AS OFFICES
),   
FOR_BSL AS (
   	 ...
   	 JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.VW_OPENSYSTEMS_REVENUE VOR on
