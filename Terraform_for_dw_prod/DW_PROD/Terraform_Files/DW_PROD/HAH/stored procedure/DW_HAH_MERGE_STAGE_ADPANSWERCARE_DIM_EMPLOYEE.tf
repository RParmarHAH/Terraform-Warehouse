resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ADPANSWERCARE_DIM_EMPLOYEE" {
	name ="MERGE_STAGE_ADPANSWERCARE_DIM_EMPLOYEE"
...
USING STAGE.ADPANSWERCARE_DIM_EMPLOYEE STAGE 
