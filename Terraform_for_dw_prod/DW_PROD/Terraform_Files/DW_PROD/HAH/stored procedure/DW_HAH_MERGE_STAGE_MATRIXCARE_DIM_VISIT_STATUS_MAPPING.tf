resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_MATRIXCARE_DIM_VISIT_STATUS_MAPPING" {
	name ="MERGE_STAGE_MATRIXCARE_DIM_VISIT_STATUS_MAPPING"
...
USING STAGE.MATRIXCARE_DIM_VISIT_STATUS_MAPPING STAGE 
