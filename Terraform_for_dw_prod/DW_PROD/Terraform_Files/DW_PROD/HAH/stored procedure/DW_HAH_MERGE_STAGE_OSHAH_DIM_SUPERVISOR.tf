resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OSHAH_DIM_SUPERVISOR" {
	name ="MERGE_STAGE_OSHAH_DIM_SUPERVISOR"
...
USING DW_${var.SF_ENVIRONMENT}."STAGE".OSHAH_DIM_SUPERVISOR AS STAGE
