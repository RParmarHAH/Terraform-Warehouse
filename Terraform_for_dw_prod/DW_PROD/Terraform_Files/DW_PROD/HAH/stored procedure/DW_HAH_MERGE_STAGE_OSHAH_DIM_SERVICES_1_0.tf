resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OSHAH_DIM_SERVICES_1_0" {
	name ="MERGE_STAGE_OSHAH_DIM_SERVICES_1_0"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.OSHAH_DIM_SERVICES_1_0 AS src
