resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OSHAH_DIM_VISIT_STATUS_MAPPING" {
	name ="MERGE_STAGE_OSHAH_DIM_VISIT_STATUS_MAPPING"
...
USING DW_${var.SF_ENVIRONMENT}."STAGE".OSHAH_DIM_VISIT_STATUS_MAPPING  AS src
