resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OPENSYSTEMS_DIM_SERVICES" {
	name ="MERGE_STAGE_OPENSYSTEMS_DIM_SERVICES"
...
USING STAGE.OPENSYSTEMS_DIM_SERVICES STAGE 
