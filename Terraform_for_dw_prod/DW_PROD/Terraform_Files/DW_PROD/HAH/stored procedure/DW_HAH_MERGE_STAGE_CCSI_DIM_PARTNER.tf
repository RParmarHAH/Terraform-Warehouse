resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_CCSI_DIM_PARTNER" {
	name ="MERGE_STAGE_CCSI_DIM_PARTNER"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.CCSI_DIM_PARTNER AS src
