resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ALAYACARE_DIM_SUPERVISOR" {
	name ="MERGE_STAGE_ALAYACARE_DIM_SUPERVISOR"
...
USING STAGE.ALAYACARE_DIM_SUPERVISOR STAGE 
