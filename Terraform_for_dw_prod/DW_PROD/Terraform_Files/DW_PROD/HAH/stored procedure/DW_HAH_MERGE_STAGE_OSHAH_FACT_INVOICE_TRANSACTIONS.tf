resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OSHAH_FACT_INVOICE_TRANSACTIONS" {
	name ="MERGE_STAGE_OSHAH_FACT_INVOICE_TRANSACTIONS"
...
USING STAGE.OSHAH_FACT_INVOICE_TRANSACTIONS STAGE
ON 
