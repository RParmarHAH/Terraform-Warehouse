resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_AXXESS_FACT_INVOICE_TRANSACTIONS" {
	name ="MERGE_STAGE_AXXESS_FACT_INVOICE_TRANSACTIONS"
...
USING STAGE.AXXESS_FACT_INVOICE_TRANSACTIONS STAGE
ON 
