resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_MATRIXCARE_DIM_CONTRACT" {
	name ="MERGE_STAGE_MATRIXCARE_DIM_CONTRACT"
...
BEGIN
    MERGE INTO HAH.DIM_CONTRACT TGT USING STAGE.MATRIXCARE_DIM_CONTRACT STAGE 
