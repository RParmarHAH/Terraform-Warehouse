resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_SANDATAIMPORT_DIM_CONTRACT" {
	name ="MERGE_STAGE_SANDATAIMPORT_DIM_CONTRACT"
...
USING STAGE.SANDATAIMPORT_DIM_CONTRACT STAGE 
