resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ALAYACARE_DIM_ACTIVITIES" {
	name ="MERGE_STAGE_ALAYACARE_DIM_ACTIVITIES"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.ALAYACARE_DIM_ACTIVITIES STAGE 
