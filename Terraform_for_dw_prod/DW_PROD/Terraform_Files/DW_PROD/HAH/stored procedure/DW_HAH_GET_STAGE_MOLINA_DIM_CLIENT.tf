resource "snowflake_procedure" "DW_HAH_GET_STAGE_MOLINA_DIM_CLIENT" {
	name ="GET_STAGE_MOLINA_DIM_CLIENT"
...
--*****************************************************************************************************************************
TRUNCATE TABLE DW_${var.SF_ENVIRONMENT}."STAGE".MOLINA_DIM_CLIENT;
INSERT ALL WHEN CLIENT_KEY IS NOT NULL AND CLIENT_NUMBER IS NOT NULL 
           THEN INTO DW_${var.SF_ENVIRONMENT}."STAGE".MOLINA_DIM_CLIENT 
           WHEN CLIENT_KEY IS NULL OR CLIENT_NUMBER IS NULL 
           THEN INTO DW_${var.SF_ENVIRONMENT}.HAH.MOLINA_EXCLUDE_CLIENT 
...
FROM
	...
	FROM
		DISC_${var.SF_ENVIRONMENT}.MOLINA.MOLINA_SOURCE_DATA) DATA;
