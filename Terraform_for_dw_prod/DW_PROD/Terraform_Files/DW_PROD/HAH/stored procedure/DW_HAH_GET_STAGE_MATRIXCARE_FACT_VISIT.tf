resource "snowflake_procedure" "DW_HAH_GET_STAGE_MATRIXCARE_FACT_VISIT" {
	name ="GET_STAGE_MATRIXCARE_FACT_VISIT"
...
(
 ...
 left join DISC_${var.SF_ENVIRONMENT}.MATRIXCARE.STVHC_T_ADMISSIONS ADM ON ADM_ID = AUTH_ADMISSIONID
