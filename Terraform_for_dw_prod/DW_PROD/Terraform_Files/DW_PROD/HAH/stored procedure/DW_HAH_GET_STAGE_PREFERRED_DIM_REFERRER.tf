resource "snowflake_procedure" "DW_HAH_GET_STAGE_PREFERRED_DIM_REFERRER" {
	name ="GET_STAGE_PREFERRED_DIM_REFERRER"
...
FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.REFERRALSOURCE r;
;
