resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_DATAFLEXSYNCDATA_FACT_BRANCH_PAYROLL_PERIODS" {
	name ="MERGE_STAGE_DATAFLEXSYNCDATA_FACT_BRANCH_PAYROLL_PERIODS"
...
USING STAGE.DATAFLEXSYNCDATA_FACT_BRANCH_PAYROLL_PERIODS STAGE 
