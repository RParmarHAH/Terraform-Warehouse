resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_EMPEONEDISON_DIM_PAYCODE_MAPPING" {
	name ="MERGE_STAGE_EMPEONEDISON_DIM_PAYCODE_MAPPING"
...
USING STAGE.EMPEONEDISON_DIM_PAYCODE_MAPPING STAGE 
