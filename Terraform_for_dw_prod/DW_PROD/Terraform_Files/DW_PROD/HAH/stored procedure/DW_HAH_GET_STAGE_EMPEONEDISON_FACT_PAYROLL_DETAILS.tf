resource "snowflake_procedure" "DW_HAH_GET_STAGE_EMPEONEDISON_FACT_PAYROLL_DETAILS" {
	name ="GET_STAGE_EMPEONEDISON_FACT_PAYROLL_DETAILS"
...
--*****************************************************************************************************************************
	...
	(
		...
		FROM  DISC_${var.SF_ENVIRONMENT}.EMPEONEDISON.EPAYHIST AS p
	...
	FROM DISC_${var.SF_ENVIRONMENT}.EMPEONEDISON.EPAYHISTDETAIL PD
	LEFT JOIN REPORT_DATE RD ON
		RD.TRANS = PD.TRANS
	LEFT JOIN PAYCODE P ON
		P.PAYCODE = PD.DETCODE
		AND P.CO = RD.CO
	LEFT JOIN DISC_${var.SF_ENVIRONMENT}.EMPEONEDISON.EPAYHIST PH
