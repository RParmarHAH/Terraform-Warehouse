resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OPENSYSTEMS_DIM_INVOICE_TRANSACTION_TYPE" {
	name ="MERGE_STAGE_OPENSYSTEMS_DIM_INVOICE_TRANSACTION_TYPE"
...
USING STAGE.OPENSYSTEMS_DIM_INVOICE_TRANSACTION_TYPE STAGE
ON 
