resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_COSTALSYNCDATA_DIM_CONTRACT" {
	name ="MERGE_STAGE_COSTALSYNCDATA_DIM_CONTRACT"
...
USING STAGE.COSTALSYNCDATA_DIM_CONTRACT STAGE 
