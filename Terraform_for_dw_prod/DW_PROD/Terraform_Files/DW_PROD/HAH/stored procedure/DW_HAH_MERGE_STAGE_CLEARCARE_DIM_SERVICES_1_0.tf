resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_CLEARCARE_DIM_SERVICES_1_0" {
	name ="MERGE_STAGE_CLEARCARE_DIM_SERVICES_1_0"
...
BEGIN		  
	...
	USING STAGE.CLEARCARE_DIM_SERVICES_1_0 STAGE
