resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ADPALLIANCE_DIM_EMPLOYEE" {
	name ="MERGE_STAGE_ADPALLIANCE_DIM_EMPLOYEE"
...
USING STAGE.ADPALLIANCE_DIM_EMPLOYEE STAGE 
