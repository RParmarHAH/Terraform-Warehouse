resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ADPANSWERCARE_FACT_PAYROLL_DETAILS" {
	name ="MERGE_STAGE_ADPANSWERCARE_FACT_PAYROLL_DETAILS"
...
USING STAGE.ADPANSWERCARE_FACT_PAYROLL_DETAILS STAGE 
