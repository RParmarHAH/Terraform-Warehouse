resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OPENSYSTEMS_DIM_SERVICES_1_0" {
	name ="MERGE_STAGE_OPENSYSTEMS_DIM_SERVICES_1_0"
...
BEGIN 
MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.DIM_SERVICES_1_0 AS tgt
USING DW_${var.SF_ENVIRONMENT}.STAGE.OPENSYSTEMS_DIM_SERVICES_1_0 AS src
