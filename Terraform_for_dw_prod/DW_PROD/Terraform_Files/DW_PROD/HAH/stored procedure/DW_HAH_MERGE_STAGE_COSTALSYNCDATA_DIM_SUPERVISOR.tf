resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_COSTALSYNCDATA_DIM_SUPERVISOR" {
	name ="MERGE_STAGE_COSTALSYNCDATA_DIM_SUPERVISOR"
...
USING STAGE.COSTALSYNCDATA_DIM_SUPERVISOR STAGE 
