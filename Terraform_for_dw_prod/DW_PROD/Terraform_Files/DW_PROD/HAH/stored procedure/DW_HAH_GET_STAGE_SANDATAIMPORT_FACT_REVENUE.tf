resource "snowflake_procedure" "DW_HAH_GET_STAGE_SANDATAIMPORT_FACT_REVENUE" {
	name ="GET_STAGE_SANDATAIMPORT_FACT_REVENUE"
...
--*****************************************************************************************************************************
--
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.STAGE.SANDATAIMPORT_FACT_REVENUE
