resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ALAYACARE_FACT_CAREGIVER_TOUCH_POINT" {
	name ="MERGE_STAGE_ALAYACARE_FACT_CAREGIVER_TOUCH_POINT"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.ALAYACARE_FACT_CAREGIVER_TOUCH_POINT STAGE 
