resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OSHAH_DIM_INVOICE_TRANSACTION_TYPE" {
	name ="MERGE_STAGE_OSHAH_DIM_INVOICE_TRANSACTION_TYPE"
...
USING STAGE.OSHAH_DIM_INVOICE_TRANSACTION_TYPE STAGE
ON 
