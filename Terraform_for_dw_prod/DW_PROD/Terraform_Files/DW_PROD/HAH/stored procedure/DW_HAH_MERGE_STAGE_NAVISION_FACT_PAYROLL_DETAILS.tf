resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_NAVISION_FACT_PAYROLL_DETAILS" {
	name ="MERGE_STAGE_NAVISION_FACT_PAYROLL_DETAILS"
...
USING STAGE.NAVISION_FACT_PAYROLL_DETAILS STAGE 
