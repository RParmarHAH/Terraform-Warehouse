resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ALAYACARE_FACT_VISIT_BKCP_0525" {
	name ="MERGE_STAGE_ALAYACARE_FACT_VISIT_BKCP_0525"
   ...
   //    try {
      var sqlCmd = `
    MERGE INTO HAH.FACT_VISIT_BKCP_AL_0525 TGT 
