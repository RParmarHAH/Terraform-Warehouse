resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_COSTALSYNCDATA_DIM_INVOICE" {
	name ="MERGE_STAGE_COSTALSYNCDATA_DIM_INVOICE"
...
USING STAGE.COSTALSYNCDATA_DIM_INVOICE STAGE 
