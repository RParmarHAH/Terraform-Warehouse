resource "snowflake_procedure" "DW_HAH_GET_STAGE_ADPOPAL_DIM_EMPLOYEE" {
	name ="GET_STAGE_ADPOPAL_DIM_EMPLOYEE"
...
FROM DISC_DEDUPE_${var.SF_ENVIRONMENT}.ADP.OPAL_EMPLOYEE_MASTER_LIST EML
