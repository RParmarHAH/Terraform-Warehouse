resource "snowflake_procedure" "DW_HAH_GET_STAGE_AXXESS_DIM_BRANCH" {
...
FROM BRANCH_INFO BI
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.AXXESS.AXXESS_BRANCH_OFFICE_MAPPING OFFICES ON BI.BRANCH_ID  = OFFICES.BRANCH_ID 
