resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_TRUSTPOINTDATA_FACT_PAYROLL" {
	name ="MERGE_STAGE_TRUSTPOINTDATA_FACT_PAYROLL"
...
BEGIN
    MERGE INTO HAH.FACT_PAYROLL TGT USING STAGE.TRUSTPOINTDATA_FACT_PAYROLL STAGE 
