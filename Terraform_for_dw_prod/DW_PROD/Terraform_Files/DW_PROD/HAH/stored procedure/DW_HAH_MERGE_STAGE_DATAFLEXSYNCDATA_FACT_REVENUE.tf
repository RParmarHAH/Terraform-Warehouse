resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_DATAFLEXSYNCDATA_FACT_REVENUE" {
	name ="MERGE_STAGE_DATAFLEXSYNCDATA_FACT_REVENUE"
...
USING STAGE.DATAFLEXSYNCDATA_FACT_REVENUE STAGE 
