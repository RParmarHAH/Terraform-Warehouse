resource "snowflake_procedure" "DW_HAH_GET_STAGE_OPENSYSTEMS_FACT_VISIT" {
	name ="GET_STAGE_OPENSYSTEMS_FACT_VISIT"
...
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}."STAGE".OPENSYSTEMS_FACT_VISIT
WITH EMPLOYEE AS
(
SELECT * FROM
(
...
FROM CLIENT P
JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.PROVIDERPATIENTCOORDINATORS PC1
...
SELECT VR.VISITID
FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.TBLVISITS_REPL VR JOIN CTE D
...
FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.VISITINFO_REPL VISITS
...
JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.VISITS V ON VISITS.VISITID = V.VISITID
...
, CR.SERVICECODEID
, CR.UNITS
FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.CONTRACTRATES CR
...
FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.PAYMENTS
)
...
FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.VISITAUTHORIZATIONS_REPL VAR
JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.PATIENTAUTHORIZATION PA ON PA.AUTHORIZATIONID = VAR.AUTHORIZATIONID
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.PATIENTS P ON P.PATIENTID = VAR.PATIENTID 
...
FROM
    DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.CALLMAINTENANCE CM
INNER JOIN
...
LEFT JOIN
    DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.OFFICE_OFFICES_REPL OFFICE 
...
SELECT UV.VISITID
FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.UNTOUCHEDVISITS UV
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.INREVIEWVISITS IV
...
JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.TBLVISITS_REPL VR
ON VISITS.VISITID = VR.VISITID
JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.VISITS VS
ON VS.VISITID = VR.VISITID
JOIN CLIENT C ON VR.PATIENTID = C.PATIENTID
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.PATIENTS P ON P.PATIENTID = C.PATIENTID
JOIN EMPLOYEE E ON VR.CAREGIVERID = E.CAREGIVERID --- THIS IS USED FOR EMPLOYEE_KEY
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.OFFICE_OFFICES_REPL O ON VISITS.OFFICEID = O.OFFICEID ---THIS IS USED
LEFT JOIN COORDINATOR ON C.PATIENTID = COORDINATOR.PATIENTID
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.SERVICECODES SC --- THIS IS USED FOR BILLCODE
ON VISITS.PRIMARYSERVICECODEID = SC.SERVICECODEID
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.CONTRACTS
...
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.PAYROLL_VISITS_REPL PAYROLL
ON VR.VISITID = PAYROLL.VISITID
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.TBLINVOICEDETAILS_REPL INVOICE ---- THIS IS USED FOR BILL RATE
