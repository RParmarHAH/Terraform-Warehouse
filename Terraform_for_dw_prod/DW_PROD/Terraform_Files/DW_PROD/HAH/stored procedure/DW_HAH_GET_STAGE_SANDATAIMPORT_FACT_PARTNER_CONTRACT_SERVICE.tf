resource "snowflake_procedure" "DW_HAH_GET_STAGE_SANDATAIMPORT_FACT_PARTNER_CONTRACT_SERVICE" {
	name ="GET_STAGE_SANDATAIMPORT_FACT_PARTNER_CONTRACT_SERVICE"
...
FROM DISC_${var.SF_ENVIRONMENT}.SANDATAIMPORT.SANDATA_CLIENTADMISSIONS CAD 
...
LEFT JOIN  DISC_${var.SF_ENVIRONMENT}.SANDATAIMPORT.SANDATA_PAYORS P
...
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.SANDATAIMPORT.SANDATA_PAYORS P ON P."NAME" = SV.PAYORNAME AND P.AGENCYID = SV.AGENCYID
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.SANDATAIMPORT.SANDATA_SERVICES S 
...
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.SANDATAIMPORT.SANDATA_INVOICEHEADER INV_H ON INV_H.INVOICENUMBER =F.INVOICENUMBER 
