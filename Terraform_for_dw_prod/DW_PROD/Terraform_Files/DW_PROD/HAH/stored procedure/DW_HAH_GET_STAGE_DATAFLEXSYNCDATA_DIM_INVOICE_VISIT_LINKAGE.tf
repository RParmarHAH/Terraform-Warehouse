resource "snowflake_procedure" "DW_HAH_GET_STAGE_DATAFLEXSYNCDATA_DIM_INVOICE_VISIT_LINKAGE" {
	name ="GET_STAGE_DATAFLEXSYNCDATA_DIM_INVOICE_VISIT_LINKAGE"
    ...
    BEGIN
        ...
        INSERT INTO STAGE.DATAFLEXSYNCDATA_DIM_INVOICE_VISIT_LINKAGE
          with AR_DIM_INVOICE_CHANGED_DATA AS (SELECT DISTINCT I.DBNAME,
            ...
            LEFT JOIN dw_${var.SF_ENVIRONMENT}.HAH.DIM_BRANCH AS BRANCH ON BRANCH.SOURCE_SYSTEM_ID = 3
        ...
        FROM AR_DIM_INVOICE AS INV
                 LEFT JOIN DISC_${var.SF_ENVIRONMENT}.DATAFLEXSYNCDATA.DFCONTRACTS con ON inv.CONTRACT_CODE = con.CONTRACTCODE
