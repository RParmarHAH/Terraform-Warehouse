resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_TRUSTPOINTDATA_DIM_PAYCODE_MAPPING" {
	name ="MERGE_STAGE_TRUSTPOINTDATA_DIM_PAYCODE_MAPPING"
...
USING STAGE.TRUSTPOINTDATA_DIM_PAYCODE_MAPPING STAGE 
