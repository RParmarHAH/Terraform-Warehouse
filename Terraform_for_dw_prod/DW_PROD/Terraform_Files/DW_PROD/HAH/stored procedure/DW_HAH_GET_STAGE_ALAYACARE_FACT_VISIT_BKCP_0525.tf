resource "snowflake_procedure" "DW_HAH_GET_STAGE_ALAYACARE_FACT_VISIT_BKCP_0525" {
	name ="GET_STAGE_ALAYACARE_FACT_VISIT_BKCP_0525"
...
--*******************************************************************************************************************************************************
--
    INSERT OVERWRITE INTO STAGE.ALAYACARE_FACT_VISIT_BKCP_0525
