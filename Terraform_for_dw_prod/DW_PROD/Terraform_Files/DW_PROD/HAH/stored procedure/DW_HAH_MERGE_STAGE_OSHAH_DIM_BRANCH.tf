resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OSHAH_DIM_BRANCH" {
	name ="MERGE_STAGE_OSHAH_DIM_BRANCH"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.OSHAH_DIM_BRANCH  AS src
