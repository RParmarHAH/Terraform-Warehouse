resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OPENSYSTEMS_DIM_REFERRER" {
	name ="MERGE_STAGE_OPENSYSTEMS_DIM_REFERRER"
...
USING STAGE.OPENSYSTEMS_DIM_REFERRER STAGE 
