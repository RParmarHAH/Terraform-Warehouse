resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_CLEARCARE_FACT_BRANCH_PAYROLL_PERIODS" {
	name ="MERGE_STAGE_CLEARCARE_FACT_BRANCH_PAYROLL_PERIODS"
...
BEGIN
	...
	USING STAGE.CLEARCARE_FACT_BRANCH_PAYROLL_PERIODS STG 
