resource "snowflake_procedure" "DW_HAH_GET_STAGE_ALAYACARE_DIM_SERVICES_1_0" {
	name ="GET_STAGE_ALAYACARE_DIM_SERVICES_1_0"
...
--08/09/2023    trushali
--*****************************************************************************************************************************
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.STAGE.ALAYACARE_DIM_SERVICES_1_0
SELECT DISTINCT  
...
LEFT JOIN (SELECT DISTINCT SERVICE_CODE_ID,VISIT_COMPUTED_RATE_UNITS,BRANCH_ID FROM DISC_${var.SF_ENVIRONMENT}.ALAYACARE.VISIT where VISIT_COMPUTED_RATE_UNITS is not null) VISITS 
