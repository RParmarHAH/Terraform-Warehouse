resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_PREFERRED_FACT_ADMISSION" {
	name ="MERGE_STAGE_PREFERRED_FACT_ADMISSION"
...
USING STAGE.PREFERRED_FACT_ADMISSION STAGE
