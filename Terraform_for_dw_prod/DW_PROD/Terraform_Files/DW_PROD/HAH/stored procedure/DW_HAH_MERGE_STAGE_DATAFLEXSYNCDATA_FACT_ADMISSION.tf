resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_DATAFLEXSYNCDATA_FACT_ADMISSION" {
	name ="MERGE_STAGE_DATAFLEXSYNCDATA_FACT_ADMISSION"
...
BEGIN
MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.FACT_ADMISSION AS tgt
USING DW_${var.SF_ENVIRONMENT}."STAGE".DATAFLEXSYNCDATA_FACT_ADMISSION AS src
