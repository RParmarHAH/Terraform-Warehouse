resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_SANDATAIMPORT_ORPHAN_BRANCH" {
	name ="MERGE_STAGE_SANDATAIMPORT_ORPHAN_BRANCH"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.SANDATAIMPORT_ORPHAN_BRANCH STAGE 
