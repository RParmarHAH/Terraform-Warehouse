resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_PARADOX_DIM_APPLICANT" {
	name ="MERGE_STAGE_PARADOX_DIM_APPLICANT"
...
BEGIN
    MERGE INTO HAH.DIM_APPLICANT TGT USING STAGE.PARADOX_DIM_APPLICANT STAGE 
