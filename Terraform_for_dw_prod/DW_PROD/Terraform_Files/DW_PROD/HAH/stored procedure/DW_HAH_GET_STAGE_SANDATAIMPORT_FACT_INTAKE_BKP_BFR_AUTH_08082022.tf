resource "snowflake_procedure" "DW_HAH_GET_STAGE_SANDATAIMPORT_FACT_INTAKE_BKP_BFR_AUTH_08082022" {
	name ="GET_STAGE_SANDATAIMPORT_FACT_INTAKE_BKP_BFR_AUTH_08082022"
