resource "snowflake_procedure" "DW_HAH_GET_STAGE_COASTALGP_DIM_EMPLOYEE" {
	name ="GET_STAGE_COASTALGP_DIM_EMPLOYEE"
...
LEFT OUTER JOIN DISC_${var.SF_ENVIRONMENT}.STAGE.COASTAL_OFFICE_MAPPING_PAYROLL AS BRANCH_MAPPING
