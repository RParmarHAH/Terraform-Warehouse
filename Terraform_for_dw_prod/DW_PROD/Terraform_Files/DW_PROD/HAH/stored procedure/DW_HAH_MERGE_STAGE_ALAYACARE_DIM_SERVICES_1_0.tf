resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ALAYACARE_DIM_SERVICES_1_0" {
	name ="MERGE_STAGE_ALAYACARE_DIM_SERVICES_1_0"
...
BEGIN
	MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.DIM_SERVICES_1_0 TGT
	USING DW_${var.SF_ENVIRONMENT}.STAGE.ALAYACARE_DIM_SERVICES_1_0 STAGE
