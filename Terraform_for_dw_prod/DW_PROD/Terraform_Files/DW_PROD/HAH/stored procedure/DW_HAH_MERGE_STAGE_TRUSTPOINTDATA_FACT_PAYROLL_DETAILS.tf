resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_TRUSTPOINTDATA_FACT_PAYROLL_DETAILS" {
	name ="MERGE_STAGE_TRUSTPOINTDATA_FACT_PAYROLL_DETAILS"
...
BEGIN
    MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.FACT_PAYROLL_DETAILS TGT USING DW_${var.SF_ENVIRONMENT}.STAGE.TRUSTPOINTDATA_FACT_PAYROLL_DETAILS STAGE 
