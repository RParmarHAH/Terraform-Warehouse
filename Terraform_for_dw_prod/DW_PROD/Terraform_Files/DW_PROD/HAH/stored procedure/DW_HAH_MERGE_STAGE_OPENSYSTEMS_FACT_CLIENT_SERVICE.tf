resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OPENSYSTEMS_FACT_CLIENT_SERVICE" {
	name ="MERGE_STAGE_OPENSYSTEMS_FACT_CLIENT_SERVICE"
...
USING STAGE.OPENSYSTEMS_FACT_CLIENT_SERVICE AS src
