resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_COSTALSYNCDATA_DIM_EMPLOYEE" {
	name ="MERGE_STAGE_COSTALSYNCDATA_DIM_EMPLOYEE"
...
USING STAGE.COSTALSYNCDATA_DIM_EMPLOYEE STAGE 
