resource "snowflake_procedure" "DW_HAH_GET_STAGE_PARADOX_FACT_APPLICANT_STATUS" {
	name ="GET_STAGE_PARADOX_FACT_APPLICANT_STATUS"
...
--*****************************************************************************************************************************
--
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.STAGE.PARADOX_FACT_APPLICANT_STATUS
