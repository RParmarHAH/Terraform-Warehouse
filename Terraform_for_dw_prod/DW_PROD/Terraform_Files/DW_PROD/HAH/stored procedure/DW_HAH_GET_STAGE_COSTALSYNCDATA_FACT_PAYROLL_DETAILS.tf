resource "snowflake_procedure" "DW_HAH_GET_STAGE_COSTALSYNCDATA_FACT_PAYROLL_DETAILS" {
	name ="GET_STAGE_COSTALSYNCDATA_FACT_PAYROLL_DETAILS"
...
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.STAGE.COSTALSYNCDATA_FACT_PAYROLL_DETAILS
