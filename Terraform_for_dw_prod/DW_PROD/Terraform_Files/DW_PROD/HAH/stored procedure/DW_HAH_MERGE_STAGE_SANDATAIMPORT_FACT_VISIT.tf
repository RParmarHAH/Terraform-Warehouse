resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_SANDATAIMPORT_FACT_VISIT" {
	name ="MERGE_STAGE_SANDATAIMPORT_FACT_VISIT"
...
USING STAGE.SANDATAIMPORT_FACT_VISIT STAGE 
...
VALUES (
   ...
   ,STAGE.BILLING_KEY,STAGE.SERVICE_DATE
   ,STAGE.PAYROLL_DATE
   ,STAGE.BRANCH_NAME
   ,STAGE.CLIENT_NUMBER
   ,STAGE.CONTRACT_CODE
