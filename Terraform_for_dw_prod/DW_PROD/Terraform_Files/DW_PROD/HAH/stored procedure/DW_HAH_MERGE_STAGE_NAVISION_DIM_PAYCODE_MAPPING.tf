resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_NAVISION_DIM_PAYCODE_MAPPING" {
	name ="MERGE_STAGE_NAVISION_DIM_PAYCODE_MAPPING"
...
USING STAGE.NAVISION_DIM_PAYCODE_MAPPING STAGE 
