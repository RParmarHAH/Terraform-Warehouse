resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_SANDATAIMPORT_DIM_VISIT_EXCEPTION" {
	name ="MERGE_STAGE_SANDATAIMPORT_DIM_VISIT_EXCEPTION"
...
BEGIN
	MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.DIM_VISIT_EXCEPTION TGT USING DW_${var.SF_ENVIRONMENT}.STAGE.SANDATAIMPORT_DIM_VISIT_EXCEPTION STAGE 
