resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_EMPEONEDISON_DIM_BRANCH" {
	name ="MERGE_STAGE_EMPEONEDISON_DIM_BRANCH"
...
USING STAGE.EMPEONEDISON_DIM_BRANCH STAGE 
