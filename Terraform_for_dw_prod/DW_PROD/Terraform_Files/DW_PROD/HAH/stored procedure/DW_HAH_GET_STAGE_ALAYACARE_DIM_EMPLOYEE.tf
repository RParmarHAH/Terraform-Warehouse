resource "snowflake_procedure" "DW_HAH_GET_STAGE_ALAYACARE_DIM_EMPLOYEE" {
	name ="GET_STAGE_ALAYACARE_DIM_EMPLOYEE"
...
(
	...
	FROM
		DISC_${var.SF_ENVIRONMENT}.ALAYACARE.EMPLOYEE_DEPARTMENT ED
