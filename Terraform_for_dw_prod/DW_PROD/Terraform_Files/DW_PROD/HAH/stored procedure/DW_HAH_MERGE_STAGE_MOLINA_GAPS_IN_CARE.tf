resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_MOLINA_GAPS_IN_CARE" {
	name ="MERGE_STAGE_MOLINA_GAPS_IN_CARE"
...
--*****************************************************************************************************************************
MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.FACT_GAPS_IN_CARE TGT
USING DW_${var.SF_ENVIRONMENT}.STAGE.MOLINA_FACT_GAPS_IN_CARE STAGE
