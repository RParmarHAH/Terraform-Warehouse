resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_CLEARCARE_DIM_SERVICES" {
	name ="MERGE_STAGE_CLEARCARE_DIM_SERVICES"
...
BEGIN
    MERGE INTO HAH.DIM_SERVICES TGT USING STAGE.CLEARCARE_DIM_SERVICES STAGE 
