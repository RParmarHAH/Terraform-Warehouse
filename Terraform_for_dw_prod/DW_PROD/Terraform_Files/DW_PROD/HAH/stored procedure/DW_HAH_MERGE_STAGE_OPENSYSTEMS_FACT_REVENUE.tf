resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_OPENSYSTEMS_FACT_REVENUE" {
	name ="MERGE_STAGE_OPENSYSTEMS_FACT_REVENUE"
...
USING STAGE.OPENSYSTEMS_FACT_REVENUE STAGE 
