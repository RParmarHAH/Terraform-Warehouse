resource "snowflake_procedure" "DW_HAH_GET_STAGE_DATAFLEXSYNCDATA_DIM_INVOICE_TRANSACTION_TYPE" {
	name ="GET_STAGE_DATAFLEXSYNCDATA_DIM_INVOICE_TRANSACTION_TYPE"
...
FROM
DISC_${var.SF_ENVIRONMENT}.DATAFLEXSYNCDATA.DFINVOICEPAYMENTS INVPAY
;
