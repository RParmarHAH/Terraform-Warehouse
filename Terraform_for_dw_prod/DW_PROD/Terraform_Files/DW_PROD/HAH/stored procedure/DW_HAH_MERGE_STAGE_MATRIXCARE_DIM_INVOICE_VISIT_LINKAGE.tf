resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_MATRIXCARE_DIM_INVOICE_VISIT_LINKAGE" {
	name ="MERGE_STAGE_MATRIXCARE_DIM_INVOICE_VISIT_LINKAGE"
...
USING STAGE.MATRIXCARE_DIM_INVOICE_VISIT_LINKAGE STAGE
ON 
