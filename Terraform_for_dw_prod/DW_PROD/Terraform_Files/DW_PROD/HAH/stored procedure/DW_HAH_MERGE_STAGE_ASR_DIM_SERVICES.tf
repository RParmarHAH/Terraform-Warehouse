resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ASR_DIM_SERVICES" {
	name ="MERGE_STAGE_ASR_DIM_SERVICES"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.ASR_DIM_SERVICES STAGE 
