resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_PARADOX_FACT_APPLICANT_WITH_PDR_STATUS" {
	name ="MERGE_STAGE_PARADOX_FACT_APPLICANT_WITH_PDR_STATUS"
...
MERGE INTO 
    DW_${var.SF_ENVIRONMENT}.HAH.FACT_APPLICANT_WITH_PDR_STATUS TGT
USING 
    DW_${var.SF_ENVIRONMENT}.STAGE.PARADOX_FACT_APPLICANT_WITH_PDR_STATUS STAGE
ON 
