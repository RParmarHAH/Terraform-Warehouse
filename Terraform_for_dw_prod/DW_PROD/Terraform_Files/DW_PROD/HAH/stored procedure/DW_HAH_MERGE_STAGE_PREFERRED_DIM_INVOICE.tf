resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_PREFERRED_DIM_INVOICE" {
	name ="MERGE_STAGE_PREFERRED_DIM_INVOICE"
...
BEGIN
    MERGE INTO HAH.DIM_INVOICE TGT 	USING STAGE.PREFERRED_DIM_INVOICE STAGE 
