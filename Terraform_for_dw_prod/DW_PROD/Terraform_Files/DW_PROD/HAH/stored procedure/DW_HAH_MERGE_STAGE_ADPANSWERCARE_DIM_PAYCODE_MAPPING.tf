resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ADPANSWERCARE_DIM_PAYCODE_MAPPING" {
	name ="MERGE_STAGE_ADPANSWERCARE_DIM_PAYCODE_MAPPING"
...
USING STAGE.ADPANSWERCARE_DIM_PAYCODE_MAPPING STAGE 
