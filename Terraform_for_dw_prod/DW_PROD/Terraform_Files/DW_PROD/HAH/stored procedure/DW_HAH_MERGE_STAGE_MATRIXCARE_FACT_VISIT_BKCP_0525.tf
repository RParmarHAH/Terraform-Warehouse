resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_MATRIXCARE_FACT_VISIT_BKCP_0525" {
	name ="MERGE_STAGE_MATRIXCARE_FACT_VISIT_BKCP_0525"
...
BEGIN
    MERGE INTO HAH.FACT_VISIT_BKCP_0525 TGT USING STAGE.MATRIXCARE_FACT_VISIT STAGE 
