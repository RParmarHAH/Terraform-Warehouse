resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_CCSI_DIM_SERVICES" {
	name ="MERGE_STAGE_CCSI_DIM_SERVICES"
...
BEGIN
    MERGE INTO HAH.DIM_SERVICES TGT USING STAGE.CCSI_DIM_SERVICES STAGE 
