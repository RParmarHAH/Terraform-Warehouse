resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_COSTALSYNCDATA_FACT_BRANCH_PAYROLL_PERIODS" {
	name ="MERGE_STAGE_COSTALSYNCDATA_FACT_BRANCH_PAYROLL_PERIODS"
...
USING STAGE.COSTALSYNCDATA_FACT_BRANCH_PAYROLL_PERIODS STAGE 
