resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_EMPEONPREFERRED_DIM_BRANCH" {
	name ="MERGE_STAGE_EMPEONPREFERRED_DIM_BRANCH"
...
USING STAGE.EMPEONPREFERRED_DIM_BRANCH STAGE 
