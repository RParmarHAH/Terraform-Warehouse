resource "snowflake_procedure" "DW_HAH_FACT_EMPLOYEE_ACQUIRED_WEEKLY_POSTPROCESSING" {
	name ="FACT_EMPLOYEE_ACQUIRED_WEEKLY_POSTPROCESSING"
...
SELECT DISTINCT 
	...
	INNER JOIN DW_${var.SF_ENVIRONMENT}.HAH.DIM_DATE DD ON DD.CALENDAR_DATE = VISIT.REPORT_DATE
