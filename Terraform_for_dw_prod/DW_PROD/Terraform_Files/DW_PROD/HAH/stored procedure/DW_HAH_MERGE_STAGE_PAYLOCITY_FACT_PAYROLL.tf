resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_PAYLOCITY_FACT_PAYROLL" {
	name ="MERGE_STAGE_PAYLOCITY_FACT_PAYROLL"
...
BEGIN
    MERGE INTO HAH.FACT_PAYROLL TGT USING STAGE.PAYLOCITY_FACT_PAYROLL STAGE 
