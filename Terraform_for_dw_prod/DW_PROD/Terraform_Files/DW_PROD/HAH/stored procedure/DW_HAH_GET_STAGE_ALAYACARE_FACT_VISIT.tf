resource "snowflake_procedure" "DW_HAH_GET_STAGE_ALAYACARE_FACT_VISIT" {
...
CAST(VISITS.VISIT_SCHEDULED_DURATION AS DECIMAL(8, 2)) AS SCHEDULE_DURATION,
...
IFF( VISITS.PROPERTIES_TBL_SCHEDULER_ITEM_HOURS_PAY IS NULL,
        ...
        )::DECIMAL(8, 2) AS ADJUSTED_DURATION,
