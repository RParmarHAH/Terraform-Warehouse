resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_COSTALSYNCDATA_ORPHAN_BRANCH" {
	name ="MERGE_STAGE_COSTALSYNCDATA_ORPHAN_BRANCH"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.COSTALSYNCDATA_ORPHAN_BRANCH STAGE 
