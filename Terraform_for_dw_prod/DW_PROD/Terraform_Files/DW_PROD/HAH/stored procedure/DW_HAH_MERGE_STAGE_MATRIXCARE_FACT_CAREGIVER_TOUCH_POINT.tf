resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_MATRIXCARE_FACT_CAREGIVER_TOUCH_POINT" {
	name ="MERGE_STAGE_MATRIXCARE_FACT_CAREGIVER_TOUCH_POINT"
...
BEGIN
    MERGE INTO DW_${var.SF_ENVIRONMENT}.HAH.FACT_CAREGIVER_TOUCH_POINT TGT 
USING DW_${var.SF_ENVIRONMENT}.STAGE.MATRIXCARE_FACT_CAREGIVER_TOUCH_POINT STAGE 
