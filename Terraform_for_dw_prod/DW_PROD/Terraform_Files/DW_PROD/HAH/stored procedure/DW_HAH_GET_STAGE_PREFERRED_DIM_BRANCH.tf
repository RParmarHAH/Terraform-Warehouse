resource "snowflake_procedure" "DW_HAH_GET_STAGE_PREFERRED_DIM_BRANCH" {
	name ="GET_STAGE_PREFERRED_DIM_BRANCH"
...
SELECT HHAEXCHANGEPREFERRED_OFFICES.BRANCH_KEY, 
	...
	LEFT JOIN DW_${var.SF_ENVIRONMENT}.HAH.DIM_SOURCE_SYSTEM AS SOURCE_SYSTEM ON SOURCE_SYSTEM.SOURCE_SYSTEM_ID = HHAEXCHANGEPREFERRED_OFFICES.SOURCE_SYSTEM_ID
