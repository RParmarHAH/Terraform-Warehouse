resource "snowflake_procedure" "DW_HAH_GET_STAGE_PREFERRED_FACT_REVENUE" {
	name ="GET_STAGE_PREFERRED_FACT_REVENUE"
...
(
	...
	FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.VISITS V 
...
(
	...
	FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.PAYMENTS PAYMENTS
	INNER JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.AGENCY_MAPPING AGENCY_CONFIG
...
(
	...
	FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.BILLING_PAIDVISITS_REPL 
...
INNER JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.tblVisits_REPL VISITS 
...
JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.VISITINFO_REPL VINFO
