resource "snowflake_procedure" "DW_HAH_GET_STAGE_DATAFLEXSYNCDATA_DIM_BRANCH" {
	name ="GET_STAGE_DATAFLEXSYNCDATA_DIM_BRANCH"
...
,RISKCONNECT_HIERARCHY AS (
	...
	FROM DISC_${var.SF_ENVIRONMENT}.DATAFLEXSYNCDATA.DFOFFICES 
	UNION ALL
