resource "snowflake_procedure" "DW_HAH_GET_STAGE_PAYLOCITY_DIM_PAYCODE_MAPPING" {
	name ="GET_STAGE_PAYLOCITY_DIM_PAYCODE_MAPPING"
...
FROM DISC_${var.SF_ENVIRONMENT}.PAYLOCITY.PAY_STATEMENT_DETAILS psd
