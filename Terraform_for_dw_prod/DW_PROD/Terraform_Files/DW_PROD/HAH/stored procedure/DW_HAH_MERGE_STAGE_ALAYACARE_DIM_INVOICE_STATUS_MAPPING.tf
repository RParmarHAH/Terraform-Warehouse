resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_ALAYACARE_DIM_INVOICE_STATUS_MAPPING" {
	name ="MERGE_STAGE_ALAYACARE_DIM_INVOICE_STATUS_MAPPING"
...
USING DW_${var.SF_ENVIRONMENT}.STAGE.ALAYACARE_DIM_INVOICE_STATUS_MAPPING STAGE 
