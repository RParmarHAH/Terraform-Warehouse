resource "snowflake_procedure" "DW_HAH_GET_STAGE_EMPEONPREFERRED_DIM_PAYCODE_MAPPING" {
	name ="GET_STAGE_EMPEONPREFERRED_DIM_PAYCODE_MAPPING"
...
WITH PAYCODES AS (
	...
	FROM DISC_${var.SF_ENVIRONMENT}.EMPEONPREFERRED.CDED
	UNION
	SELECT DISTINCT 
		CO AS CO ,
	...
	FROM DISC_${var.SF_ENVIRONMENT}.EMPEONPREFERRED.ETAX
...
USAGE_DATES AS (
	...
	FROM DISC_${var.SF_ENVIRONMENT}.EMPEONPREFERRED.EPAYHISTDETAIL ED
	LEFT JOIN DISC_${var.SF_ENVIRONMENT}.EMPEONPREFERRED.EPAYHIST EH 
