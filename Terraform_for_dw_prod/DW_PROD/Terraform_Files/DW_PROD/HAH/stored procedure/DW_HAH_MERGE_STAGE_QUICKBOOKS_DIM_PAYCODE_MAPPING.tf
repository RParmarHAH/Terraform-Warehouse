resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_QUICKBOOKS_DIM_PAYCODE_MAPPING" {
	name ="MERGE_STAGE_QUICKBOOKS_DIM_PAYCODE_MAPPING"
...
USING STAGE.QUICKBOOKS_DIM_PAYCODE_MAPPING STAGE 
