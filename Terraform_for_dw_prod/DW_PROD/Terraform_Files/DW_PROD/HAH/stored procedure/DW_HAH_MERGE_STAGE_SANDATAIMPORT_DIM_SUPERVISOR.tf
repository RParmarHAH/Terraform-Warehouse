resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_SANDATAIMPORT_DIM_SUPERVISOR" {
	name ="MERGE_STAGE_SANDATAIMPORT_DIM_SUPERVISOR"
...
USING STAGE.SANDATAIMPORT_DIM_SUPERVISOR STAGE 
