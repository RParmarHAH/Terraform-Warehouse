resource "snowflake_procedure" "DW_HAH_GET_STAGE_CLEARCARE_DIM_BRANCH" {
	name ="GET_STAGE_CLEARCARE_DIM_BRANCH"
...
FROM DISC_${var.SF_ENVIRONMENT}.CLEARCARE.AGENCY_AGENCYLOCATION AGENCY
