resource "snowflake_procedure" "DW_HAH_MERGE_STAGE_DATAFLEXSYNCDATA_FACT_VISIT_BKCP_0525" {
	name ="MERGE_STAGE_DATAFLEXSYNCDATA_FACT_VISIT_BKCP_0525"
...
BEGIN
    ...
    MERGE INTO HAH.FACT_VISIT_DF_BKCP_0525 TGT 
USING STAGE.DATAFLEXSYNCDATA_FACT_VISIT STAGE 
