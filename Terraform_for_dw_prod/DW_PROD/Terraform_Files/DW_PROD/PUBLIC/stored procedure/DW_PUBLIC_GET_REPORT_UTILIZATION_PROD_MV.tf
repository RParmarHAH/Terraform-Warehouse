resource "snowflake_procedure" "DW_PUBLIC_GET_REPORT_UTILIZATION_PROD_MV" {
	name ="GET_REPORT_UTILIZATION_PROD_MV"
...
--*****************************************************************************************************************************
	INSERT OVERWRITE INTO PUBLIC.UTILIZATION_${var.SF_ENVIRONMENT}_MV
