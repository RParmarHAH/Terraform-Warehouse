resource "snowflake_view" "DW_PUBLIC_VW_ALVAREZMARSALDATA" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "PUBLIC"
	name = "VW_ALVAREZMARSALDATA"
	statement = <<-SQL
...
JOIN DW_${var.SF_ENVIRONMENT}.HAH.DIM_EMPLOYEE e 
...
LEFT JOIN DW_${var.SF_ENVIRONMENT}.HAH.DIM_BRANCH b 
