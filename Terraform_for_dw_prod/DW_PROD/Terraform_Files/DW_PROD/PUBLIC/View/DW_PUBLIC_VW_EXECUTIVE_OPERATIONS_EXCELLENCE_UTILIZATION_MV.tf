resource "snowflake_view" "DW_PUBLIC_VW_EXECUTIVE_OPERATIONS_EXCELLENCE_UTILIZATION_MV" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "PUBLIC"
	name = "VW_EXECUTIVE_OPERATIONS_EXCELLENCE_UTILIZATION_MV"
	statement = <<-SQL
	 WITH DATES AS 
(
