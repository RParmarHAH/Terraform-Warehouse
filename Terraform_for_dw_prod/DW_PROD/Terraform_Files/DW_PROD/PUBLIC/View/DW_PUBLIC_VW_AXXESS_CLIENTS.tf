resource "snowflake_view" "DW_PUBLIC_VW_AXXESS_CLIENTS" {
...
FROM DISC_${var.SF_ENVIRONMENT}.AXXESS.AXXESS_PATIENTINFO 
...
FROM DISC_${var.SF_ENVIRONMENT}.AXXESS.AXXESS_CAREPERIODS
WHERE PATIENT_ID IS NOT NULL;
SQL
	or_replace = true 
	is_secure = false 
