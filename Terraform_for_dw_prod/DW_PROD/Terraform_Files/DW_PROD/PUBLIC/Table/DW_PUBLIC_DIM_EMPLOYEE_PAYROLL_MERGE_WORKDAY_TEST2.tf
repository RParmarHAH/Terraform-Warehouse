resource "snowflake_table" "DW_PUBLIC_DIM_EMPLOYEE_PAYROLL_MERGE_WORKDAY_TEST2" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "PUBLIC"
	name = "DIM_EMPLOYEE_PAYROLL_MERGE_WORKDAY_TEST2"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.PUBLIC.DIM_EMPLOYEE_PAYROLL_MERGE_WORKDAY_TEST2
