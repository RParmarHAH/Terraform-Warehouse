resource "snowflake_table" "DW_PUBLIC_DATAFLEXSYNCDATA_DIM_EMPLOYEE_SS_BCKP_01312024" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "PUBLIC"
	name = "DATAFLEXSYNCDATA_DIM_EMPLOYEE_SS_BCKP_01312024"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.PUBLIC.DATAFLEXSYNCDATA_DIM_EMPLOYEE_SS_BCKP_01312024
