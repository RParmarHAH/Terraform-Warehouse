resource "snowflake_table" "DW_PUBLIC_DIM_CLIENT_MERGED_BKCP_09272023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "PUBLIC"
	name = "DIM_CLIENT_MERGED_BKCP_09272023"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.PUBLIC.DIM_CLIENT_MERGED_BKCP_09272023
