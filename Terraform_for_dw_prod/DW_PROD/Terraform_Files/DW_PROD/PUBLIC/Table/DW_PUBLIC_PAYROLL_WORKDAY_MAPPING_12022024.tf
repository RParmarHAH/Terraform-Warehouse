resource "snowflake_table" "DW_PUBLIC_PAYROLL_WORKDAY_MAPPING_12022024" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "PUBLIC"
	name = "PAYROLL_WORKDAY_MAPPING_12022024"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.PUBLIC.PAYROLL_WORKDAY_MAPPING_12022024
