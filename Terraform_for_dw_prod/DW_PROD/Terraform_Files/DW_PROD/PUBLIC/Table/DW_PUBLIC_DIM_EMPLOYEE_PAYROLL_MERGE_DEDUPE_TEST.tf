resource "snowflake_table" "DW_PUBLIC_DIM_EMPLOYEE_PAYROLL_MERGE_DEDUPE_TEST" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "PUBLIC"
	name = "DIM_EMPLOYEE_PAYROLL_MERGE_DEDUPE_TEST"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.PUBLIC.DIM_EMPLOYEE_PAYROLL_MERGE_DEDUPE_TEST
