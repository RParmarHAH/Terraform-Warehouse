resource "snowflake_table" "DW_PUBLIC_SANDATAIMPORT_FACT_INTAKE_MV_COMP" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "PUBLIC"
	name = "SANDATAIMPORT_FACT_INTAKE_MV_COMP"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.PUBLIC.SANDATAIMPORT_FACT_INTAKE_MV_COMP
