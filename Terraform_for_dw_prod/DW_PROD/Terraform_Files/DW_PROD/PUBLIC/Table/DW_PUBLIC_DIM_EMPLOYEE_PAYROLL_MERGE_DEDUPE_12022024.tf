resource "snowflake_table" "DW_PUBLIC_DIM_EMPLOYEE_PAYROLL_MERGE_DEDUPE_12022024" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "PUBLIC"
	name = "DIM_EMPLOYEE_PAYROLL_MERGE_DEDUPE_12022024"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.PUBLIC.DIM_EMPLOYEE_PAYROLL_MERGE_DEDUPE_12022024
