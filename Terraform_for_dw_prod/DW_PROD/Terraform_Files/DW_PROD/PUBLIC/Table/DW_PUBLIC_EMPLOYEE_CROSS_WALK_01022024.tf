resource "snowflake_table" "DW_PUBLIC_EMPLOYEE_CROSS_WALK_01022024" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "PUBLIC"
	name = "EMPLOYEE_CROSS_WALK_01022024"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.PUBLIC.EMPLOYEE_CROSS_WALK_01022024 CLUSTER BY
