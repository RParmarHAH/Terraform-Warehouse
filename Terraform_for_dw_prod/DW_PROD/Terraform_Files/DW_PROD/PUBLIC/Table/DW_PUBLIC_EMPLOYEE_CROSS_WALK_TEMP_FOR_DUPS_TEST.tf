resource "snowflake_table" "DW_PUBLIC_EMPLOYEE_CROSS_WALK_TEMP_FOR_DUPS_TEST" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "PUBLIC"
	name = "EMPLOYEE_CROSS_WALK_TEMP_FOR_DUPS_TEST"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.PUBLIC.EMPLOYEE_CROSS_WALK_TEMP_FOR_DUPS_TEST CLUSTER BY
