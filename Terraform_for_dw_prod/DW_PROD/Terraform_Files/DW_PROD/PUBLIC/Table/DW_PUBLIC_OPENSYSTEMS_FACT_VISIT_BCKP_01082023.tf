resource "snowflake_table" "DW_PUBLIC_OPENSYSTEMS_FACT_VISIT_BCKP_01082023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "PUBLIC"
	name = "OPENSYSTEMS_FACT_VISIT_BCKP_01082023"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.PUBLIC.OPENSYSTEMS_FACT_VISIT_BCKP_01082023
