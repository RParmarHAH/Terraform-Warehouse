resource "snowflake_table" "DW_PUBLIC_DATAFLEXSYNCDATA_FACT_VISIT_BCKP_08102023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "PUBLIC"
	name = "DATAFLEXSYNCDATA_FACT_VISIT_BCKP_08102023"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.PUBLIC.DATAFLEXSYNCDATA_FACT_VISIT_BCKP_08102023
