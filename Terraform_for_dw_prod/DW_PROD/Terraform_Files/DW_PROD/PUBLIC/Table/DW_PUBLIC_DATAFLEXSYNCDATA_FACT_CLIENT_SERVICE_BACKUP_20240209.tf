resource "snowflake_table" "DW_PUBLIC_DATAFLEXSYNCDATA_FACT_CLIENT_SERVICE_BACKUP_20240209" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "PUBLIC"
	name = "DATAFLEXSYNCDATA_FACT_CLIENT_SERVICE_BACKUP_20240209"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.PUBLIC.DATAFLEXSYNCDATA_FACT_CLIENT_SERVICE_BACKUP_20240209
