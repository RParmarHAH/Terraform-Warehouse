resource "snowflake_table" "DW_PUBLIC_OSHAH_FACT_VISIT_BCKP_01082023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "PUBLIC"
	name = "OSHAH_FACT_VISIT_BCKP_01082023"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.PUBLIC.OSHAH_FACT_VISIT_BCKP_01082023
