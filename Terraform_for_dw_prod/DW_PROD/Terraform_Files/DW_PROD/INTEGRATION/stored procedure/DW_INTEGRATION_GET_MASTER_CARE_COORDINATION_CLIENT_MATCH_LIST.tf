resource "snowflake_procedure" "DW_INTEGRATION_GET_MASTER_CARE_COORDINATION_CLIENT_MATCH_LIST" {
	name ="GET_MASTER_CARE_COORDINATION_CLIENT_MATCH_LIST"
...
BEGIN
    INSERT OVERWRITE INTO APP_DB_${var.SF_ENVIRONMENT}.CARE_COORDINATION.CLIENT_MATCH_LIST
    WITH PRIORITY_SOURCE AS (
     ...
     FROM DW_${var.SF_ENVIRONMENT}.INTEGRATION.CARE_COORDINATION_CLIENT_DEDUPE
    ...
    FROM DW_${var.SF_ENVIRONMENT}.INTEGRATION.CARE_COORDINATION_CLIENT_DEDUPE R
