resource "snowflake_procedure" "DW_INTEGRATION_GET_MASTER_FACT_AMS_PAYROLL_MAPPING" {
	name ="GET_MASTER_FACT_AMS_PAYROLL_MAPPING"
...
--*****************************************************************************************************************************
    ...
    INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.INTEGRATION.FACT_AMS_PAYROLL_MAPPING
select 
*
from (
 --  INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.INTEGRATION.FACT_AMS_PAYROLL_MAPPING
  ...
  SELECT DISTINCT EMPLOYEE_KEY, EMPLOYEE_REHIRE_DATE,DERIVED_LAST_SERVICE_DATE,DERIVED_FIRST_SERVICE_DATE 
    ,DERIVED_PAYROLL_FIRST_CHECK_DATE, DERIVED_PAYROLL_LAST_CHECK_DATE FROM DW_${var.SF_ENVIRONMENT}.HAH.DIM_EMPLOYEE
  )
