resource "snowflake_procedure" "DW_INTEGRATION_FACT_BUDGET_MERGED_POSTPROCESSING" {
	name ="FACT_BUDGET_MERGED_POSTPROCESSING"
...
BEGIN
    ...
    INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.INTEGRATION.FACT_BUDGET_MERGED  
