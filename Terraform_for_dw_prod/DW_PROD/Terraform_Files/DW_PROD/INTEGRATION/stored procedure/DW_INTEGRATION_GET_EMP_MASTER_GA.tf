resource "snowflake_procedure" "DW_INTEGRATION_GET_EMP_MASTER_GA" {
	name ="GET_EMP_MASTER_GA"
...
BEGIN
delete FROM DW_${var.SF_ENVIRONMENT}.INTEGRATION.DIM_EMPLOYEE_MASTER 
...
from DW_${var.SF_ENVIRONMENT}.HAH.DIM_EMPLOYEE GA_emp
