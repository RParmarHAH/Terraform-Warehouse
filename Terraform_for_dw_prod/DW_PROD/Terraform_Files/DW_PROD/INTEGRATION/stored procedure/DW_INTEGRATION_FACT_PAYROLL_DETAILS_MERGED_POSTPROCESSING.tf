resource "snowflake_procedure" "DW_INTEGRATION_FACT_PAYROLL_DETAILS_MERGED_POSTPROCESSING" {
	name ="FACT_PAYROLL_DETAILS_MERGED_POSTPROCESSING"
...
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.INTEGRATION.FACT_PAYROLL_DETAILS_MERGED
SELECT 
...
FROM DW_${var.SF_ENVIRONMENT}.HAH.FACT_PAYROLL_DETAILS PD
