resource "snowflake_procedure" "DW_INTEGRATION_GET_ROSTER_AMS_MAPPING" {
	name ="GET_ROSTER_AMS_MAPPING"
...
-------------------------------------------------------------------------------------------------------------------------------
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.INTEGRATION.ROSTER_AMS_MAPPING
...
(
	...
	INNER JOIN DISC_${var.SF_ENVIRONMENT}.CENTENE.CENTENE_SOURCE_DATA CENTENE_CURRENT_ROSTER
	...
	-- Added Below Join to consider the clients in Current Active Roster Only
	INNER JOIN DISC_${var.SF_ENVIRONMENT}.MOLINA.MOLINA_SOURCE_DATA MOLINA_CURRENT_ROSTER
