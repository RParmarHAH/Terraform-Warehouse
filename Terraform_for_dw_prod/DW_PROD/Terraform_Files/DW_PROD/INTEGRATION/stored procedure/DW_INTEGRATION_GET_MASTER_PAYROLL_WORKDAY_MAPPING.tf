resource "snowflake_procedure" "DW_INTEGRATION_GET_MASTER_PAYROLL_WORKDAY_MAPPING" {
	name ="GET_MASTER_PAYROLL_WORKDAY_MAPPING"
...
--*****************************************************************************************************************************
-- NAME:  DW_${var.SF_ENVIRONMENT}.INTEGRATION.PAYROLL_WORKDAY_MAPPING
--
...
-- DATE        		AUTHOR                	NOTES:
-- ----------  		-------------------   	-----------------------------------------------------------------------------------------------
-- 2024-01-22 		JIGAR PRAJAPATI            	Initial Development
--*****************************************************************************************************************************

BEGIN 
   INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.INTEGRATION.PAYROLL_WORKDAY_MAPPING
...
FROM(
    ...
    case  WHEN  SOURCE_SYSTEM_ID in (36) THEN CURRENT_DATE +30 
        when  SOURCE_SYSTEM_ID in (6,10,22,34,36) then CURRENT_DATE ELSE ''1900-01-01''::DATE END  DESC ,               
        LATEST_DATE DESC,  EMPLOYEE_HIRE_DATE desc,
    EMPLOYEE_ID desc
    ) min_record_id,
