resource "snowflake_procedure" "DW_INTEGRATION_UPDATE_EMPLOYEE_KEYRING_BY_WORKDAY_ID" {
	name ="UPDATE_EMPLOYEE_KEYRING_BY_WORKDAY_ID"
...
# This is a stored procedure that updates employee data in the DW_${var.SF_ENVIRONMENT}.INTEGRATION.EMPLOYEE_CROSS_WALK table.
