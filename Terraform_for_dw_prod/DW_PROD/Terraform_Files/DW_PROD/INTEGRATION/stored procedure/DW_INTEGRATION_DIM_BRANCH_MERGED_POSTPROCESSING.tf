resource "snowflake_procedure" "DW_INTEGRATION_DIM_BRANCH_MERGED_POSTPROCESSING" {
	name ="DIM_BRANCH_MERGED_POSTPROCESSING"
...
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.INTEGRATION.DIM_BRANCH_MERGED
WITH FINAL AS (
	SELECT * 
