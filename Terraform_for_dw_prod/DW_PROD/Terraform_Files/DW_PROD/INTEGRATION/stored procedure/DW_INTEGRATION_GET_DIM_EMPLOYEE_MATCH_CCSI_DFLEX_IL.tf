resource "snowflake_procedure" "DW_INTEGRATION_GET_DIM_EMPLOYEE_MATCH_CCSI_DFLEX_IL" {
	name ="GET_DIM_EMPLOYEE_MATCH_CCSI_DFLEX_IL"
...
BEGIN
delete FROM DW_${var.SF_ENVIRONMENT}.INTEGRATION.DIM_EMPLOYEE_MATCH WHERE (SOURCE_SYSTEM_ID=3 AND SYSTEM_CODE= ''IL'') OR SOURCE_SYSTEM_ID=8;
