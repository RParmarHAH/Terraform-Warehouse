resource "snowflake_procedure" "DW_INTEGRATION_DIM_PARTNER_CONTRACT_MERGED_POSTPROCESSING" {
...
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.INTEGRATION.DIM_PARTNER_CONTRACT_MERGED
