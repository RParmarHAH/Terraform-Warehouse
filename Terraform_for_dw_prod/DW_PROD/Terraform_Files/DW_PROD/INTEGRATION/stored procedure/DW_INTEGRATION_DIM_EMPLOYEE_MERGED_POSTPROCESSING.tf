resource "snowflake_procedure" "DW_INTEGRATION_DIM_EMPLOYEE_MERGED_POSTPROCESSING" {
...
--*****************************************************************************************************************************
INSERT OVERWRITE INTO DW_${var.SF_ENVIRONMENT}.INTEGRATION.DIM_EMPLOYEE_MERGED
...
D.DERIVED_EMPLOYEE_TERMINATE_DATE
 FROM DW_${var.SF_ENVIRONMENT}.INTEGRATION.DIM_EMPLOYEE_MERGED_DEDUPE D
left JOIN DW_${var.SF_ENVIRONMENT}.HAH.DIM_EMPLOYEE E ON D.ORIGINAL_EMPLOYEE_KEY = E.EMPLOYEE_KEY  
LEFT JOIN DW_${var.SF_ENVIRONMENT}.HAH.DIM_EMPLOYEE E2 ON D.EMPLOYEE_KEY = E2.EMPLOYEE_KEY  ), 
EMPLOYEE AS(
...
FROM DW_${var.SF_ENVIRONMENT}.INTEGRATION.VW_DIM_EMPLOYEE_MERGED WHERE SOURCE_SYSTEM_ID NOT IN (''13'',''14'',''16'')
AND NOT(
