resource "snowflake_view" "DW_INTEGRATION_VW_APPLICANT_EMPLOYEE_INPUT_QUERY_BKP" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "INTEGRATION"
	name = "VW_APPLICANT_EMPLOYEE_INPUT_QUERY_BKP"
	statement = <<-SQL
...
EMPLOYEE_FIRST_CHECK_DATE,EMPLOYEE_LAST_WORKED_DATE,EMPLOYEE_HIRE_DATE,'APPLICANT' AS SOURCE_SYSTEM FROM DW_${var.SF_ENVIRONMENT}.INTEGRATION.VW_JAZZHR_PARADOX_MASTER_LIST
)
UNION ALL 
