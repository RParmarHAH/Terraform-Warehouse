resource "snowflake_table" "DW_INTEGRATION_DIM_CLIENT_MERGED_BAKUP_24072023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "INTEGRATION"
	name = "DIM_CLIENT_MERGED_BAKUP_24072023"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.INTEGRATION.DIM_CLIENT_MERGED_BAKUP_24072023
