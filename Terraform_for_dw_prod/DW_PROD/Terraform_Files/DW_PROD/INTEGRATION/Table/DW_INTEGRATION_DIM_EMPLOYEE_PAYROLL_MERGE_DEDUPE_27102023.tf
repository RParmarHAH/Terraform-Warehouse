resource "snowflake_table" "DW_INTEGRATION_DIM_EMPLOYEE_PAYROLL_MERGE_DEDUPE_27102023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "INTEGRATION"
	name = "DIM_EMPLOYEE_PAYROLL_MERGE_DEDUPE_27102023"
	change_tracking = false
	comment = "backup before making survival logic change - jigar prajapati"
