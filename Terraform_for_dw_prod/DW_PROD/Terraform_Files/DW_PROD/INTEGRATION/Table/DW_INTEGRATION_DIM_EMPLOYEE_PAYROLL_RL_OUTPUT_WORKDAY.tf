resource "snowflake_table" "DW_INTEGRATION_DIM_EMPLOYEE_PAYROLL_RL_OUTPUT_WORKDAY" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "INTEGRATION"
	name = "DIM_EMPLOYEE_PAYROLL_RL_OUTPUT_WORKDAY"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.INTEGRATION.DIM_EMPLOYEE_PAYROLL_RL_OUTPUT_WORKDAY
