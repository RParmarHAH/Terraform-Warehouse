resource "snowflake_table" "DW_INTEGRATION_FACT_PAYROLL_MERGED_16102023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "INTEGRATION"
	name = "FACT_PAYROLL_MERGED_16102023"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.INTEGRATION.FACT_PAYROLL_MERGED_16102023
