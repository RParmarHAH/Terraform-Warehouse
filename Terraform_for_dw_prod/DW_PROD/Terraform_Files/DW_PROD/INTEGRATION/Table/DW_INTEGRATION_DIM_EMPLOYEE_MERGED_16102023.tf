resource "snowflake_table" "DW_INTEGRATION_DIM_EMPLOYEE_MERGED_16102023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "INTEGRATION"
	name = "DIM_EMPLOYEE_MERGED_16102023"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.INTEGRATION.DIM_EMPLOYEE_MERGED_16102023
