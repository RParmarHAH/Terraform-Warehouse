resource "snowflake_table" "DW_INTEGRATION_JAZZHR_PARADOX_DEDUPE_OUTPUT" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "INTEGRATION"
	name = "JAZZHR_PARADOX_DEDUPE_OUTPUT"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.INTEGRATION.JAZZHR_PARADOX_DEDUPE_OUTPUT
