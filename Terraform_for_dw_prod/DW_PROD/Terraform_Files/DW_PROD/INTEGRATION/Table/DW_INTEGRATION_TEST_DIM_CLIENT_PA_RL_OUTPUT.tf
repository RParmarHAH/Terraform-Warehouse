resource "snowflake_table" "DW_INTEGRATION_TEST_DIM_CLIENT_PA_RL_OUTPUT" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "INTEGRATION"
	name = "TEST_DIM_CLIENT_PA_RL_OUTPUT"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.INTEGRATION.TEST_DIM_CLIENT_PA_RL_OUTPUT
