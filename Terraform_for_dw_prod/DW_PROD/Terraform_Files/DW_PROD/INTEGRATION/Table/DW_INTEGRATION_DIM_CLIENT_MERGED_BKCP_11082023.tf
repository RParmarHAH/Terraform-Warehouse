resource "snowflake_table" "DW_INTEGRATION_DIM_CLIENT_MERGED_BKCP_11082023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "INTEGRATION"
	name = "DIM_CLIENT_MERGED_BKCP_11082023"
	change_tracking = false
	comment = "taking backup after prod pipeline refresh before making changes for cleint ethnicity field IDDOX-388"
...
column {
	name = "DERIVED_CONTRACT_BEGIN_DATE"
	type = "DATE"
	nullable = true
}
...
column {
	name = "DERIVED_CONTRACT_END_DATE"
	type = "DATE"
	nullable = true
}
