resource "snowflake_table" "DW_INTEGRATION_EMPLOYEE_CROSS_WALK_10032023" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "INTEGRATION"
	name = "EMPLOYEE_CROSS_WALK_10032023"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.INTEGRATION.EMPLOYEE_CROSS_WALK_10032023 CLUSTER BY
