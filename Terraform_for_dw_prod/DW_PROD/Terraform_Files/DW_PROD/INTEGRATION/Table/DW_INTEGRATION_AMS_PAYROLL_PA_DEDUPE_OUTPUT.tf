resource "snowflake_table" "DW_INTEGRATION_AMS_PAYROLL_PA_DEDUPE_OUTPUT" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "INTEGRATION"
	name = "AMS_PAYROLL_PA_DEDUPE_OUTPUT"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.INTEGRATION.AMS_PAYROLL_PA_DEDUPE_OUTPUT
