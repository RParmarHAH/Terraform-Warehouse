resource "snowflake_table" "DW_INTEGRATION_VW_EMPLOYEE_CROSS_WALK_TBL_MASTER" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "INTEGRATION"
	name = "VW_EMPLOYEE_CROSS_WALK_TBL_MASTER"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.INTEGRATION.VW_EMPLOYEE_CROSS_WALK_TBL_MASTER
