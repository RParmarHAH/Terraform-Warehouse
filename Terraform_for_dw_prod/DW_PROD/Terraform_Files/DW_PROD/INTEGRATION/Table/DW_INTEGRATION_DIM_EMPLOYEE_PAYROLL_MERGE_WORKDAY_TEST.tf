resource "snowflake_table" "DW_INTEGRATION_DIM_EMPLOYEE_PAYROLL_MERGE_WORKDAY_TEST" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "INTEGRATION"
	name = "DIM_EMPLOYEE_PAYROLL_MERGE_WORKDAY_TEST"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.INTEGRATION.DIM_EMPLOYEE_PAYROLL_MERGE_WORKDAY_TEST
