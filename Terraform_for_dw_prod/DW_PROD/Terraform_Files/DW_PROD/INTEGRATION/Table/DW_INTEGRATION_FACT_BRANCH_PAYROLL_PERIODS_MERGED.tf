resource "snowflake_table" "DW_INTEGRATION_FACT_BRANCH_PAYROLL_PERIODS_MERGED" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "INTEGRATION"
	name = "FACT_BRANCH_PAYROLL_PERIODS_MERGED"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.INTEGRATION.FACT_BRANCH_PAYROLL_PERIODS_MERGED
