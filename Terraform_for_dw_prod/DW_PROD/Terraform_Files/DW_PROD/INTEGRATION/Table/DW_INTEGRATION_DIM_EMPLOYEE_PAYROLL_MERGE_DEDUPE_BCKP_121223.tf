resource "snowflake_table" "DW_INTEGRATION_DIM_EMPLOYEE_PAYROLL_MERGE_DEDUPE_BCKP_121223" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "INTEGRATION"
	name = "DIM_EMPLOYEE_PAYROLL_MERGE_DEDUPE_BCKP_121223"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.INTEGRATION.DIM_EMPLOYEE_PAYROLL_MERGE_DEDUPE_BCKP_121223
...
column {
	name = "DERIVED_EMPLOYEE_HIRE_DATE"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "DERIVED_EMPLOYEE_REHIRE_DATE"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "DERIVED_EMPLOYEE_BENEFIT_START_DATE"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "DERIVED_EMPLOYEE_FIRST_CHECK_DATE"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "DERIVED_EMPLOYEE_LAST_CHECK_DATE"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "DERIVED_EMPLOYEE_LAST_WORKED_DATE"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "DERIVED_EMPLOYEE_TERMINATE_DATE"
	type = "VARCHAR(16777216)"
	nullable = true
}
