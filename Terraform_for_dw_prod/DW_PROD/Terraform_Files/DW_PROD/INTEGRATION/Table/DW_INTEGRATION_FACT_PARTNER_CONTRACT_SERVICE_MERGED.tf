resource "snowflake_table" "DW_INTEGRATION_FACT_PARTNER_CONTRACT_SERVICE_MERGED" {
	database = "DW_${var.SF_ENVIRONMENT}"
	schema = "INTEGRATION"
	name = "FACT_PARTNER_CONTRACT_SERVICE_MERGED"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DW_PROD.INTEGRATION.FACT_PARTNER_CONTRACT_SERVICE_MERGED
