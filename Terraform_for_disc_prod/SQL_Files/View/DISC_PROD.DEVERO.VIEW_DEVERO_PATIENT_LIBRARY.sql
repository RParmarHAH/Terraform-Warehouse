create or replace view DISC_PROD.DEVERO.VIEW_DEVERO_PATIENT_LIBRARY(
	PATIENT_ID,
	AGENCY_ID,
	ACTIVE,
	DATE_MODIFIED,
...
SELECT DISTINCT
    ...
    FROM DISC_PROD.DEVERO.HIST_DEVERO_PATIENT_LIBRARY PL
...
--SELECT MAX(DATE(ETL_LAST_UPDATED_DATE)) FROM DISC_PROD.DEVERO.HIST_DEVERO_PATIENT_LIBRARY),DATE(GETDATE()))
)
SELECT  PATIENT_ID
        , AGENCY_ID
        , ACTIVE
