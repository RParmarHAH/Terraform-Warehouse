create or replace view DISC_PROD.DEVERO.VIEW_DEVERO_PATIENT_PROFILE(
	PATIENT_CODE,
	CHART_NUMBER,
...
(
	SELECT FORM_ID
		...
		FROM DISC_PROD.DEVERO.HIST_DEVERO_PATIENT_PROFILE 
...
--SELECT MAX(DATE(ETL_LAST_UPDATED_DATE)) FROM DISC_PROD.DEVERO.HIST_DEVERO_PATIENT_PROFILE)
);