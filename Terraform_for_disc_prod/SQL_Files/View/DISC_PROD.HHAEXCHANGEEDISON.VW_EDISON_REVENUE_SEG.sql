create or replace view DISC_PROD.HHAEXCHANGEEDISON.VW_EDISON_REVENUE_SEG(
	VISITID,
	CONTRACTID,
	SERVICECODEID,
...
WITH VW_EDISON_REVENUE_SEG AS (
    ...
    FROM (
        ...
        LEFT JOIN DISC_PROD.HHAEXCHANGEEDISON.OFFICE_OFFICES_REPL OFC ON OFC.OFFICEID = V.OFFICEID --RSUTHAR CHANGE Disc_dev TO Disc_prod
