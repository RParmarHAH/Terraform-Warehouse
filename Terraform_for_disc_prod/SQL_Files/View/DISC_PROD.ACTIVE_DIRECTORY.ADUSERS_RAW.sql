create or replace view DISC_PROD.ACTIVE_DIRECTORY.ADUSERS_RAW(
...
FROM @DISC_PROD.Stage.AWSAZSTAGEPROD/ActiveDirectory/ADExport_05-16-2022.csv (file_format => DISC_PROD.STAGE.CSV_Format) a ; -- changed STAGE/file_format FOR AWS Migration RSUTHAR,KDHOKAI