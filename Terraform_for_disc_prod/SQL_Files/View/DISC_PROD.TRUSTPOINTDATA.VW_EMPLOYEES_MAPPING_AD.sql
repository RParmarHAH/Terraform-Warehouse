create or replace view DISC_PROD.TRUSTPOINTDATA.VW_EMPLOYEES_MAPPING_AD(
	SSN,
	EMPLOYEE_ID,
	FIRST_NAME,
	LAST_NAME,
...
FROM @DISC_PROD.STAGE.AZSTAGEPROD/TRUSTPOINT_EMP_MAPPING/Account (FILE_FORMAT => DW_PROD.PUBLIC.CSV_FORMAT_TEST_JP) WP 
);