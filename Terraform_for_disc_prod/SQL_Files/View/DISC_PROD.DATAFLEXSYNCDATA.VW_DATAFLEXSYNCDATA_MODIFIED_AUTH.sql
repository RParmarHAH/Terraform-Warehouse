create or replace view DISC_PROD.DATAFLEXSYNCDATA.VW_DATAFLEXSYNCDATA_MODIFIED_AUTH(
	MAXRN,
	RN,
	DBNAME,
	CLIENTNUMBER,
...
FROM  DW_PROD.HAH.FACT_VISIT WHERE source_system_id=3 GROUP BY 1,2,3
)
,CURRENT_AUTH AS (
