create or replace view DISC_PROD.DATAFLEXSYNCDATA.VW_DATAFLEXSYNCDATA_ALL_AUTH(
	DBNAME,
	CLIENTNUMBER,
	CONTRACTCODE,
	AUTH_START_DATE,
	...
	AUTH_MONTHLY_OLD,
	AUTHTYPE,
	CLIENT_BEGIN_SERVICE,
	CLIENT_END_SERVICE,
	DERIVED_AUTH_START_DATE,
	DERIVED_AUTH_END_DATE,
	AUTH_DAYS,
	ONHOLDSTARTDATE,
	ONHOLDENDDATE,
	PERIOD_ONHOLD_BEGIN_DATE,
	PERIOD_ONHOLD_END_DATE,
	ONHOLD_DAYS,
	DERIVED_AUTH_DAYS_WOH,
	PERIOD_HOURS_AUTHORIZED,
	PERIOD_HOURS_AUTHORIZED_WOH,
	PERIOD_HOURS_AUTHORIZED_MAX
) as(
(WITH DATA AS (
 ...
 SELECT  ROW_NUMBER() OVER(PARTITION BY DBNAME,CLIENTNUMBER,CONTRACTCODE ORDER BY DT,BEGINSERVICEDATE,ENDSERVICEDATE ASC) AS SEQNO,* FROM
	(SELECT DISTINCT DBNAME,CLIENTNUMBER,CONTRACTCODE,BEGINSERVICEDATE,ENDSERVICEDATE, NEW::date AS DT
 	 ...
 	 (SELECT DISTINCT DBNAME,CLIENTNUMBER,CONTRACTCODE,BEGINSERVICEDATE,ENDSERVICEDATE,WEEKLYMAXHOURS,MONTHLYMAXHOURS,OLDAUTHORIZEDHOURS,DATECHANGED
 	  ...
 	  FROM DISC_PROD.DATAFLEXSYNCDATA.HIST_DFCLIENTCONTRACTS WHERE ( 
