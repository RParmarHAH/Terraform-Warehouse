CREATE OR REPLACE TABLE DISC_PROD.CLEARCARE.HIST_EMPLOYMENT_SCREENING_ESVENDORACCOUNT (
	...
	VENDOR_DATA VARCHAR(16383),
	IS_AUTHORIZATION_ENABLED BOOLEAN,
	SHOW_REPORT_STATUS BOOLEAN,
	SHOW_AUDIT_LINK BOOLEAN,
