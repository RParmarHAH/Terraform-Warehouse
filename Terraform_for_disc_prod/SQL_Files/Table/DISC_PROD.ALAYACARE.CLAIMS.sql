CREATE OR REPLACE TABLE DISC_PROD.ALAYACARE.CLAIMS (
	...
	INVOICE_SENT_DATE TIMESTAMP_NTZ(9),
	BILLING_INCREMENT NUMBER(38,0),
	BANK_SUM NUMBER(13,2),
	VISIT_QTY_HOURS NUMBER(13,2),
	VISIT_QTY NUMBER(13,2)
);