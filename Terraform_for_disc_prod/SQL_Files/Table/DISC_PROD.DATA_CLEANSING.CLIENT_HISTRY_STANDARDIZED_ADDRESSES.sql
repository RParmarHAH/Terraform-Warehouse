CREATE OR REPLACE TABLE DISC_PROD.DATA_CLEANSING.CLIENT_HISTRY_STANDARDIZED_ADDRESSES (
	SOURCE_SYSTEM_ID VARCHAR(16777216) NOT NULL,
	SYSTEM_CODE VARCHAR(16777216) NOT NULL,
	CLIENT_NUMBER VARCHAR(16777216) NOT NULL,
	FIRST_NAME VARCHAR(16777216) COMMENT 'First name of client',
	LAST_NAME VARCHAR(16777216) COMMENT 'Last name of client',
