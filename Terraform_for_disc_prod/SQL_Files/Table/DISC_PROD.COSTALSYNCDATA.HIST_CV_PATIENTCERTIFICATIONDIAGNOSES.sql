CREATE OR REPLACE TABLE DISC_PROD.COSTALSYNCDATA.HIST_CV_PATIENTCERTIFICATIONDIAGNOSES (
	...
	CERT_TRAN_NUMBER VARCHAR(11) NOT NULL,
	DIAGNOSIS_SEQUENCE NUMBER(19,5) NOT NULL,
	ICD_CODE VARCHAR(9),
