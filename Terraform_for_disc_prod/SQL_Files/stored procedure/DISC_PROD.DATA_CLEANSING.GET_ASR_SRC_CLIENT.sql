CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_ASR_SRC_CLIENT("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
FROM DISC_PROD.ASR.VW_ASR_CUSTOMERS AS cust
LEFT JOIN DW_PROD.HAH.DIM_GEOGRAPHY GEO ON TRIM(cust.POSTALCODE) = GEO.ZIP_CODE
LEFT JOIN DISC_PROD.ASR.ASR_VISITS VI ON VI.CustomerID = cust.CUSTOMERID
