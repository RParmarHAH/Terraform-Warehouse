CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_ZENDESK_SRC_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
USING
(SELECT *  FROM  DISC_PROD.DATA_CLEANSING.EMPLOYEE_SRC_ZENDESK_ATTRIBUTES) AS src
