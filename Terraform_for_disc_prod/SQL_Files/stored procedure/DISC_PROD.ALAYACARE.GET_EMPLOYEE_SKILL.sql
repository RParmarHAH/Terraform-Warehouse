CREATE OR REPLACE PROCEDURE DISC_PROD.ALAYACARE.GET_EMPLOYEE_SKILL()
...
BEGIN
    ...
    INSERT OVERWRITE INTO ALAYACARE.EMPLOYEE_SKILL (
        ...
        FROM ALAYACARE_PRODUCTION."5C3EE5FE-45A5-4DA7-A35B-BD7CDAFE3548".SHARED_EMPLOYEE_SKILL;
