CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_CLEARCARE_SRC_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
SELECT DISTINCT 
 ...
 FROM DISC_PROD.CLEARCARE.VM_CAREGIVER_CAREGIVER AS PR 
 LEFT JOIN DISC_PROD.CLEARCARE.profile_patient_agencylocation AS EM ON PR.CAREGIVER_ID = EM.CAREGIVER_ID
 LEFT JOIN DISC_PROD.CLEARCARE.carelogs_carelog CC ON PR.caregiver_id = CC.CAREGIVER_ID
