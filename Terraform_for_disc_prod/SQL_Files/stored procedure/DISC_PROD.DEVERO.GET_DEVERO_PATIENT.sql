CREATE OR REPLACE PROCEDURE DISC_PROD.DEVERO.GET_DEVERO_PATIENT("TASKKEY" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS ' 
--*****************************************************************************************************************************
-- NAME:  DISC_PROD.DEVERO.GET_DEVERO_PATIENT 
--
...
BEGIN 
    ...
    --ViewSQL
    CREATE OR REPLACE TABLE DISC_PROD.DEVERO.DEVERO_PATIENT AS (SELECT * FROM DISC_PROD.DEVERO.VIEW_DEVERO_PATIENT );
