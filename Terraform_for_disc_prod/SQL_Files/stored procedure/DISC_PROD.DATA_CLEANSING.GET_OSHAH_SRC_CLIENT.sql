CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_OSHAH_SRC_CLIENT("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
FROM DISC_PROD.HHAEXCHANGEOSHAH.Patients AS pt
LEFT JOIN DISC_PROD.HHAEXCHANGEOSHAH.OFFICE_OFFICES_REPL OFFICE ON pt.OFFICEID = OFFICE.OFFICEID
LEFT JOIN DISC_PROD.HHAEXCHANGEOSHAH.TBLVISITS_REPL AS VISIT ON pt.PatientID = visit.PatientID
