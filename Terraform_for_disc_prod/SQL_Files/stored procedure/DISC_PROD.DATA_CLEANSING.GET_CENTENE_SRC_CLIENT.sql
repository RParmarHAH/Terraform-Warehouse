CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_CENTENE_SRC_CLIENT("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
FROM DISC_PROD.CENTENE.CENTENE_SOURCE_DATA  F 
