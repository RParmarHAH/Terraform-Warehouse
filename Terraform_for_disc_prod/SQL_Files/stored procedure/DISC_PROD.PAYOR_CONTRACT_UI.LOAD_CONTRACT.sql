CREATE OR REPLACE PROCEDURE DISC_PROD.PAYOR_CONTRACT_UI.LOAD_CONTRACT("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
BEGIN
MERGE INTO DISC_PROD.PAYOR_CONTRACT_UI.CONTRACT TGT 
USING APP_DB_PROD.PAYOR_CONTRACT_MAPPING.CONTRACT STAGE 
