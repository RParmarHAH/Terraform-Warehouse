CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_CCSI_SRC_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
FROM DISC_PROD.CCSI.EMPLOYEE1 E
LEFT JOIN DISC_PROD.CCSI.RAWVRFP AS p 
