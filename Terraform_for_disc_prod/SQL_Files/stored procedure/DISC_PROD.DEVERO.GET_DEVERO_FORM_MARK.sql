CREATE OR REPLACE PROCEDURE DISC_PROD.DEVERO.GET_DEVERO_FORM_MARK("TASKKEY" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS ' 
--*****************************************************************************************************************************
-- NAME:  DISC_PROD.DEVERO.GET_DEVERO_FORM_MARK 
--
...
BEGIN 
    ...
    --ViewSQL
    CREATE OR REPLACE TABLE DISC_PROD.DEVERO.DEVERO_FORM_MARK AS (SELECT * FROM DISC_PROD.DEVERO.VIEW_DEVERO_FORM_MARKS );
