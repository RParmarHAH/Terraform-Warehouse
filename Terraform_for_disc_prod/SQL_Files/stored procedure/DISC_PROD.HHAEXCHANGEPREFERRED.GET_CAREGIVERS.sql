CREATE OR REPLACE PROCEDURE DISC_PROD.HHAEXCHANGEPREFERRED.GET_CAREGIVERS("TASKKEY" VARCHAR(16777216))
...
CREATE OR REPLACE TABLE DISC_PROD.HHAEXCHANGEPREFERRED.Caregivers 
 ...
 FROM DISC_PROD.HHAEXCHANGEPREFERRED.Hist_Caregivers P 
...
create OR REPLACE table DISC_PROD.HHAEXCHANGEPREFERRED.Hist_Caregivers CLONE DISC_PROD.HHAEXCHANGEPREFERRED.Caregivers;
------------------------------------------------------------------------------------------------------
 END;
';