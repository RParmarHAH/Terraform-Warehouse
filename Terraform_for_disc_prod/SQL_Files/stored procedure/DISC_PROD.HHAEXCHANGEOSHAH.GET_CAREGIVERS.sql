CREATE OR REPLACE PROCEDURE DISC_PROD.HHAEXCHANGEOSHAH.GET_CAREGIVERS("TASKKEY" VARCHAR(16777216))
...
--*****************************************************************************************************************************
    ...
    BEGIN
        ...
        CREATE OR REPLACE TABLE DISC_PROD.HHAEXCHANGEOSHAH.Caregivers 
         ...
         FROM DISC_PROD.HHAEXCHANGEOSHAH.Hist_Caregivers P 
        ...
        create OR REPLACE table DISC_PROD.HHAEXCHANGEOSHAH.Hist_Caregivers CLONE DISC_PROD.HHAEXCHANGEOSHAH.Caregivers;
------------------------------------------------------------------------------------------------------
  END;
';