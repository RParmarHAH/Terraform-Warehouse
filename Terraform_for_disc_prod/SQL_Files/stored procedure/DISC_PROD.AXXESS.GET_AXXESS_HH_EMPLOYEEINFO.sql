CREATE OR REPLACE PROCEDURE DISC_PROD.AXXESS.GET_AXXESS_HH_EMPLOYEEINFO("TASKKEY" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
--*****************************************************************************************************************************
-- NAME:  DISC_PROD.AXXESS.GET_AXXESS_HH_EMPLOYEEINFO 
--
...
CREATE OR REPLACE TABLE DISC_PROD.AXXESS.AXXESS_HH_EMPLOYEEINFO
 ...
 FROM DISC_PROD.AXXESS.HIST_AXXESS_HH_EMPLOYEEINFO GROUP BY System_Employee_Id )   
 ...
 FROM DISC_PROD.AXXESS.HIST_AXXESS_HH_EMPLOYEEINFO P 
...
create OR REPLACE table DISC_PROD.AXXESS.HIST_AXXESS_HH_EMPLOYEEINFO CLONE DISC_PROD.AXXESS.AXXESS_HH_EMPLOYEEINFO;
