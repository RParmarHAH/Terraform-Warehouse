CREATE OR REPLACE PROCEDURE DISC_PROD.SANDATAEXCHANGE.GET_DFIMPORT_DATAFLEXTIMESHEETS("TASKKEY" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS ' 
--*****************************************************************************************************************************
-- NAME:  DISC_PROD.SanDataExchange.GET_DfImport_DataFlexTimeSheets 
--
