CREATE OR REPLACE PROCEDURE DISC_PROD.HHAEXCHANGEPREFERRED.GET_STAGE_PATIENTS("TASKKEY" VARCHAR(16777216))
...
CREATE OR REPLACE TABLE DISC_PROD.HHAEXCHANGEPREFERRED.stage_Patients
 ...
 FROM DISC_PROD.HHAEXCHANGEPREFERRED.hist_stage_Patients P 
...
create OR REPLACE table DISC_PROD.HHAEXCHANGEPREFERRED.hist_stage_Patients CLONE DISC_PROD.HHAEXCHANGEPREFERRED.stage_Patients;
------------------------------------------------------------------------------------------------------
END;
';