CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_VAULT.LOAD_SAT_EMPLOYEE_SANDATA("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
