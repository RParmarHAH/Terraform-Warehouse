CREATE OR REPLACE PROCEDURE DISC_PROD.HHAEXCHANGEOSHAH.GET_PATIENTS("TASKKEY" VARCHAR(16777216))
...
CREATE OR REPLACE TABLE DISC_PROD.HHAEXCHANGEOSHAH.Patients
 ...
 FROM DISC_PROD.HHAEXCHANGEOSHAH.Hist_Patients P 
...
create OR REPLACE table DISC_PROD.HHAEXCHANGEOSHAH.Hist_Patients CLONE DISC_PROD.HHAEXCHANGEOSHAH.Patients;
------------------------------------------------------------------------------------------------------
END;
';