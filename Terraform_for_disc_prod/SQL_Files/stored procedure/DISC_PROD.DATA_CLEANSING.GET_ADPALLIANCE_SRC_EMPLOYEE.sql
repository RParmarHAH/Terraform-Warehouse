CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_ADPALLIANCE_SRC_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
FROM DISC_PROD.ADP.ALLIANCE_EMPLOYEE GA 
LEFT JOIN  DISC_PROD.GENERATIONSALLIANCE.EMPLOYEE EMP ON GA.EMPLOYEE_SSN = EMP.SOCIALSECURITYNUM 
LEFT JOIN DISC_PROD.ADP.ALLIANCE_PAYROLL SCH ON GA.EMPLOYEE_SSN = SCH.TAX_ID 
