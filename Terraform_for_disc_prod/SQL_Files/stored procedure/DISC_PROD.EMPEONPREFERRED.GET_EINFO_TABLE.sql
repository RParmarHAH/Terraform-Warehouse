CREATE OR REPLACE PROCEDURE DISC_PROD.EMPEONPREFERRED.GET_EINFO_TABLE("TASKKEY" VARCHAR(16777216))
...
CREATE OR REPLACE TABLE DISC_PROD.EmpeonPreferred.EInfo_table 
 ...
 FROM DISC_PROD.EmpeonPreferred.Hist_EInfo_table GROUP BY co, id) 
 ...
 FROM DISC_PROD.EmpeonPreferred.Hist_EInfo_table P 
...
create OR REPLACE table DISC_PROD.EmpeonPreferred.Hist_EInfo_table CLONE DISC_PROD.EmpeonPreferred.EInfo_table;
---------------------------------------------------
   END;
';