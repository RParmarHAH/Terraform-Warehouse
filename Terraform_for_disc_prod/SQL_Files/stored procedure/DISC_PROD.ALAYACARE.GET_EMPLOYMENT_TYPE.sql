CREATE OR REPLACE PROCEDURE DISC_PROD.ALAYACARE.GET_EMPLOYMENT_TYPE()
...
BEGIN
    ...
    INSERT OVERWRITE INTO ALAYACARE.EMPLOYMENT_TYPE (
        ...
        FROM ALAYACARE_PRODUCTION."5C3EE5FE-45A5-4DA7-A35B-BD7CDAFE3548".SHARED_EMPLOYMENT_TYPE;
