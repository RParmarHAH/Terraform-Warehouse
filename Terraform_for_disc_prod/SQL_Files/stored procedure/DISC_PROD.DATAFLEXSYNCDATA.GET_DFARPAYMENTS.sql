CREATE OR REPLACE PROCEDURE DISC_PROD.DATAFLEXSYNCDATA.GET_DFARPAYMENTS("TASKKEY" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS ' 
--*****************************************************************************************************************************
-- NAME:  DISC_PROD.DataFlexSyncData.GET_DfArPayments 
--
...
BEGIN 
    --TargetSQL
    COPY INTO DISC_PROD.DataFlexSyncData.HIST_DfArPayments FROM (SELECT t.$1 AS DbName, t.$2 AS ReferenceNo, t.$3 AS ContractCode, t.$4 AS Period, t.$5 AS SupplementNo, t.$6 AS OfficeNo, t.$7 AS BilledAmount, t.$8 AS HoursBilled, t.$9 AS PaymentAmount, t.$10 AS PaymentDateTime, t.$11 AS AddedDate, t.$12 AS ChangedDate, t.$13 AS Reported, t.$14 AS Code, t.$15 AS AuditNo, t.$16 AS CheckNumber, t.$17 AS PaymentDescription, t.$18 AS CreatedDate, t.$19 AS UpdateBatch, t.$20 AS UpdatedTime, t.$21 AS SYS_CHANGE_VERSION, t.$22 AS SYS_CHANGE_OPERATION, :TaskKey AS ETL_TASK_KEY, :TaskKey AS ETL_INSERTED_TASK_KEY, current_timestamp::TIMESTAMP_NTZ(9) AS ETL_INSERTED_DATE, current_user() AS ETL_INSERTED_BY, current_timestamp::TIMESTAMP_NTZ(9) AS ETL_LAST_UPDATED_DATE, current_user() AS ETL_LAST_UPDATED_BY, DECODE(t.$22,''D'', True, False) AS ETL_DELETED_FLAG FROM @DISC_PROD.STAGE.AWSAZSTAGEPROD/To_Be_Processed/DATAFLEXSYNCDATA/ (PATTERN => ''.*DataFlexSyncData_dbo_DfArPayments.*[.]csv.gz'' , FILE_FORMAT=>DISC_PROD.STAGE.MY_CSV_FORMAT) t);
