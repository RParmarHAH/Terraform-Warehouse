CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_VIVENTIUM_SRC_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
FROM  DISC_PROD.VIVENTIUM.EXPORTEMPLOYEES EM
LEFT JOIN DISC_PROD.viventium.EXPORTCHECKS_UNFLATTEN EC 
