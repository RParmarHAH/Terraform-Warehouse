CREATE OR REPLACE PROCEDURE DISC_PROD.ALAYACARE.GET_EMERGENCY_CONTACT()
...
BEGIN
    ...
    INSERT OVERWRITE INTO ALAYACARE.EMERGENCY_CONTACT (
        ...
        FROM ALAYACARE_PRODUCTION."5C3EE5FE-45A5-4DA7-A35B-BD7CDAFE3548".SHARED_EMERGENCY_CONTACT;
