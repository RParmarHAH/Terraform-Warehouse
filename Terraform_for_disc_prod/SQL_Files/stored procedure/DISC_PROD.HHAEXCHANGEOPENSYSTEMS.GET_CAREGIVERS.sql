CREATE OR REPLACE PROCEDURE DISC_PROD.HHAEXCHANGEOPENSYSTEMS.GET_CAREGIVERS("TASKKEY" VARCHAR(16777216))
...
CREATE OR REPLACE TABLE DISC_PROD.HHAEXCHANGEOPENSYSTEMS.Caregivers 
 ...
 FROM DISC_PROD.HHAEXCHANGEOPENSYSTEMS.Hist_Caregivers P 
...
create OR REPLACE table DISC_PROD.HHAEXCHANGEOPENSYSTEMS.Hist_Caregivers CLONE DISC_PROD.HHAEXCHANGEOPENSYSTEMS.Caregivers;
------------------------------------------------------------------------------------------------------
 END;
';