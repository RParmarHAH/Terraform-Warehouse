CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_GATOR_SRC_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
FROM DISC_PROD.HEALTH_NAVIGATOR.ACCOUNT AS A
INNER JOIN DISC_PROD.HEALTH_NAVIGATOR.RECORDTYPE  r ON r.ID = a.RECORDTYPEID
LEFT JOIN DW_PROD.HAH.DIM_STATE s ON UPPER(s.STATE_NAME) = UPPER(TRIM(a.PERSONMAILINGSTATE))
