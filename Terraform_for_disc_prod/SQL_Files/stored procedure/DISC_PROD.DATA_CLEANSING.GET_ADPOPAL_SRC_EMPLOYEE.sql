CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_ADPOPAL_SRC_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
FROM DISC_PROD.ADP.OPALEMPLOYEE 	EMP
LEFT JOIN DISC_PROD.ADP.OPALPAYROLL PAY
