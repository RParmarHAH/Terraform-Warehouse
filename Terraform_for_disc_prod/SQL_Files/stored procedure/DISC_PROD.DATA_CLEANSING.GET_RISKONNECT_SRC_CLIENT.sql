CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_RISKONNECT_SRC_CLIENT("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
,LOCATION__C
      ...
      LEFT OUTER JOIN DISC_PROD.RISKONNECT.HIERARCHY_NODE H on C.LOCATION__C = H.ID 
      INNER JOIN DISC_PROD.RISKONNECT.PROPERTY P on H.PROPERTY__C = P.ID  WHERE  CONTACT_TYPE__C = ''Client''  QUALIFY IND =1
)
SELECT 
