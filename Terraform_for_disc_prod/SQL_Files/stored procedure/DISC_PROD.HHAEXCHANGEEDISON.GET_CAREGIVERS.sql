CREATE OR REPLACE PROCEDURE DISC_PROD.HHAEXCHANGEEDISON.GET_CAREGIVERS("TASKKEY" VARCHAR(16777216))
...
CREATE OR REPLACE TABLE DISC_PROD.HHAEXCHANGEEDISON.Caregivers 
 ...
 FROM DISC_PROD.HHAEXCHANGEEDISON.Hist_Caregivers P 
...
create OR REPLACE table DISC_PROD.HHAEXCHANGEEDISON.Hist_Caregivers CLONE DISC_PROD.HHAEXCHANGEEDISON.Caregivers;
------------------------------------------------------------------------------------------------------
END;
';