CREATE OR REPLACE PROCEDURE DISC_PROD.ACTIVE_DIRECTORY.ADUSERS_RAW("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
INSERT INTO DISC_PROD.ACTIVE_DIRECTORY.HIST_ADUSERS_RAW
...
FROM @DISC_PROD.Stage.AWSAZSTAGEPROD/ActiveDirectory/ADusers (file_format => DISC_PROD.STAGE.CSV_FORMAT_TRIM_SPACE) a;
';