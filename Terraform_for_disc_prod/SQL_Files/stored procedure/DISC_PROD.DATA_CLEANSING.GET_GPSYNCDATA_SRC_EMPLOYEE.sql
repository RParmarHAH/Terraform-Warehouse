CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_GPSYNCDATA_SRC_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
FROM DISC_PROD.GPSyncData.GPAllEmployeesBase AS e
LEFT JOIN DISC_PROD.GPSyncData.Paystub_Master AS p ON p.EmployeeID= e.Employee_ID AND p.DB = e.DB
