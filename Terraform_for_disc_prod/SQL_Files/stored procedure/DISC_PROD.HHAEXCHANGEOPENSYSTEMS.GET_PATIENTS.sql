CREATE OR REPLACE PROCEDURE DISC_PROD.HHAEXCHANGEOPENSYSTEMS.GET_PATIENTS("TASKKEY" VARCHAR(16777216))
...
CREATE OR REPLACE TABLE DISC_PROD.HHAEXCHANGEOPENSYSTEMS.Patients
 ...
 FROM DISC_PROD.HHAEXCHANGEOPENSYSTEMS.Hist_Patients P 
...
create OR REPLACE table DISC_PROD.HHAEXCHANGEOPENSYSTEMS.Hist_Patients CLONE DISC_PROD.HHAEXCHANGEOPENSYSTEMS.Patients;
------------------------------------------------------------------------------------------------------
END;
';