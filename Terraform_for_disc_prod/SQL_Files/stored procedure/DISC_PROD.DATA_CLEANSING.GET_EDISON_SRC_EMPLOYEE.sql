CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_EDISON_SRC_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
FROM DISC_PROD.HHAEXCHANGEEdison.Caregivers AS car
LEFT JOIN DISC_PROD.HHAEXCHANGEEdison.TBLVISITS_REPL AS VISIT ON car.CaregiverID = visit.CaregiverID
