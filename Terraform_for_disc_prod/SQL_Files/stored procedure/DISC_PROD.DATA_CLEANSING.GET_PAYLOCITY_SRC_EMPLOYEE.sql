CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_PAYLOCITY_SRC_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
FROM DISC_PROD.PAYLOCITY.EMPLOYEE_DETAILS AS  ED
LEFT JOIN DISC_PROD.PAYLOCITY.PAY_STATEMENT_SUMMARY PSS 
