CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_VAULT.LOAD_SAT_EMPLOYEE_GP("STR_ETL_TASK_KEY" VARCHAR(16777216), "STR_CDC_START" VARCHAR(16777216), "STR_CDC_END" VARCHAR(16777216))
...
BEGIN
	        INSERT OVERWRITE INTO DATA_VAULT.HUB_EMPLOYEE
					...
					FROM DISC_PROD.GPSYNCDATA.GPALLEMPLOYEESBASE em
	...
	SELECT CONCAT (''MESSAGE : '',"number of rows inserted",'' Rows Inserted.'') into :return_result FROM TABLE(RESULT_SCAN(LAST_QUERY_ID()));				
	            ...
	            CREATE OR REPLACE TABLE DATA_VAULT.SAT_EMPLOYEE_GP AS 
					SELECT
						...
						, *
					FROM DISC_PROD.GPSYNCDATA.GPALLEMPLOYEESBASE gp;
