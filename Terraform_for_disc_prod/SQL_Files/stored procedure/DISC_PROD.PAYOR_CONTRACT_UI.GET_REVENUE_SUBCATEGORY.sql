CREATE OR REPLACE PROCEDURE DISC_PROD.PAYOR_CONTRACT_UI.GET_REVENUE_SUBCATEGORY("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
BEGIN
MERGE INTO DISC_PROD.PAYOR_CONTRACT_UI.REVENUE_SUBCATEGORY TGT 
USING APP_DB_PROD.PAYOR_CONTRACT_MAPPING.REVENUE_SUBCATEGORY STAGE 
