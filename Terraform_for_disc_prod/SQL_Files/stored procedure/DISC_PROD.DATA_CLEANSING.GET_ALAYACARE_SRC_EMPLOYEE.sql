CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_ALAYACARE_SRC_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
FROM DISC_PROD.Alayacare.Employee AS e
LEFT OUTER JOIN DW_PROD.HAH.DIM_Zip_Code AS z ON z.Zip_Code = e.Profile_Zip
LEFT JOIN DISC_PROD.Alayacare.Visit AS v ON v.Employee_ID = e.Employee_ID
