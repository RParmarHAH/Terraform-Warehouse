CREATE OR REPLACE PROCEDURE DISC_PROD.AXXESS.GET_AXXESS_HH_CLIENTINFO("TASKKEY" VARCHAR(16777216))
RETURNS VARCHAR(16777216)
LANGUAGE SQL
EXECUTE AS OWNER
AS '
--*****************************************************************************************************************************
-- NAME:  DISC_PROD.AXXESS.GET_AXXESS_HH_CLIENTINFO 
--
...
CREATE OR REPLACE TABLE DISC_PROD.AXXESS.AXXESS_HH_CLIENTINFO
 ...
 FROM DISC_PROD.AXXESS.HIST_AXXESS_HH_CLIENTINFO GROUP BY SYSTEM_ID )   
 ...
 FROM DISC_PROD.AXXESS.HIST_AXXESS_HH_CLIENTINFO P 
...
CREATE OR REPLACE table DISC_PROD.AXXESS.HIST_AXXESS_HH_CLIENTINFO CLONE DISC_PROD.AXXESS.AXXESS_HH_CLIENTINFO;	
