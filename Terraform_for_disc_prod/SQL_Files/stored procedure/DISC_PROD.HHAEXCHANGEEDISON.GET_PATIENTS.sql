CREATE OR REPLACE PROCEDURE DISC_PROD.HHAEXCHANGEEDISON.GET_PATIENTS("TASKKEY" VARCHAR(16777216))
...
CREATE OR REPLACE TABLE DISC_PROD.HHAEXCHANGEEDISON.Patients
 ...
 FROM DISC_PROD.HHAEXCHANGEEDISON.Hist_Patients GROUP BY AgencyID, PatientID) 
 ...
 FROM DISC_PROD.HHAEXCHANGEEDISON.Hist_Patients P 
...
create OR REPLACE table DISC_PROD.HHAEXCHANGEEDISON.Hist_Patients CLONE DISC_PROD.HHAEXCHANGEEDISON.Patients;
------------------------------------------------------------------------------------------------------
END;
';