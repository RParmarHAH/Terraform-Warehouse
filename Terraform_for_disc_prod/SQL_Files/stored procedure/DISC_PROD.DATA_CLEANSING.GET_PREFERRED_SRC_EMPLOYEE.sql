CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_PREFERRED_SRC_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
FROM DISC_PROD.HHAEXCHANGEPreferred.Caregivers AS car
LEFT JOIN DISC_PROD.HHAEXCHANGEPreferred.TBLVISITS_REPL AS VISIT ON car.CaregiverID = visit.CaregiverID
LEFT JOIN DISC_PROD.HHAEXCHANGEPreferred.VISITS VI ON VI.MISSEDVISIT = ''N'' AND VI.VISITID = VISIT.VISITID
