CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_GENERATIONSALLIANCE_SRC_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
FROM DISC_PROD.GENERATIONSALLIANCE.EMPLOYEE AS  E
LEFT JOIN DISC_PROD.GENERATIONSALLIANCE.SCHEDULES SCH ON E.SOCIALSECURITYNUM = SCH.SOCIALSECNUM  
