CREATE OR REPLACE PROCEDURE DISC_PROD.ALAYACARE.GET_AUDIT_VISIT_EMPLOYEE_CHANGE()
...
BEGIN
    ...
    INSERT OVERWRITE INTO ALAYACARE.AUDIT_VISIT_EMPLOYEE_CHANGE (
        ...
        FROM ALAYACARE_PRODUCTION."5C3EE5FE-45A5-4DA7-A35B-BD7CDAFE3548".SHARED_AUDIT_VISIT_EMPLOYEE_CHANGE;
