CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_EMPEONPREFERRED_SRC_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
FROM DISC_PROD.EMPEONPREFERRED.EINFO_TABLE EML
LEFT JOIN DISC_PROD.EMPEONPREFERRED.EPAYHIST EP
