CREATE OR REPLACE PROCEDURE DISC_PROD.PAYOR_CONTRACT_UI.LOAD_SERVICE("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
BEGIN
MERGE INTO DISC_PROD.PAYOR_CONTRACT_UI.Service TGT
USING APP_DB_PROD.PAYOR_CONTRACT_MAPPING.Service AS STAGE 
