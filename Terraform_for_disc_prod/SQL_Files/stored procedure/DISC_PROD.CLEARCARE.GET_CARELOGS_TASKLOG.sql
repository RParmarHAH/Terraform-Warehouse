CREATE OR REPLACE PROCEDURE DISC_PROD.CLEARCARE.GET_CARELOGS_TASKLOG("TASKKEY" VARCHAR(16777216))
...
--*****************************************************************************************************************************
-- NAME:  DISC_PROD.ClearCare.GET_carelogs_tasklog 
--
