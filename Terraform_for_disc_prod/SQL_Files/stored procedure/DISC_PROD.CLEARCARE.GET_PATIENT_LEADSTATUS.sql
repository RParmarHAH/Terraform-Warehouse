CREATE OR REPLACE PROCEDURE DISC_PROD.CLEARCARE.GET_PATIENT_LEADSTATUS("TASKKEY" VARCHAR(16777216))
...
--*****************************************************************************************************************************
-- NAME:  DISC_PROD.ClearCare.GET_patient_leadstatus 
--
