CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_ASR_SRC_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
FROM DISC_PROD.ASR.ASR_EMPLOYEES E
LEFT JOIN DW_PROD.HAH.DIM_GEOGRAPHY GEO ON LEFT(TRIM(E.POSTALCODE),5) = GEO.ZIP_CODE
LEFT JOIN DISC_PROD.ASR.ASR_VISITS VI ON E.EMPLOYEEID = VI.EMPLOYEEID
