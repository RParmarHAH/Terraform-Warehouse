CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_MOLINA_SRC_CLIENT("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
FROM DISC_PROD.MOLINA.MOLINA_SOURCE_DATA F
--LEFT JOIN DISC_PROD.MOLINA.MOLINA_IP_CENSUS C ON F.MEDICAID_ID = C.MEDICAIDID 
