CREATE OR REPLACE PROCEDURE DISC_PROD.DATA_CLEANSING.GET_ADPANSWERCARE_SRC_EMPLOYEE("STR_ETL_TASK_KEY" VARCHAR(16777216))
...
FROM DISC_PROD.ADP.VW_ANSWERCARE_EMPLOYEE EML
LEFT JOIN DISC_PROD.ADP.ANSWERCARE_PAYROLL AP
