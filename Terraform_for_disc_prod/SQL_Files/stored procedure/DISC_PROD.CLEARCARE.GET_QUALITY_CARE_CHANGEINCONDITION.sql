CREATE OR REPLACE PROCEDURE DISC_PROD.CLEARCARE.GET_QUALITY_CARE_CHANGEINCONDITION("TASKKEY" VARCHAR(16777216))
...
--*****************************************************************************************************************************
-- NAME:  DISC_PROD.ClearCare.GET_quality_care_changeincondition 
--
