CREATE OR REPLACE PROCEDURE DISC_PROD.CLEARCARE.GET_RECEIVABLES_PREPAYMENTDESIGNATION("TASKKEY" VARCHAR(16777216))
...
--*****************************************************************************************************************************
-- NAME:  DISC_PROD.ClearCare.GET_receivables_prepaymentdesignation 
--
