resource "snowflake_table" "DISC_HHAEXCHANGEOSHAH_OFFICE_OFFICES_REPL_28" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "HHAEXCHANGEOSHAH"
	name = "OFFICE_OFFICES_REPL_28"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.HHAEXCHANGEOSHAH.OFFICE_OFFICES_REPL_28
