resource "snowflake_table" "DISC_HHAEXCHANGEOSHAH_TBLINVOICEDETAILS_REPL_27" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "HHAEXCHANGEOSHAH"
	name = "TBLINVOICEDETAILS_REPL_27"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.HHAEXCHANGEOSHAH.TBLINVOICEDETAILS_REPL_27
