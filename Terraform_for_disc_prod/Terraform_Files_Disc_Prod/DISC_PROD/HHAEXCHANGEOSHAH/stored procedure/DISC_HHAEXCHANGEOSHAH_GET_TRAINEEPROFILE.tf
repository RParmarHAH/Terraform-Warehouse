resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_TRAINEEPROFILE" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_TraineeProfile 
--
