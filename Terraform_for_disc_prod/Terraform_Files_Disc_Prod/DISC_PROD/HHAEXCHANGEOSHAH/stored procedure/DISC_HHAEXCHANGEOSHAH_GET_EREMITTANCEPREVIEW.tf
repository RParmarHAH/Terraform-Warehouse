resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_EREMITTANCEPREVIEW" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_ERemittancePreview 
--
