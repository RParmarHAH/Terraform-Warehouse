resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_UNTOUCHEDVISITS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_UntouchedVisits 
--
