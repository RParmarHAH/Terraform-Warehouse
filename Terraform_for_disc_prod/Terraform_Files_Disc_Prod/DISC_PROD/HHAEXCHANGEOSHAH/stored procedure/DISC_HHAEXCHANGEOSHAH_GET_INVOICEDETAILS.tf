resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_INVOICEDETAILS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_InvoiceDetails 
--
