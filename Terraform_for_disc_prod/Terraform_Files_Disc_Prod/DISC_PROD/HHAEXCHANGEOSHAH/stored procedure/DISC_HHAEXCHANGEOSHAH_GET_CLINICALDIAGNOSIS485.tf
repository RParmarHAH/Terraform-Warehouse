resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_CLINICALDIAGNOSIS485" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_ClinicalDiagnosis485 
--
