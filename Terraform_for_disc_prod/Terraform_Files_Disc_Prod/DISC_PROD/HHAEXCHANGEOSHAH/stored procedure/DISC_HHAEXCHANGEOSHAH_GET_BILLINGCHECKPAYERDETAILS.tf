resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_BILLINGCHECKPAYERDETAILS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_BillingCheckPayerDetails 
--
