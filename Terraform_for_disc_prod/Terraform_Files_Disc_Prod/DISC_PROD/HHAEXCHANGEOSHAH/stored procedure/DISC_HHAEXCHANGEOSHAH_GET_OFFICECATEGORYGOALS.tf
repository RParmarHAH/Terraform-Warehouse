resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_OFFICECATEGORYGOALS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_OfficeCategoryGoals 
--
