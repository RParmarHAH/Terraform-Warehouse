resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_EVVMOBILECALLLOG" {
	name ="GET_EVVMOBILECALLLOG"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_EVVMobileCallLog 
--
