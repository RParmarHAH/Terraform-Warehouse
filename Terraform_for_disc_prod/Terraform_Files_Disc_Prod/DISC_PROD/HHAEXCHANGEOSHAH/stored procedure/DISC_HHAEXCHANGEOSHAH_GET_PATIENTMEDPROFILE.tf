resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_PATIENTMEDPROFILE" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_PatientMedProfile 
--
