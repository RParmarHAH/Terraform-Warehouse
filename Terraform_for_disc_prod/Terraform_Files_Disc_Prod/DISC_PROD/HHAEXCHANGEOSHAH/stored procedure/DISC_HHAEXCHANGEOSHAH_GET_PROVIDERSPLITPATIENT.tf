resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_PROVIDERSPLITPATIENT" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_ProviderSplitPatient 
--
