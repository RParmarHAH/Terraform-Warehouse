resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_BATCHSUBMISSIONSUMMARY" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_BatchSubmissionSummary 
--
