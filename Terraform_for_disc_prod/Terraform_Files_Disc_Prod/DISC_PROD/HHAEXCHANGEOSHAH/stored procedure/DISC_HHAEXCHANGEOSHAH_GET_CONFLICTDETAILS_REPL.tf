resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_CONFLICTDETAILS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_ConflictDetails_REPL 
--
