resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_CDDOCSUBTYPES" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_cdDocSubTypes 
--
