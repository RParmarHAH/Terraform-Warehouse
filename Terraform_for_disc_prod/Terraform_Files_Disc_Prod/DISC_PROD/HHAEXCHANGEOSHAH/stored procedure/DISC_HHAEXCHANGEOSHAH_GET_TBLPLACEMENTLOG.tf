resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_TBLPLACEMENTLOG" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_TblPlacementLog 
--
