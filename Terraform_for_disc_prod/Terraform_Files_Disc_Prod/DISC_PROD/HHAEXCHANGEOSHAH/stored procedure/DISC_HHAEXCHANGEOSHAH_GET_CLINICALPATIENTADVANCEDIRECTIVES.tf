resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_CLINICALPATIENTADVANCEDIRECTIVES" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_ClinicalPatientAdvanceDirectives 
--
