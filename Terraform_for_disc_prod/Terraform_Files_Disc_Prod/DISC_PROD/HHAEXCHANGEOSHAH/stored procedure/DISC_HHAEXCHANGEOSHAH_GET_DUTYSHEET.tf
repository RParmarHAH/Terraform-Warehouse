resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_DUTYSHEET" {
	name ="GET_DUTYSHEET"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_DutySheet 
--
