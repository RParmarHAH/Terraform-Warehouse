resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_PAYROLL_OTHERCHARGESDETAILS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_Payroll_OtherChargesDetails_REPL 
--
