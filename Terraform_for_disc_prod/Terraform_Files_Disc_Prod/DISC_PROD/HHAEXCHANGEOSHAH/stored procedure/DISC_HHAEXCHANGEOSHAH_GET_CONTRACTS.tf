resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_CONTRACTS" {
	name ="GET_CONTRACTS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_Contracts 
--
