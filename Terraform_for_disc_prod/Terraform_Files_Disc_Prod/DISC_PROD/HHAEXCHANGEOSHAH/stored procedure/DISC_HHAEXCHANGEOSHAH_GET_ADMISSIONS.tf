resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_ADMISSIONS" {
	name ="GET_ADMISSIONS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_Admissions 
--
