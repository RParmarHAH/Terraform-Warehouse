resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_PAYER_REPL" {
	name ="GET_PAYER_REPL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_Payer_REPL 
--
