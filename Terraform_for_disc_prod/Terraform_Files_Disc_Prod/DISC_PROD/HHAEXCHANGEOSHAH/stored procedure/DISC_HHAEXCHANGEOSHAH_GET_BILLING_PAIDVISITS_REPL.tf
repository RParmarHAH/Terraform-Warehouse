resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_BILLING_PAIDVISITS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_Billing_PaidVisits_REPL 
--
