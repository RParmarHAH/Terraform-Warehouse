resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_SERVICETYPE_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_ServiceType_REPL 
--
