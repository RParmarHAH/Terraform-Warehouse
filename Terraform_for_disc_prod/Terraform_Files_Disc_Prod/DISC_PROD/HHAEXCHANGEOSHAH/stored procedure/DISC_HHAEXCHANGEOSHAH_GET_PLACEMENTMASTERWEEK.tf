resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_PLACEMENTMASTERWEEK" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_PlacementMasterWeek 
--
