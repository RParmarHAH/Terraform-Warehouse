resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_PATIENTCUSTOMFIELDS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_PatientCustomFields_REPL 
--
