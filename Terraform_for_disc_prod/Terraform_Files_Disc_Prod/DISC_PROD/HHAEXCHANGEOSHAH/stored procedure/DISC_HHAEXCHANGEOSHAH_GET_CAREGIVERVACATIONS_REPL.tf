resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_CAREGIVERVACATIONS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_CaregiverVacations_REPL 
--
