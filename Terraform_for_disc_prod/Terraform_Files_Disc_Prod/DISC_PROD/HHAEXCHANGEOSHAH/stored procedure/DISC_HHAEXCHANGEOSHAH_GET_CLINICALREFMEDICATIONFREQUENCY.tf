resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_CLINICALREFMEDICATIONFREQUENCY" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_ClinicalRefMedicationFrequency 
--
