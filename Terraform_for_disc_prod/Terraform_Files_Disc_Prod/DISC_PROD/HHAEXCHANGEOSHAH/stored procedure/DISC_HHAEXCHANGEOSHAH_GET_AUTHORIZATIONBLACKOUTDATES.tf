resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_AUTHORIZATIONBLACKOUTDATES" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_AuthorizationBlackoutDates 
--
