resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_PATIENTS" {
	name ="GET_PATIENTS"
...
CREATE OR REPLACE TABLE DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.Patients
 ...
 FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.Hist_Patients P 
...
create OR REPLACE table DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.Hist_Patients CLONE DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.Patients;
------------------------------------------------------------------------------------------------------
END;
