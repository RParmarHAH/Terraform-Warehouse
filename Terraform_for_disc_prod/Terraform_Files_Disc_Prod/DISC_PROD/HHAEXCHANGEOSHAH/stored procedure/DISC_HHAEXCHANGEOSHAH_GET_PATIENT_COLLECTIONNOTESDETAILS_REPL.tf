resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_PATIENT_COLLECTIONNOTESDETAILS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_Patient_CollectionNotesDetails_REPL 
--
