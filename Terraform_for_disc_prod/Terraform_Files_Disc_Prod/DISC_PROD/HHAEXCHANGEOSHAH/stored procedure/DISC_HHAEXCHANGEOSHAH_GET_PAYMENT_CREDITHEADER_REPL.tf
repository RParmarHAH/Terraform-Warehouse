resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_PAYMENT_CREDITHEADER_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_Payment_CreditHeader_REPL 
--
