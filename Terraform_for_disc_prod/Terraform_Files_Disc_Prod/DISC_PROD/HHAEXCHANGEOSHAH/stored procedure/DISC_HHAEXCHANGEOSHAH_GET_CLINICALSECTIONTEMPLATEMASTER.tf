resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_CLINICALSECTIONTEMPLATEMASTER" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_ClinicalSectionTemplateMaster 
--
