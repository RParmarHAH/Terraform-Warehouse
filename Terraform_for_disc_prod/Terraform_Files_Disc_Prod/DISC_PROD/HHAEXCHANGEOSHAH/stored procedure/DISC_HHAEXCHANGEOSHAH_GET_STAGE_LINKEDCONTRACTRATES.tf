resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_STAGE_LINKEDCONTRACTRATES" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_stage_LinkedContractRates 
--
