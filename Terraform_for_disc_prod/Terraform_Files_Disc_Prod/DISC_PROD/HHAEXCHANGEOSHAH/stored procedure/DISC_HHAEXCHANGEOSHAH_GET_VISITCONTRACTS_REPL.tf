resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_VISITCONTRACTS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_VisitContracts_REPL 
--
