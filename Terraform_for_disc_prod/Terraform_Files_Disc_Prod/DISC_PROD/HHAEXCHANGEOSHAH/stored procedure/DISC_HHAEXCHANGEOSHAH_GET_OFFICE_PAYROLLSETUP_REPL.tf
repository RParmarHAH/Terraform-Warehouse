resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_OFFICE_PAYROLLSETUP_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_Office_PayrollSetup_REPL 
--
