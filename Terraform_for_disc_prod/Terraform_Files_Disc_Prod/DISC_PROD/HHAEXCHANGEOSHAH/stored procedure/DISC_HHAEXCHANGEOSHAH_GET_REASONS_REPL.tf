resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_REASONS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_Reasons_REPL 
--
