resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_OVERTIMESUMMARY" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_OverTimeSummary 
--
