resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_REFERRAL" {
	name ="GET_REFERRAL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_Referral 
--
