resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_MILEAGE" {
	name ="GET_MILEAGE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_Mileage 
--
