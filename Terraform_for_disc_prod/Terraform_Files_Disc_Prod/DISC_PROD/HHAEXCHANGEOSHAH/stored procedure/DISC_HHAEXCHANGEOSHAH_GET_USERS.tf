resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_USERS" {
	name ="GET_USERS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_Users 
--
