resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_SALESSTAFF" {
	name ="GET_SALESSTAFF"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_SalesStaff 
--
