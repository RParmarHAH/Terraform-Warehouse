resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_PAYERPATIENTS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_PayerPatients 
--
