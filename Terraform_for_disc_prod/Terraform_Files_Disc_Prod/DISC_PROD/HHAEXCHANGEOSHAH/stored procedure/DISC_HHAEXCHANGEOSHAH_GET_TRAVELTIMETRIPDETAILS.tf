resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_TRAVELTIMETRIPDETAILS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_TravelTimeTripDetails 
--
