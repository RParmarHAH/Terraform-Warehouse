resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_SCHEDULECHANGES" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_ScheduleChanges 
--
