resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_CAREGIVERTRAININGSCHOOLS_REPL" {
	name ="GET_CAREGIVERTRAININGSCHOOLS_REPL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_CaregiverTrainingSchools_REPL 
--
