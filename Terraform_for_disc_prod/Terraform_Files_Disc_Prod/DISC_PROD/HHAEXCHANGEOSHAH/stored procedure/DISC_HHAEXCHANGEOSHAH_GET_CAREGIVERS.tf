resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_CAREGIVERS" {
	name ="GET_CAREGIVERS"
...
--*****************************************************************************************************************************
    ...
    BEGIN
        ...
        CREATE OR REPLACE TABLE DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.Caregivers 
         ...
         FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.Hist_Caregivers P 
        ...
        create OR REPLACE table DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.Hist_Caregivers CLONE DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.Caregivers;
------------------------------------------------------------------------------------------------------
  END;
