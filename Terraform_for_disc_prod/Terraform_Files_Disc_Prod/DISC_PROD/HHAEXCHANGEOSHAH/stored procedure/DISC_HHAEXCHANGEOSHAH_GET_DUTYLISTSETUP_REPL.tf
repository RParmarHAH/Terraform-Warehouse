resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_DUTYLISTSETUP_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_DutyListSetup_REPL 
--
