resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_PAYROLL_BATCH_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_Payroll_Batch_REPL 
--
