resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_STAGE_TBLPOCHEADER_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_stage_TblPOCHeader_REPL 
--
