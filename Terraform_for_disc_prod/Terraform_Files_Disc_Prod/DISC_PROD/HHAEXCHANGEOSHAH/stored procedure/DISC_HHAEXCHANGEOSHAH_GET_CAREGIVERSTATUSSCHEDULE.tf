resource "snowflake_procedure" "DISC_HHAEXCHANGEOSHAH_GET_CAREGIVERSTATUSSCHEDULE" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOSHAH.GET_CaregiverStatusSchedule 
--
