resource "snowflake_procedure" "DISC_GPSYNCDATA_GET_GPALLEMPLOYEESTATETAXBASE" {
	name ="GET_GPALLEMPLOYEESTATETAXBASE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GpSyncData.GET_GpAllEmployeeStateTaxBase 
--
