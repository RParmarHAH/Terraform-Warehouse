resource "snowflake_table" "DISC_GPSYNCDATA_GPALLEMPLOYEESFEDERALTAXBASE" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "GPSYNCDATA"
	name = "GPALLEMPLOYEESFEDERALTAXBASE"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.GPSYNCDATA.GPALLEMPLOYEESFEDERALTAXBASE
