resource "snowflake_procedure" "DISC_CCSI_GET_CLIENTCALL" {
	name ="GET_CLIENTCALL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CCSI.GET_CLIENTCALL 
--
