resource "snowflake_procedure" "DISC_DATA_CLEANSING_GET_JAZZHR_SRC_EMPLOYEE" {
	name ="GET_JAZZHR_SRC_EMPLOYEE"
...
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.JAZZHR.APPLICANTS_DETAILS_ACTIVITIES DA ON AD.ID = DA.APPLICANT_ID 
