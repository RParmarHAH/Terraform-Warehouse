resource "snowflake_procedure" "DISC_DATA_CLEANSING_GET_OPENSYSTEMS_SRC_CLIENT" {
	name ="GET_OPENSYSTEMS_SRC_CLIENT"
...
FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOpenSystems.Stage_Patients AS pt
INNER JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.OFFICE_OFFICES_REPL OFFICE ON pt.OFFICEID = OFFICE.OFFICEID
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOpenSystems.TBLVISITS_REPL AS VISIT ON pt.PatientID = visit.PatientID
