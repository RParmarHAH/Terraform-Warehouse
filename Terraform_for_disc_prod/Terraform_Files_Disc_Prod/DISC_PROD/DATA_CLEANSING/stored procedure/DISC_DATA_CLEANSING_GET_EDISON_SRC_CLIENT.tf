resource "snowflake_procedure" "DISC_DATA_CLEANSING_GET_EDISON_SRC_CLIENT" {
	name ="GET_EDISON_SRC_CLIENT"
...
FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEdison.Patients AS pt
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEdison.TBLVISITS_REPL AS VISIT ON pt.PatientID = visit.PatientID
