resource "snowflake_procedure" "DISC_DATA_CLEANSING_GET_CENTENE_SRC_CLIENT" {
	name ="GET_CENTENE_SRC_CLIENT"
...
BEGIN
    --*****************************************************************************************************************************
-- NAME:  CENTENE_SRC_CLIENT
--
-- PURPOSE: Creates script for data cleanse for CENTENE source
--
-- DEVELOPMENT LOG:
-- DATE        AUTHOR                NOTES:
-- --------    -------------------   -----------------------------------------------------------------------------------------------
...
TRY_TO_DATE(TRIM(F.DATE_OF_BIRTH)) AS Src_Client_DOB,
...
FROM DISC_${var.SF_ENVIRONMENT}.CENTENE.CENTENE_SOURCE_DATA  F 
