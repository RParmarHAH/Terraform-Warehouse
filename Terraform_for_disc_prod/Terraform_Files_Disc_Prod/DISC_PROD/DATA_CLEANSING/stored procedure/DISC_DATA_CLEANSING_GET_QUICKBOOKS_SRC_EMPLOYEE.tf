resource "snowflake_procedure" "DISC_DATA_CLEANSING_GET_QUICKBOOKS_SRC_EMPLOYEE" {
	name ="GET_QUICKBOOKS_SRC_EMPLOYEE"
...
LEFT JOIN DISC_${var.SF_ENVIRONMENT}.TRUSTPOINTDATA.EMPLOYEES EMP
...
LEFT JOIN  DISC_${var.SF_ENVIRONMENT}.ADP.QB_PAYROLL_DATES DATES
