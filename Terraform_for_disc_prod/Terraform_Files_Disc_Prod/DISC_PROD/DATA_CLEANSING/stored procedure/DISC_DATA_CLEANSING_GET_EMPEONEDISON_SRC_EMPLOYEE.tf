resource "snowflake_procedure" "DISC_DATA_CLEANSING_GET_EMPEONEDISON_SRC_EMPLOYEE" {
	name ="GET_EMPEONEDISON_SRC_EMPLOYEE"
...
FROM DISC_${var.SF_ENVIRONMENT}.EMPEONEDISON.EINFO_TABLE emp_m
LEFT JOIN  DISC_${var.SF_ENVIRONMENT}.EMPEONEDISON.EPAYHIST EP
