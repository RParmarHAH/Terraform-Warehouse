resource "snowflake_table" "DISC_DATA_CLEANSING_CLIENT_STD_ATTRIBUTES_20231003" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "DATA_CLEANSING"
	name = "CLIENT_STD_ATTRIBUTES_20231003"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.DATA_CLEANSING.CLIENT_STD_ATTRIBUTES_20231003
