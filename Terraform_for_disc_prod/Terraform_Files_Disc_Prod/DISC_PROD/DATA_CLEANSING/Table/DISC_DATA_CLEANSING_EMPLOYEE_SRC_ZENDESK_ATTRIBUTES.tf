resource "snowflake_table" "DISC_DATA_CLEANSING_EMPLOYEE_SRC_ZENDESK_ATTRIBUTES" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "DATA_CLEANSING"
	name = "EMPLOYEE_SRC_ZENDESK_ATTRIBUTES"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.DATA_CLEANSING.EMPLOYEE_SRC_ZENDESK_ATTRIBUTES
