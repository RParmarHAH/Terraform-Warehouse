resource "snowflake_table" "DISC_DATA_CLEANSING_EMPLOYEE_STG_STANDARDIZED_ADDRESSES" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "DATA_CLEANSING"
	name = "EMPLOYEE_STG_STANDARDIZED_ADDRESSES"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.DATA_CLEANSING.EMPLOYEE_STG_STANDARDIZED_ADDRESSES
