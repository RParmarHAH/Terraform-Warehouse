resource "snowflake_table" "DISC_DATA_CLEANSING_EMPLOYEE_STANDARDIZED_ADDRESSES_TEST" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "DATA_CLEANSING"
	name = "EMPLOYEE_STANDARDIZED_ADDRESSES_TEST"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.DATA_CLEANSING.EMPLOYEE_STANDARDIZED_ADDRESSES_TEST
