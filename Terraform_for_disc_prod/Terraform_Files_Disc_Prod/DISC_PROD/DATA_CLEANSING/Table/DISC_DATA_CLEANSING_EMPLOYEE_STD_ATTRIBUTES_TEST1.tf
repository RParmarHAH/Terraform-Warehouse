resource "snowflake_table" "DISC_DATA_CLEANSING_EMPLOYEE_STD_ATTRIBUTES_TEST1" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "DATA_CLEANSING"
	name = "EMPLOYEE_STD_ATTRIBUTES_TEST1"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.DATA_CLEANSING.EMPLOYEE_STD_ATTRIBUTES_TEST1
