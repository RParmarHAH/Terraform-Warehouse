resource "snowflake_procedure" "DISC_SANDATAIMPORT_GET_SANDATA_PAYMENTDETAILS" {
	name ="GET_SANDATA_PAYMENTDETAILS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.SandataImport.GET_Sandata_PaymentDetails 
--
...
BEGIN 
    --TargetSQL
    COPY INTO DISC_${var.SF_ENVIRONMENT}.SandataImport.HIST_Sandata_PaymentDetails FROM (SELECT t.$1 AS ID, t.$2 AS agencyID, t.$3 AS DetailID, t.$4 AS PaymentID, t.$5 AS InvoiceDetailID, t.$6 AS InvoiceID, t.$7 AS PaymentAmount, t.$8 AS CreatedAt, t.$9 AS UpdatedAt, t.$10 AS HashedRowValues, t.$11 AS BatchId, t.$12 AS SYS_CHANGE_VERSION, t.$13 AS SYS_CHANGE_OPERATION, :TaskKey AS ETL_TASK_KEY, :TaskKey AS ETL_INSERTED_TASK_KEY, current_timestamp::TIMESTAMP_NTZ(9) AS ETL_INSERTED_DATE, current_user() AS ETL_INSERTED_BY, current_timestamp::TIMESTAMP_NTZ(9) AS ETL_LAST_UPDATED_DATE, current_user() AS ETL_LAST_UPDATED_BY, DECODE(t.$13,''D'', True, False) AS ETL_DELETED_FLAG FROM @DISC_${var.SF_ENVIRONMENT}.STAGE.AWSAZSTAGEPROD/To_Be_Processed/SANDATAIMPORT/ (PATTERN => ''.*SandataImport_Sandata_PaymentDetails.*[.]csv.gz'' , FILE_FORMAT=>DISC_${var.SF_ENVIRONMENT}.STAGE.MY_CSV_FORMAT) t);
