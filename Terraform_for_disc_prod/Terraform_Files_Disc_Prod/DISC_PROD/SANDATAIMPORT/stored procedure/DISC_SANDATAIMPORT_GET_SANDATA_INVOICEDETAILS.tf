resource "snowflake_procedure" "DISC_SANDATAIMPORT_GET_SANDATA_INVOICEDETAILS" {
	name ="GET_SANDATA_INVOICEDETAILS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.SandataImport.GET_Sandata_InvoiceDetails 
--
