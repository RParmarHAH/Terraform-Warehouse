resource "snowflake_procedure" "DISC_SANDATAIMPORT_GET_SANDATA_CLIENTADMISSIONS" {
	name ="GET_SANDATA_CLIENTADMISSIONS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.SandataImport.GET_Sandata_ClientAdmissions 
--
