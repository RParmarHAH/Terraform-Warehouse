resource "snowflake_procedure" "DISC_SANDATAIMPORT_GET_SANDATA_SCHEDULESSTAFFS" {
	name ="GET_SANDATA_SCHEDULESSTAFFS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.SandataImport.GET_Sandata_SchedulesStaffs 
--
...
BEGIN 
    --TargetSQL
    COPY INTO DISC_${var.SF_ENVIRONMENT}.SandataImport.HIST_Sandata_SchedulesStaffs FROM (SELECT t.$1 AS ID, t.$2 AS agencyID, t.$3 AS ScheduleID, t.$4 AS StaffSchedHdrID, t.$5 AS StaffSchedDtlID, t.$6 AS StaffID, t.$7 AS EventID, t.$8 AS AuthorizationID, t.$9 AS UnitType, t.$10 AS Status, t.$11 AS Rate, t.$12 AS Amount, t.$13 AS Duration, t.$14 AS sedUnits, t.$15 AS CreatedAt, t.$16 AS UpdatedAt, t.$17 AS HashedRowValues, t.$18 AS BatchId, t.$19 AS Overtime, t.$20 AS SYS_CHANGE_VERSION, t.$21 AS SYS_CHANGE_OPERATION, :TaskKey AS ETL_TASK_KEY, :TaskKey AS ETL_INSERTED_TASK_KEY, current_timestamp::TIMESTAMP_NTZ(9) AS ETL_INSERTED_DATE, current_user() AS ETL_INSERTED_BY, current_timestamp::TIMESTAMP_NTZ(9) AS ETL_LAST_UPDATED_DATE, current_user() AS ETL_LAST_UPDATED_BY, DECODE(t.$21,''D'', True, False) AS ETL_DELETED_FLAG FROM @DISC_${var.SF_ENVIRONMENT}.STAGE.AWSAZSTAGEPROD/To_Be_Processed/SANDATAIMPORT/ (PATTERN => ''.*SandataImport_Sandata_SchedulesStaffs.*[.]csv.gz'' , FILE_FORMAT=>DISC_${var.SF_ENVIRONMENT}.STAGE.MY_CSV_FORMAT) t);
