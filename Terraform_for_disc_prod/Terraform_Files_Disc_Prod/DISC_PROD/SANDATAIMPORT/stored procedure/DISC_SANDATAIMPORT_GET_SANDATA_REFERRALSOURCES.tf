resource "snowflake_procedure" "DISC_SANDATAIMPORT_GET_SANDATA_REFERRALSOURCES" {
	name ="GET_SANDATA_REFERRALSOURCES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.SandataImport.GET_Sandata_ReferralSources 
--
