resource "snowflake_table" "DISC_SANDATAIMPORT_SANDATA_CLIENTADMISSIONS" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "SANDATAIMPORT"
	name = "SANDATA_CLIENTADMISSIONS"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.SANDATAIMPORT.SANDATA_CLIENTADMISSIONS
