resource "snowflake_procedure" "DISC_ZENDESK_GET_TICKET_METRICS_EVENT" {
	name ="GET_TICKET_METRICS_EVENT"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ZENDESK.GET_TICKET_METRICS_EVENT 
--
