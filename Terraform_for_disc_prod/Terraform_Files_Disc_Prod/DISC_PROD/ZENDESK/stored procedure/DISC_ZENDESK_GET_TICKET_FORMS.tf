resource "snowflake_procedure" "DISC_ZENDESK_GET_TICKET_FORMS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ZENDESK.GET_TICKET_FORMS 
--
