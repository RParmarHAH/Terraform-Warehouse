resource "snowflake_procedure" "DISC_ZENDESK_GET_TICKET_CUSTOM_FIELDS_MAPPING" {
	name ="GET_TICKET_CUSTOM_FIELDS_MAPPING"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ZENDESK.GET_TICKET_CUSTOM_FIELDS_MAPPING 
--
