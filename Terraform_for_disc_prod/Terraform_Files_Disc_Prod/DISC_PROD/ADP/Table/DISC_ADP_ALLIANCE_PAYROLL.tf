resource "snowflake_table" "DISC_ADP_ALLIANCE_PAYROLL" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "ADP"
	name = "ALLIANCE_PAYROLL"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.ADP.ALLIANCE_PAYROLL
...
column {
	name = "ADDITIONAL_EARNINGS__1FE_FF_PSL_EE"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__500_SICK_PAY"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__AUT_PERSONAL_AUTO_I"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__BON_AGN_BONUS"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__CAL_AGN_ON_CALL"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__COR_CORP_PTO"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__GRB_GRV_BONUS"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__GRO_GRV_ON_CALL"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__HAB_HHA__BONUS"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__HHL_HOL_ON_CALL"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__MSA_MSK_ON_CALL"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__NOP_STJ_BONUS"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__ONT_MONTHLY_BONUS"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__OT1_OT_ERNGS"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__OTE_HHA_OTHER_EAR"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__OVO_OVERPAYT_OT"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__OVP_OVERPAYMENT"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__PTO_AGN_PTO"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__QUA_BONUS"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__REF_REFERRAL_BONUS"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__SCP_SCORP"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__SI1_SICK_PAY"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__SIP_SICK_PAY"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__STC_STJ_ON_CALL"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__TOH_PTO_HOURLY"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_6_ROTH"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_AIN_AUTO_INSURANCE"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_AUT_PERS_USE_AUTO"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_DEN_DENTAL"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_HS1_HSA_EMPLOYEE"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_HSA_DO_NOT_USE"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_HSO_OFFSET"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_K_401K"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_MHI_HEALTH_INSURANC"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_MIL_MILEAGE"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_MIS_MISCELLANDED"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_PCA_PCA_TRAINING_F"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_SCP_SCORP"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_TB_TB_TEST"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_UNI_UNIFORMS"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_VAC_VOL_ACC_INSURA"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_VLI_VOL_LIFE_INSURA"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_VSP_VISION"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_VST_VOL_ST_DISABILI"
	type = "VARCHAR(16777216)"
	nullable = true
}
