resource "snowflake_table" "DISC_ADP_OPALPAYROLLDETAIL" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "ADP"
	name = "OPALPAYROLLDETAIL"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.ADP.OPALPAYROLLDETAIL
...
column {
	name = "ADDITIONAL_EARNINGS__B_BONUS"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__OR_ORIENTAT"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__PEL_C19_LEAVE"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__PT2_PW_T_AMP_T_OT"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__PTO_PTO"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EARNINGS__PWV_PW_VISIT"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_HOURS__OR_ORIENTAT"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_HOURS__PEL_C19_LEAVE"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_HOURS__PT2_PW_T_AMP_T_OT"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_HOURS__PTO_PTO"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_HOURS__PWV_PW_VISIT"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "DIRECT_DEPOSIT_CK1_CHECKING_1"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "DIRECT_DEPOSIT_CK1_CHKCK1"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "DIRECT_DEPOSIT_CK2_CHECKING_2"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "DIRECT_DEPOSIT_CK3_CHECKING_3"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "DIRECT_DEPOSIT_CK4_CHECKING_4"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "DIRECT_DEPOSIT_CK5_CHECKING_5"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ASLOCAL_4_EMPLOYEE_TAXABLE"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_77_SUPPORT"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_L_LIFE_INSUR"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_OAC_OPT_AD_AMP_D_CHILD"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_OAS_OPT_AD_AMP_D_SPOUSE"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_STD_SHORT_TRM_DISB"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_VAC_OTHER"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_VAC_VAC"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_VHO_OTHER"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "VOLUNTARY_DEDUCTION_VHO_VHO"
	type = "VARCHAR(16777216)"
	nullable = true
}
