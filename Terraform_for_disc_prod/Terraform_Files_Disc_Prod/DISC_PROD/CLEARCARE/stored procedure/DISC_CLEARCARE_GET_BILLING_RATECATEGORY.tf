resource "snowflake_procedure" "DISC_CLEARCARE_GET_BILLING_RATECATEGORY" {
	name ="GET_BILLING_RATECATEGORY"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_billing_ratecategory 
--
