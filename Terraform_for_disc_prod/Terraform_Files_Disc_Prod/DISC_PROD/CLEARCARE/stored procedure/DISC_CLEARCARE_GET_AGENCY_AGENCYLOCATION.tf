resource "snowflake_procedure" "DISC_CLEARCARE_GET_AGENCY_AGENCYLOCATION" {
	name ="GET_AGENCY_AGENCYLOCATION"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_agency_agencylocation 
--
