resource "snowflake_procedure" "DISC_CLEARCARE_GET_AGENCY_AGENCYMATCHINGCRITERIA" {
	name ="GET_AGENCY_AGENCYMATCHINGCRITERIA"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_agency_agencymatchingcriteria 
--
