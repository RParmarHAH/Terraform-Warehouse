resource "snowflake_procedure" "DISC_CLEARCARE_GET_ASSESSMENT_COMMUNITYTASK" {
	name ="GET_ASSESSMENT_COMMUNITYTASK"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_assessment_communitytask 
--
