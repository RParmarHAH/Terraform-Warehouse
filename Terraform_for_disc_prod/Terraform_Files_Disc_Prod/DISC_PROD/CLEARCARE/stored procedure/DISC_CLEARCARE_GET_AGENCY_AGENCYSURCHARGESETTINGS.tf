resource "snowflake_procedure" "DISC_CLEARCARE_GET_AGENCY_AGENCYSURCHARGESETTINGS" {
	name ="GET_AGENCY_AGENCYSURCHARGESETTINGS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_agency_agencysurchargesettings 
--
