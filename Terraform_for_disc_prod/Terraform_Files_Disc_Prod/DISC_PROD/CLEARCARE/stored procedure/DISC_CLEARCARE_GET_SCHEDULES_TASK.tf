resource "snowflake_procedure" "DISC_CLEARCARE_GET_SCHEDULES_TASK" {
	name ="GET_SCHEDULES_TASK"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_schedules_task 
--
