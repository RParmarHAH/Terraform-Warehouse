resource "snowflake_procedure" "DISC_CLEARCARE_GET_CARELOGS_CARELOG" {
	name ="GET_CARELOGS_CARELOG"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_carelogs_carelog 
--
