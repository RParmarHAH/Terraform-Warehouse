resource "snowflake_procedure" "DISC_CLEARCARE_GET_FAMILY_ROOM_FAMILYROOMMESSAGE" {
	name ="GET_FAMILY_ROOM_FAMILYROOMMESSAGE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_family_room_familyroommessage 
--
