resource "snowflake_procedure" "DISC_CLEARCARE_GET_PATIENT_LEADSTATUS" {
	name ="GET_PATIENT_LEADSTATUS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_patient_leadstatus 
--
