resource "snowflake_procedure" "DISC_CLEARCARE_GET_ASSESSMENT_LIFEACTIVITY" {
	name ="GET_ASSESSMENT_LIFEACTIVITY"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_assessment_lifeactivity 
--
