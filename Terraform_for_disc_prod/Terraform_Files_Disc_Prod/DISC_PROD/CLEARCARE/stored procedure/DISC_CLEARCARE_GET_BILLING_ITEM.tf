resource "snowflake_procedure" "DISC_CLEARCARE_GET_BILLING_ITEM" {
	name ="GET_BILLING_ITEM"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_billing_item 
--
