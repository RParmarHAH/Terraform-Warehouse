resource "snowflake_procedure" "DISC_CLEARCARE_GET_SCHEDULES_SHIFTFCFSCLAIMED" {
	name ="GET_SCHEDULES_SHIFTFCFSCLAIMED"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_schedules_shiftfcfsclaimed 
--
