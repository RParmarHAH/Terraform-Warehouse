resource "snowflake_procedure" "DISC_CLEARCARE_GET_WORKERS_COMPENSATION_SAFETYTASKNOTE" {
	name ="GET_WORKERS_COMPENSATION_SAFETYTASKNOTE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_workers_compensation_safetytasknote 
--
