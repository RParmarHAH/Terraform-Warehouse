resource "snowflake_procedure" "DISC_CLEARCARE_GET_CAREGIVER_CAREGIVERSKILLSEDUCATION" {
	name ="GET_CAREGIVER_CAREGIVERSKILLSEDUCATION"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_caregiver_caregiverskillseducation 
--
