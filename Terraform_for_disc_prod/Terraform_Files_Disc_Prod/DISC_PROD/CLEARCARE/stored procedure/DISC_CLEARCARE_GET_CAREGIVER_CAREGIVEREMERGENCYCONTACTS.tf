resource "snowflake_procedure" "DISC_CLEARCARE_GET_CAREGIVER_CAREGIVEREMERGENCYCONTACTS" {
	name ="GET_CAREGIVER_CAREGIVEREMERGENCYCONTACTS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_caregiver_caregiveremergencycontacts 
--
