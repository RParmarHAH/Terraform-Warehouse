resource "snowflake_procedure" "DISC_CLEARCARE_GET_PROFILE_RECEIVABLESBALANCE" {
	name ="GET_PROFILE_RECEIVABLESBALANCE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_profile_receivablesbalance 
--
