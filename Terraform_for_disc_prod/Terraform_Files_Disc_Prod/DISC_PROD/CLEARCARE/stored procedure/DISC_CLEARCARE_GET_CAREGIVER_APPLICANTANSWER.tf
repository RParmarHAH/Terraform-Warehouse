resource "snowflake_procedure" "DISC_CLEARCARE_GET_CAREGIVER_APPLICANTANSWER" {
	name ="GET_CAREGIVER_APPLICANTANSWER"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_caregiver_applicantanswer 
--
