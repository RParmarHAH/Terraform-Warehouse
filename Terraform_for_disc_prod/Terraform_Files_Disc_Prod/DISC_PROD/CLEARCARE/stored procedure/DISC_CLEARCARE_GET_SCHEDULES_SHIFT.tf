resource "snowflake_procedure" "DISC_CLEARCARE_GET_SCHEDULES_SHIFT" {
	name ="GET_SCHEDULES_SHIFT"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_schedules_shift 
--
