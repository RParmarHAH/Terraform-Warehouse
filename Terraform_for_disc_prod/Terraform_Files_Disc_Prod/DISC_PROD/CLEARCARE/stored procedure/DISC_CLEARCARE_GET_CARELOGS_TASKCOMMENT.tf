resource "snowflake_procedure" "DISC_CLEARCARE_GET_CARELOGS_TASKCOMMENT" {
	name ="GET_CARELOGS_TASKCOMMENT"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_carelogs_taskcomment 
--
