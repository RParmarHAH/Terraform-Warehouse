resource "snowflake_procedure" "DISC_CLEARCARE_GET_AUTH_USER" {
	name ="GET_AUTH_USER"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_auth_user 
--
