resource "snowflake_procedure" "DISC_CLEARCARE_GET_BILLING_CLIENTRATESCHEDULE" {
	name ="GET_BILLING_CLIENTRATESCHEDULE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_billing_clientrateschedule 
--
