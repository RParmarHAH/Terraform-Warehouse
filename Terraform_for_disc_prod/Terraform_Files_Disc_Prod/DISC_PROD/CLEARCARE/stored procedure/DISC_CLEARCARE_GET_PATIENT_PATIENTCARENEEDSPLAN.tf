resource "snowflake_procedure" "DISC_CLEARCARE_GET_PATIENT_PATIENTCARENEEDSPLAN" {
	name ="GET_PATIENT_PATIENTCARENEEDSPLAN"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_patient_patientcareneedsplan 
--
