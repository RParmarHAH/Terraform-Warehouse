resource "snowflake_procedure" "DISC_CLEARCARE_GET_REFERRAL_SOURCES_REFERRALSOURCETYPE" {
	name ="GET_REFERRAL_SOURCES_REFERRALSOURCETYPE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_referral_sources_referralsourcetype 
--
