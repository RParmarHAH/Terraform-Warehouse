resource "snowflake_procedure" "DISC_CLEARCARE_GET_PROFILE_PARENTPAYER" {
	name ="GET_PROFILE_PARENTPAYER"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_profile_parentpayer 
--
