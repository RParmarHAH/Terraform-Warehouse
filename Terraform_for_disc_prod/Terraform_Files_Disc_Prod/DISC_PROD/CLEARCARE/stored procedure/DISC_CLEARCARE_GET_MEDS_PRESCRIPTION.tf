resource "snowflake_procedure" "DISC_CLEARCARE_GET_MEDS_PRESCRIPTION" {
	name ="GET_MEDS_PRESCRIPTION"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_meds_prescription 
--
