resource "snowflake_procedure" "DISC_CLEARCARE_GET_PROFILE_UB04REVENUECODE" {
	name ="GET_PROFILE_UB04REVENUECODE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_profile_ub04revenuecode 
--
