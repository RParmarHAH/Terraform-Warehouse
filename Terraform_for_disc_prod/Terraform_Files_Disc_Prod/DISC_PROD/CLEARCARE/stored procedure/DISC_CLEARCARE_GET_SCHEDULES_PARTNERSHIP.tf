resource "snowflake_procedure" "DISC_CLEARCARE_GET_SCHEDULES_PARTNERSHIP" {
	name ="GET_SCHEDULES_PARTNERSHIP"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_schedules_partnership 
--
