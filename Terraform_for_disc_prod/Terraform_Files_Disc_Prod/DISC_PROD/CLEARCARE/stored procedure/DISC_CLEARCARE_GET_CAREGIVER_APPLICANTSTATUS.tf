resource "snowflake_procedure" "DISC_CLEARCARE_GET_CAREGIVER_APPLICANTSTATUS" {
	name ="GET_CAREGIVER_APPLICANTSTATUS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_caregiver_applicantstatus 
--
