resource "snowflake_procedure" "DISC_CLEARCARE_GET_CARELOGS_CARELOGREVISION" {
	name ="GET_CARELOGS_CARELOGREVISION"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_carelogs_carelogrevision 
--
