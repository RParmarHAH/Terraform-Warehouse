resource "snowflake_procedure" "DISC_CLEARCARE_GET_CAREGIVER_CAREGIVERACTIVATIONRECORD" {
	name ="GET_CAREGIVER_CAREGIVERACTIVATIONRECORD"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_caregiver_caregiveractivationrecord 
--
