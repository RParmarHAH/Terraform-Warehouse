resource "snowflake_procedure" "DISC_CLEARCARE_GET_PATIENT_PATIENTREPORTCHECKLIST" {
	name ="GET_PATIENT_PATIENTREPORTCHECKLIST"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_patient_patientreportchecklist 
--
