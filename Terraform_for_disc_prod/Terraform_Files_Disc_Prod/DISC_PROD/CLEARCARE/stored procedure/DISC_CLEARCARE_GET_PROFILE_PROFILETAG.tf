resource "snowflake_procedure" "DISC_CLEARCARE_GET_PROFILE_PROFILETAG" {
	name ="GET_PROFILE_PROFILETAG"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_profile_profiletag 
--
