resource "snowflake_procedure" "DISC_CLEARCARE_GET_EMPLOYMENT_SCREENING_ESVENDORACCOUNT" {
	name ="GET_EMPLOYMENT_SCREENING_ESVENDORACCOUNT"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ClearCare.GET_employment_screening_esvendoraccount 
--
