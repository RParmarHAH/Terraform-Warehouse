resource "snowflake_table" "DISC_CLEARCARE_HIST_AGENCY_AGENCY" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "CLEARCARE"
	name = "HIST_AGENCY_AGENCY"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.CLEARCARE.HIST_AGENCY_AGENCY
...
column {
	name = "INVOICE_SUMMARIZE_COMMUNITY_CARE"
	type = "BOOLEAN"
	nullable = true
}
...
column {
	name = "ECLAIM_CREDENTIALS_VERIFIED"
	type = "BOOLEAN"
	nullable = true
}
...
column {
	name = "ECLAIM_INTEGRATED_PARTNER_HOST"
	type = "VARCHAR(16383)"
	nullable = true
}
...
column {
	name = "ECLAIM_INTEGRATED_PARTNER_PASSWORD"
	type = "VARCHAR(16383)"
	nullable = true
}
...
column {
	name = "ECLAIM_INTEGRATED_PARTNER_USERNAME"
	type = "VARCHAR(16383)"
	nullable = true
}
...
column {
	name = "QOC_AUTOMATION_CLIENT_DEFAULT"
	type = "BOOLEAN"
	nullable = true
}
...
column {
	name = "ALLOW_UNAVAILABILITY_REQUESTS_VIA_MOBILE_APP"
	type = "BOOLEAN"
	nullable = true
}
