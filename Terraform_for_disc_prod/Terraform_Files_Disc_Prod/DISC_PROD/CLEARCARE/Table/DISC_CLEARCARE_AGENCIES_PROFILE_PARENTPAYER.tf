resource "snowflake_table" "DISC_CLEARCARE_AGENCIES_PROFILE_PARENTPAYER" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "CLEARCARE"
	name = "AGENCIES_PROFILE_PARENTPAYER"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.CLEARCARE.AGENCIES_PROFILE_PARENTPAYER
