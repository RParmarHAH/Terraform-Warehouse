resource "snowflake_table" "DISC_CLEARCARE_CAREGIVER_CAREGIVERSKILLSEDUCATION" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "CLEARCARE"
	name = "CAREGIVER_CAREGIVERSKILLSEDUCATION"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.CLEARCARE.CAREGIVER_CAREGIVERSKILLSEDUCATION
