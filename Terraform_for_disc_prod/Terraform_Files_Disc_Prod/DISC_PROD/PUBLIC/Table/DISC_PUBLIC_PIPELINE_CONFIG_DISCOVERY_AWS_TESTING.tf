resource "snowflake_table" "DISC_PUBLIC_PIPELINE_CONFIG_DISCOVERY_AWS_TESTING" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PUBLIC"
	name = "PIPELINE_CONFIG_DISCOVERY_AWS_TESTING"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PUBLIC.PIPELINE_CONFIG_DISCOVERY_AWS_TESTING
