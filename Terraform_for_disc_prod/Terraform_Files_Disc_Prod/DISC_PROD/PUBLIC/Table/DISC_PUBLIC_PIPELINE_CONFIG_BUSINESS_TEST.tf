resource "snowflake_table" "DISC_PUBLIC_PIPELINE_CONFIG_BUSINESS_TEST" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PUBLIC"
	name = "PIPELINE_CONFIG_BUSINESS_TEST"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PUBLIC.PIPELINE_CONFIG_BUSINESS_TEST
