resource "snowflake_table" "DISC_PUBLIC_PIPELINE_DEDUPE_CONFIG_FINAL_AWS_TEST" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PUBLIC"
	name = "PIPELINE_DEDUPE_CONFIG_FINAL_AWS_TEST"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PUBLIC.PIPELINE_DEDUPE_CONFIG_FINAL_AWS_TEST
