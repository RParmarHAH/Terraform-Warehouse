resource "snowflake_procedure" "DISC_HAH_REPORTING_GET_AGING_SUMMARY_CLIENTS" {
	name ="GET_AGING_SUMMARY_CLIENTS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HAH_Reporting.GET_aging_summary_Clients 
--
...
BEGIN 
    --TargetSQL
    COPY INTO DISC_${var.SF_ENVIRONMENT}.HAH_Reporting.HIST_aging_summary_Clients FROM (SELECT t.$1 AS DfDb, t.$2 AS ClientNumber, t.$3 AS LastName, t.$4 AS FirstName, t.$5 AS OfficeNumber, t.$6 AS SupervisorCode, t.$7 AS BillOffice, t.$8 AS Agent, t.$9 AS RegionCode, t.$10 AS SYS_CHANGE_VERSION, t.$11 AS SYS_CHANGE_OPERATION, :TaskKey AS ETL_TASK_KEY, :TaskKey AS ETL_INSERTED_TASK_KEY, current_timestamp::TIMESTAMP_NTZ(9) AS ETL_INSERTED_DATE, current_user() AS ETL_INSERTED_BY, current_timestamp::TIMESTAMP_NTZ(9) AS ETL_LAST_UPDATED_DATE, current_user() AS ETL_LAST_UPDATED_BY, DECODE(t.$11,''D'', True, False) AS ETL_DELETED_FLAG FROM @DISC_${var.SF_ENVIRONMENT}.STAGE.AWSAZSTAGEPROD/To_Be_Processed/HAH_REPORTING/ (PATTERN => ''.*HAH_Reporting_aging_summary_Clients.*[.]csv.gz'' , FILE_FORMAT=>DISC_${var.SF_ENVIRONMENT}.STAGE.MY_CSV_FORMAT) t);
