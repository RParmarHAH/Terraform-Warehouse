resource "snowflake_procedure" "DISC_HAH_REPORTING_GET_AGING_SUMMARY_AMOUNTDATA" {
	name ="GET_AGING_SUMMARY_AMOUNTDATA"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HAH_Reporting.GET_aging_summary_AmountData 
--
