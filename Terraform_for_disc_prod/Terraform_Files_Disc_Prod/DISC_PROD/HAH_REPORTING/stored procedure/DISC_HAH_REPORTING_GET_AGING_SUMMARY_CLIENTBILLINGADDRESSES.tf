resource "snowflake_procedure" "DISC_HAH_REPORTING_GET_AGING_SUMMARY_CLIENTBILLINGADDRESSES" {
	name ="GET_AGING_SUMMARY_CLIENTBILLINGADDRESSES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HAH_Reporting.GET_aging_summary_ClientBillingAddresses 
--
