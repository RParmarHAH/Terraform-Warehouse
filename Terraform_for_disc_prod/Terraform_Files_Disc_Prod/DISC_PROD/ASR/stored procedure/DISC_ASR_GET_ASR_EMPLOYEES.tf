resource "snowflake_procedure" "DISC_ASR_GET_ASR_EMPLOYEES" {
	name ="GET_ASR_EMPLOYEES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.ASR.GET_ASR_EMPLOYEES 
--
