resource "snowflake_table" "DISC_PARADOX_HIST_CANDIDATE_FORM_OH" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PARADOX"
	name = "HIST_CANDIDATE_FORM_OH"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PARADOX.HIST_CANDIDATE_FORM_OH
...
column {
	name = "EMPLOYMENT_HISTORY_1__EMPLOYER_NAME"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "EMPLOYMENT_HISTORY_2__EMPLOYER_NAME"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "EMPLOYMENT_HISTORY_3__EMPLOYER_NAME"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "PROOF_OF_RESIDENCY_HAVE_YOU_BEEN_A_RESIDENT_OF_OHIO_FOR_5_CONSECUTIVE_YEARS"
	type = "VARCHAR(16777216)"
	nullable = true
}
