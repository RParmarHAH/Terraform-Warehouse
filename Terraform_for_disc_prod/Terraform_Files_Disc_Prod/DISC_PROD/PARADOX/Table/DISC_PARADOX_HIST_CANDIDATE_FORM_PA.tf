resource "snowflake_table" "DISC_PARADOX_HIST_CANDIDATE_FORM_PA" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PARADOX"
	name = "HIST_CANDIDATE_FORM_PA"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PARADOX.HIST_CANDIDATE_FORM_PA
...
column {
	name = "INITIAL_COMPETENCY_EXAM_MATH_SUPPLEMENT_28_7"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "INITIAL_COMPETENCY_EXAM_MATH_SUPPLEMENT_8_5"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "INITIAL_COMPETENCY_EXAM_MATH_SUPPLEMENT_8_X_7"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "INITIAL_COMPETENCY_EXAM_MATH_SUPPLEMENT_21_7"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "INITIAL_COMPETENCY_EXAM_MATH_SUPPLEMENT_7_X_7"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "INITIAL_COMPETENCY_EXAM_MATH_SUPPLEMENT_1000_100"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "INITIAL_COMPETENCY_EXAM_MATH_SUPPLEMENT_49_7_1_2_8"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "INITIAL_COMPETENCY_EXAM_MATH_SUPPLEMENT_17_14"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "INITIAL_COMPETENCY_EXAM_MATH_SUPPLEMENT_8_8_8_8_8"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "INITIAL_COMPETENCY_EXAM_MATH_SUPPLEMENT_8_8_0_8_8_8_0"
	type = "VARCHAR(16777216)"
	nullable = true
}
