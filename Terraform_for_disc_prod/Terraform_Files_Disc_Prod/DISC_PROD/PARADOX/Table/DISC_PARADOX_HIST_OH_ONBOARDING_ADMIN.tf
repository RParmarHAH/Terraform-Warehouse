resource "snowflake_table" "DISC_PARADOX_HIST_OH_ONBOARDING_ADMIN" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PARADOX"
	name = "HIST_OH_ONBOARDING_ADMIN"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PARADOX.HIST_OH_ONBOARDING_ADMIN
...
column {
	name = "ONBOARDING_DOCUMENTS_AUTHORIZATION_OF_CONFIDENTIAL_REFERENCES"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ONBOARDING_DOCUMENTS_EMPLOYMENT_VERIFICATION_I9"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ONBOARDING_DOCUMENTS_HAH_DIRECT_DEPOSIT_FORM"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ONBOARDING_DOCUMENTS_HEP_B_VACCINE_ACKNOWLEDGEMENT_FORM"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ONBOARDING_DOCUMENTS_HANDBOOK"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ONBOARDING_DOCUMENTS_HANDBOOK_SIGN_OFF"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ONBOARDING_DOCUMENTS_ORIENTATION_REVIEW_VERIFICATION"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ONBOARDING_DOCUMENTS_ACKNOWLEDGMENT_OF_HANDBOOK_SIGN_OFF"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ONBOARDING_DOCUMENTS_INCIDENT_REPORT_INVESTIGATION_AND_PROTECTION_POLICY"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ONBOARDING_DOCUMENTS_IT4_FORM"
	type = "VARCHAR(16777216)"
	nullable = true
}
