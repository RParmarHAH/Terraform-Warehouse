resource "snowflake_table" "DISC_PARADOX_CANDIDATE_JOURNEY_STATUS_HISTORY" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PARADOX"
	name = "CANDIDATE_JOURNEY_STATUS_HISTORY"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PARADOX.CANDIDATE_JOURNEY_STATUS_HISTORY
