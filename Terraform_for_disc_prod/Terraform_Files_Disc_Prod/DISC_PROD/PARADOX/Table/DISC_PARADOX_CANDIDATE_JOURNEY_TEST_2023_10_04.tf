resource "snowflake_table" "DISC_PARADOX_CANDIDATE_JOURNEY_TEST_2023_10_04" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PARADOX"
	name = "CANDIDATE_JOURNEY_TEST_2023_10_04"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PARADOX.CANDIDATE_JOURNEY_TEST_2023_10_04
