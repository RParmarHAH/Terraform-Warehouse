resource "snowflake_table" "DISC_PARADOX_CANDIDATE_JOURNEY_FULL_LOAD_TEST_20230808" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PARADOX"
	name = "CANDIDATE_JOURNEY_FULL_LOAD_TEST_20230808"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PARADOX.CANDIDATE_JOURNEY_FULL_LOAD_TEST_20230808
