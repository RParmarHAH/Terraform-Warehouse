resource "snowflake_table" "DISC_PARADOX_HIST_CANDIDATE_FORM_MO_BACKUP_20230907" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PARADOX"
	name = "HIST_CANDIDATE_FORM_MO_BACKUP_20230907"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PARADOX.HIST_CANDIDATE_FORM_MO_BACKUP_20230907
...
column {
	name = "PROOF_OF_RESIDENCY_HAVE_YOU_BEEN_A_RESIDENT_OF_MISSOURI_FOR_2_CONSECUTIVE_YEARS"
	type = "VARCHAR(16777216)"
	nullable = true
}
