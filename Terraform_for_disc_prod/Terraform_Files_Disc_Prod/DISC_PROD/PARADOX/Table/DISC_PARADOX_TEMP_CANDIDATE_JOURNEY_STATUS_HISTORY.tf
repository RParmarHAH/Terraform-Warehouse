resource "snowflake_table" "DISC_PARADOX_TEMP_CANDIDATE_JOURNEY_STATUS_HISTORY" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PARADOX"
	name = "TEMP_CANDIDATE_JOURNEY_STATUS_HISTORY"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PARADOX.TEMP_CANDIDATE_JOURNEY_STATUS_HISTORY
