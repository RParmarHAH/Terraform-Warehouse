resource "snowflake_table" "DISC_PARADOX_HIST_IN_ADAPTIVE_ONBOARDING_ADMIN" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PARADOX"
	name = "HIST_IN_ADAPTIVE_ONBOARDING_ADMIN"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PARADOX.HIST_IN_ADAPTIVE_ONBOARDING_ADMIN
...
column {
	name = "ONBOARDING_DOCUMENTS_AUTHORIZATION_FOR_CONFIDENTIAL_REFERENCE"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ONBOARDING_DOCUMENTS_W4_FEDERAL"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ONBOARDING_DOCUMENTS_IN_STATE_TAX"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ONBOARDING_DOCUMENTS_ADAPTIVE_HANDBOOK"
	type = "VARCHAR(16777216)"
	nullable = true
}
