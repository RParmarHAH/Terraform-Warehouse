resource "snowflake_table" "DISC_PARADOX_HIST_GA_ONBOARDING_ADMIN_BACKUP_20230907" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PARADOX"
	name = "HIST_GA_ONBOARDING_ADMIN_BACKUP_20230907"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PARADOX.HIST_GA_ONBOARDING_ADMIN_BACKUP_20230907
...
column {
	name = "CODE_OF_CONDUCT_CODE_OF_CONDUCT"
	type = "VARCHAR(16777216)"
	nullable = true
}
