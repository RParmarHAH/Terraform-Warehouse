resource "snowflake_table" "DISC_PARADOX_IN_ADAPTIVE_ONBOARDING_ADMIN" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PARADOX"
	name = "IN_ADAPTIVE_ONBOARDING_ADMIN"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PARADOX.IN_ADAPTIVE_ONBOARDING_ADMIN
