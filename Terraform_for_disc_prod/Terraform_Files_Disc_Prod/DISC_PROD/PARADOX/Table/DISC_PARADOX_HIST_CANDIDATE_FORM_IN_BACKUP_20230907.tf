resource "snowflake_table" "DISC_PARADOX_HIST_CANDIDATE_FORM_IN_BACKUP_20230907" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PARADOX"
	name = "HIST_CANDIDATE_FORM_IN_BACKUP_20230907"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PARADOX.HIST_CANDIDATE_FORM_IN_BACKUP_20230907
