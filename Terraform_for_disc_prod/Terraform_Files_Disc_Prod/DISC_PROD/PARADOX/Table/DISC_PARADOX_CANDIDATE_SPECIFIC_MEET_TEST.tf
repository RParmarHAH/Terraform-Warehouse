resource "snowflake_table" "DISC_PARADOX_CANDIDATE_SPECIFIC_MEET_TEST" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PARADOX"
	name = "CANDIDATE_SPECIFIC_MEET_TEST"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PARADOX.CANDIDATE_SPECIFIC_MEET_TEST
