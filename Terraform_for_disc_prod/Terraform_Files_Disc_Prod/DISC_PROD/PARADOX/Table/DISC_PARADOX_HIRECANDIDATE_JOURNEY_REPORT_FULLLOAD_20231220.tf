resource "snowflake_table" "DISC_PARADOX_HIRECANDIDATE_JOURNEY_REPORT_FULLLOAD_20231220" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PARADOX"
	name = "HIRECANDIDATE_JOURNEY_REPORT_FULLLOAD_20231220"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PARADOX.HIRECANDIDATE_JOURNEY_REPORT_FULLLOAD_20231220
