resource "snowflake_table" "DISC_PARADOX_HIST_GA_ONBOARDING_DIRECT_CARE" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PARADOX"
	name = "HIST_GA_ONBOARDING_DIRECT_CARE"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PARADOX.HIST_GA_ONBOARDING_DIRECT_CARE
...
column {
	name = "JOB_DESCRIPTION_PLEASE_REVIEW_AND_ACCEPT_THE_JOB_REQUIREMENTS"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "CONSENT_FOR_FINGERPRINT__BACKGROUND_CHECK_PRIVACY_RIGHTS_AND_CONSENT_FOR_FINGERPRINT_BACKGROUND_CHECK"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "CONSENT_FOR_FINGERPRINT__BACKGROUND_CHECK_DRIVERS_LICENSE_OR_STATE_ID"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "CONSENT_FOR_FINGERPRINT__BACKGROUND_CHECK_SOCIAL_SECURITY_CARD"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ACKNOWLEDGEMENT_OF_INSURANCE_ACKNOWLEDGEMENT_OF_INSURANCE"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "CLIENT_RIGHTS__RESPONSIBILITIES_I_CONSENT_TO_HELP_AT_HOME_COMMUNICATING_WITH_ME_DURING_MY_EMPLOYMENT_USING_THE_PERSONAL_CONTACT_INFORMATION_I_PROVIDED"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "EMPLOYEE_HANDBOOK_EMPLOYEE_HANDBOOK"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "EMPLOYEE_HANDBOOK_HAH_CODE_OF_CONDUCT"
	type = "VARCHAR(16777216)"
	nullable = true
}
