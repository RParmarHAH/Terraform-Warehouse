resource "snowflake_table" "DISC_PARADOX_GA_ONBOARDING_ADMIN_BACKUP_20230907" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PARADOX"
	name = "GA_ONBOARDING_ADMIN_BACKUP_20230907"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PARADOX.GA_ONBOARDING_ADMIN_BACKUP_20230907
