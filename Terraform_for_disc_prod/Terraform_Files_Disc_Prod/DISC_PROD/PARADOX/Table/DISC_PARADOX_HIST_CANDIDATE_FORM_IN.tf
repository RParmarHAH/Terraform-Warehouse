resource "snowflake_table" "DISC_PARADOX_HIST_CANDIDATE_FORM_IN" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PARADOX"
	name = "HIST_CANDIDATE_FORM_IN"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PARADOX.HIST_CANDIDATE_FORM_IN
...
column {
	name = "REFERENCES_PHONE_NUMBER_2"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "REFERENCES_RELATIONSHIP_2"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "BACKGROUND_CHECK_CONSENT_FORM_BACKGROUND_CHECK_CONSENT_FORM"
	type = "VARCHAR(16777216)"
	nullable = true
}
