resource "snowflake_table" "DISC_PARADOX_HIST_CANDIDATE_FORM_IN_ADAPTIVE" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PARADOX"
	name = "HIST_CANDIDATE_FORM_IN_ADAPTIVE"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PARADOX.HIST_CANDIDATE_FORM_IN_ADAPTIVE
...
column {
	name = "EMPLOYMENT_HISTORY_1__EMPLOYMENT_NAME"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "EMPLOYMENT_HISTORY_2__EMPLOYMENT_NAME"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "EMPLOYMENT_HISTORY_3__EMPLOYMENT_NAME"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ONBOARDINGBACKGROUND_CHECK_REQUIREMENTS_BACKGROUND_CHECK_CONSENT_FORM"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "PROOF_OF_RESIDENCY_HAVE_YOU_BEEN_A_RESIDENT_OF_INDIANA_FOR_2_CONSECUTIVE_YEARS"
	type = "VARCHAR(16777216)"
	nullable = true
}
