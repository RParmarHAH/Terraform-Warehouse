resource "snowflake_table" "DISC_PARADOX_HIST_IN_ONBOARDING_DIRECT_CARE" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PARADOX"
	name = "HIST_IN_ONBOARDING_DIRECT_CARE"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PARADOX.HIST_IN_ONBOARDING_DIRECT_CARE
