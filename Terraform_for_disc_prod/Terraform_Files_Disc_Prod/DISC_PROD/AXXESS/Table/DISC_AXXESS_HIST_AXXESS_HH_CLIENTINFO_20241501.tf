resource "snowflake_table" "DISC_AXXESS_HIST_AXXESS_HH_CLIENTINFO_20241501" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "AXXESS"
	name = "HIST_AXXESS_HH_CLIENTINFO_20241501"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.AXXESS.HIST_AXXESS_HH_CLIENTINFO_20241501
...
column {
	name = "EMERGENCY_TRIAGE_DESCRIPTION"
	type = "VARCHAR(16777216)"
	nullable = true
}
...
column {
	name = "ADDITIONAL_EMERGENCY_PREPAREDNESS_INFORMATION"
	type = "VARCHAR(16777216)"
	nullable = true
}
