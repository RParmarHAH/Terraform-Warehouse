resource "snowflake_table" "DISC_AXXESS_AXXESS_HC_CLIENTINFO_20241501" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "AXXESS"
	name = "AXXESS_HC_CLIENTINFO_20241501"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.AXXESS.AXXESS_HC_CLIENTINFO_20241501
