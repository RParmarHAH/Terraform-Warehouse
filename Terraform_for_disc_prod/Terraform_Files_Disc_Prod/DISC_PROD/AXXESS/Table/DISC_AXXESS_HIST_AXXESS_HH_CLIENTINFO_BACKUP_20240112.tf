resource "snowflake_table" "DISC_AXXESS_HIST_AXXESS_HH_CLIENTINFO_BACKUP_20240112" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "AXXESS"
	name = "HIST_AXXESS_HH_CLIENTINFO_BACKUP_20240112"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.AXXESS.HIST_AXXESS_HH_CLIENTINFO_BACKUP_20240112
