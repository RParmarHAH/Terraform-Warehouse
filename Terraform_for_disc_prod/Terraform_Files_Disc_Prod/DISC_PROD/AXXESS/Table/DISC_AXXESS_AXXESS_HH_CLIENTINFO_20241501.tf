resource "snowflake_table" "DISC_AXXESS_AXXESS_HH_CLIENTINFO_20241501" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "AXXESS"
	name = "AXXESS_HH_CLIENTINFO_20241501"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.AXXESS.AXXESS_HH_CLIENTINFO_20241501
