resource "snowflake_procedure" "DISC_AXXESS_GET_AXXESS_HC_CLIENTINFO" {
	name ="GET_AXXESS_HC_CLIENTINFO"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.AXXESS.GET_AXXESS_HC_CLIENTINFO 
--
...
CREATE OR REPLACE TABLE DISC_${var.SF_ENVIRONMENT}.AXXESS.AXXESS_HC_CLIENTINFO
 ...
 FROM DISC_${var.SF_ENVIRONMENT}.AXXESS.HIST_AXXESS_HC_CLIENTINFO P 
...
CREATE OR REPLACE table DISC_${var.SF_ENVIRONMENT}.AXXESS.HIST_AXXESS_HC_CLIENTINFO CLONE DISC_${var.SF_ENVIRONMENT}.AXXESS.AXXESS_HC_CLIENTINFO;	
