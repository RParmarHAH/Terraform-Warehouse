resource "snowflake_procedure" "DISC_AXXESS_GET_AXXESS_FINANCIALTRANSACTIONS" {
	name ="GET_AXXESS_FINANCIALTRANSACTIONS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.AXXESS.GET_AXXESS_FinancialTransactions 
--
