resource "snowflake_procedure" "DISC_AXXESS_GET_AXXESS_HH_CLIENTINFO" {
	name ="GET_AXXESS_HH_CLIENTINFO"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.AXXESS.GET_AXXESS_HH_CLIENTINFO 
--
...
CREATE OR REPLACE TABLE DISC_${var.SF_ENVIRONMENT}.AXXESS.AXXESS_HH_CLIENTINFO
 ...
 FROM DISC_${var.SF_ENVIRONMENT}.AXXESS.HIST_AXXESS_HH_CLIENTINFO P 
...
CREATE OR REPLACE table DISC_${var.SF_ENVIRONMENT}.AXXESS.HIST_AXXESS_HH_CLIENTINFO CLONE DISC_${var.SF_ENVIRONMENT}.AXXESS.AXXESS_HH_CLIENTINFO;	
