resource "snowflake_procedure" "DISC_AXXESS_GET_AXXESS_BILLINGPERIODS" {
	name ="GET_AXXESS_BILLINGPERIODS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.AXXESS.GET_AXXESS_BILLINGPERIODS 
--
