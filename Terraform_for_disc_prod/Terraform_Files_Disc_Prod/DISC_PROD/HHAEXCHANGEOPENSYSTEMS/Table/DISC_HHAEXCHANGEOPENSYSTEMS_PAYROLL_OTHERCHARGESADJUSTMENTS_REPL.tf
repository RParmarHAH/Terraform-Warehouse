resource "snowflake_table" "DISC_HHAEXCHANGEOPENSYSTEMS_PAYROLL_OTHERCHARGESADJUSTMENTS_REPL" {
    ...
    -- NAME :  DISC_PROD.HHAEXCHANGEOPENSYSTEMS.PAYROLL_OTHERCHARGESADJUSTMENTS_REPL
