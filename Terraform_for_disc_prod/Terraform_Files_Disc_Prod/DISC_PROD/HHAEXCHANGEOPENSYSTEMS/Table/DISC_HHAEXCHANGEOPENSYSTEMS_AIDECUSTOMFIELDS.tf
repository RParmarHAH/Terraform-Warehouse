resource "snowflake_table" "DISC_HHAEXCHANGEOPENSYSTEMS_AIDECUSTOMFIELDS" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "HHAEXCHANGEOPENSYSTEMS"
	name = "AIDECUSTOMFIELDS"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.HHAEXCHANGEOPENSYSTEMS.AIDECUSTOMFIELDS
