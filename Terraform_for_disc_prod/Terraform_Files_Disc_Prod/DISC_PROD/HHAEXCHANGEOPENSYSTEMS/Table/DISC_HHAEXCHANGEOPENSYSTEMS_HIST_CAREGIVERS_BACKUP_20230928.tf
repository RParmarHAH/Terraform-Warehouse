resource "snowflake_table" "DISC_HHAEXCHANGEOPENSYSTEMS_HIST_CAREGIVERS_BACKUP_20230928" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "HHAEXCHANGEOPENSYSTEMS"
	name = "HIST_CAREGIVERS_BACKUP_20230928"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.HHAEXCHANGEOPENSYSTEMS.HIST_CAREGIVERS_BACKUP_20230928
