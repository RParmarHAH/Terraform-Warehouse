resource "snowflake_table" "DISC_HHAEXCHANGEOPENSYSTEMS_CAREGIVERPERMANENTWEEKAVAILABILITY" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "HHAEXCHANGEOPENSYSTEMS"
	name = "CAREGIVERPERMANENTWEEKAVAILABILITY"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.HHAEXCHANGEOPENSYSTEMS.CAREGIVERPERMANENTWEEKAVAILABILITY
