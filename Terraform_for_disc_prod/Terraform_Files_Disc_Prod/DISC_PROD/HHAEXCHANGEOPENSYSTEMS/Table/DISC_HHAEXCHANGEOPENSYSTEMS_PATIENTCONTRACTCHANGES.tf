resource "snowflake_table" "DISC_HHAEXCHANGEOPENSYSTEMS_PATIENTCONTRACTCHANGES" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "HHAEXCHANGEOPENSYSTEMS"
	name = "PATIENTCONTRACTCHANGES"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.HHAEXCHANGEOPENSYSTEMS.PATIENTCONTRACTCHANGES
