resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_TBLVISITS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_tblVisits_REPL 
--
