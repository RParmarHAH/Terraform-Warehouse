resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_UNBILLEDCONFLICTDETAILS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_UnbilledConflictDetails_REPL 
--
