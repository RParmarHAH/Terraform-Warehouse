resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_VISITS" {
	name ="GET_VISITS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_Visits 
--
