resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_PAYROLL_OTHERCHARGESDETAILS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_Payroll_OtherChargesDetails_REPL 
--
