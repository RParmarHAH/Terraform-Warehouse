resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_INREVIEWVISITS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_InReviewVisits 
--
