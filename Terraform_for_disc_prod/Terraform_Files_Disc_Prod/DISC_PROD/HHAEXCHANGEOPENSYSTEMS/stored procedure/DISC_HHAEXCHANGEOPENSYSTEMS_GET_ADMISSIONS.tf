resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_ADMISSIONS" {
	name ="GET_ADMISSIONS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_Admissions 
--
