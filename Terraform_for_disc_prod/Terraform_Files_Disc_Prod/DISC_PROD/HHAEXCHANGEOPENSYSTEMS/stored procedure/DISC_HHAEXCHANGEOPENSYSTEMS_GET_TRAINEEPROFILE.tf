resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_TRAINEEPROFILE" {
	name ="GET_TRAINEEPROFILE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_TraineeProfile 
--
