resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_PATIENTCUSTOMFIELDS_REPL" {
	name ="GET_PATIENTCUSTOMFIELDS_REPL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_PatientCustomFields_REPL 
--
