resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_CLINICALREFMEDICATIONFREQUENCY" {
	name ="GET_CLINICALREFMEDICATIONFREQUENCY"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_ClinicalRefMedicationFrequency 
--
