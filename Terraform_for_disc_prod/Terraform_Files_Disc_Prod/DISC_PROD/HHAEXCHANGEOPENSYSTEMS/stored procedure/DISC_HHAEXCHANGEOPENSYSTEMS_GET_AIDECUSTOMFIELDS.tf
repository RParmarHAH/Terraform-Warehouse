resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_AIDECUSTOMFIELDS" {
	name ="GET_AIDECUSTOMFIELDS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_AideCustomFields 
--
