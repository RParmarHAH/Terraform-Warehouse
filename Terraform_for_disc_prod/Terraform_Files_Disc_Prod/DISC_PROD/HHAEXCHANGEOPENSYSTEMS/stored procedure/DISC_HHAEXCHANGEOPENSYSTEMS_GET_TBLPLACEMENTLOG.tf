resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_TBLPLACEMENTLOG" {
	name ="GET_TBLPLACEMENTLOG"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_TblPlacementLog 
--
