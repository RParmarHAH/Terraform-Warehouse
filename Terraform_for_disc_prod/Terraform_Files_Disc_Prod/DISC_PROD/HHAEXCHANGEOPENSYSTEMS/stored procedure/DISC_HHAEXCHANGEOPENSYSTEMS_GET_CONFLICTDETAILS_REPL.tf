resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_CONFLICTDETAILS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_ConflictDetails_REPL 
--
