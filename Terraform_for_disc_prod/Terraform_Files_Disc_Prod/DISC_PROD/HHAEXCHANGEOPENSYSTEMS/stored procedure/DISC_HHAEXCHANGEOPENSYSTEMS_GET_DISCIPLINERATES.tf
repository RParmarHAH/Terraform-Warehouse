resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_DISCIPLINERATES" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_DisciplineRates 
--
