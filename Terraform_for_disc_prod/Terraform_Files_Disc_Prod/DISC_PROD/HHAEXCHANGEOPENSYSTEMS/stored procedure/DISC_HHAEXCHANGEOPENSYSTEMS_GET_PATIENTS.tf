resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_PATIENTS" {
	name ="GET_PATIENTS"
...
CREATE OR REPLACE TABLE DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.Patients
 ...
 FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.Hist_Patients P 
...
create OR REPLACE table DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.Hist_Patients CLONE DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.Patients;
------------------------------------------------------------------------------------------------------
END;
