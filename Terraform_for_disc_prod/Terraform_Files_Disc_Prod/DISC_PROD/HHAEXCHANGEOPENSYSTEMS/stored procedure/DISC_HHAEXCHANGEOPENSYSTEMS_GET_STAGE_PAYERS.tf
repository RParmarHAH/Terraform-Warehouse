resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_STAGE_PAYERS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_stage_Payers 
--
