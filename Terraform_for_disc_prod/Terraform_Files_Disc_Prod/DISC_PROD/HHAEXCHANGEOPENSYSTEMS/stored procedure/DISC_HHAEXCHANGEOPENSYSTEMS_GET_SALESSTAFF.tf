resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_SALESSTAFF" {
	name ="GET_SALESSTAFF"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_SalesStaff 
--
