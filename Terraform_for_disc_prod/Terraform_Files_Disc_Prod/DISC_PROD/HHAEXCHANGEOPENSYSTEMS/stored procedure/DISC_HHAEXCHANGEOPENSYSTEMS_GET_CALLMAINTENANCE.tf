resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_CALLMAINTENANCE" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_CallMaintenance 
--
