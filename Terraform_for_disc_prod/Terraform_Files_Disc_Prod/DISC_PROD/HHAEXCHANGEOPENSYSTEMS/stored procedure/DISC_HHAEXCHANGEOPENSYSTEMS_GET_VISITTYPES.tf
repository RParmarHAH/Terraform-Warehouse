resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_VISITTYPES" {
	name ="GET_VISITTYPES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_VisitTypes 
--
