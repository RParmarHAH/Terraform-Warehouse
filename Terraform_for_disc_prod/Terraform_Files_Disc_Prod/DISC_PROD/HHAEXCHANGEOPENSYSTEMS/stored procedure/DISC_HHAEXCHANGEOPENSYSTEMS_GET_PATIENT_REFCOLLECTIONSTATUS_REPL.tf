resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_PATIENT_REFCOLLECTIONSTATUS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_Patient_RefCollectionStatus_REPL 
--
