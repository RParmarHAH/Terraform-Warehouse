resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_EVVMOBILECALLLOG" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_EVVMobileCallLog 
--
