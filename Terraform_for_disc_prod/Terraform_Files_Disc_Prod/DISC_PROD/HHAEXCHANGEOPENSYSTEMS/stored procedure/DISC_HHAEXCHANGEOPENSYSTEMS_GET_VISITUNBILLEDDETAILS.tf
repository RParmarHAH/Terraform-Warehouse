resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_VISITUNBILLEDDETAILS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_VisitUnbilledDetails 
--
