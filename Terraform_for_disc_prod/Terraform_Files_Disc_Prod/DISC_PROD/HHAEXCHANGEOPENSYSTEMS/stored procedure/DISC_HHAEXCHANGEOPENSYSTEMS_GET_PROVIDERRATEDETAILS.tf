resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_PROVIDERRATEDETAILS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_ProviderRateDetails 
--
