resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_TRANSACTIONS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_Transactions_REPL 
--
