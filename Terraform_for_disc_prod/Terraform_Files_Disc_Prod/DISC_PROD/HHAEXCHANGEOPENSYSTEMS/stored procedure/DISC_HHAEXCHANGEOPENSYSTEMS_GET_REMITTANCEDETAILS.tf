resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_REMITTANCEDETAILS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_RemittanceDetails 
--
