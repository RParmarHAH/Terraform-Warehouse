resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_VISITCONTRACTS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_VisitContracts_REPL 
--
