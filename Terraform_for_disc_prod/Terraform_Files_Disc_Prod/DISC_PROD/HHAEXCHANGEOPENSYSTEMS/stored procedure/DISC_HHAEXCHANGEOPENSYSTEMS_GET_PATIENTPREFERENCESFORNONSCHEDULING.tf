resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_PATIENTPREFERENCESFORNONSCHEDULING" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_PatientPreferencesForNonScheduling 
--
