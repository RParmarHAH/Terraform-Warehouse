resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_STAGE_TBLPOCDETAIL_REPL" {
	name ="GET_STAGE_TBLPOCDETAIL_REPL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_stage_TblPOCDetail_REPL 
--
