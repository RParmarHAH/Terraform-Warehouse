resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_PHYSICIANS" {
	name ="GET_PHYSICIANS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_Physicians 
--
