resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_MILEAGE" {
	name ="GET_MILEAGE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_Mileage 
--
