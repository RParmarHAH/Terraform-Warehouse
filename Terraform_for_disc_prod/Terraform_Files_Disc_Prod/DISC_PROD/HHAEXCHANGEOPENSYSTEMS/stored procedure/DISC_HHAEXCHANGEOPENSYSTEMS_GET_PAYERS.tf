resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_PAYERS" {
	name ="GET_PAYERS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_Payers 
--
