resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_SCHEDULECHANGES" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_ScheduleChanges 
--
