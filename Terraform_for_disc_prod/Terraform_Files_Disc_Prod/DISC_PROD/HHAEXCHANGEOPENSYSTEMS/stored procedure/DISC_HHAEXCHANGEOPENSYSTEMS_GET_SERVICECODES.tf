resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_SERVICECODES" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_ServiceCodes 
--
