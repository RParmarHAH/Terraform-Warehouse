resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_STAGE_PATIENTADDRESSES" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_stage_PatientAddresses 
--
