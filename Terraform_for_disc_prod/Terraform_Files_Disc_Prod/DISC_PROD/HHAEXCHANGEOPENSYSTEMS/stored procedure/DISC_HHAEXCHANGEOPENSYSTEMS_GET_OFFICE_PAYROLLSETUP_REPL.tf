resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_OFFICE_PAYROLLSETUP_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_Office_PayrollSetup_REPL 
--
