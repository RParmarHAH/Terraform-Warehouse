resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_BILLING_CHECKDETAILS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_Billing_CheckDetails_REPL 
--
