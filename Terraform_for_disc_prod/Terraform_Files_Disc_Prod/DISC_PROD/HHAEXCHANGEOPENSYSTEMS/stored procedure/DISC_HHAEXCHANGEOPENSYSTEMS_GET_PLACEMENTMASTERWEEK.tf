resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_PLACEMENTMASTERWEEK" {
	name ="GET_PLACEMENTMASTERWEEK"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_PlacementMasterWeek 
--
