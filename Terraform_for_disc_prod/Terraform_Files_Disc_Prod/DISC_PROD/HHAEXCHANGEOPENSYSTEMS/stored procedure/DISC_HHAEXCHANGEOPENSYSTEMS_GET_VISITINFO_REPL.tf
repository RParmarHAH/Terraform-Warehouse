resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_VISITINFO_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_VisitInfo_REPL 
--
