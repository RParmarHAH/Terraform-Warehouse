resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_PAYROLL_ADJUSTMENTS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_Payroll_Adjustments_REPL 
--
