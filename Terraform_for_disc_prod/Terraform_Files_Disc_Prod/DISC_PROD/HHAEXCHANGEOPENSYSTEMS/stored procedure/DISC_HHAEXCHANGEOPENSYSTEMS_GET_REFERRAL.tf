resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_REFERRAL" {
	name ="GET_REFERRAL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_Referral 
--
