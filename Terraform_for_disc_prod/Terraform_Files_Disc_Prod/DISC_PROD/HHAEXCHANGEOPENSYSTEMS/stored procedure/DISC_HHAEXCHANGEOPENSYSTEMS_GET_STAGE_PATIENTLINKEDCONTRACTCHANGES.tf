resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_STAGE_PATIENTLINKEDCONTRACTCHANGES" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_stage_PatientLinkedContractChanges 
--
