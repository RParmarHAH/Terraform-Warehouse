resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_TBLPOCDETAIL_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_tblPOCDetail_REPL 
--
