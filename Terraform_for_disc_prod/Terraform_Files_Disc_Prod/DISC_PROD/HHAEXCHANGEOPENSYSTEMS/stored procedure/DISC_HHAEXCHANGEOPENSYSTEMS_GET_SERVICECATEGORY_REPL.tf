resource "snowflake_procedure" "DISC_HHAEXCHANGEOPENSYSTEMS_GET_SERVICECATEGORY_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEOPENSYSTEMS.GET_ServiceCategory_REPL 
--
