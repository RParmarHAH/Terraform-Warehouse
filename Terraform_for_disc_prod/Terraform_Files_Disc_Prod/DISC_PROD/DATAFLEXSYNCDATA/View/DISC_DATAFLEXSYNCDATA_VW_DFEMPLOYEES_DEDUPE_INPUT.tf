resource "snowflake_view" "DISC_DATAFLEXSYNCDATA_VW_DFEMPLOYEES_DEDUPE_INPUT" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "DATAFLEXSYNCDATA"
	name = "VW_DFEMPLOYEES_DEDUPE_INPUT"
	statement = <<-SQL
...
FROM (
	...
	LEFT OUTER JOIN DISC_${var.SF_ENVIRONMENT}.GPSyncData.GPAllEmployeesBase AS gp --RSUTHAR/KDHOKAI - changed DISC_${var.SF_ENVIRONMENT}.GPSyncData.GPAllEmployeesBase TO DISC_${var.SF_ENVIRONMENT}.GPSyncData.GPAllEmployeesBase 
