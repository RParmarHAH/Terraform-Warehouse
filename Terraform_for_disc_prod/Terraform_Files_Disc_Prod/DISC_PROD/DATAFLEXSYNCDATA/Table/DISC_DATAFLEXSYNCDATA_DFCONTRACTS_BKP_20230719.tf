resource "snowflake_table" "DISC_DATAFLEXSYNCDATA_DFCONTRACTS_BKP_20230719" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "DATAFLEXSYNCDATA"
	name = "DFCONTRACTS_BKP_20230719"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.DATAFLEXSYNCDATA.DFCONTRACTS_BKP_20230719
