resource "snowflake_table" "DISC_DATAFLEXSYNCDATA_HIST_DFCLIENTCONTRACTS" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "DATAFLEXSYNCDATA"
	name = "HIST_DFCLIENTCONTRACTS"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.DATAFLEXSYNCDATA.HIST_DFCLIENTCONTRACTS
