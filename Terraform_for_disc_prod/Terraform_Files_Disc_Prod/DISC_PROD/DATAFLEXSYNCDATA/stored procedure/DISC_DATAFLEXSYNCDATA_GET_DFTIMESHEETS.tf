resource "snowflake_procedure" "DISC_DATAFLEXSYNCDATA_GET_DFTIMESHEETS" {
	name ="GET_DFTIMESHEETS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.DataFlexSyncData.GET_DfTimeSheets 
--
