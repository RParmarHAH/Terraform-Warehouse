resource "snowflake_procedure" "DISC_DATAFLEXSYNCDATA_GET_DFINVOICEPAYMENTS" {
	name ="GET_DFINVOICEPAYMENTS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.DataFlexSyncData.GET_DfInvoicePayments 
--
