resource "snowflake_procedure" "DISC_DATAFLEXSYNCDATA_GET_DFBILLCODES" {
	name ="GET_DFBILLCODES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.DataFlexSyncData.GET_DfBillCodes 
--
...
BEGIN 
    --TargetSQL
    COPY INTO DISC_${var.SF_ENVIRONMENT}.DataFlexSyncData.HIST_DfBillCodes FROM (SELECT t.$1 AS DbName, t.$2 AS BillCode, t.$3 AS Description, t.$4 AS Type, t.$5 AS Rate, t.$6 AS Contract, t.$7 AS WeekdayFlag, t.$8 AS WeekendFlag, t.$9 AS CptCode, t.$10 AS BluecrossCode, t.$11 AS DescriptionCode, t.$12 AS ServiceType, t.$13 AS CreatedDate, t.$14 AS UpdateBatch, t.$15 AS UpdatedTime, t.$16 AS SYS_CHANGE_VERSION, t.$17 AS SYS_CHANGE_OPERATION, :TaskKey AS ETL_TASK_KEY, :TaskKey AS ETL_INSERTED_TASK_KEY, current_timestamp::TIMESTAMP_NTZ(9) AS ETL_INSERTED_DATE, current_user() AS ETL_INSERTED_BY, current_timestamp::TIMESTAMP_NTZ(9) AS ETL_LAST_UPDATED_DATE, current_user() AS ETL_LAST_UPDATED_BY, DECODE(t.$17,''D'', True, False) AS ETL_DELETED_FLAG FROM @DISC_${var.SF_ENVIRONMENT}.STAGE.AWSAZSTAGEPROD/To_Be_Processed/DATAFLEXSYNCDATA/ (PATTERN => ''.*DataFlexSyncData_dbo_DfBillCodes.*[.]csv.gz'' , FILE_FORMAT=>DISC_${var.SF_ENVIRONMENT}.STAGE.MY_CSV_FORMAT) t);
