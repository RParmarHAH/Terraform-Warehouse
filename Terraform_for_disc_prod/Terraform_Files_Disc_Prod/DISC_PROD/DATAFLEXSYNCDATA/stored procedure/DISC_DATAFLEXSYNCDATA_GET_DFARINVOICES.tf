resource "snowflake_procedure" "DISC_DATAFLEXSYNCDATA_GET_DFARINVOICES" {
	name ="GET_DFARINVOICES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.DataFlexSyncData.GET_DfArInvoices 
--
