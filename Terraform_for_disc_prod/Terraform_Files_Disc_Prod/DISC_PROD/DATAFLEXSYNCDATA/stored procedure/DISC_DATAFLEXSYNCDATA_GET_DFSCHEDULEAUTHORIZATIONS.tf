resource "snowflake_procedure" "DISC_DATAFLEXSYNCDATA_GET_DFSCHEDULEAUTHORIZATIONS" {
	name ="GET_DFSCHEDULEAUTHORIZATIONS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.DataFlexSyncData.GET_DfScheduleAuthorizations 
--
...
BEGIN 
    --TargetSQL
    COPY INTO DISC_${var.SF_ENVIRONMENT}.DataFlexSyncData.HIST_DfScheduleAuthorizations FROM (SELECT t.$1 AS DbName, t.$2 AS ReferenceNo, t.$3 AS SequenceNo, t.$4 AS AuthorizationDays, t.$5 AS AuthorizationHours, t.$6 AS CreatedDate, t.$7 AS UpdateBatch, t.$8 AS UpdatedTime, t.$9 AS SYS_CHANGE_VERSION, t.$10 AS SYS_CHANGE_OPERATION, :TaskKey AS ETL_TASK_KEY, :TaskKey AS ETL_INSERTED_TASK_KEY, current_timestamp::TIMESTAMP_NTZ(9) AS ETL_INSERTED_DATE, current_user() AS ETL_INSERTED_BY, current_timestamp::TIMESTAMP_NTZ(9) AS ETL_LAST_UPDATED_DATE, current_user() AS ETL_LAST_UPDATED_BY, DECODE(t.$10,''D'', True, False) AS ETL_DELETED_FLAG FROM @DISC_${var.SF_ENVIRONMENT}.STAGE.AWSAZSTAGEPROD/To_Be_Processed/DATAFLEXSYNCDATA/ (PATTERN => ''.*DataFlexSyncData_dbo_DfScheduleAuthorizations.*[.]csv.gz'' , FILE_FORMAT=>DISC_${var.SF_ENVIRONMENT}.STAGE.MY_CSV_FORMAT) t);
