resource "snowflake_procedure" "DISC_DATAFLEXSYNCDATA_GET_DFPAYMENTS" {
	name ="GET_DFPAYMENTS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.DataFlexSyncData.GET_DfPayments 
--
