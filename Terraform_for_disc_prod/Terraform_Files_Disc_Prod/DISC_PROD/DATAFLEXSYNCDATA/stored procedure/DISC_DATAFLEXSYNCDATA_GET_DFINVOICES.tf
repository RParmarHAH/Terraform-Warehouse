resource "snowflake_procedure" "DISC_DATAFLEXSYNCDATA_GET_DFINVOICES" {
	name ="GET_DFINVOICES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.DataFlexSyncData.GET_DfInvoices 
--
