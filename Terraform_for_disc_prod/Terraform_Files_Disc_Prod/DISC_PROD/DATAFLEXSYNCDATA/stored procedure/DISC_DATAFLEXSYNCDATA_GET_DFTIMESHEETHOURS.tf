resource "snowflake_procedure" "DISC_DATAFLEXSYNCDATA_GET_DFTIMESHEETHOURS" {
	name ="GET_DFTIMESHEETHOURS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.DataFlexSyncData.GET_DfTimeSheetHours 
--
