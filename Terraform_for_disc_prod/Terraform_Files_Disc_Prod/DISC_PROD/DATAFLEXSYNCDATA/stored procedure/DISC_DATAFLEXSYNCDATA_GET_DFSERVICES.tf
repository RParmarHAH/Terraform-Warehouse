resource "snowflake_procedure" "DISC_DATAFLEXSYNCDATA_GET_DFSERVICES" {
	name ="GET_DFSERVICES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.DataFlexSyncData.GET_DfServices 
--
