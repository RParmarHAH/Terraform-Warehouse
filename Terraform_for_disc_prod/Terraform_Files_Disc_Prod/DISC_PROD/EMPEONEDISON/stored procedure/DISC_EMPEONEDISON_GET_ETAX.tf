resource "snowflake_procedure" "DISC_EMPEONEDISON_GET_ETAX" {
	name ="GET_ETAX"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.GET_ETax 
--
