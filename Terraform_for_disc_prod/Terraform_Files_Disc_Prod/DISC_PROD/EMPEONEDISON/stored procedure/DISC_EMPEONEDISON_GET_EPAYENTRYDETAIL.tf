resource "snowflake_procedure" "DISC_EMPEONEDISON_GET_EPAYENTRYDETAIL" {
	name ="GET_EPAYENTRYDETAIL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.GET_EPayEntryDetail 
--
