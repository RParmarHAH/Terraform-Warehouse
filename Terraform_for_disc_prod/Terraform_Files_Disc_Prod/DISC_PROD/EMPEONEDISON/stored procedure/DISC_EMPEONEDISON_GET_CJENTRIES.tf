resource "snowflake_procedure" "DISC_EMPEONEDISON_GET_CJENTRIES" {
	name ="GET_CJENTRIES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.GET_CJEntries 
--
