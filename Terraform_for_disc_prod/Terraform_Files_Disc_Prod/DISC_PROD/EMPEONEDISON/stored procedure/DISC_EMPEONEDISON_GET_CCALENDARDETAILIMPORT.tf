resource "snowflake_procedure" "DISC_EMPEONEDISON_GET_CCALENDARDETAILIMPORT" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.GET_CCalendarDetailImport 
--
