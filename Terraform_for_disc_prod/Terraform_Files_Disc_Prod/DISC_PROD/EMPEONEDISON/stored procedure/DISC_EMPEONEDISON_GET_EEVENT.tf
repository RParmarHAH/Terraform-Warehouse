resource "snowflake_procedure" "DISC_EMPEONEDISON_GET_EEVENT" {
	name ="GET_EEVENT"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.GET_EEvent 
--
