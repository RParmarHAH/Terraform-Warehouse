resource "snowflake_procedure" "DISC_EMPEONEDISON_GET_EPAYHISTDETAIL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.GET_EPayHistDetail 
--
