resource "snowflake_procedure" "DISC_EMPEONEDISON_GET_EPAYHIST" {
	name ="GET_EPAYHIST"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.GET_EPayHist 
--
