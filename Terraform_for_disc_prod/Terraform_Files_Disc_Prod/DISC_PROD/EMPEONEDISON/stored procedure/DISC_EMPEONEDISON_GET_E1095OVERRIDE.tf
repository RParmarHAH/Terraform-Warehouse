resource "snowflake_procedure" "DISC_EMPEONEDISON_GET_E1095OVERRIDE" {
	name ="GET_E1095OVERRIDE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.GET_E1095Override 
--
