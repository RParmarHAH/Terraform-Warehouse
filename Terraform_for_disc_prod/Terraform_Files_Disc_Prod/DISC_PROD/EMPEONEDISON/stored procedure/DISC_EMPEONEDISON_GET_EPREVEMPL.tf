resource "snowflake_procedure" "DISC_EMPEONEDISON_GET_EPREVEMPL" {
	name ="GET_EPREVEMPL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.GET_EPrevEmpl 
--
