resource "snowflake_procedure" "DISC_EMPEONEDISON_GET_ERAWPUNCH" {
	name ="GET_ERAWPUNCH"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.GET_ERawPunch 
--
