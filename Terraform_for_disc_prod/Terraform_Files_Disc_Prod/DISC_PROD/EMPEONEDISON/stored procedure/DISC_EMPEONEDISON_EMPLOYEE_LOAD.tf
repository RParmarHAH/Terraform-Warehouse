resource "snowflake_procedure" "DISC_EMPEONEDISON_EMPLOYEE_LOAD" {
	name ="EMPLOYEE_LOAD"
    ...
    BEGIN
       ...
       CREATE OR REPLACE TABLE DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.EInfo_table 
        ...
        FROM DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.Hist_EInfo_table P 
       ...
       CREATE OR REPLACE table DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.Hist_EInfo_table CLONE DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.EInfo_table;
    END;
