resource "snowflake_procedure" "DISC_EMPEONEDISON_GET_ECERTIFICATE" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.GET_ECertificate 
--
