resource "snowflake_procedure" "DISC_EMPEONEDISON_GET_EREQUEST" {
	name ="GET_EREQUEST"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.GET_ERequest 
--
