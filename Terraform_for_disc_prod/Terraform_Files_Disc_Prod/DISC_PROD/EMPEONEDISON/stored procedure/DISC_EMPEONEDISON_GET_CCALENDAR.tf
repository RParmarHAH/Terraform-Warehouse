resource "snowflake_procedure" "DISC_EMPEONEDISON_GET_CCALENDAR" {
	name ="GET_CCALENDAR"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.GET_CCalendar 
--
