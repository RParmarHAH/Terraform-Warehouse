resource "snowflake_procedure" "DISC_EMPEONEDISON_GET_ETIMEAPPROVEDUNPAID" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.GET_ETimeApprovedUnpaid 
--
