resource "snowflake_procedure" "DISC_EMPEONEDISON_GET_EACCRUALPAYSTUB" {
	name ="GET_EACCRUALPAYSTUB"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.GET_EAccrualPayStub 
--
