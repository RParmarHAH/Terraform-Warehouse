resource "snowflake_procedure" "DISC_EMPEONEDISON_GET_CDEPT2" {
	name ="GET_CDEPT2"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.GET_CDept2 
--
