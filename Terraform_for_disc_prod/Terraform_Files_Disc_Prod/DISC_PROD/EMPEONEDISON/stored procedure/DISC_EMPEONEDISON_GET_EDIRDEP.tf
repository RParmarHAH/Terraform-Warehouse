resource "snowflake_procedure" "DISC_EMPEONEDISON_GET_EDIRDEP" {
	name ="GET_EDIRDEP"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.GET_EDirDep 
--
