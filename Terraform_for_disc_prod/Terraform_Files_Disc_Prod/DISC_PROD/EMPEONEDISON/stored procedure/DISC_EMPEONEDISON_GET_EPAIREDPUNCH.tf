resource "snowflake_procedure" "DISC_EMPEONEDISON_GET_EPAIREDPUNCH" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.GET_EPairedPunch 
--
