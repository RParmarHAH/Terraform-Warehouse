resource "snowflake_procedure" "DISC_EMPEONEDISON_GET_ENOTE" {
	name ="GET_ENOTE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonEdison.GET_ENote 
--
