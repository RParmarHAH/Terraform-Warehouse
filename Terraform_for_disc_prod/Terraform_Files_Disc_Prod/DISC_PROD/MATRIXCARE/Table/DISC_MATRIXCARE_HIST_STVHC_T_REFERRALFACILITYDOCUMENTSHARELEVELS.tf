resource "snowflake_table" "DISC_MATRIXCARE_HIST_STVHC_T_REFERRALFACILITYDOCUMENTSHARELEVELS" {
    ...
    -- NAME :  DISC_PROD.MATRIXCARE.HIST_STVHC_T_REFERRALFACILITYDOCUMENTSHARELEVELS
