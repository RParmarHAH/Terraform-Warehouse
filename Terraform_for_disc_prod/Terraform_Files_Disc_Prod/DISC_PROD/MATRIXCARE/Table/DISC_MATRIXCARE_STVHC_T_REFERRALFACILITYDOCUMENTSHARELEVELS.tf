resource "snowflake_table" "DISC_MATRIXCARE_STVHC_T_REFERRALFACILITYDOCUMENTSHARELEVELS" {
    ...
    -- NAME :  DISC_PROD.MATRIXCARE.STVHC_T_REFERRALFACILITYDOCUMENTSHARELEVELS
