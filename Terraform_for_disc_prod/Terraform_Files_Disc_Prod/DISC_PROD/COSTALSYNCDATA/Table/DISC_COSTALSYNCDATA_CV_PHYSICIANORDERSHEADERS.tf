resource "snowflake_table" "DISC_COSTALSYNCDATA_CV_PHYSICIANORDERSHEADERS" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "COSTALSYNCDATA"
	name = "CV_PHYSICIANORDERSHEADERS"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.COSTALSYNCDATA.CV_PHYSICIANORDERSHEADERS
