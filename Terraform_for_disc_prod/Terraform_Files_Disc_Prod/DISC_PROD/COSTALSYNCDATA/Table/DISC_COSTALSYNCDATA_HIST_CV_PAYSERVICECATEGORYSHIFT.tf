resource "snowflake_table" "DISC_COSTALSYNCDATA_HIST_CV_PAYSERVICECATEGORYSHIFT" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "COSTALSYNCDATA"
	name = "HIST_CV_PAYSERVICECATEGORYSHIFT"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.COSTALSYNCDATA.HIST_CV_PAYSERVICECATEGORYSHIFT
