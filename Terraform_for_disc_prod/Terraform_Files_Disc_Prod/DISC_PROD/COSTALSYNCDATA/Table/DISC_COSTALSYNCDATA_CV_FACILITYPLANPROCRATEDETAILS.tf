resource "snowflake_table" "DISC_COSTALSYNCDATA_CV_FACILITYPLANPROCRATEDETAILS" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "COSTALSYNCDATA"
	name = "CV_FACILITYPLANPROCRATEDETAILS"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.COSTALSYNCDATA.CV_FACILITYPLANPROCRATEDETAILS
