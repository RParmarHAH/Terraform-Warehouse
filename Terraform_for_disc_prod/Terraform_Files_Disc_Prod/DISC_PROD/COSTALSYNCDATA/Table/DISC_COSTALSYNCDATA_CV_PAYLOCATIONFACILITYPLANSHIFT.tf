resource "snowflake_table" "DISC_COSTALSYNCDATA_CV_PAYLOCATIONFACILITYPLANSHIFT" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "COSTALSYNCDATA"
	name = "CV_PAYLOCATIONFACILITYPLANSHIFT"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.COSTALSYNCDATA.CV_PAYLOCATIONFACILITYPLANSHIFT
