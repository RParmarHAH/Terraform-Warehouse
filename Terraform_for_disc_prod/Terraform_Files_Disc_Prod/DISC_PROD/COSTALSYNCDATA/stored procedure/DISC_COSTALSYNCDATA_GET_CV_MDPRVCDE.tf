resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_MDPRVCDE" {
	name ="GET_CV_MDPRVCDE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_MDPRVCDE 
--
