resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_ICDCODES" {
	name ="GET_CV_ICDCODES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_ICDCodes 
--
