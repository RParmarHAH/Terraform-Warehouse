resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_EMPLOYEES" {
	name ="GET_CV_EMPLOYEES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_Employees 
--
