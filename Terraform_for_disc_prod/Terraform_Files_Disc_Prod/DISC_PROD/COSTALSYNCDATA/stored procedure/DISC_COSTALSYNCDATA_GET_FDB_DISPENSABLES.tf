resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_FDB_DISPENSABLES" {
	name ="GET_FDB_DISPENSABLES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_FDB_Dispensables 
--
