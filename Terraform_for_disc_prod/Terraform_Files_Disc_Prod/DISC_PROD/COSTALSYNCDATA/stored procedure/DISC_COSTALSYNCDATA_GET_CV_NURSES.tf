resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_NURSES" {
	name ="GET_CV_NURSES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_Nurses 
--
