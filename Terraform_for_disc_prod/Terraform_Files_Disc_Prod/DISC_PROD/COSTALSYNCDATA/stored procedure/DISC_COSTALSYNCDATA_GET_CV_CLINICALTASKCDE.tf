resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_CLINICALTASKCDE" {
	name ="GET_CV_CLINICALTASKCDE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_ClinicalTaskCde 
--
