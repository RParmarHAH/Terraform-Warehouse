resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_REFERRINGSOURCECODES" {
	name ="GET_CV_REFERRINGSOURCECODES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_ReferringSourceCodes 
--
