resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_SERVICECATEGORYCODES" {
	name ="GET_CV_SERVICECATEGORYCODES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_ServiceCategoryCodes 
--
