resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_PATIENTPLANS" {
	name ="GET_CV_PATIENTPLANS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_PatientPlans 
--
