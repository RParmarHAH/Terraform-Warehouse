resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_PATIENTCERTIFICATIONDIAGNOSES" {
	name ="GET_CV_PATIENTCERTIFICATIONDIAGNOSES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_PatientCertificationDiagnoses 
--
