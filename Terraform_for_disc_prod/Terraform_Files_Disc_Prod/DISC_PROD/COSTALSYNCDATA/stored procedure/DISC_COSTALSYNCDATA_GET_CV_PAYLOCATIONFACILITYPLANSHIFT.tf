resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_PAYLOCATIONFACILITYPLANSHIFT" {
	name ="GET_CV_PAYLOCATIONFACILITYPLANSHIFT"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_PayLocationFacilityPlanShift 
--
