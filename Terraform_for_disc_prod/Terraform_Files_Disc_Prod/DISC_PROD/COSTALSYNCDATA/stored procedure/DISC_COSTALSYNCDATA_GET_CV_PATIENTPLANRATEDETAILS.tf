resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_PATIENTPLANRATEDETAILS" {
	name ="GET_CV_PATIENTPLANRATEDETAILS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_PatientPlanRateDetails 
--
