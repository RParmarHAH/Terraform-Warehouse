resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_ADMISSIONDIAGNOSES" {
	name ="GET_CV_ADMISSIONDIAGNOSES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_AdmissionDiagnoses 
--
