resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_ADMISSIONADMITDIAGNOSES" {
	name ="GET_CV_ADMISSIONADMITDIAGNOSES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_AdmissionAdmitDiagnoses 
--
