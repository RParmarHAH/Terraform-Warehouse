resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_PATIENTPROFESSIONALCONTACTS" {
	name ="GET_CV_PATIENTPROFESSIONALCONTACTS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_PatientProfessionalContacts 
--
