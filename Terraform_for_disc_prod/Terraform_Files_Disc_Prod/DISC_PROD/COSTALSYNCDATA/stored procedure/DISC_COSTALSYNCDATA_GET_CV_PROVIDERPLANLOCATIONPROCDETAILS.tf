resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_PROVIDERPLANLOCATIONPROCDETAILS" {
	name ="GET_CV_PROVIDERPLANLOCATIONPROCDETAILS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_ProviderPlanLocationProcDetails 
--
