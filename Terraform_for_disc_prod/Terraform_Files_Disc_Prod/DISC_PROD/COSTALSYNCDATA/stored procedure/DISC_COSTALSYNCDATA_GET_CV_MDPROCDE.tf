resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_MDPROCDE" {
	name ="GET_CV_MDPROCDE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_MDPROCDE 
--
