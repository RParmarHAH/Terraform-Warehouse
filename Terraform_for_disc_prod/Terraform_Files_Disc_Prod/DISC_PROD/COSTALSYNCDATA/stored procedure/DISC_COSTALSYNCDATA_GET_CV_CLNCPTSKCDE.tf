resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_CLNCPTSKCDE" {
	name ="GET_CV_CLNCPTSKCDE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_CLNCPTSKCDE 
--
