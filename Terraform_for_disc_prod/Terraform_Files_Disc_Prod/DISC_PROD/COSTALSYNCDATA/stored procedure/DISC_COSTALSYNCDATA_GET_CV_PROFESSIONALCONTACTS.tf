resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_PROFESSIONALCONTACTS" {
	name ="GET_CV_PROFESSIONALCONTACTS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_ProfessionalContacts 
--
