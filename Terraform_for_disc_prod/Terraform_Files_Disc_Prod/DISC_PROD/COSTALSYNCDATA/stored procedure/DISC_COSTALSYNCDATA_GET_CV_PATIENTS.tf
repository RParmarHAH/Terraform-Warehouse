resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_PATIENTS" {
	name ="GET_CV_PATIENTS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_Patients 
--
