resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_PATIENTPLANCOPAYS" {
	name ="GET_CV_PATIENTPLANCOPAYS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_PatientPlanCopays 
--
