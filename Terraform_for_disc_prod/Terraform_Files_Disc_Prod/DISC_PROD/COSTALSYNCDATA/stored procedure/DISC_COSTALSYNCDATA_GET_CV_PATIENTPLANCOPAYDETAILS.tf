resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_PATIENTPLANCOPAYDETAILS" {
	name ="GET_CV_PATIENTPLANCOPAYDETAILS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_PatientPlanCopayDetails 
--
