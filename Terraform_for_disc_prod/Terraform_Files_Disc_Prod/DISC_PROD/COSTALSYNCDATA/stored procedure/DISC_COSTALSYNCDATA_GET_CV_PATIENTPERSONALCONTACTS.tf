resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_PATIENTPERSONALCONTACTS" {
	name ="GET_CV_PATIENTPERSONALCONTACTS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_PatientPersonalContacts 
--
