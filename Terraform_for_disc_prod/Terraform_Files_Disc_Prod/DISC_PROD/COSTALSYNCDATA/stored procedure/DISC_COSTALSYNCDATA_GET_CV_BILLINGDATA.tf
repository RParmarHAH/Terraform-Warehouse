resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_BILLINGDATA" {
	name ="GET_CV_BILLINGDATA"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_Cv_BillingData 
--
