resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_FACILITIES" {
	name ="GET_CV_FACILITIES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_Facilities 
--
