resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_SCHEDULESPLITSHIFTS" {
	name ="GET_CV_SCHEDULESPLITSHIFTS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_ScheduleSplitShifts 
--
