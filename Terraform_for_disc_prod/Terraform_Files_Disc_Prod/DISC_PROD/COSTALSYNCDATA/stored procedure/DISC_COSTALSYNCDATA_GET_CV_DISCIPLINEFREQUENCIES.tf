resource "snowflake_procedure" "DISC_COSTALSYNCDATA_GET_CV_DISCIPLINEFREQUENCIES" {
	name ="GET_CV_DISCIPLINEFREQUENCIES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.CostalSyncData.GET_CV_DisciplineFrequencies 
--
