resource "snowflake_table" "DISC_HHAEXCHANGEEDISON_PAYROLL_OTHERCHARGESADJUSTMENTS_REPL" {
    ...
    -- NAME :  DISC_PROD.HHAEXCHANGEEDISON.PAYROLL_OTHERCHARGESADJUSTMENTS_REPL
