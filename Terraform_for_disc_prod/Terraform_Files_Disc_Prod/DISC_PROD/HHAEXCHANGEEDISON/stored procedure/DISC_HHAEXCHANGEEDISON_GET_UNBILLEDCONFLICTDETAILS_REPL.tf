resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_UNBILLEDCONFLICTDETAILS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_UnbilledConflictDetails_REPL 
--
