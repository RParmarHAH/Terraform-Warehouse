resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_SERVICETYPE_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_ServiceType_REPL 
--
