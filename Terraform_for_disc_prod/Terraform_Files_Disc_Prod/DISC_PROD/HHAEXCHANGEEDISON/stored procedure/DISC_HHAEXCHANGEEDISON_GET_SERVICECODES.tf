resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_SERVICECODES" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_ServiceCodes 
--
