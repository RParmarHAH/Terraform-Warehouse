resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_PATIENTCONTRACTCHANGES" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_PatientContractChanges 
--
