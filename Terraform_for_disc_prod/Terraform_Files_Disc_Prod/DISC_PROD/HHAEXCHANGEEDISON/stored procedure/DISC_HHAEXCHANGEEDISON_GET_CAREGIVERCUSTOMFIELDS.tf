resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_CAREGIVERCUSTOMFIELDS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_CaregiverCustomFields 
--
