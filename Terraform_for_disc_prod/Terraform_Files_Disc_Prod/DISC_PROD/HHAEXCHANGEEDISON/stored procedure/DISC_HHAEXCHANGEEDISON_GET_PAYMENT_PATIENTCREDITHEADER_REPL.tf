resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_PAYMENT_PATIENTCREDITHEADER_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_Payment_PatientCreditHeader_REPL 
--
