resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_STAGE_USERPATIENTASSIGNMENT" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_stage_UserPatientAssignment 
--
