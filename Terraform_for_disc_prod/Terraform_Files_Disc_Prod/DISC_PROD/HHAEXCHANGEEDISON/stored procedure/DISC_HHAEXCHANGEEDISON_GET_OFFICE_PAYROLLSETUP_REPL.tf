resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_OFFICE_PAYROLLSETUP_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_Office_PayrollSetup_REPL 
--
