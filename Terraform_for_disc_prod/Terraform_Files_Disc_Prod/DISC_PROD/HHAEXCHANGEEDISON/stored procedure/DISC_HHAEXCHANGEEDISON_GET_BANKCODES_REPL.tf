resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_BANKCODES_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_BankCodes_REPL 
--
