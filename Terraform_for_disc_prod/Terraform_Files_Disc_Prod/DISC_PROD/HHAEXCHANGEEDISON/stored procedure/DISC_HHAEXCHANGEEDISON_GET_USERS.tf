resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_USERS" {
	name ="GET_USERS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_Users 
--
