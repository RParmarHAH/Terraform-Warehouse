resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_PAYROLL_OTHERCHARGESDETAILS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_Payroll_OtherChargesDetails_REPL 
--
