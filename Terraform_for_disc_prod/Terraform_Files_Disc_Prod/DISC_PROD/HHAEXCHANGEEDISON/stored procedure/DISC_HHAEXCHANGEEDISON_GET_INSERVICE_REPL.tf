resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_INSERVICE_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_InService_REPL 
--
