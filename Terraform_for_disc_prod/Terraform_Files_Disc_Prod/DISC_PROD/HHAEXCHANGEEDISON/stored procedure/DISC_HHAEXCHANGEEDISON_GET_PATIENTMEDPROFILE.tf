resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_PATIENTMEDPROFILE" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_PatientMedProfile 
--
