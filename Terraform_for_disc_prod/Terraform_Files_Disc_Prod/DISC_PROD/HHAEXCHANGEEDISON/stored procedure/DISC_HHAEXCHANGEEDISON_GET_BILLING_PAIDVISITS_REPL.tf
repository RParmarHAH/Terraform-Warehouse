resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_BILLING_PAIDVISITS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_Billing_PaidVisits_REPL 
--
