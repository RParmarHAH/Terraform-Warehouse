resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_REFPOCTASKS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_RefPocTasks_REPL 
--
