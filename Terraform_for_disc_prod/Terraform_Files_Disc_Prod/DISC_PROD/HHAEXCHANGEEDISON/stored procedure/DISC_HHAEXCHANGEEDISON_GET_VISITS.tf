resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_VISITS" {
	name ="GET_VISITS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_Visits 
--
