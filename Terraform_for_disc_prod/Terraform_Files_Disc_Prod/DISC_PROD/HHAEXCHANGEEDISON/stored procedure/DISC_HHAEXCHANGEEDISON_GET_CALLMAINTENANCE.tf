resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_CALLMAINTENANCE" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_CallMaintenance 
--
