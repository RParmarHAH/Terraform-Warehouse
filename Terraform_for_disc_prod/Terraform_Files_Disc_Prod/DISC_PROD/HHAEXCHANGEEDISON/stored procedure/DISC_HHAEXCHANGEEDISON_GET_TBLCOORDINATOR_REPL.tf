resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_TBLCOORDINATOR_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_TblCoordinator_REPL 
--
