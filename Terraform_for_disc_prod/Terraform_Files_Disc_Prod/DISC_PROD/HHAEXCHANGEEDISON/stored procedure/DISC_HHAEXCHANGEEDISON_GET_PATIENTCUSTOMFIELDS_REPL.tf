resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_PATIENTCUSTOMFIELDS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_PatientCustomFields_REPL 
--
