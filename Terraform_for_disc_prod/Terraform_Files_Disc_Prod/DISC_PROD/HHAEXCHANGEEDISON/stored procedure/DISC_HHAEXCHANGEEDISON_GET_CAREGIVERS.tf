resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_CAREGIVERS" {
	name ="GET_CAREGIVERS"
...
CREATE OR REPLACE TABLE DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.Caregivers 
 ...
 FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.Hist_Caregivers P 
...
create OR REPLACE table DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.Hist_Caregivers CLONE DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.Caregivers;
------------------------------------------------------------------------------------------------------
END;
