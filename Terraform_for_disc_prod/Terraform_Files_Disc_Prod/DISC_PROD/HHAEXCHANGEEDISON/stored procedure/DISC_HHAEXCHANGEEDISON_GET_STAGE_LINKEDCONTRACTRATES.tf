resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_STAGE_LINKEDCONTRACTRATES" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_stage_LinkedContractRates 
--
