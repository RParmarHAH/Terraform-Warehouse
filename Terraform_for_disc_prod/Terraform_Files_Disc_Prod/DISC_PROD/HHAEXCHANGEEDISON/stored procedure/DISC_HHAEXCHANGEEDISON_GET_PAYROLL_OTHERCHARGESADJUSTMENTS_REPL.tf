resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_PAYROLL_OTHERCHARGESADJUSTMENTS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_Payroll_OtherChargesAdjustments_REPL 
--
