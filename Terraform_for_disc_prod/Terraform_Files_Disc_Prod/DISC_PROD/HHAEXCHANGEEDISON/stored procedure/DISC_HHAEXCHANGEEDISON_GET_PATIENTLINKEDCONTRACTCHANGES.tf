resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_PATIENTLINKEDCONTRACTCHANGES" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_PatientLinkedContractChanges 
--
