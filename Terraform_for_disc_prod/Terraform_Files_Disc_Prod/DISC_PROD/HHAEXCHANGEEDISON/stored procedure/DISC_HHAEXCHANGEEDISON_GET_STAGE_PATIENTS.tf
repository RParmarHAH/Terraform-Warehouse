resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_STAGE_PATIENTS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_stage_Patients 
--
