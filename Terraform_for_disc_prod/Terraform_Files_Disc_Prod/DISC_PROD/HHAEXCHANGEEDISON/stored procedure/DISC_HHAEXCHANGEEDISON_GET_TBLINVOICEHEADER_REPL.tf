resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_TBLINVOICEHEADER_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_tblInvoiceHeader_REPL 
--
