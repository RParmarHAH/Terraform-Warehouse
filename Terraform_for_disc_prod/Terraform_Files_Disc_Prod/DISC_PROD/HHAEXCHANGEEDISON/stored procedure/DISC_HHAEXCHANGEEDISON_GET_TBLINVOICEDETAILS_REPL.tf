resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_TBLINVOICEDETAILS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_tblInvoiceDetails_REPL 
--
