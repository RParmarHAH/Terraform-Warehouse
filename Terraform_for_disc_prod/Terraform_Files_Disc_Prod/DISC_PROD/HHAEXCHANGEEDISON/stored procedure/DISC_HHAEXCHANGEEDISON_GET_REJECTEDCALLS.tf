resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_REJECTEDCALLS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_RejectedCalls 
--
