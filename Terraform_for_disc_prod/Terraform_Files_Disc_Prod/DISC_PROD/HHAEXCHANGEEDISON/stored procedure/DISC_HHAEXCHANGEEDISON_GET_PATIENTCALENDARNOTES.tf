resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_PATIENTCALENDARNOTES" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_PatientCalendarNotes 
--
