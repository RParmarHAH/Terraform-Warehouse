resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_TBLCALLHISTORY_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_tblCallHistory_REPL 
--
