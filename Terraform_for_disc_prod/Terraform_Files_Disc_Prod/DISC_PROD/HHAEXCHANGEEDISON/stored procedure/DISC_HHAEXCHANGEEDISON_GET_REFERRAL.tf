resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_REFERRAL" {
	name ="GET_REFERRAL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_Referral 
--
