resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_PLACEMENTMASTERWEEK" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_PlacementMasterWeek 
--
