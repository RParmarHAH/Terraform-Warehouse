resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_CONTRACTS" {
	name ="GET_CONTRACTS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_Contracts 
--
