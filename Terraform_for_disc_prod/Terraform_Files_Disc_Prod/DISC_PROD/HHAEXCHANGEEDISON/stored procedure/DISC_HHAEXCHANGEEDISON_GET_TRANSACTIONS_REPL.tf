resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_TRANSACTIONS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_Transactions_REPL 
--
