resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_AIDECUSTOMFIELDS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_AideCustomFields 
--
