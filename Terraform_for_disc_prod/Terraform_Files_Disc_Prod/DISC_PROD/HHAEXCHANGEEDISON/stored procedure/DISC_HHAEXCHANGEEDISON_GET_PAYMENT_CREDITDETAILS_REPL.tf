resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_PAYMENT_CREDITDETAILS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_Payment_CreditDetails_REPL 
--
