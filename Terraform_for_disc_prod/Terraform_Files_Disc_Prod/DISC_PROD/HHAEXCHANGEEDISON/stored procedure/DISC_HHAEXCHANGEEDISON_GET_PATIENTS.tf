resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_PATIENTS" {
	name ="GET_PATIENTS"
...
CREATE OR REPLACE TABLE DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.Patients
 ...
 FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.Hist_Patients P 
 INNER JOIN curr_v v ON P.AgencyID = v.AgencyID AND P.PatientID = v.PatientID
 AND P.ETL_LAST_UPDATED_DATE = v.MAX_LAST_UPDATED_DATE;

 ----REPLACE HIST TABLE WITH CURRETN TABLE 
create OR REPLACE table DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.Hist_Patients CLONE DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.Patients;
------------------------------------------------------------------------------------------------------
END;
