resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_TBLVISITS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_tblVisits_REPL 
--
