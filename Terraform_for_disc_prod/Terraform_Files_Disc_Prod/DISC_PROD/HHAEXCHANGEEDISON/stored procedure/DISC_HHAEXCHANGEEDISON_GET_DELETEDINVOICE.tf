resource "snowflake_procedure" "DISC_HHAEXCHANGEEDISON_GET_DELETEDINVOICE" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEEDISON.GET_DeletedInvoice 
--
