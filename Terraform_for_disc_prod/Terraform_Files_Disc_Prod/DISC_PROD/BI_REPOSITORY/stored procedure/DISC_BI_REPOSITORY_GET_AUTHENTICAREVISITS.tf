resource "snowflake_procedure" "DISC_BI_REPOSITORY_GET_AUTHENTICAREVISITS" {
	name ="GET_AUTHENTICAREVISITS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.BI_Repository.GET_AuthenticareVisits 
--
