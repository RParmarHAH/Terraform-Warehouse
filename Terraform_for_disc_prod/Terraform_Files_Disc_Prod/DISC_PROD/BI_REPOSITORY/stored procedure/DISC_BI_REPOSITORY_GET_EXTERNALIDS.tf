resource "snowflake_procedure" "DISC_BI_REPOSITORY_GET_EXTERNALIDS" {
	name ="GET_EXTERNALIDS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.BI_Repository.GET_ExternalIDs 
--
