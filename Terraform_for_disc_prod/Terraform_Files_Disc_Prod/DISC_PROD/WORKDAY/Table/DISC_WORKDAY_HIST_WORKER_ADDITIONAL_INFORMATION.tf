resource "snowflake_table" "DISC_WORKDAY_HIST_WORKER_ADDITIONAL_INFORMATION" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "WORKDAY"
	name = "HIST_WORKER_ADDITIONAL_INFORMATION"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.WORKDAY.HIST_WORKER_ADDITIONAL_INFORMATION
