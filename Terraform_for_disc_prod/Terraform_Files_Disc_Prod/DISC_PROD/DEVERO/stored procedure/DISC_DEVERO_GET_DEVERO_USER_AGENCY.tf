resource "snowflake_procedure" "DISC_DEVERO_GET_DEVERO_USER_AGENCY" {
	name ="GET_DEVERO_USER_AGENCY"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.DEVERO.GET_${var.SF_ENVIRONMENT}ERO_USER_AGENCY 
--
...
BEGIN 
    ...
    --ViewSQL
    CREATE OR REPLACE TABLE DISC_${var.SF_ENVIRONMENT}.DEVERO.DEVERO_USER_AGENCY AS (SELECT * FROM DISC_${var.SF_ENVIRONMENT}.DEVERO.VIEW_${var.SF_ENVIRONMENT}ERO_USER_AGENCY);
