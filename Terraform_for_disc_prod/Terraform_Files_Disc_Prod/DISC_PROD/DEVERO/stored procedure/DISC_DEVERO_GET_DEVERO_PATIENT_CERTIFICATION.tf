resource "snowflake_procedure" "DISC_DEVERO_GET_DEVERO_PATIENT_CERTIFICATION" {
	name ="GET_DEVERO_PATIENT_CERTIFICATION"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.DEVERO.GET_${var.SF_ENVIRONMENT}ERO_PATIENT_CERTIFICATION 
--
...
BEGIN 
    ...
    --ViewSQL
    CREATE OR REPLACE TABLE DISC_${var.SF_ENVIRONMENT}.DEVERO.DEVERO_PATIENT_CERTIFICATION AS (SELECT * FROM DISC_${var.SF_ENVIRONMENT}.DEVERO.VIEW_${var.SF_ENVIRONMENT}ERO_PATIENT_CERTIFICATION );
