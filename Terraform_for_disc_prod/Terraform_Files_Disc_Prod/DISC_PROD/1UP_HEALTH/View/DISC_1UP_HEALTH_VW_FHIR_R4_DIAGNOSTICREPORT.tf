resource "snowflake_view" "DISC_1UP_HEALTH_VW_FHIR_R4_DIAGNOSTICREPORT" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "1UP_HEALTH"
	name = "VW_FHIR_R4_DIAGNOSTICREPORT"
	statement = <<-SQL
	 (
select 
...
ETL_TASK_KEY,
ETL_INSERTED_DATE 
FROM DISC_${var.SF_ENVIRONMENT}."1UP_HEALTH".HIST_FHIR_R4_DIAGNOSTICREPORT
);
SQL
	or_replace = true 
	is_secure = false 
