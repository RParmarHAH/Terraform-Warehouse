resource "snowflake_procedure" "DISC_SANDATAEXCHANGE_GET_DFIMPORT_IMPORTVISITS" {
	name ="GET_DFIMPORT_IMPORTVISITS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.SanDataExchange.GET_DfImport_ImportVisits 
--
...
BEGIN 
    --TargetSQL
    COPY INTO DISC_${var.SF_ENVIRONMENT}.SanDataExchange.HIST_DfImport_ImportVisits FROM (SELECT t.$1 AS LineId, t.$2 AS VisitKey, t.$3 AS ImportTaskId, t.$4 AS TimesheetId, t.$5 AS State, t.$6 AS RefNo, t.$7 AS TrackingId, t.$8 AS ClientNo, t.$9 AS EmployeeNo, t.$10 AS ContractCode, t.$11 AS BillCode, t.$12 AS PayrollDate, t.$13 AS WeekendDate, t.$14 AS OfficeNo, t.$15 AS SupervisorCode, t.$16 AS IsImported, t.$17 AS ReadTime, t.$18 AS IsValid, t.$19 AS VisitChangeType, t.$20 AS ServiceDate, t.$21 AS HoursDelta, t.$22 AS SYS_CHANGE_VERSION, t.$23 AS SYS_CHANGE_OPERATION, :TaskKey AS ETL_TASK_KEY, :TaskKey AS ETL_INSERTED_TASK_KEY, current_timestamp::TIMESTAMP_NTZ(9) AS ETL_INSERTED_DATE, current_user() AS ETL_INSERTED_BY, current_timestamp::TIMESTAMP_NTZ(9) AS ETL_LAST_UPDATED_DATE, current_user() AS ETL_LAST_UPDATED_BY, DECODE(t.$23,''D'', True, False) AS ETL_DELETED_FLAG FROM @DISC_${var.SF_ENVIRONMENT}.STAGE.AWSAZSTAGEPROD/To_Be_Processed/SANDATAEXCHANGE/ (PATTERN => ''.*SanDataExchange_DfImport_ImportVisits.*[.]csv.gz'' , FILE_FORMAT=>DISC_${var.SF_ENVIRONMENT}.STAGE.MY_CSV_FORMAT) t);
