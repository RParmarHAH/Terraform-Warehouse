resource "snowflake_table" "DISC_HEALTH_NAVIGATOR_HEALTHCLOUDGA__PROGRAMPATIENTAFFILIATION__C" {
    ...
    -- NAME :  DISC_PROD.HEALTH_NAVIGATOR.HEALTHCLOUDGA__PROGRAMPATIENTAFFILIATION__C
...
column {
	name = "HEALTHCLOUDGA__PROVIDER__C"
	type = "VARCHAR(18)"
	nullable = true
}
...
column {
	name = "HEALTHCLOUDGA__RECALCULATE__C"
	type = "BOOLEAN"
	nullable = true
}
