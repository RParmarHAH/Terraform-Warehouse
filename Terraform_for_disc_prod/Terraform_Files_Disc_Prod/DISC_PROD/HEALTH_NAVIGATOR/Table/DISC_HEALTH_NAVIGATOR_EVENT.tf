resource "snowflake_table" "DISC_HEALTH_NAVIGATOR_EVENT" {
    ...
    -- NAME :  DISC_PROD.HEALTH_NAVIGATOR.EVENT
...
column {
	name = "ACTIVITYRECURRENCE2EXCEPTIONID"
	type = "VARCHAR(18)"
	nullable = true
}
