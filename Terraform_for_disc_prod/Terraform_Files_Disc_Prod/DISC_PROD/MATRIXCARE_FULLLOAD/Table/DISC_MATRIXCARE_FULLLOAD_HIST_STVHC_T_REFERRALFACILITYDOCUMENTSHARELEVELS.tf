resource "snowflake_table" "DISC_MATRIXCARE_FULLLOAD_HIST_STVHC_T_REFERRALFACILITYDOCUMENTSHARELEVELS" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "MATRIXCARE_FULLLOAD"
	name = "HIST_STVHC_T_REFERRALFACILITYDOCUMENTSHARELEVELS"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.MATRIXCARE_FULLLOAD.HIST_STVHC_T_REFERRALFACILITYDOCUMENTSHARELEVELS
