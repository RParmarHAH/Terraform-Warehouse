resource "snowflake_table" "DISC_MATRIXCARE_FULLLOAD_MATRIXCARE_MASTER_CLIENT_MAPPING_ALL" {
    ...
    -- NAME :  DISC_PROD.MATRIXCARE_FULLLOAD.MATRIXCARE_MASTER_CLIENT_MAPPING_ALL
