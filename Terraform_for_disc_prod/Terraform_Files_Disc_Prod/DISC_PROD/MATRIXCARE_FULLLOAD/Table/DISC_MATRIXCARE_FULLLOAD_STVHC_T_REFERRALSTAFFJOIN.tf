resource "snowflake_table" "DISC_MATRIXCARE_FULLLOAD_STVHC_T_REFERRALSTAFFJOIN" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "MATRIXCARE_FULLLOAD"
	name = "STVHC_T_REFERRALSTAFFJOIN"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.MATRIXCARE_FULLLOAD.STVHC_T_REFERRALSTAFFJOIN
