resource "snowflake_procedure" "DISC_MATRIXCARE_FULLLOAD_GET_STVHC_T_ADMISSIONSDISCHARGEREASONS" {
	name ="GET_STVHC_T_ADMISSIONSDISCHARGEREASONS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.MatrixCare.GET_STVHC_T_AdmissionsDischargeReasons 
--
