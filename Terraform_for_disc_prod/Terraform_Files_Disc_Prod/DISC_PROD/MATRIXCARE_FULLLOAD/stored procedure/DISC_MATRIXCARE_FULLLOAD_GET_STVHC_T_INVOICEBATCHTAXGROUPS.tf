resource "snowflake_procedure" "DISC_MATRIXCARE_FULLLOAD_GET_STVHC_T_INVOICEBATCHTAXGROUPS" {
	name ="GET_STVHC_T_INVOICEBATCHTAXGROUPS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.MatrixCare.GET_STVHC_T_InvoiceBatchTaxGroups 
--
