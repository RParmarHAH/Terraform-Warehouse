resource "snowflake_procedure" "DISC_MATRIXCARE_FULLLOAD_GET_STVHC_T_PLANOFCAREDOCUMENTS" {
	name ="GET_STVHC_T_PLANOFCAREDOCUMENTS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.MatrixCare.GET_STVHC_T_PlanOfCareDocuments 
--
