resource "snowflake_procedure" "DISC_MATRIXCARE_FULLLOAD_MATRIXCARE_MASTER_EMPLOYEE_MAPPING_ALL" {
...
BEGIN  
    INSERT OVERWRITE INTO DISC_${var.SF_ENVIRONMENT}.MATRIXCARE.MATRIXCARE_MASTER_EMPLOYEE_MAPPING_ALL
