resource "snowflake_procedure" "DISC_ALAYACARE_GET_EMERGENCY_CONTACT" {
...
BEGIN
    ...
    INSERT OVERWRITE INTO ALAYACARE.EMERGENCY_CONTACT (
        ...
        FROM ALAYACARE_${var.SF_ENVIRONMENT}UCTION."5C3EE5FE-45A5-4DA7-A35B-BD7CDAFE3548".SHARED_EMERGENCY_CONTACT;
