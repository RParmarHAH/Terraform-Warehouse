resource "snowflake_procedure" "DISC_ALAYACARE_GET_CLIENT_MEDHIST_PAST" {
...
BEGIN
    ...
    INSERT OVERWRITE INTO ALAYACARE.CLIENT_MEDHIST_PAST (
        ...
        FROM ALAYACARE_${var.SF_ENVIRONMENT}UCTION."5C3EE5FE-45A5-4DA7-A35B-BD7CDAFE3548".SHARED_CLIENT_MEDHIST_PAST;
