resource "snowflake_procedure" "DISC_ALAYACARE_GET_BILLING_PERIOD" {
...
BEGIN
    ...
    INSERT OVERWRITE INTO ALAYACARE.BILLING_PERIOD (
        ...
        FROM ALAYACARE_${var.SF_ENVIRONMENT}UCTION."5C3EE5FE-45A5-4DA7-A35B-BD7CDAFE3548".SHARED_BILLING_PERIOD;
