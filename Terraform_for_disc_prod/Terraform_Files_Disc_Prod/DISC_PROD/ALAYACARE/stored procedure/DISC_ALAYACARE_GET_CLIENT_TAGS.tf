resource "snowflake_procedure" "DISC_ALAYACARE_GET_CLIENT_TAGS" {
...
BEGIN
    ...
    INSERT OVERWRITE INTO ALAYACARE.CLIENT_TAGS (
        ...
        FROM ALAYACARE_${var.SF_ENVIRONMENT}UCTION."5C3EE5FE-45A5-4DA7-A35B-BD7CDAFE3548".SHARED_CLIENT_TAGS;
