resource "snowflake_procedure" "DISC_ALAYACARE_GET_FUNDING_BLOCK_TIER_4" {
...
VISIT_COUNT
FROM
ALAYACARE_${var.SF_ENVIRONMENT}UCTION."5C3EE5FE-45A5-4DA7-A35B-BD7CDAFE3548".SHARED_FUNDING_BLOCK_TIER_4;
