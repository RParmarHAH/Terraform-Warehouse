resource "snowflake_table" "DISC_MOLINA_HIST_MOLINA_GAPS_IN_CARE_0118" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "MOLINA"
	name = "HIST_MOLINA_GAPS_IN_CARE_0118"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.MOLINA.HIST_MOLINA_GAPS_IN_CARE_0118
