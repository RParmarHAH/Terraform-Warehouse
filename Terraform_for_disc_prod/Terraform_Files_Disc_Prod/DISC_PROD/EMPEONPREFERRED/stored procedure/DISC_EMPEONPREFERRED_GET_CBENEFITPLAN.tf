resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_CBENEFITPLAN" {
	name ="GET_CBENEFITPLAN"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_CBenefitPlan 
--
