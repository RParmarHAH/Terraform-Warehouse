resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_EAUTOPAY" {
	name ="GET_EAUTOPAY"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_EAutoPay 
--
