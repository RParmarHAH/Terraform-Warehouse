resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_CDED" {
	name ="GET_CDED"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_CDed 
--
