resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_ERAWPUNCH" {
	name ="GET_ERAWPUNCH"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_ERawPunch 
--
