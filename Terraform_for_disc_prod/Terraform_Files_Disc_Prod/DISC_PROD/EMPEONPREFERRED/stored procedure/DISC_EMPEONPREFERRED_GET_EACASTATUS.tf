resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_EACASTATUS" {
	name ="GET_EACASTATUS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_EACAStatus 
--
