resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_EPAYENTRY" {
	name ="GET_EPAYENTRY"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_EPayEntry 
--
