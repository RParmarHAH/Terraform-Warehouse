resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_ESCHEDULEPATTERN" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_ESchedulePattern 
--
