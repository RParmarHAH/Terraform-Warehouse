resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_EPREVEMPL" {
	name ="GET_EPREVEMPL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_EPrevEmpl 
--
