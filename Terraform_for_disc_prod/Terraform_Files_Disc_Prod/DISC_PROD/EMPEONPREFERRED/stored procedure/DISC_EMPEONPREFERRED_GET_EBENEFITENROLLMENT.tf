resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_EBENEFITENROLLMENT" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_EBenefitEnrollment 
--
