resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_CDEPT1" {
	name ="GET_CDEPT1"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_CDept1 
--
