resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_ETRAINING" {
	name ="GET_ETRAINING"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_ETraining 
--
