resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_EACCRUALTRANS" {
	name ="GET_EACCRUALTRANS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_EAccrualTrans 
--
