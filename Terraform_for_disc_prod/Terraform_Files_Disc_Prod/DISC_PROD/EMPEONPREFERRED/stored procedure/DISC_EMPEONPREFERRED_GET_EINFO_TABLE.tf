resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_EINFO_TABLE" {
...
CREATE OR REPLACE TABLE DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.EInfo_table 
 ...
 FROM DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.Hist_EInfo_table P 
...
create OR REPLACE table DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.Hist_EInfo_table CLONE DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.EInfo_table;
---------------------------------------------------
   END;
