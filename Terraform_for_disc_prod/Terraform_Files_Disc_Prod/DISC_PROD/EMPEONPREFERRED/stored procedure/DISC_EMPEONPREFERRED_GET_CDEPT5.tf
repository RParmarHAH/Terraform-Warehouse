resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_CDEPT5" {
	name ="GET_CDEPT5"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_CDept5 
--
