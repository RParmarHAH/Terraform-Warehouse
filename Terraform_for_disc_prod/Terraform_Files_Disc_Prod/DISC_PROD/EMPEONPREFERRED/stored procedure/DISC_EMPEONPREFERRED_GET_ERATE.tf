resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_ERATE" {
	name ="GET_ERATE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_ERate 
--
