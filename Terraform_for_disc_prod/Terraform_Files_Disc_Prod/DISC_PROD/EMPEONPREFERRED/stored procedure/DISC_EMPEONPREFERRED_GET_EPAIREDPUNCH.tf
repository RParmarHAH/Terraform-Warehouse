resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_EPAIREDPUNCH" {
	name ="GET_EPAIREDPUNCH"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_EPairedPunch 
--
