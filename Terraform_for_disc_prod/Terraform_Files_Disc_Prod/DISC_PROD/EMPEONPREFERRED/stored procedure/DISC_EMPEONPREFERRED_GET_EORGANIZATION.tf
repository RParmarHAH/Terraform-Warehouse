resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_EORGANIZATION" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_EOrganization 
--
