resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_CDEPT3" {
	name ="GET_CDEPT3"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_CDept3 
--
