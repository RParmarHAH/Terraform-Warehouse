resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_EDEP" {
	name ="GET_EDEP"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_EDep 
--
