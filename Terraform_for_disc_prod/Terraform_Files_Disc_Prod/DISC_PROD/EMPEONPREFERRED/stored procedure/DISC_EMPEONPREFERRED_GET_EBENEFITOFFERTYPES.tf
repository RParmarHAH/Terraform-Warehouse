resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_EBENEFITOFFERTYPES" {
	name ="GET_EBENEFITOFFERTYPES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_EBenefitOfferTypes 
--
