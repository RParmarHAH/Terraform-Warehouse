resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_EACCRUALPAYSTUB" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_EAccrualPayStub 
--
