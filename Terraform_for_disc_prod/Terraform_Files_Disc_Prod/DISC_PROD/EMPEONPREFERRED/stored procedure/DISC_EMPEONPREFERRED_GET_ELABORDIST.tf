resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_ELABORDIST" {
	name ="GET_ELABORDIST"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_ELaborDist 
--
