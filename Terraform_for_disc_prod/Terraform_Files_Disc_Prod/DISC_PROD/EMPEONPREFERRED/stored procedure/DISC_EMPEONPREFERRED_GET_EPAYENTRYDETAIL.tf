resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_EPAYENTRYDETAIL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_EPayEntryDetail 
--
