resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_EPAYHIST" {
	name ="GET_EPAYHIST"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_EPayHist 
--
