resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_EFRINGE" {
	name ="GET_EFRINGE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_EFringe 
--
