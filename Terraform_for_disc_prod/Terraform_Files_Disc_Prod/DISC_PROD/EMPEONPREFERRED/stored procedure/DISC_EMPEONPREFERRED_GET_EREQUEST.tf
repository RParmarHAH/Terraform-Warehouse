resource "snowflake_procedure" "DISC_EMPEONPREFERRED_GET_EREQUEST" {
	name ="GET_EREQUEST"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmpeonPreferred.GET_ERequest 
--
