resource "snowflake_table" "DISC_PAYOR_CONTRACT_UI_PAYOR_CONTRACT_MAPPING" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "PAYOR_CONTRACT_UI"
	name = "PAYOR_CONTRACT_MAPPING"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.PAYOR_CONTRACT_UI.PAYOR_CONTRACT_MAPPING
