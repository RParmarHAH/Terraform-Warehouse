resource "snowflake_table" "DISC_HHAEXCHANGEPREFERRED_PAYROLL_OTHERCHARGESADJUSTMENTS_REPL" {
    ...
    -- NAME :  DISC_PROD.HHAEXCHANGEPREFERRED.PAYROLL_OTHERCHARGESADJUSTMENTS_REPL
