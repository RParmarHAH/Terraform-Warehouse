resource "snowflake_table" "DISC_HHAEXCHANGEPREFERRED_TBLVISITS_REPL_TEMP" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "HHAEXCHANGEPREFERRED"
	name = "TBLVISITS_REPL_TEMP"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.HHAEXCHANGEPREFERRED.TBLVISITS_REPL_TEMP CLUSTER BY
