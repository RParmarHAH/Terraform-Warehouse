resource "snowflake_table" "DISC_HHAEXCHANGEPREFERRED_VISITINFO_REPL_TEMP" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "HHAEXCHANGEPREFERRED"
	name = "VISITINFO_REPL_TEMP"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.HHAEXCHANGEPREFERRED.VISITINFO_REPL_TEMP CLUSTER BY
