resource "snowflake_table" "DISC_HHAEXCHANGEPREFERRED_PAYROLL_OTHERCHARGESDETAILS_REPL" {
    ...
    -- NAME :  DISC_PROD.HHAEXCHANGEPREFERRED.PAYROLL_OTHERCHARGESDETAILS_REPL
