resource "snowflake_table" "DISC_HHAEXCHANGEPREFERRED_CAREGIVERPERMANENTWEEKAVAILABILITY" {
    ...
    -- NAME :  DISC_PROD.HHAEXCHANGEPREFERRED.CAREGIVERPERMANENTWEEKAVAILABILITY
