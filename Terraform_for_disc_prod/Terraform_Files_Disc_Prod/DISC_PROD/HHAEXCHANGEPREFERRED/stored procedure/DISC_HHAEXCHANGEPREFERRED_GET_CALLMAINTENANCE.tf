resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_CALLMAINTENANCE" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_CallMaintenance 
--
