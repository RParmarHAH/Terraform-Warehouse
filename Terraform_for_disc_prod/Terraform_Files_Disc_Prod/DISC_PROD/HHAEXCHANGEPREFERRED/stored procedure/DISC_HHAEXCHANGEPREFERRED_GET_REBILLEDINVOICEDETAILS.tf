resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_REBILLEDINVOICEDETAILS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_RebilledInvoiceDetails 
--
