resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_OFFICE_OFFICES_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_Office_Offices_REPL 
--
