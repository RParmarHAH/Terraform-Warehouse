resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_PLACEMENTMASTERWEEK" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_PlacementMasterWeek 
--
