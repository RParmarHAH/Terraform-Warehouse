resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_CALENDARBILLEDNOTES" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_CalendarBilledNotes 
--
