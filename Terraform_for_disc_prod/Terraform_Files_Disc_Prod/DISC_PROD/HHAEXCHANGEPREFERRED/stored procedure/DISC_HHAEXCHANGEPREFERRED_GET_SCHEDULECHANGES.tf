resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_SCHEDULECHANGES" {
	name ="GET_SCHEDULECHANGES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_ScheduleChanges 
--
