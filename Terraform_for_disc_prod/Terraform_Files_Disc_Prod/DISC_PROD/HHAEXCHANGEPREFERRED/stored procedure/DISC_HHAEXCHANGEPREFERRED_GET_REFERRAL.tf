resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_REFERRAL" {
	name ="GET_REFERRAL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_Referral 
--
