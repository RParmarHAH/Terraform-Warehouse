resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_TBLVISITS_REPL" {
	name ="GET_TBLVISITS_REPL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_tblVisits_REPL 
--
