resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_VISITUNBILLEDDETAILS" {
	name ="GET_VISITUNBILLEDDETAILS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_VisitUnbilledDetails 
--
