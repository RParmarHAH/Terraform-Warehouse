resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_CALENDARREASONNOTES" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_CalendarReasonNotes 
--
