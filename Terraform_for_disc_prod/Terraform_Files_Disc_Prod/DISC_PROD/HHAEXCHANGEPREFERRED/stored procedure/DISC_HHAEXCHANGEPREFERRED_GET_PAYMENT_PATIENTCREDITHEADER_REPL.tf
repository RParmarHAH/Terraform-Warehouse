resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_PAYMENT_PATIENTCREDITHEADER_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_Payment_PatientCreditHeader_REPL 
--
