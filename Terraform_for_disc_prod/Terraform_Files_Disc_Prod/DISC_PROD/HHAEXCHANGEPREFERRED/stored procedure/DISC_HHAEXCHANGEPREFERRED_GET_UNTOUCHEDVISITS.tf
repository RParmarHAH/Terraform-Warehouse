resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_UNTOUCHEDVISITS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_UntouchedVisits 
--
