resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_CAREGIVERCUSTOMFIELDS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_CaregiverCustomFields 
--
