resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_STAGE_PATIENTAUTHORIZATION" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_stage_PatientAuthorization 
--
