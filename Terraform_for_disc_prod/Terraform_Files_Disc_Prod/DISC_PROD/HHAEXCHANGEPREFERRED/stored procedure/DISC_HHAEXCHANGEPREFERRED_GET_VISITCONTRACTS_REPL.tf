resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_VISITCONTRACTS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_VisitContracts_REPL 
--
