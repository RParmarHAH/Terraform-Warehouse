resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_VISITS" {
	name ="GET_VISITS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_Visits 
--
