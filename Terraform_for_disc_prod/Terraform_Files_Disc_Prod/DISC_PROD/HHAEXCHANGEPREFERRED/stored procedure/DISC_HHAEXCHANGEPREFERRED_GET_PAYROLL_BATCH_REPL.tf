resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_PAYROLL_BATCH_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_Payroll_Batch_REPL 
--
