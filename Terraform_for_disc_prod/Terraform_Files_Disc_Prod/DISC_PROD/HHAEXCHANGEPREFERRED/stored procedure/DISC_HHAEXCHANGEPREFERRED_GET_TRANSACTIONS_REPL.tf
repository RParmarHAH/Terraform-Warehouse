resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_TRANSACTIONS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_Transactions_REPL 
--
