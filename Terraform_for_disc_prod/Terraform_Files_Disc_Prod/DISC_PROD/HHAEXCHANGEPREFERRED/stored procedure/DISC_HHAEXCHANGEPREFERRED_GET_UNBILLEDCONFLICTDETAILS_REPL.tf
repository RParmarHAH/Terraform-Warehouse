resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_UNBILLEDCONFLICTDETAILS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_UnbilledConflictDetails_REPL 
--
