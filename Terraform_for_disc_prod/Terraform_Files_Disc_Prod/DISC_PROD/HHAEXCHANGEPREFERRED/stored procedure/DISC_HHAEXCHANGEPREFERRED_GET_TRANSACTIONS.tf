resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_TRANSACTIONS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_Transactions 
--
