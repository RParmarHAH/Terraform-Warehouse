resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_PAYROLL_OTHERCHARGESADJUSTMENTS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_Payroll_OtherChargesAdjustments_REPL 
--
