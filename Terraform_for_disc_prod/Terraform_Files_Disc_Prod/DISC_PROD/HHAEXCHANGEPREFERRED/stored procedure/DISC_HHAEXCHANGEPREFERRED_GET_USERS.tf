resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_USERS" {
	name ="GET_USERS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_Users 
--
