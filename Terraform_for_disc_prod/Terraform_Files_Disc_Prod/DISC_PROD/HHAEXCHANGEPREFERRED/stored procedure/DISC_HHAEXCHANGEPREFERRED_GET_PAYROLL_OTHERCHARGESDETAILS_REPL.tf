resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_PAYROLL_OTHERCHARGESDETAILS_REPL" {
	name ="GET_PAYROLL_OTHERCHARGESDETAILS_REPL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_Payroll_OtherChargesDetails_REPL 
--
