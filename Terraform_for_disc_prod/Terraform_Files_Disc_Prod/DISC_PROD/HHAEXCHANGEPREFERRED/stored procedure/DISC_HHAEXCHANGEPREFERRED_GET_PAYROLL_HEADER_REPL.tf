resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_PAYROLL_HEADER_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_Payroll_Header_REPL 
--
