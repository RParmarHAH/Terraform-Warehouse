resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_STAGE_TBLPOCHEADER_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_stage_TblPOCHeader_REPL 
--
