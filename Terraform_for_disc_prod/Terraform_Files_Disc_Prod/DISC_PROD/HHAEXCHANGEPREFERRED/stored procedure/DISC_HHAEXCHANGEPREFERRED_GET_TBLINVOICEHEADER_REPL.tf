resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_TBLINVOICEHEADER_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_tblInvoiceHeader_REPL 
--
