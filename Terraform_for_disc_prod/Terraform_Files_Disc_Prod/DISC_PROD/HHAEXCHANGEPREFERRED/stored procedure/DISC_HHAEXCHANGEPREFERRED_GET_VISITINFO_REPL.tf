resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_VISITINFO_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_VisitInfo_REPL 
--
