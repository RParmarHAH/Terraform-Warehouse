resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_BATCHSUBMISSIONSUMMARY" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_BatchSubmissionSummary 
--
