resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_INVOICEDETAILS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_InvoiceDetails 
--
