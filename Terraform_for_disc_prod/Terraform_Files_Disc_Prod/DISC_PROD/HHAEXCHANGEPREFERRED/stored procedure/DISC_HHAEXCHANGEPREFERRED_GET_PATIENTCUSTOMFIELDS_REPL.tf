resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_PATIENTCUSTOMFIELDS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_PatientCustomFields_REPL 
--
