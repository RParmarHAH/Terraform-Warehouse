resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_STAGE_PATIENTS" {
...
CREATE OR REPLACE TABLE DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.stage_Patients
 ...
 FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.hist_stage_Patients P 
...
create OR REPLACE table DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.hist_stage_Patients CLONE DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.stage_Patients;
------------------------------------------------------------------------------------------------------
END;
