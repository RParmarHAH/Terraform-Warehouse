resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_BILLING_CHECKDETAILS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_Billing_CheckDetails_REPL 
--
