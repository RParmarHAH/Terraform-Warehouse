resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_SERVICECODES" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_ServiceCodes 
--
