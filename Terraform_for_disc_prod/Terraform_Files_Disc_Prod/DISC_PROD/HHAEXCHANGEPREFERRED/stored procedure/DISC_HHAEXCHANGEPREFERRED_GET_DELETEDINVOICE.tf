resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_DELETEDINVOICE" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_DeletedInvoice 
--
