resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_INSERVICE_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_InService_REPL 
--
