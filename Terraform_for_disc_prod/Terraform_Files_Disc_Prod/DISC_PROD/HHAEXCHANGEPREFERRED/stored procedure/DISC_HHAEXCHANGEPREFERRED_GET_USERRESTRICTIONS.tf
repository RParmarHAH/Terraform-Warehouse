resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_USERRESTRICTIONS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_UserRestrictions 
--
