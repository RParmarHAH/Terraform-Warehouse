resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_PAYMENT_VISITADJUSTMENTS_REPL" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_Payment_VisitAdjustments_REPL 
--
