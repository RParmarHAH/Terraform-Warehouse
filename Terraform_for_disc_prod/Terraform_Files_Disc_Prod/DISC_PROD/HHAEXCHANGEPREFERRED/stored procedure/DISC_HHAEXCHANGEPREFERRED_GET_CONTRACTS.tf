resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_CONTRACTS" {
	name ="GET_CONTRACTS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_Contracts 
--
