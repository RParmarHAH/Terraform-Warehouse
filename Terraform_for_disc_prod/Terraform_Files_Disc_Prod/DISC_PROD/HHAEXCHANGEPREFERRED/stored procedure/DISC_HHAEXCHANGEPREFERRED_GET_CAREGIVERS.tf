resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_CAREGIVERS" {
	name ="GET_CAREGIVERS"
...
CREATE OR REPLACE TABLE DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.Caregivers 
 ...
 FROM DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.Hist_Caregivers P 
...
create OR REPLACE table DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.Hist_Caregivers CLONE DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.Caregivers;
------------------------------------------------------------------------------------------------------
 END;
