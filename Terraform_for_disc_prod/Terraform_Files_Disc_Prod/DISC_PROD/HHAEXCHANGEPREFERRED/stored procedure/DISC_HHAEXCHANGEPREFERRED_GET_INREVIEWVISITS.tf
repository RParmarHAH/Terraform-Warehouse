resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_INREVIEWVISITS" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_InReviewVisits 
--
