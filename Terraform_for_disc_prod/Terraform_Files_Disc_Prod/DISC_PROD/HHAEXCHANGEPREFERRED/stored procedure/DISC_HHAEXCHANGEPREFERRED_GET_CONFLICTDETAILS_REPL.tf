resource "snowflake_procedure" "DISC_HHAEXCHANGEPREFERRED_GET_CONFLICTDETAILS_REPL" {
	name ="GET_CONFLICTDETAILS_REPL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.HHAEXCHANGEPREFERRED.GET_ConflictDetails_REPL 
--
