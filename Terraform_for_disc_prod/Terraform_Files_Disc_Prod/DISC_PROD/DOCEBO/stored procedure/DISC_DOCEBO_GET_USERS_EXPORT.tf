resource "snowflake_procedure" "DISC_DOCEBO_GET_USERS_EXPORT" {
	name ="GET_USERS_EXPORT"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.DOCEBO.GET_USERS_EXPORT 
--
