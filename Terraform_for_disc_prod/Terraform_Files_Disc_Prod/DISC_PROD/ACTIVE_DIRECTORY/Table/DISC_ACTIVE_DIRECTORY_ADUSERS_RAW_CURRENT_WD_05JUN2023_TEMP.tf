resource "snowflake_table" "DISC_ACTIVE_DIRECTORY_ADUSERS_RAW_CURRENT_WD_05JUN2023_TEMP" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "ACTIVE_DIRECTORY"
	name = "ADUSERS_RAW_CURRENT_WD_05JUN2023_TEMP"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.ACTIVE_DIRECTORY.ADUSERS_RAW_CURRENT_WD_05JUN2023_TEMP
