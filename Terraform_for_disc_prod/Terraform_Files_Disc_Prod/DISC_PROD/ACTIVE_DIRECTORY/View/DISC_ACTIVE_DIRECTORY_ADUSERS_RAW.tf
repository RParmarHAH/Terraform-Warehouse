resource "snowflake_view" "DISC_ACTIVE_DIRECTORY_ADUSERS_RAW" {
...
FROM @DISC_${var.SF_ENVIRONMENT}.Stage.AWSAZSTAGEPROD/ActiveDirectory/ADExport_05-16-2022.csv (file_format => DISC_${var.SF_ENVIRONMENT}.STAGE.CSV_Format) a ; -- changed STAGE/file_format FOR AWS Migration RSUTHAR,KDHOKAI
SQL
	or_replace = true 
	is_secure = false 
}
