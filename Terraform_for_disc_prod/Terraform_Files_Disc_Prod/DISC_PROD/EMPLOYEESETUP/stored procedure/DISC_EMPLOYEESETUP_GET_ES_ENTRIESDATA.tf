resource "snowflake_procedure" "DISC_EMPLOYEESETUP_GET_ES_ENTRIESDATA" {
	name ="GET_ES_ENTRIESDATA"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.EmployeeSetup.GET_ES_EntriesData 
--
