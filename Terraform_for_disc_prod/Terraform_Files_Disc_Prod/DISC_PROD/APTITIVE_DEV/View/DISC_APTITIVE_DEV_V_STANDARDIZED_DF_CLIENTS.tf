resource "snowflake_view" "DISC_APTITIVE_DEV_V_STANDARDIZED_DF_CLIENTS" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "APTITIVE_DEV"
	name = "V_STANDARDIZED_DF_CLIENTS"
	statement = <<-SQL
	 /***********************************************************************************************
...
FROM DISC_${var.SF_ENVIRONMENT}.DATAFLEXSYNCDATA.DFCLIENTS
