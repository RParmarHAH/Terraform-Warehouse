resource "snowflake_table" "DISC_STAGE_DISC_PROD_TABLE_DETAILS_20230722" {
	database = "DISC_${var.SF_ENVIRONMENT}"
	schema = "STAGE"
	name = "DISC_PROD_TABLE_DETAILS_20230722"
	change_tracking = false
	comment = " 
    --*****************************************************************************************************************************

    -- NAME :  DISC_PROD.STAGE.DISC_PROD_TABLE_DETAILS_20230722
