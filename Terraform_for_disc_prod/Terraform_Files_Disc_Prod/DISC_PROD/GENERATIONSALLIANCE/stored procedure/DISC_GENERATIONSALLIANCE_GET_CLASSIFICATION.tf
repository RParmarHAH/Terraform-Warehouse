resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CLASSIFICATION" {
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_classification 
--
