resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_DELETEDSCHEDULEAUDIT" {
	name ="GET_DELETEDSCHEDULEAUDIT"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_DeletedScheduleAudit 
--
