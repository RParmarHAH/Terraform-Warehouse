resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_UB04MARGINS" {
	name ="GET_UB04MARGINS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_UB04Margins 
--
