resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TBL_IMAGES_APPLICANT" {
	name ="GET_TBL_IMAGES_APPLICANT"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tbl_images_applicant 
--
