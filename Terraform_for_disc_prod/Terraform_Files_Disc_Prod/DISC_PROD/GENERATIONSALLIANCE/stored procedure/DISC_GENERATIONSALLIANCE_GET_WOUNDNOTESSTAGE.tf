resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_WOUNDNOTESSTAGE" {
	name ="GET_WOUNDNOTESSTAGE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_WoundNotesStage 
--
