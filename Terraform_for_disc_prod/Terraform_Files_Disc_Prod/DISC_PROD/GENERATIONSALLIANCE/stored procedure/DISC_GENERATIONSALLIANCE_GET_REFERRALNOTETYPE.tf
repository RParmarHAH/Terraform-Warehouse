resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_REFERRALNOTETYPE" {
	name ="GET_REFERRALNOTETYPE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_ReferralNoteType 
--
