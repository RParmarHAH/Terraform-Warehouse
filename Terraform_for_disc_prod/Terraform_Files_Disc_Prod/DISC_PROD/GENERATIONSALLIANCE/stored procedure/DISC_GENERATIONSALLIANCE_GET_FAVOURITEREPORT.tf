resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_FAVOURITEREPORT" {
	name ="GET_FAVOURITEREPORT"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_FavouriteReport 
--
