resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TBL_ALERTFAILURE" {
	name ="GET_TBL_ALERTFAILURE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tbl_AlertFailure 
--
