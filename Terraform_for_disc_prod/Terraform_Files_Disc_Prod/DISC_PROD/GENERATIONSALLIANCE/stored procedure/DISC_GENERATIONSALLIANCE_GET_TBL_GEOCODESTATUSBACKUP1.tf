resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TBL_GEOCODESTATUSBACKUP1" {
	name ="GET_TBL_GEOCODESTATUSBACKUP1"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tbl_GeocodeStatusBackup1 
--
