resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TBL_IMAGES_CLIENT" {
	name ="GET_TBL_IMAGES_CLIENT"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tbl_images_client 
--
