resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CLIENTCMS1500" {
	name ="GET_CLIENTCMS1500"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_ClientCMS1500 
--
