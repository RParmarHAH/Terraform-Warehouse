resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_SANTRAXVISITSCHEDULE" {
	name ="GET_SANTRAXVISITSCHEDULE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_SantraxVisitSchedule 
--
