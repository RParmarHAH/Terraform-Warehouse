resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_APPNOTIFICATION" {
	name ="GET_APPNOTIFICATION"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_AppNotification 
--
