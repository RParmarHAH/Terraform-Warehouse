resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TMPAUTHVALIDATIONSHEADER" {
	name ="GET_TMPAUTHVALIDATIONSHEADER"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tmpAuthValidationsHeader 
--
