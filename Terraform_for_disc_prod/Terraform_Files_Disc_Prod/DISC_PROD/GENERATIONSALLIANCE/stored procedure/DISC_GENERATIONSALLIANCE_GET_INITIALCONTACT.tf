resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_INITIALCONTACT" {
	name ="GET_INITIALCONTACT"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_InitialContact 
--
