resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_SCHEDULEREQUEST" {
	name ="GET_SCHEDULEREQUEST"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_ScheduleRequest 
--
