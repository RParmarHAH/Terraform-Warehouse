resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TASKCATEGORY" {
	name ="GET_TASKCATEGORY"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_TaskCategory 
--
