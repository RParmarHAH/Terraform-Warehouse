resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CALLCENTERMULTIPLE" {
	name ="GET_CALLCENTERMULTIPLE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_CallCenterMultiple 
--
