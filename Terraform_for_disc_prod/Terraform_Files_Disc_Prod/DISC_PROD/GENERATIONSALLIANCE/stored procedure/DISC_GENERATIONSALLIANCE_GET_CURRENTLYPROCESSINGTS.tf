resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CURRENTLYPROCESSINGTS" {
	name ="GET_CURRENTLYPROCESSINGTS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_CurrentlyProcessingTS 
--
