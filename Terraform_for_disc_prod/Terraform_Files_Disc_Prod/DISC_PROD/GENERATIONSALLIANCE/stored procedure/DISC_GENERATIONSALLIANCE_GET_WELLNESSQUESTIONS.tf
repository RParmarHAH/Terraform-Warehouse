resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_WELLNESSQUESTIONS" {
	name ="GET_WELLNESSQUESTIONS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_WellnessQuestions 
--
