resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TELLUSLOCATIONSETTINGS" {
	name ="GET_TELLUSLOCATIONSETTINGS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_TellusLocationSettings 
--
