resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TMPQBTSAUDITCLASS" {
	name ="GET_TMPQBTSAUDITCLASS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tmpQbTsAuditClass 
--
