resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CAREGIVERACASTATUS" {
	name ="GET_CAREGIVERACASTATUS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_CaregiverACAStatus 
--
