resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TIMEZONEDETAIL" {
	name ="GET_TIMEZONEDETAIL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_TimeZoneDetail 
--
