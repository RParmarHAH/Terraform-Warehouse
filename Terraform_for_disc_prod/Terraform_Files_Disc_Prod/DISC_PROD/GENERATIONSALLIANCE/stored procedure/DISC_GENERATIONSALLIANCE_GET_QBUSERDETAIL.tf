resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_QBUSERDETAIL" {
	name ="GET_QBUSERDETAIL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_QbUserDetail 
--
