resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CAREBRIDGELOG" {
	name ="GET_CAREBRIDGELOG"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_CareBridgeLog 
--
