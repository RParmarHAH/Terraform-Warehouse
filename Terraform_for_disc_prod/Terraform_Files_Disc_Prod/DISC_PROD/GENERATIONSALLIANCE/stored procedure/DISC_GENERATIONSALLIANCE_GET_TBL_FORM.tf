resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TBL_FORM" {
	name ="GET_TBL_FORM"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tbl_form 
--
