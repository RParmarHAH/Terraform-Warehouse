resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CLIENT" {
	name ="GET_CLIENT"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_client 
--
