resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_QBERRORLOG" {
	name ="GET_QBERRORLOG"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_QbErrorLog 
--
