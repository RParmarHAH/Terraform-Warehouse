resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CLIENTPAYORCODE" {
	name ="GET_CLIENTPAYORCODE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_ClientPayorCode 
--
