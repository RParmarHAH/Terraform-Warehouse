resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_APPLICATIONDETAILS" {
	name ="GET_APPLICATIONDETAILS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_ApplicationDetails 
--
