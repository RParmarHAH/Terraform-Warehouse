resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TMPQB" {
	name ="GET_TMPQB"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tmpQB 
--
