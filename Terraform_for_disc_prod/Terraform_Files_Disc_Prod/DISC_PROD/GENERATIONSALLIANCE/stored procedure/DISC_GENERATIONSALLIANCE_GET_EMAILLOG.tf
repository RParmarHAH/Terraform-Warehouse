resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_EMAILLOG" {
	name ="GET_EMAILLOG"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_EmailLog 
--
