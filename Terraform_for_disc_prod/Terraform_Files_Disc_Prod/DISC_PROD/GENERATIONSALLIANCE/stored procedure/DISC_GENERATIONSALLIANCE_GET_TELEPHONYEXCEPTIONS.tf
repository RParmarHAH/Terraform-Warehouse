resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TELEPHONYEXCEPTIONS" {
	name ="GET_TELEPHONYEXCEPTIONS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_TelephonyExceptions 
--
