resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_AGENCY" {
	name ="GET_AGENCY"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_agency 
--
