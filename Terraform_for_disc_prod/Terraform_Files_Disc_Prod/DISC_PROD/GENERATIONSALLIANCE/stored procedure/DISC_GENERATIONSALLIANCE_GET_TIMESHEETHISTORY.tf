resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TIMESHEETHISTORY" {
	name ="GET_TIMESHEETHISTORY"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_TimesheetHistory 
--
