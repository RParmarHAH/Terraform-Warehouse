resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_SCREENINGQUESTION" {
	name ="GET_SCREENINGQUESTION"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_ScreeningQuestion 
--
