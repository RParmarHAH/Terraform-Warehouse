resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CLIENTWOUNDMASTER" {
	name ="GET_CLIENTWOUNDMASTER"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_ClientWoundMaster 
--
