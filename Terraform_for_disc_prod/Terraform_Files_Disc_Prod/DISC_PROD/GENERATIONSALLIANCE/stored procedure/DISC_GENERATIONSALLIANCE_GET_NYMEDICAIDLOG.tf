resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_NYMEDICAIDLOG" {
	name ="GET_NYMEDICAIDLOG"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_NYMedicaidLog 
--
