resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_APDICONNECTFLLOG" {
	name ="GET_APDICONNECTFLLOG"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_APDiConnectFLLog 
--
