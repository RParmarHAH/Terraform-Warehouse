resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_SCHEDULEDTASKDELETED418955" {
	name ="GET_SCHEDULEDTASKDELETED418955"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_ScheduledTaskDeleted418955 
--
