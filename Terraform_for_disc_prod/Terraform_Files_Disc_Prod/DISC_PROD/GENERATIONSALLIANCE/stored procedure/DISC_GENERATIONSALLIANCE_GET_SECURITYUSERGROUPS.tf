resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_SECURITYUSERGROUPS" {
	name ="GET_SECURITYUSERGROUPS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_securityUserGroups 
--
