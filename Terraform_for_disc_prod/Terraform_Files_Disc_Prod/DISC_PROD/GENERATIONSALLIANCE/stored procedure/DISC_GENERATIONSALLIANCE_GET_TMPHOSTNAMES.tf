resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TMPHOSTNAMES" {
	name ="GET_TMPHOSTNAMES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tmpHostnames 
--
