resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CLASS" {
	name ="GET_CLASS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_class 
--
