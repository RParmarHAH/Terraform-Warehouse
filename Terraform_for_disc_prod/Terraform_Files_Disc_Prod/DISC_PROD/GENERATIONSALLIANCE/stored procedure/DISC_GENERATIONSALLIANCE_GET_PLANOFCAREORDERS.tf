resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_PLANOFCAREORDERS" {
	name ="GET_PLANOFCAREORDERS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_planofcareorders 
--
