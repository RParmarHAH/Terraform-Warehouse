resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CLIENTNOTETYPE" {
	name ="GET_CLIENTNOTETYPE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_clientNoteType 
--
