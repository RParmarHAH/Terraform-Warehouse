resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TBL_TEMP_SCHEDULES" {
	name ="GET_TBL_TEMP_SCHEDULES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tbl_temp_schedules 
--
