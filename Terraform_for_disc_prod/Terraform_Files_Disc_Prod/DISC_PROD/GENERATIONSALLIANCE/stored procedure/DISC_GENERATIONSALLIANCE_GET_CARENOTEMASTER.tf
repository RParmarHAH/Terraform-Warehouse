resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CARENOTEMASTER" {
	name ="GET_CARENOTEMASTER"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_CareNoteMaster 
--
