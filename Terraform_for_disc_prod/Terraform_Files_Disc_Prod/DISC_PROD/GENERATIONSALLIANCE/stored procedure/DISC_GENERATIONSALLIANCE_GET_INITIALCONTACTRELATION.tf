resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_INITIALCONTACTRELATION" {
	name ="GET_INITIALCONTACTRELATION"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_InitialContactRelation 
--
