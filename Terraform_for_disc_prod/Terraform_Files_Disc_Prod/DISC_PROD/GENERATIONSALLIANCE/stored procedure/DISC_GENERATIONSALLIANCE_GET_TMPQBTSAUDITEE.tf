resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TMPQBTSAUDITEE" {
	name ="GET_TMPQBTSAUDITEE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tmpQbTsAuditEE 
--
