resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TIMESHEETSAB" {
	name ="GET_TIMESHEETSAB"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_timesheetsab 
--
