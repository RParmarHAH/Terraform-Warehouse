resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_DELETEDSCHEDULEDTASK" {
	name ="GET_DELETEDSCHEDULEDTASK"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_DeletedScheduledTask 
--
