resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TMPSELECTEDTS" {
	name ="GET_TMPSELECTEDTS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_TmpSelectedTs 
--
