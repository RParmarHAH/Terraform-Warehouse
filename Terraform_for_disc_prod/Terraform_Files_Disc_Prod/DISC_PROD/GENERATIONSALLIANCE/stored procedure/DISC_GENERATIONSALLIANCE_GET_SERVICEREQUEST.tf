resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_SERVICEREQUEST" {
	name ="GET_SERVICEREQUEST"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_servicerequest 
--
