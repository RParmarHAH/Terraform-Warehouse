resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TELEPHONYRESOLUTIONS" {
	name ="GET_TELEPHONYRESOLUTIONS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_TelephonyResolutions 
--
