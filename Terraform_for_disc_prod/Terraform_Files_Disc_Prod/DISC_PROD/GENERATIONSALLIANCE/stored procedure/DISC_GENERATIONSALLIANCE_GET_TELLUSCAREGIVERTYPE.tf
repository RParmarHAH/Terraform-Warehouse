resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TELLUSCAREGIVERTYPE" {
	name ="GET_TELLUSCAREGIVERTYPE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_TellusCaregiverType 
--
