resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TELLUSLOG" {
	name ="GET_TELLUSLOG"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_TellusLog 
--
