resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TBLREPORT_WIZARD_SOURCES" {
	name ="GET_TBLREPORT_WIZARD_SOURCES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tblReport_Wizard_Sources 
--
