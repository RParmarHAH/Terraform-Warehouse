resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CLIENTCARENOTEDETAIL" {
	name ="GET_CLIENTCARENOTEDETAIL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_ClientCareNoteDetail 
--
