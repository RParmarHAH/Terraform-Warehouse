resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CLIENTACCESSLOG" {
	name ="GET_CLIENTACCESSLOG"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_ClientAccessLog 
--
