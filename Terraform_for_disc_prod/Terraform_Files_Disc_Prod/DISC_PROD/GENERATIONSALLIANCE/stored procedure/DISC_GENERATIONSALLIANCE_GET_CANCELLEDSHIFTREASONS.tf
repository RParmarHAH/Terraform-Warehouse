resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CANCELLEDSHIFTREASONS" {
	name ="GET_CANCELLEDSHIFTREASONS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_CancelledShiftReasons 
--
