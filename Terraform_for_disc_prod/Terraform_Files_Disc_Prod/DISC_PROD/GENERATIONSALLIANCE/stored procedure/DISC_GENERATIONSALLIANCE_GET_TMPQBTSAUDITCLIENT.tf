resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TMPQBTSAUDITCLIENT" {
	name ="GET_TMPQBTSAUDITCLIENT"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tmpQbTsAuditClient 
--
