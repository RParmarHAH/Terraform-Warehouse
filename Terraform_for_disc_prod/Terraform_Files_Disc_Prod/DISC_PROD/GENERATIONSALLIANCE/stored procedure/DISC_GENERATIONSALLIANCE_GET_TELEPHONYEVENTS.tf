resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TELEPHONYEVENTS" {
	name ="GET_TELEPHONYEVENTS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_TelephonyEvents 
--
