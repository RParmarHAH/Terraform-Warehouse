resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_HCFA1500RPT" {
	name ="GET_HCFA1500RPT"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_HCFA1500rpt 
--
