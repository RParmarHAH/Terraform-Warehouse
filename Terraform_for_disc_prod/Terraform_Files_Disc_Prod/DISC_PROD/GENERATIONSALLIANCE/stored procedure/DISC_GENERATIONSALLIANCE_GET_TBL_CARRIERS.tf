resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TBL_CARRIERS" {
	name ="GET_TBL_CARRIERS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tbl_Carriers 
--
