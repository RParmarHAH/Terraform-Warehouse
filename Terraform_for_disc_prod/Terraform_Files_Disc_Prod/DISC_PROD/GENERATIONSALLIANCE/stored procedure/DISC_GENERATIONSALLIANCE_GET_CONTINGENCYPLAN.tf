resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CONTINGENCYPLAN" {
	name ="GET_CONTINGENCYPLAN"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_ContingencyPlan 
--
