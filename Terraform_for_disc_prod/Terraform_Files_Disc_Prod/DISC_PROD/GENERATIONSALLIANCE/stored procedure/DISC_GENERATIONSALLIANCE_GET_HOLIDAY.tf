resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_HOLIDAY" {
	name ="GET_HOLIDAY"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_holiday 
--
