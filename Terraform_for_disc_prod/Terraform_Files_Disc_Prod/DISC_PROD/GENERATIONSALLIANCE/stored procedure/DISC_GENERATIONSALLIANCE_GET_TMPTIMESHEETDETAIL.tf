resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TMPTIMESHEETDETAIL" {
	name ="GET_TMPTIMESHEETDETAIL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tmpTimesheetDetail 
--
