resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_APPLICATIONEDUCATIONDETAILS" {
	name ="GET_APPLICATIONEDUCATIONDETAILS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_ApplicationEducationDetails 
--
