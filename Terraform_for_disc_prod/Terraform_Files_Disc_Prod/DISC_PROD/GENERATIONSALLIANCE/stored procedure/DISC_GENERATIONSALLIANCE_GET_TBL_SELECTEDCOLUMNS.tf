resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TBL_SELECTEDCOLUMNS" {
	name ="GET_TBL_SELECTEDCOLUMNS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tbl_selectedcolumns 
--
