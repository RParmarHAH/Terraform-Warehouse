resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_PAYOREXCLUSIONS" {
	name ="GET_PAYOREXCLUSIONS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_PayorExclusions 
--
