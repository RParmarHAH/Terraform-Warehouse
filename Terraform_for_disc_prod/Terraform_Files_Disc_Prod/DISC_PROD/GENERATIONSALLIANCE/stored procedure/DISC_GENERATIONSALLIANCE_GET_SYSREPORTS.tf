resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_SYSREPORTS" {
	name ="GET_SYSREPORTS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_sysReports 
--
