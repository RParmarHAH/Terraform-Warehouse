resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TBL_LOCATION" {
	name ="GET_TBL_LOCATION"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tbl_location 
--
