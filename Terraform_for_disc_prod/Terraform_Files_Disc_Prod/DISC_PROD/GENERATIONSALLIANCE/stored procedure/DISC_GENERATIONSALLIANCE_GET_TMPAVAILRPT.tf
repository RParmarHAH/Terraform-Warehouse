resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TMPAVAILRPT" {
	name ="GET_TMPAVAILRPT"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tmpAvailRpt 
--
