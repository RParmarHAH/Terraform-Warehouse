resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CARENOTECATEGORY" {
	name ="GET_CARENOTECATEGORY"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_CareNoteCategory 
--
