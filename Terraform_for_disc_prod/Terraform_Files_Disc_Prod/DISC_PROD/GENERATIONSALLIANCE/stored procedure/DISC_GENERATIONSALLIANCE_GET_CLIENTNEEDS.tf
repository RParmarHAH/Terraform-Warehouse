resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CLIENTNEEDS" {
	name ="GET_CLIENTNEEDS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_ClientNeeds 
--
