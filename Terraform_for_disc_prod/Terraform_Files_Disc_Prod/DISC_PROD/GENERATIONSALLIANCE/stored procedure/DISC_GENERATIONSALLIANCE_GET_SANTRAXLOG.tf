resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_SANTRAXLOG" {
	name ="GET_SANTRAXLOG"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_SantraxLog 
--
