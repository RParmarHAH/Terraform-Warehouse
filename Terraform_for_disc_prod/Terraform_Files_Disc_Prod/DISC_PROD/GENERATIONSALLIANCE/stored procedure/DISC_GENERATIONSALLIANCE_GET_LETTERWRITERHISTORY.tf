resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_LETTERWRITERHISTORY" {
	name ="GET_LETTERWRITERHISTORY"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_LetterWriterHistory 
--
