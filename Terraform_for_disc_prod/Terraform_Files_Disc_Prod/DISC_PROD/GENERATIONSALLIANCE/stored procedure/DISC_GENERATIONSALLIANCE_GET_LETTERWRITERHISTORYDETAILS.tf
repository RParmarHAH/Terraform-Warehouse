resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_LETTERWRITERHISTORYDETAILS" {
	name ="GET_LETTERWRITERHISTORYDETAILS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_LetterWriterHistoryDetails 
--
