resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_REFERREDBY" {
	name ="GET_REFERREDBY"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_Referredby 
--
