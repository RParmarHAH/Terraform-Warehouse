resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_ITEMTYPE" {
	name ="GET_ITEMTYPE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_itemtype 
--
