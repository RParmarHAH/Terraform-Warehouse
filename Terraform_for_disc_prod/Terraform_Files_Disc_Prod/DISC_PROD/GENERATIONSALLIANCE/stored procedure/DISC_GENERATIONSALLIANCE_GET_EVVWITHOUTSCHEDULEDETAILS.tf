resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_EVVWITHOUTSCHEDULEDETAILS" {
	name ="GET_EVVWITHOUTSCHEDULEDETAILS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_EVVwithoutScheduleDetails 
--
