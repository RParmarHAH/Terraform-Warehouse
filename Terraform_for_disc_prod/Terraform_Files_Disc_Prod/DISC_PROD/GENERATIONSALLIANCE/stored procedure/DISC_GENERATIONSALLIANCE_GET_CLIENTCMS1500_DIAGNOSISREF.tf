resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CLIENTCMS1500_DIAGNOSISREF" {
	name ="GET_CLIENTCMS1500_DIAGNOSISREF"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_ClientCMS1500_DiagnosisRef 
--
