resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CSVSCHEDULEIMPORT" {
	name ="GET_CSVSCHEDULEIMPORT"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_CSVScheduleImport 
--
