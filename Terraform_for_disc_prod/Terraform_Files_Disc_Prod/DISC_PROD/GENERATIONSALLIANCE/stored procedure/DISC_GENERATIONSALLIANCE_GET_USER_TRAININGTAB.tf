resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_USER_TRAININGTAB" {
	name ="GET_USER_TRAININGTAB"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_User_TrainingTab 
--
