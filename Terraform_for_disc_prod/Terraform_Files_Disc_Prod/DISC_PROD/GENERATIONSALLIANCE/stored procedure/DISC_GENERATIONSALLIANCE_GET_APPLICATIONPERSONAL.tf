resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_APPLICATIONPERSONAL" {
	name ="GET_APPLICATIONPERSONAL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_ApplicationPersonal 
--
