resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TELEPHONYXVERSION" {
	name ="GET_TELEPHONYXVERSION"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_TelephonyXVersion 
--
