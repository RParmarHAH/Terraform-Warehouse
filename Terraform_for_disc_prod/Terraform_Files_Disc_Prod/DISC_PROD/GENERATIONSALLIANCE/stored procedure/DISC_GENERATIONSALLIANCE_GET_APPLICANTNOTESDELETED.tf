resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_APPLICANTNOTESDELETED" {
	name ="GET_APPLICANTNOTESDELETED"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_ApplicantNotesDeleted 
--
