resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_AUTHORIZATIONPERIODS" {
	name ="GET_AUTHORIZATIONPERIODS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_authorizationPeriods 
--
