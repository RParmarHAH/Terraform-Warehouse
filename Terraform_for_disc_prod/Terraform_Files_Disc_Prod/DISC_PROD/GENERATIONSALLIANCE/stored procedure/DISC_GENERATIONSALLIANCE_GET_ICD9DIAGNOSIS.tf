resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_ICD9DIAGNOSIS" {
	name ="GET_ICD9DIAGNOSIS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_icd9diagnosis 
--
