resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TRAVELTIMESCHEDULES" {
	name ="GET_TRAVELTIMESCHEDULES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_TravelTimeSchedules 
--
