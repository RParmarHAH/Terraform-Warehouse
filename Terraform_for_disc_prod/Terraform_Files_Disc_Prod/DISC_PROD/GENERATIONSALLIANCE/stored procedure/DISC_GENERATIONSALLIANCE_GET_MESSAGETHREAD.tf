resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_MESSAGETHREAD" {
	name ="GET_MESSAGETHREAD"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_MessageThread 
--
