resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_SERVICEREQUESTDETAIL" {
	name ="GET_SERVICEREQUESTDETAIL"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_servicerequestdetail 
--
