resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TMPQBTSAUDITSERVICEITEMS" {
	name ="GET_TMPQBTSAUDITSERVICEITEMS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tmpQbTsAuditServiceItems 
--
