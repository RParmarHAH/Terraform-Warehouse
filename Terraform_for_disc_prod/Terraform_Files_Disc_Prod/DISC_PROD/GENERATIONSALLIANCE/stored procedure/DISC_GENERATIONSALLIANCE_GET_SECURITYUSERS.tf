resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_SECURITYUSERS" {
	name ="GET_SECURITYUSERS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_securityUsers 
--
