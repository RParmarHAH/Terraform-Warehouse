resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_REPROTWRITERCUSTOMCOLUMN_WEB" {
	name ="GET_REPROTWRITERCUSTOMCOLUMN_WEB"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_ReprotWriterCustomColumn_web 
--
