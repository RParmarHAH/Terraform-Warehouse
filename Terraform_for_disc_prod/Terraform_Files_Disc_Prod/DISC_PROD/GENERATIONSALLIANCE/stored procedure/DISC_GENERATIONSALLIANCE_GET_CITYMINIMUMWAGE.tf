resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CITYMINIMUMWAGE" {
	name ="GET_CITYMINIMUMWAGE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_CityMinimumWage 
--
