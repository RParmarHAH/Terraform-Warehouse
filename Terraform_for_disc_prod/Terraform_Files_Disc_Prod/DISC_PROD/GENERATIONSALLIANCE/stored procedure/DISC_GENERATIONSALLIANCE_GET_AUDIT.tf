resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_AUDIT" {
	name ="GET_AUDIT"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_Audit 
--
