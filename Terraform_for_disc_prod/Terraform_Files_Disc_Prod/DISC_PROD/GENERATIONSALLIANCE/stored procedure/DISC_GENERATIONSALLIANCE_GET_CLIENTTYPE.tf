resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CLIENTTYPE" {
	name ="GET_CLIENTTYPE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_ClientType 
--
