resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TBL_REASONS" {
	name ="GET_TBL_REASONS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tbl_reasons 
--
