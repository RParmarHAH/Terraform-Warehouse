resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_INSERVICEMASTER" {
	name ="GET_INSERVICEMASTER"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_InserviceMaster 
--
