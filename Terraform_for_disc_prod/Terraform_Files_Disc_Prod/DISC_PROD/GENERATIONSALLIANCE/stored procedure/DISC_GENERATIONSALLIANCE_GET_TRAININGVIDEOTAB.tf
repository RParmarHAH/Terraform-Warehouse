resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TRAININGVIDEOTAB" {
	name ="GET_TRAININGVIDEOTAB"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_TrainingVideoTab 
--
