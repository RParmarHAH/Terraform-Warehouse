resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TBL_IMAGES" {
	name ="GET_TBL_IMAGES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tbl_images 
--
