resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TBL_TEMP_CAREGIVERSCHEDULES" {
	name ="GET_TBL_TEMP_CAREGIVERSCHEDULES"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tbl_temp_caregiverSchedules 
--
