resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_PAYCHEXHISTORY" {
	name ="GET_PAYCHEXHISTORY"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_paychexHistory 
--
