resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TIMESHEETDETAILAB" {
	name ="GET_TIMESHEETDETAILAB"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_timesheetdetailab 
--
