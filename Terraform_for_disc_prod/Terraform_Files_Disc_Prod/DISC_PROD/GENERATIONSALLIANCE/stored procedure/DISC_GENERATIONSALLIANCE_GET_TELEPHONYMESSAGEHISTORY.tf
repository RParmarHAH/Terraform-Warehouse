resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TELEPHONYMESSAGEHISTORY" {
	name ="GET_TELEPHONYMESSAGEHISTORY"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_TelephonyMessageHistory 
--
