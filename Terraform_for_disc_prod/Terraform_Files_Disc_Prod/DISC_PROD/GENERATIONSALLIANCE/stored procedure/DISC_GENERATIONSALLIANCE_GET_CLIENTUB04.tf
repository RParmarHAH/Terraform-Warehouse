resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CLIENTUB04" {
	name ="GET_CLIENTUB04"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_ClientUB04 
--
