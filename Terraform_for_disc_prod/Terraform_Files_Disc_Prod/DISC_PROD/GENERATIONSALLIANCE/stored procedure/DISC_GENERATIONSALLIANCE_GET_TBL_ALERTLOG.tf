resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TBL_ALERTLOG" {
	name ="GET_TBL_ALERTLOG"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tbl_AlertLog 
--
