resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TMPREMOVALS" {
	name ="GET_TMPREMOVALS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tmpRemovals 
--
