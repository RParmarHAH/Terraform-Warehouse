resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TELEPHONYOPTIONS" {
	name ="GET_TELEPHONYOPTIONS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_TelephonyOptions 
--
