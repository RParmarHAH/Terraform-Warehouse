resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TBL_SECURITYUSERS_LOCATION" {
	name ="GET_TBL_SECURITYUSERS_LOCATION"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_tbl_securityusers_location 
--
