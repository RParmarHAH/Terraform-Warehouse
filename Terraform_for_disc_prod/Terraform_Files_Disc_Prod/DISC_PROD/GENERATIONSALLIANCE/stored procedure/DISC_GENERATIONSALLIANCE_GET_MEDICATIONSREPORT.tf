resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_MEDICATIONSREPORT" {
	name ="GET_MEDICATIONSREPORT"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_medicationsReport 
--
