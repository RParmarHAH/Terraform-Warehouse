resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_CUSTOMFILTERCOLUMNS" {
	name ="GET_CUSTOMFILTERCOLUMNS"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_CustomFilterColumns 
--
