resource "snowflake_procedure" "DISC_GENERATIONSALLIANCE_GET_TELEPHONYMESSAGE" {
	name ="GET_TELEPHONYMESSAGE"
...
--*****************************************************************************************************************************
-- NAME:  DISC_${var.SF_ENVIRONMENT}.GENERATIONSALLIANCE.GET_TelephonyMessage 
--
